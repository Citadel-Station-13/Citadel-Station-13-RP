...
/**
 * @param {string|null|undefined} namedVersion
 * @returns {Promise<string>}
 */
async function getDmPath(namedVersion) {
 ...
 * @returns {Promise<string>}
 */
async function getNamedByondVersionPath(namedVersion) {
...
/** @returns {Promise<string[]>} */
async function getDefaultNamedByondVersionPath() {
 ...
 * @returns {{name: string; path: string; default: boolean;}[]}
 */
...
/**
 *
 * @param {{dmbFile: string; namedDmVersion?: string | null;}} options
 * @param  {any[]} args
 * @returns {Promise<Juke.ExecReturn>}
 */
