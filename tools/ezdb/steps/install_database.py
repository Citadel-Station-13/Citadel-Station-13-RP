...
class InstallDatabase(Step):
    ...
    def run(args: argparse.Namespace):
        ...
        with open(get_config_path(), "w") as file:
            ...
            file.write(f"SQL_PORT {args.port}\n")
            file.write(f"SQL_USER root\n")
            file.write(f"SQL_PASSWORD {password}\n")
            file.write("SQL_DATABASE tgstation\n")
            file.write("SQL_SERVER_PREFIX\n")
