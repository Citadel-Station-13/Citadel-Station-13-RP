...
# ugh
excluded_specific_dir = [
    "code/game/content/factions/derelict/derelict.dm",
    "code/game/content/factions/derelict/derelict.dmi",
    "code/game/content/factions/eldritch/eldritch.dm",
    "code/game/content/factions/eldritch/eldritch.dmi",
    "code/game/content/factions/fey_forest/fey_forest.dmi",
]

for applicable_file in files_to_scan:
    if applicable_file in excluded_specific_dir:
        continue
