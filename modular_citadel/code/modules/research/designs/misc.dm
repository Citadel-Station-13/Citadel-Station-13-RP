/datum/design/item/translator_all
	...
	materials = list(MATERIAL_ID_STEEL = 3000, MATERIAL_ID_GLASS = 3000, MATERIAL_ID_GOLD = 500, MATERIAL_ID_SILVER = 500)
...
/datum/design/item/ear_translator_all
  ...
  materials = list(MATERIAL_ID_STEEL = 2000, MATERIAL_ID_GLASS = 2000, MATERIAL_ID_GOLD = 2000, MATERIAL_ID_SILVER = 2000)
