...
/proc/pollCandidatesForMob(Question, jobbanType, poll_time = 300, mob/M, ignore_category = null)
	var/list/L = pollGhostCandidates(Question, jobbanType, poll_time, ignore_category)
	if(!M || QDELETED(M) || !M.loc)
		return list()
	return L

/proc/get_all_ghost_role_eligible()
...
/proc/pollGhostCandidates(Question, jobbanType, poll_time = 300, ignore_category = null, flashwindow = TRUE)
	var/list/candidates = get_all_ghost_role_eligible()
	return pollCandidates(Question, jobbanType, poll_time, ignore_category, flashwindow, candidates)

/proc/pollCandidates(Question, jobbanType, poll_time = 300, ignore_category = null, flashwindow = TRUE, list/group = null)
