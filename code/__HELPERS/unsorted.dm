...
/proc/DirBlocked(turf/loc,var/dir)
	...
	for(var/obj/machinery/door/D in loc)
		...
		else return TRUE	// it's a real, air blocking door
	return FALSE
...
/proc/get_random_color(var/simple, var/lower=0, var/upper=255)
	var/color
	if(simple)
		color = pick(list("FF0000","FF7F00","FFFF00","00FF00","0000FF","4B0082","8F00FF"))
	else
		for(var/i=1;i<=3;i++)
...
//Sender is optional
/proc/admin_chat_message(var/message = "Debug Message", var/color = COLOR_WHITE, var/sender)
	if(message)
