...
//This will update a mob's name, real_name, mind.name, GLOB.data_core records, pda and id
...
/proc/get_fancy_list_of_atom_types()
	...
	if (!pre_generated_list) //init
		pre_generated_list = get_typepath_shortnames(typesof(/atom))
	return pre_generated_list

/proc/get_fancy_list_of_datum_types()
	var/static/list/pre_generated_list
	if (!pre_generated_list) //init
		pre_generated_list = get_typepath_shortnames(sortList(typesof(/datum) - typesof(/atom)))
	return pre_generated_list
