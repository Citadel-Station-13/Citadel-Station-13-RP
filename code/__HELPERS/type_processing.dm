...
/proc/make_types_fancy(list/types)
	...
	var/static/list/shortcut_lookup = list(
		...
		/obj/item/vehicle_component/integral  = "//vehicle_integral",
		/obj/item/vehicle_component/module = "//vehicle_module",
		/obj/item/vehicle_component/module/weapon = "//vehicle_weapon",
