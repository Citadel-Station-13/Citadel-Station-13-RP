...
var/global/list/remainless_species = list(SPECIES_ID_PROMETHEAN,
				...
				SPECIES_ID_ALRAUNE,
				SPECIES_ID_PROTEAN,
				SPECIES_ID_MONKEY, //Exclude all monkey subtypes, to prevent abuse of it. They aren't,
				SPECIES_ID_MONKEY_TAJ, //set to have remains anyway, but making double sure,
				SPECIES_ID_MONKEY_SKRELL,
				SPECIES_ID_MONKEY_UNATHI,
				SPECIES_ID_MONKEY_AKULA,
				SPECIES_ID_MONKEY_NEVREAN,
				SPECIES_ID_MONKEY_SERGAL,
				SPECIES_ID_MONKEY_VULPKANIN,
				SPECIES_ID_XENO, //Same for xenos,
				SPECIES_ID_XENO_DRONE,
				SPECIES_ID_XENO_HUNTER,
				SPECIES_ID_XENO_SENTINEL,
				SPECIES_ID_XENO_QUEEN,
				SPECIES_ID_SHADOW,
