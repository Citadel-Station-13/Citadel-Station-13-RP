...
/proc/make_datum_reference_lists()
	...
	tim_sort(hair_styles_list, GLOBAL_PROC_REF(cmp_name_asc), associative = TRUE)
	...
	tim_sort(facial_hair_styles_list, GLOBAL_PROC_REF(cmp_name_asc), associative = TRUE)
	...
	tim_sort(body_marking_styles_list, GLOBAL_PROC_REF(cmp_name_asc), associative = TRUE)
