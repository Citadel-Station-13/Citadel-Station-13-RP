...
/proc/command_name()
	if(istype(using_map_legacy()))
		return using_map_legacy().boss_name

/proc/change_command_name(var/name)

	using_map_legacy().boss_name = name
...
/proc/system_name()
	return using_map_legacy().starsys_name

/proc/station_name()
	if (using_map_legacy().station_name)
...
/proc/world_name(var/name)
	...
	using_map_legacy().station_name = name
