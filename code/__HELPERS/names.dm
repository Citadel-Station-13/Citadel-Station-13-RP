...
/proc/command_name()
	if(istype(SSmapping.legacy_map_config))
		return SSmapping.legacy_map_config.boss_name

/proc/change_command_name(var/name)

	SSmapping.legacy_map_config.boss_name = name
...
/proc/system_name()
	return SSmapping.legacy_map_config.starsys_name

/proc/station_name()
	if (SSmapping.legacy_map_config.station_name)
		return SSmapping.legacy_map_config.station_name
...
/proc/world_name(var/name)
	...
	SSmapping.legacy_map_config.station_name = name
