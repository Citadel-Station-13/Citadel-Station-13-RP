...
/*
				if("station_levels")
					SSmapping.legacy_map_config.station_levels = text2numlist(value, ";")

				if("admin_levels")
					SSmapping.legacy_map_config.admin_levels = text2numlist(value, ";")

				if("contact_levels")
					SSmapping.legacy_map_config.contact_levels = text2numlist(value, ";")

				if("player_levels")
					SSmapping.legacy_map_config.player_levels = text2numlist(value, ";")
*/
