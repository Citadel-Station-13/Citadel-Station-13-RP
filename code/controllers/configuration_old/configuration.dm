...
/*
				if("station_levels")
					using_map_legacy().station_levels = text2numlist(value, ";")

				if("admin_levels")
					using_map_legacy().admin_levels = text2numlist(value, ";")

				if("contact_levels")
					using_map_legacy().contact_levels = text2numlist(value, ";")

				if("player_levels")
					using_map_legacy().player_levels = text2numlist(value, ";")
*/
