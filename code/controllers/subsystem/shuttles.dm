...
/datum/controller/subsystem/shuttle/proc/register_landmark(shuttle_landmark_tag, obj/effect/shuttle_landmark/shuttle_landmark)
	...
	if (istype(shuttle_landmark))
		...
		var/atom/movable/overmap/entity/visitable/O = landmarks_still_needed[shuttle_landmark_tag]
...
/datum/controller/subsystem/shuttle/proc/initialize_sector(atom/movable/overmap/entity/visitable/given_sector)
...
/datum/controller/subsystem/shuttle/proc/try_add_landmark_tag(landmark_tag, atom/movable/overmap/entity/visitable/given_sector)
...
/datum/controller/subsystem/shuttle/proc/toggle_overmap(new_setting)
	...
	for(var/ship in ships)
		var/atom/movable/overmap/entity/visitable/ship/ship_effect = ship
