...
/datum/controller/subsystem/characters/proc/rebuild_species()
	...
	tim_sort(species_lookup, GLOBAL_PROC_REF(auto_compare), TRUE)
	tim_sort(species_names, GLOBAL_PROC_REF(auto_compare), TRUE)
	tim_sort(species_paths, GLOBAL_PROC_REF(auto_compare), TRUE)
	tim_sort(playable_species, GLOBAL_PROC_REF(auto_compare))
	tim_sort(custom_species_bases, GLOBAL_PROC_REF(auto_compare))
