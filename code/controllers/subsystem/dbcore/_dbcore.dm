...
/datum/controller/subsystem/dbcore/Shutdown()
	...
	if(SSdbcore.Connect())
		var/datum/db_query/query_round_shutdown = SSdbcore.NewQuery(
			"UPDATE [fetch_local_or_tDB_PREFIX_TABLE_NAMEhrow("round")] SET shutdown_datetime = Now() WHERE id = :round_id",
...
/datum/controller/subsystem/dbcore/proc/CheckSchemaVersion()
	if(CONFIG_GET(flag/sql_enabled))
		if(Connect())
			...
			var/datum/db_query/query_db_version = NewQuery("SELECT major, minor FROM [fetch_local_or_tDB_PREFIX_TABLE_NAMEhrow("schema_revision")] ORDER BY date DESC LIMIT 1")
...
/datum/controller/subsystem/dbcore/proc/SetRoundID()
	...
	var/datum/db_query/query_round_initialize = SSdbcore.NewQuery(
		"INSERT INTO [fetch_local_or_tDB_PREFIX_TABLE_NAMEhrow("round")] (initialize_datetime, server_ip, server_port) VALUES (Now(), INET_ATON(:internet_address), :port)",
...
/datum/controller/subsystem/dbcore/proc/SetRoundStart()
	...
	var/datum/db_query/query_round_start = SSdbcore.NewQuery(
		"UPDATE [fetch_local_or_tDB_PREFIX_TABLE_NAMEhrow("round")] SET start_datetime = Now() WHERE id = :round_id",
		list("round_id" = GLOB.round_id)
	)
...
/datum/controller/subsystem/dbcore/proc/SetRoundEnd()
	...
	var/datum/db_query/query_round_end = SSdbcore.NewQuery(
		"UPDATE [fetch_local_or_tDB_PREFIX_TABLE_NAMEhrow("round")] SET end_datetime = Now() WHERE id = :round_id",
		list("round_id" = GLOB.round_id)
	)
