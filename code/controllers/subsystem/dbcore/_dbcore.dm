...
/datum/controller/subsystem/dbcore/stat_entry()
	var/msg = "P:[length(all_queries)]|Active:[length(queries_active)]|Standby:[length(queries_standby)]"
	return ..() + " [msg]"
...
/datum/controller/subsystem/dbcore/proc/Connect()
	...
	var/max_sql_connections = CONFIG_GET(number/bsql_thread_limit)
...
/datum/controller/subsystem/dbcore/proc/InitializeRound()
	...
	GLOB.round_number = text2num(GLOB.round_id) // what
