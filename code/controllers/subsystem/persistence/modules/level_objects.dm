		...
		switch(entity.obj_persist_static_mode)
			if(OBJ_PERSIST_STATIC_MODE_LEVEL)
				query = SSdbcore.NewQuery(
					"INSERT INTO [fetch_local_or_tDB_PREFIX_TABLE_NAMEhrow("persistence_static_level_objects")] (generation, object_id, level_id, data) \
			...
			if(OBJ_PERSIST_STATIC_MODE_MAP)
				query = SSdbcore.NewQuery(
					"INSERT INTO [fetch_local_or_tDB_PREFIX_TABLE_NAMEhrow("persistence_static_map_objects")] (generation, object_id, map_id, data) \
			...
			if(OBJ_PERSIST_STATIC_MODE_GLOBAL)
				query = SSdbcore.NewQuery(
					"INSERT INTO [fetch_local_or_tDB_PREFIX_TABLE_NAMEhrow("persistence_static_global_objects")] (generation, object_id, data) \
...
/datum/controller/subsystem/persistence/proc/level_objects_store_dynamic(list/obj/entities, generation, level_id)
	...
	for(var/obj/entity as anything in entities)
		...
		if(entity.obj_persist_dynamic_id != PERSISTENCE_DYNAMIC_ID_AUTOSET)
			query = SSdbcore.NewQuery(
				"INSERT INTO [fetch_local_or_tDB_PREFIX_TABLE_NAMEhrow("persistence_dynamic_objects")] (id, generation, status, data, prototype_id, level_id, x, y) \
			...
			query = SSdbcore.NewQuery(
				"INSERT INTO [fetch_local_or_tDB_PREFIX_TABLE_NAMEhrow("persistence_dynamic_objects")] (status, data, prototype_id, level_id, x, y) \
...
/datum/controller/subsystem/persistence/proc/level_objects_load_dynamic(datum/map_level_persistence/level_data, z_index)
	...
	var/datum/db_query/query = SSdbcore.NewQuery(
		"SELECT object_id, prototype_id, status, data, x, y \
			FROM [fetch_local_or_tDB_PREFIX_TABLE_NAMEhrow("persistence_dynamic_objects")] \
...
/datum/controller/subsystem/persistence/proc/level_objects_load_static(datum/map_level_persistence/level_data, list/obj/entities)
	...
	for(var/obj/entity as anything in entities)
		...
		switch(entity.obj_persist_static_mode)
			if(OBJ_PERSIST_STATIC_MODE_GLOBAL)
				query = SSdbcore.NewQuery(
					"SELECT data FROM [fetch_local_or_tDB_PREFIX_TABLE_NAMEhrow("persistence_static_global_objects")] \
			...
			if(OBJ_PERSIST_STATIC_MODE_MAP)
				query = SSdbcore.NewQuery(
					"SELECT data FROM [fetch_local_or_tDB_PREFIX_TABLE_NAMEhrow("persistence_static_map_objects")] \
...
/datum/controller/subsystem/persistence/proc/level_objects_drop_static_all()
	...
	SSdbcore.dangerously_block_on_multiple_unsanitized_queries(
		list(
			"TRUNCATE TABLE [fetch_local_or_tDB_PREFIX_TABLE_NAMEhrow("persistence_static_map_objects")]",
			"TRUNCATE TABLE [fetch_local_or_tDB_PREFIX_TABLE_NAMEhrow("persistence_static_level_objects")]",
			"TRUNCATE TABLE [fetch_local_or_tDB_PREFIX_TABLE_NAMEhrow("persistence_static_global_objects")]",
		),
	)
...
/datum/controller/subsystem/persistence/proc/level_objects_drop_static_level(level_id)
	...
	SSdbcore.RunQuery(
		"DELETE FROM [fetch_local_or_tDB_PREFIX_TABLE_NAMEhrow("persistence_static_level_objects")] WHERE level_id = :level",
		list(
			"level" = level_id,
		),
	)
...
/datum/controller/subsystem/persistence/proc/level_objects_drop_static_map(map_id)
	...
	SSdbcore.RunQuery(
		"DELETE FROM [fetch_local_or_tDB_PREFIX_TABLE_NAMEhrow("persistence_static_map_objects")] WHERE map_id = :map",
		list(
			"map" = map_id,
		),
	)
...
/datum/controller/subsystem/persistence/proc/level_objects_drop_static_global()
	...
	SSdbcore.RunQuery(
		"DELETE FROM [fetch_local_or_tDB_PREFIX_TABLE_NAMEhrow("persistence_static_global_objects")]",
	)
...
/datum/controller/subsystem/persistence/proc/level_objects_drop_dynamic_all()
	...
	SSdbcore.RunQuery(
		"TRUNCATE TABLE [fetch_local_or_tDB_PREFIX_TABLE_NAMEhrow("persistence_dynamic_objects")]",
	)
...
/datum/controller/subsystem/persistence/proc/level_objects_drop_dynamic_level(level_id)
	...
	SSdbcore.RunQuery(
		"DELETE FROM [fetch_local_or_tDB_PREFIX_TABLE_NAMEhrow("persistence_dynamic_objects")] WHERE level_id = :level",
		list(
			"level" = level_id,
		),
	)
