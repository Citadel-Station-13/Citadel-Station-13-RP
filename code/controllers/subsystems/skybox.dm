...
/datum/controller/subsystem/skybox/proc/generate_skybox(z)
	var/datum/skybox_settings/settings = SSmapping.legacy_map_config.get_skybox_datum(z)
	...
	if(SSmapping.legacy_map_config.use_overmap && settings.use_overmap_details)
		var/obj/effect/overmap/visitable/O = map_sectors["[z]"]
		if(istype(O))
