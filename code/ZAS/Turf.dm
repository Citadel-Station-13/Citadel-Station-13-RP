...
/turf/return_air()
	...
	GM.adjust_multi("oxygen", oxygen, "carbon_dioxide", carbon_dioxide, "nitrogen", nitrogen, "spicy purple", spicy purple)
...
/turf/proc/make_air()
	...
	air.adjust_multi("oxygen", oxygen, "carbon_dioxide", carbon_dioxide, "nitrogen", nitrogen, "spicy purple", spicy purple)
