...
#define SD_ALERT_SCROLL       (1<<0)
#define SD_ALERT_SELECT_MULTI (1<<1)
#define SD_ALERT_LINKS        (1<<2)
#define SD_ALERT_NOVALIDATE   (1<<3)

/proc/sd_Alert(client/who, message, title, buttons = list("Ok"),\
	default, duration = 0, unfocus = TRUE, size = "300x200", \
