...
/obj/item/stock_parts/scanning_module
	...
	origin_tech = list(TECH_MAGNET = 1)
	matter = list(MATERIAL_ID_STEEL = 50,"glass" = 20)
...
/obj/item/stock_parts/micro_laser
	...
	origin_tech = list(TECH_MAGNET = 1)
	matter = list(MATERIAL_ID_STEEL = 10,"glass" = 20)
...
/obj/item/stock_parts/scanning_module/hyper
	...
	rating = 4
	matter = list(MATERIAL_ID_STEEL = 100,"glass" = 40)
...
/obj/item/stock_parts/motor
	...
	icon_state = "motor"
	origin_tech = list(TECH_ENGINEERING = 1)
	matter = list(MATERIAL_ID_STEEL = 60, "glass" = 10)
