...
/obj/item/SWF_uplink
	...
	throw_speed = 4
	throw_range = 20
	matter = list(MATERIAL_ID_STEEL = 100)
...
/obj/item/stock_parts/console_screen
	...
	matter = list(MATERIAL_ID_GLASS = 200)
...
/obj/item/stock_parts/manipulator
	...
	matter = list(MATERIAL_ID_STEEL = 30)
...
/obj/item/stock_parts/micro_laser
	...
	origin_tech = list(TECH_MAGNET = 1)
	matter = list(MATERIAL_ID_STEEL = 10,MATERIAL_ID_GLASS = 20)
...
/obj/item/stock_parts/capacitor/hyper
	...
	rating = 4
	matter = list(MATERIAL_ID_STEEL = 80, MAT_GLASS = 40)
...
/obj/item/stock_parts/scanning_module/hyper
	...
	rating = 4
	matter = list(MATERIAL_ID_STEEL = 100,MATERIAL_ID_GLASS = 40)
...
/obj/item/stock_parts/micro_laser/hyper
	...
	rating = 4
	matter = list(MATERIAL_ID_STEEL = 30, MAT_GLASS = 40)
...
/obj/item/stock_parts/motor
	...
	icon_state = "motor"
	origin_tech = list(TECH_ENGINEERING = 1)
	matter = list(MATERIAL_ID_STEEL = 60, MATERIAL_ID_GLASS = 10)
...
/obj/item/stock_parts/spring
	...
	icon_state = "spring"
	origin_tech = list(TECH_ENGINEERING = 1)
	matter = list(MATERIAL_ID_STEEL = 40)
