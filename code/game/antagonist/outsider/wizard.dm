...
/datum/antagonist/wizard/equip(mob/living/carbon/human/wizard_mob)
	...
	wizard_mob.equip_to_slot_or_del(new /obj/item/storage/box(wizard_mob), /datum/inventory_slot/abstract/put_in_backpack)
	wizard_mob.equip_to_slot_or_del(new /obj/item/teleportation_scroll(wizard_mob), SLOT_ID_RIGHT_POCKET)
	wizard_mob.equip_to_slot_or_del(new /obj/item/spellbook(wizard_mob), /datum/inventory_slot/abstract/hand/right)
	return 1
