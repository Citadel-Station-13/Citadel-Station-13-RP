...
/datum/antagonist/traitor/equip(var/mob/living/carbon/human/traitor_mob)
	...
	if(M && M != traitor_mob)
		...
		traitor_mob.mind.legacy_add_html_memory("<b>Potential Collaborator</b>: [M.real_name]")
...
/datum/antagonist/traitor/proc/give_codewords(mob/living/traitor_mob)
	...
	traitor_mob.mind.legacy_add_html_memory("<b>Code Phrase</b>: [syndicate_code_phrase]")
	traitor_mob.mind.legacy_add_html_memory("<b>Code Response</b>: [syndicate_code_response]")
...
/datum/antagonist/traitor/proc/spawn_uplink(var/mob/living/carbon/human/traitor_mob)
	...
	if(istype(R,/obj/item/radio))
		...
		traitor_mob.mind.legacy_add_html_memory("<B>Radio Freq:</B> [format_frequency(freq)] ([R.name] [loc]).")
		...
		traitor_mob.mind.legacy_add_html_memory("<B>Uplink Passcode:</B> [pda_pass] ([R.name] [loc]).")
