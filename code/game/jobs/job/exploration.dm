...
/datum/job/explorer
	...
	access = list(access_explorer, access_external_airlocks, access_pilot, access_gateway)
	minimal_access = list(access_explorer, access_external_airlocks, access_pilot, access_gateway)
