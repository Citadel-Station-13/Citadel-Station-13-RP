...
/obj/item/pinpointer/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
	if(!active)
...
/obj/item/pinpointer/advpinpointer/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
	if(!active)
...
/obj/item/pinpointer/nukeop/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
	if(!active)
...
/obj/item/pinpointer/shuttle/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
	if(!active)
