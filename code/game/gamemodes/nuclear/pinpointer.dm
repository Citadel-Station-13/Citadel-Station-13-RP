...
/obj/item/pinpointer/attack_self(mob/user, datum/event_args/actor/e_args)
	. = ..()
	if(.)
		return
	if(!active)
...
/obj/item/pinpointer/advpinpointer/attack_self(mob/user, datum/event_args/actor/e_args)
	. = ..()
	if(.)
		return
	if(!active)
...
/obj/item/pinpointer/nukeop/attack_self(mob/user, datum/event_args/actor/e_args)
	. = ..()
	if(.)
		return
	if(!active)
...
/obj/item/pinpointer/shuttle/attack_self(mob/user, datum/event_args/actor/e_args)
	. = ..()
	if(.)
		return
	if(!active)
