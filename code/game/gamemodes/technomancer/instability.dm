	...
	if(instability)
		...
		switch(instability)
			...
			if(31 to 50) //Moderate
				...
				switch(rng)
					if(0)
						electrocute_act_parse_this(instability * 0.3, "unstable energies", 0.75)
					if(1)
			...
			if(51 to 100) //Severe
				...
				switch(rng)
					if(0)
						electrocute_act_parse_this(instability * 0.5, "extremely unstable energies", 0.75)
					if(1)
						emp_act(2)
					if(2)
			...
			if(101 to 200) //Lethal
				...
				switch(rng)
					if(0)
						electrocute_act_parse_this(instability, "extremely unstable energies", 0.75)
					if(1)
						emp_act(1)
					if(2)
		...
		switch(instability)
			...
			if(30 to 50) //Moderate
				...
				switch(rng)
					...
					if(4)
						electrocute_act_parse_this(instability * 0.3, "unstable energies")
					if(5)
						adjustFireLoss(instability * 0.15) //7.5 burn @ 50 instability
			...
			if(50 to 100) //Severe
				...
				switch(rng)
					...
					if(3)
						...
						to_chat(src, "<span class='danger'>Your eyes start to get cloudy!</span>")
					if(4)
						electrocute_act_parse_this(instability * 0.5, "extremely unstable energies")
					if(5)
						fire_act()
			...
			if(100 to 200) //Lethal
				...
				switch(rng)
					...
					if(3)
						...
						to_chat(src, "<span class='danger'>Your eyes start to get cloudy!</span>")
					if(4)
						electrocute_act_parse_this(instability, "extremely unstable energies")
					if(5)
						fire_act()
						to_chat(src, "<span class='danger'>You spontaneously combust!</span>")
					if(6)
