...
/obj/item/spell/energy_siphon/proc/siphon(atom/movable/siphoning, mob/user)
	...
	if(core.energy < core.max_energy)
		...
		to_chat(user, SPAN_NOTICE("Stolen [charge_to_give * 0.001] kJ and converted to [charge_to_give] Core energy."))
		...
		to_chat(user, SPAN_NOTICE("Stolen [charge_to_give * 0.001] kJ."))
