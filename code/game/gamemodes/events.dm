...
/proc/appendicitis()
	//! HEY! on tg the organ sets this during Init
	for(var/mob/living/carbon/human/H in shuffle(GLOB.mob_living_list))
...
*/
	...
	//AI laws
	for(var/mob/living/silicon/ai/M in GLOB.mob_living_list)
