...
/obj/machinery/appliance/cultify() // Citadel change
...
/obj/structure/table/cultify()
	...
	SetMaterial(MATERIAL_ID_WOOD, MATINDEX_OBJ_PRIMARY, FALSE)
	SetMaterial(MATERIAL_ID_WOOD, MATINDEX_OBJ_REINFORCING, FALSE)
	UpdateMaterials()
