...
/datum/game_mode/malfunction/verb/system_override()
	...
	for(var/obj/machinery/power/apc/A in machines)
		if(!(A.z in SSmapping.legacy_map_config.station_levels)) 		// Only station APCs
			continue
	...
	for(var/obj/machinery/power/apc/A in machines)
		if((!A.hacker || (A.hacker != src)) && !A.aidisabled && (A.z in SSmapping.legacy_map_config.station_levels))
			A.ai_hack(src)
