...
/obj/effect/decal/remains/attack_hand(mob/user, list/params, datum/event_args/clickchain/e_args)
...
/obj/effect/decal/remains/robot/attack_hand(mob/user, list/params, datum/event_args/clickchain/e_args)
	return
