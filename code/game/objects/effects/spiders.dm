...
/obj/effect/spider/attackby(var/obj/item/weapon/W, var/mob/user)
	...
	if(W.attack_verb.len)
		visible_message("<span class='warning'>\The [src] has been [pick(W.attack_verb)] with \the [W][(user ? " by [user]." : ".")]</span>") //Citadel change, grammar
	else
		visible_message("<span class='warning'>\The [src] has been attacked with \the [W][(user ? " by [user]." : ".")]</span>") //Citadel change, grammar
...
/obj/effect/spider/cocoon/Destroy()
	...
	for(var/atom/movable/A in contents)
		A.loc = src.loc
	return ..()
>>>>>>> 3f659d9... Merge pull request #4758 from VOREStation/upstream-merge-5947
