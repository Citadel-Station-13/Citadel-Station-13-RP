...
/obj/effect/alien/resin/attack_hand(mob/user, list/params, datum/event_args/clickchain/e_args)
...
/obj/effect/alien/egg/attack_hand(mob/user, list/params, datum/event_args/clickchain/e_args)
