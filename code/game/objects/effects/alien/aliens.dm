...
/obj/effect/alien/resin/attack_hand(mob/user, datum/event_args/clickchain/e_args)
...
/obj/effect/alien/egg/attack_hand(mob/user, datum/event_args/clickchain/e_args)
