...
/obj/effect/step_trigger/thrower
	...
	/// Delay of movement.
	var/speed = 1
	/// If TRUE: atom faces the direction of movement.
	var/facedir = FALSE
	/// If TRUE: will only be stopped by teleporters.
	var/nostop = FALSE
...
/// Terrible, but the alternative is looping through world.
var/global/list/tele_landmarks = list()
