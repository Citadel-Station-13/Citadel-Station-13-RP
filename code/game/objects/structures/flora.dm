...
/obj/structure/flora/sif/attack_hand(mob/user, list/params, datum/event_args/clickchain/e_args)
...
/obj/structure/flora/pumpkin/pumpkin_patch/presents/attack_hand(mob/user, list/params, datum/event_args/clickchain/e_args)
	. = ..()
	if(.)
		return
	if(!user.ckey)
