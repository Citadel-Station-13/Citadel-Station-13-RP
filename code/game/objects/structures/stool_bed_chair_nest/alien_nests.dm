...
/obj/structure/bed/nest/user_buckle_mob(mob/M as mob, mob/user as mob)
	...
	if(istype(xenos) && !((locate(/obj/item/organ/internal/xenos/hivenode) in xenos.internal_organs) || locate(/obj/item/organ/internal/xenos/weak_hivenode) in xenos.internal_organs))
		return
