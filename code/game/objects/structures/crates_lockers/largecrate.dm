...
/obj/structure/largecrate/hoverpod/attackby(obj/item/W as obj, mob/user as mob)
	if(W.is_crowbar())
		var/obj/item/vehicle_module/lazy/legacy/ME
		var/obj/vehicle/sealed/mecha/working/hoverpod/H = new (loc)

		ME = new /obj/item/vehicle_module/lazy/legacy/tool/hydraulic_clamp
		ME.attach(H)
		ME = new /obj/item/vehicle_module/lazy/legacy/tool/passenger
		ME.attach(H)
	..()
