...
/obj/structure/largecrate/hoverpod/attackby(obj/item/W as obj, mob/user as mob)
	if(W.is_crowbar())
		var/obj/item/vehicle_component/equipment/ME
		var/obj/vehicle/sealed/mecha/working/hoverpod/H = new (loc)

		ME = new /obj/item/vehicle_component/equipment/tool/hydraulic_clamp
		ME.attach(H)
		ME = new /obj/item/vehicle_component/equipment/tool/passenger
		ME.attach(H)
	..()
