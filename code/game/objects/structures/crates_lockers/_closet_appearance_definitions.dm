...
/singleton/closet_appearance/Initialize()
	. = ..()
	...
	// singletonare storage vars for icons.
	var/icon/open_icon
...
/singleton/closet_appearance/tactical
	color = COLOR_RED_GRAY
	extra_decals = list(
		"inset" = COLOR_GRAY
	)

/singleton/closet_appearance/tactical/alt
	color = COLOR_PALE_BTL_GREEN

/singleton/closet_appearance/wardrobe
	extra_decals = list(
		"stripe_horizontal" = COLOR_PALE_BLUE_GRAY,
		"stripe_w" = COLOR_GRAY
	)

/singleton/closet_appearance/wardrobe/legal
	extra_decals = list(
		"stripe_horizontal" = COLOR_BLUE,
		"stripe_w" = COLOR_GRAY
	)

/singleton/closet_appearance/wardrobe/red
	extra_decals = list(
		"stripe_horizontal" = COLOR_RED,
		"stripe_w" = COLOR_GRAY
	)

/singleton/closet_appearance/wardrobe/janitor
	extra_decals = list(
		"stripe_horizontal" = COLOR_PALE_PURPLE_GRAY,
		"stripe_w" = COLOR_GRAY
	)

/singleton/closet_appearance/wardrobe/mixed
	extra_decals = list(
...
/singleton/closet_appearance/wardrobe/orange
	extra_decals = list(
		"stripe_horizontal" = COLOR_PALE_ORANGE,
		"stripe_w" = COLOR_OFF_WHITE
	)

/singleton/closet_appearance/wardrobe/green
	extra_decals = list(
		"stripe_horizontal" = COLOR_GREEN_GRAY,
		"stripe_w" = COLOR_OFF_WHITE
	)

/singleton/closet_appearance/wardrobe/grey
	extra_decals = list(
		"stripe_horizontal" = COLOR_GRAY,
		"stripe_w" = COLOR_OFF_WHITE
	)

/singleton/closet_appearance/wardrobe/pink
	extra_decals = list(
		"stripe_horizontal" = COLOR_PALE_PINK,
		"stripe_w" = COLOR_OFF_WHITE
	)

/singleton/closet_appearance/wardrobe/black
	extra_decals = list(
		"stripe_horizontal" = COLOR_GRAY20,
		"stripe_w" = COLOR_OFF_WHITE
	)

/singleton/closet_appearance/wardrobe/yellow
	extra_decals = list(
...
/singleton/closet_appearance/wardrobe/white
	extra_decals = list(
		"stripe_horizontal" = COLOR_GRAY,
		"stripe_w" = COLOR_OFF_WHITE,
	)

/singleton/closet_appearance/bio
...
/singleton/closet_appearance/bio/command
	extra_decals = list(
		"lower_half_solid" = COLOR_BLUE_GRAY,
		"biohazard" = COLOR_OFF_WHITE
	)

/singleton/closet_appearance/bio/science
	extra_decals = list(
		"lower_half_solid" = COLOR_PALE_YELLOW,
		"biohazard" = COLOR_OFF_WHITE
	)

/singleton/closet_appearance/bio/security
	extra_decals = list(
		"lower_half_solid" = COLOR_RED_GRAY,
		"biohazard" = COLOR_OFF_WHITE
	)

/singleton/closet_appearance/bio/janitor
	color = COLOR_PURPLE
	decals = list(
		"l3" = COLOR_OFF_WHITE,
	)
...
/singleton/closet_appearance/bio/virology
	extra_decals = list(
		"lower_half_solid" = COLOR_GREEN_GRAY,
		"biohazard" = COLOR_OFF_WHITE
	)

/singleton/closet_appearance/emergency
...
/singleton/closet_appearance/bio/medical
	extra_decals = list(
...
/singleton/closet_appearance/secure_closet/engineering/senior
	can_lock = TRUE
	color = COLOR_YELLOW_GRAY
	decals = list(
		"upper_side_vent",
...
/singleton/closet_appearance/secure_closet/engineering/electrical
	decals = list(
		"lower_vent"
	)
	extra_decals = list(
...
/singleton/closet_appearance/secure_closet/engineering/atmos
	extra_decals = list(
...
/singleton/closet_appearance/secure_closet/engineering/welding
	decals = list(
		"lower_vent"
	)
	extra_decals = list(
...
/singleton/closet_appearance/secure_closet/engineering/tools
	can_lock = FALSE
	decals = list(
		"lower_vent"
	)
...
/singleton/closet_appearance/secure_closet/engineering/tools/radiation
	extra_decals = list(
		"l2" = COLOR_BEASTY_BROWN,
		"rads" = COLOR_BEASTY_BROWN
	)

/singleton/closet_appearance/secure_closet/engineering/ce
...
/singleton/closet_appearance/secure_closet/mining
...
/singleton/closet_appearance/secure_closet/command/hop
...
/singleton/closet_appearance/secure_closet/cmo
	color = COLOR_BABY_BLUE
	decals = list(
		"upper_side_vent",
		"lower_side_vent"
...
/singleton/closet_appearance/secure_closet/medical
	color = COLOR_OFF_WHITE
	decals = null
	extra_decals = list(
...
/singleton/closet_appearance/secure_closet/medical/paramedic
	color = COLOR_OFF_WHITE
	decals = null
	extra_decals = list(
		"circle" = COLOR_BLUE_GRAY,
		"stripes_horizontal" = COLOR_GREEN
	)

/singleton/closet_appearance/secure_closet/medical/chemicals
	color = COLOR_OFF_WHITE
	decals = null
	extra_decals = list(
		"circle" = COLOR_SUN,
		"stripes_horizontal" = COLOR_SUN
	)

/singleton/closet_appearance/secure_closet/medical/virology
	decals = list(
		"upper_side_vent",
		"lower_side_vent"
	)
...
/singleton/closet_appearance/secure_closet/medical/alt
	extra_decals = list(
...
/singleton/closet_appearance/secure_closet/cargo
	color = COLOR_WARM_YELLOW
	decals = list(
		"upper_side_vent",
		"lower_side_vent"
...
/singleton/closet_appearance/secure_closet/cargo/qm
	extra_decals = list(
...
/singleton/closet_appearance/secure_closet/security/weapons
	color = COLOR_GRAY20
	decals = list(
		"lower_holes"
	)
...
/singleton/closet_appearance/secure_closet/security/warden
	extra_decals = list(
...
/singleton/closet_appearance/secure_closet/security/hos
	extra_decals = list(
		"stripe_vertical_left_full" =  COLOR_WARM_YELLOW,
		"stripe_vertical_right_full" = COLOR_WARM_YELLOW,
...
/singleton/closet_appearance/secure_closet/blueshield
	...
	extra_decals = list(
		...
		"stripe_vertical_mid_full" =  COLOR_COMMAND_BLUE,
		"security" = COLOR_CLOSET_GOLD
	)

/singleton/closet_appearance/bomb
...
/singleton/closet_appearance/bomb/security
	extra_decals = list(
		"lower_half_solid" = COLOR_WARM_YELLOW
	)

/singleton/closet_appearance/oxygen
...
/singleton/closet_appearance/oxygen/fire
	color = COLOR_RED_GRAY
	extra_decals = list(
...
/singleton/closet_appearance/alien
	color = COLOR_PURPLE

/singleton/closet_appearance/secure_closet/expedition
	color = COLOR_BLUE_GRAY
	decals = list(
		"lower_side_vent"
	)
...
/singleton/closet_appearance/secure_closet/expedition/medic
	color = COLOR_BLUE_GRAY
	decals = list(
		"lower_side_vent"
	)
...
/singleton/closet_appearance/secure_closet/expedition/pathfinder
	extra_decals = list(
...
/singleton/closet_appearance/secure_closet/expedition/science
	extra_decals = list(
		"stripe_vertical_mid_full" = COLOR_PURPLE,
...
/singleton/closet_appearance/secure_closet/scientst
	extra_decals = list(
		"stripe_vertical_mid_full" = COLOR_PURPLE,
		"research" = COLOR_PURPLE
	)
...
/singleton/closet_appearance/secure_closet/chaplain
	decals = list(
		"lower_side_vent",
		"upper_side_vent"
	)
...
/singleton/closet_appearance/secure_closet/sol
	color = COLOR_BABY_BLUE
	decals = list(
		"lower_side_vent"
	)
...
/singleton/closet_appearance/secure_closet/sol/two
	extra_decals = list(
...
/singleton/closet_appearance/crate/plastic
	color = COLOR_GRAY80

/singleton/closet_appearance/crate/oxygen
...
/singleton/closet_appearance/crate/medical
	color = COLOR_GRAY80
	decals = list(
...
/singleton/closet_appearance/crate/medical/oxygen
	decals = list(
		"crate_stripe" = COLOR_BABY_BLUE,
		"crate_cross" = COLOR_OFF_WHITE
	)

/singleton/closet_appearance/crate/medical/toxins
	decals = list(
		"crate_stripe" = COLOR_GREEN_GRAY,
		"crate_cross" = COLOR_OFF_WHITE
	)

/singleton/closet_appearance/crate/hydroponics
	decals = list(
		"crate_stripe_left" = COLOR_GREEN_GRAY,
		"crate_stripe_right" = COLOR_GREEN_GRAY
	)

/singleton/closet_appearance/crate/radiation
...
/singleton/closet_appearance/crate/science
	color = COLOR_OFF_WHITE
	decals = list(
		"crate_bracing"
	)
	extra_decals = list(
		"crate_stripe_left" = COLOR_PALE_PURPLE_GRAY,
		"crate_stripe_right" = COLOR_PALE_PURPLE_GRAY,
	)

/singleton/closet_appearance/crate/secure
	can_lock = TRUE
...
/singleton/closet_appearance/crate/secure/weapon
	color = COLOR_GREEN_GRAY
	decals = list(
		"crate_bracing"
	)
...
/singleton/closet_appearance/crate/secure/hydroponics
	extra_decals = list(
		"crate_stripe_left" = COLOR_GREEN_GRAY,
		"crate_stripe_right" = COLOR_GREEN_GRAY
	)

/singleton/closet_appearance/crate/secure/shuttle
	extra_decals = list(
		"crate_stripe_left" = COLOR_YELLOW_GRAY,
		"crate_stripe_right" = COLOR_YELLOW_GRAY
	)

/singleton/closet_appearance/crate/branded/gilthari
	decals = list(
		"gilthari"
	)

/singleton/closet_appearance/crate/branded/gilthari/secure
	can_lock = TRUE

/singleton/closet_appearance/crate/branded/centauri
	decals = list(
		"centauri"
	)

/singleton/closet_appearance/crate/branded/einstein
	decals = list(
		"einstein"
	)

/singleton/closet_appearance/crate/branded/einstein/secure
	can_lock = TRUE

/singleton/closet_appearance/crate/branded/focal
	decals = list(
		"focal"
	)

/singleton/closet_appearance/crate/branded/focal/secure
	can_lock = TRUE

/singleton/closet_appearance/crate/branded/aether
	decals = list(
		"aether"
	)

/singleton/closet_appearance/crate/branded/aether/secure
	can_lock = TRUE

/singleton/closet_appearance/crate/branded/hephaestus
	decals = list(
		"heph"
	)

/singleton/closet_appearance/crate/branded/hephaestus/secure
	can_lock = TRUE

/singleton/closet_appearance/crate/branded/morpheus
	decals = list(
		"morpheus"
	)

/singleton/closet_appearance/crate/branded/morpheus/secure
	can_lock = TRUE

/singleton/closet_appearance/crate/branded/nanotrasen
	decals = list(
		"nt"
	)

/singleton/closet_appearance/crate/branded/nanotrasen/secure
	can_lock = TRUE

/singleton/closet_appearance/crate/branded/oculum
	decals = list(
		"oculum"
	)

/singleton/closet_appearance/crate/branded/oculum/secure
	can_lock = TRUE

/singleton/closet_appearance/crate/branded/veymed
	decals = list(
		"crate_bracing"
	)

/singleton/closet_appearance/crate/branded/ward
	decals = list(
		"wt"
	)

/singleton/closet_appearance/crate/branded/ward/secure
	can_lock = TRUE

/singleton/closet_appearance/crate/branded/xion
	decals = list(
		"xion"
	)

/singleton/closet_appearance/crate/branded/xion/secure
	can_lock = TRUE

/singleton/closet_appearance/crate/branded/zhenghu
	decals = list(
		"zhenghu"
	)

/singleton/closet_appearance/crate/branded/zhenghu/secure
	can_lock = TRUE

/singleton/closet_appearance/crate/branded/hedberg
	decals = list(
		"hedberg"
	)

/singleton/closet_appearance/crate/branded/hedberg/secure
	can_lock = TRUE

/singleton/closet_appearance/crate/branded/bishop
	decals = list(
		"bishop"
	)

/singleton/closet_appearance/crate/branded/bishop/secure
	can_lock = TRUE

/singleton/closet_appearance/crate/branded/grayson
	decals = list(
		"grayson"
	)

/singleton/closet_appearance/crate/branded/grayson/secure
	can_lock = TRUE

/singleton/closet_appearance/crate/branded/lawson
	decals = list(
		"lawson"
	)

/singleton/closet_appearance/crate/branded/lawson/secure
	can_lock = TRUE

/singleton/closet_appearance/crate/branded/oricon
	decals = list(
		"scg"
	)

/singleton/closet_appearance/crate/branded/oricon/secure
	can_lock = TRUE


// Large crates.
/singleton/closet_appearance/large_crate
	base_icon =  'icons/obj/closets/bases/large_crate.dmi'
	decal_icon = 'icons/obj/closets/decals/large_crate.dmi'
	decals = null
	extra_decals = null

/singleton/closet_appearance/large_crate/secure
	can_lock = TRUE

/singleton/closet_appearance/large_crate/critter
	decals = list(
		"airholes"
	)
	extra_decals = list(
...
/singleton/closet_appearance/large_crate/hydroponics
	extra_decals = list(
...
// Cabinets.
/singleton/closet_appearance/cabinet
...
/singleton/closet_appearance/cabinet/secure
	can_lock = TRUE

// Wall lockers.
/singleton/closet_appearance/wall
...
/singleton/closet_appearance/wall/secure
	base_icon =  'icons/obj/closets/bases/wall.dmi'
	decal_icon = 'icons/obj/closets/decals/wall.dmi'
	decals = list(
		"vent"
...
/singleton/closet_appearance/wall/emergency
	decals = null
	extra_decals = list(
		"glass" = COLOR_WHITE
	)

/singleton/closet_appearance/wall/emergency/fire
	decals = list(
		"fire"
	)
	color = COLOR_MAROON
...
/singleton/closet_appearance/wall/shipping
	color = COLOR_WARM_YELLOW
	decals = null
	extra_decals = list(
...
// Carts
/singleton/closet_appearance/cart
	color = COLOR_GRAY20
...
/singleton/closet_appearance/cart/biohazard
	can_lock = TRUE
	decals = list(
		"biohazard" = COLOR_GRAY80
	)

/singleton/closet_appearance/cart/biohazard/alt
