...
/obj/structure/largecrate/animal/pred/Initialize() //This is nessesary to get a random one each time.
	starts_with = list(pick(/mob/living/simple_mob/animal/bee,
						...
						/mob/living/simple_mob/animal/passive/rat,
...
/obj/structure/largecrate/animal/dangerous/Initialize()
	starts_with = list(pick(/mob/living/simple_mob/animal/space/carp/pike,
						...
						/mob/living/simple_mob/animal/otie/feral,
...
/obj/structure/largecrate/animal/guardbeast
	...
	starts_with = list(/mob/living/simple_mob/animal/otie/security)
...
/obj/structure/largecrate/animal/guardmutant
	...
	icon = 'icons/obj/storage_vr.dmi'
	icon_state = "sotiecrate"
	starts_with = list(/mob/living/simple_mob/animal/otie/security/phoron)
...
/obj/structure/largecrate/animal/otie
	...
	starts_with = list(/mob/living/simple_mob/animal/otie/cotie)
	var/taped = 1
...
/obj/structure/largecrate/animal/otie/phoron
	...
	starts_with = list(/mob/living/simple_mob/animal/otie/cotie/phoron)

/obj/structure/largecrate/animal/otie/phoron/Initialize()
	starts_with = list(pick(/mob/living/simple_mob/animal/otie/cotie/phoron;2,
						/mob/living/simple_mob/animal/otie/red/friendly;0.5))
	return ..()
