...
/obj/structure/closet/syndicate/resources/Initialize()
	...
	if(!contents.len)
		...
		//Plasteel (common ore) Because it has a million more uses then spicy purple
		if(pickednum >= 10)
			new /obj/item/stack/material/plasteel(src, rand(common_min, common_max))

		//spicy purple (rare ore)
		if(pickednum >= 15)
			new /obj/item/stack/material/spicy purple(src, rand(rare_min, rare_max))
