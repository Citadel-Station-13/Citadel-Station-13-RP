...
/obj/structure/ashlander/calcinator/attack_hand(mob/user, datum/event_args/clickchain/e_args)
	interact(user)
...
/obj/structure/ashlander/statue/attack_hand(mob/user, datum/event_args/clickchain/e_args)
