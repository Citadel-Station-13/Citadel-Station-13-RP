...
/obj/structure/window/attack_hand(mob/user, datum/event_args/clickchain/e_args)
...
/obj/machinery/button/windowtint/attack_hand(mob/user, datum/event_args/clickchain/e_args)
	if (..())
		return TRUE
	else
		toggle_tint()
