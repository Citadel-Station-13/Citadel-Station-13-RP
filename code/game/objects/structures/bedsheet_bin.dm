...
/obj/item/bedsheet/attack_self(mob/user, datum/event_args/clickchain/e_args)
	. = ..()
	if(.)
		return
...
/obj/structure/bedsheetbin/attack_hand(mob/user, list/params, datum/event_args/clickchain/e_args)
	if(amount >= 1)
		amount--
