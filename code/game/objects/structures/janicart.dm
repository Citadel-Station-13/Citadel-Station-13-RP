...
/obj/structure/janitorialcart/attack_hand(mob/user, datum/event_args/clickchain/e_args)
...
/obj/structure/bed/chair/janicart/attack_hand(mob/user, datum/event_args/clickchain/e_args)
	if(mybag)
		user.grab_item_from_interacted_with(mybag, src)
		mybag = null
	else
