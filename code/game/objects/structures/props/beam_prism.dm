...
/obj/structure/prop/prism/attack_hand(mob/user, datum/event_args/clickchain/e_args)
	..()
...
/obj/structure/prop/prismcontrol/attack_hand(mob/user, datum/event_args/clickchain/e_args)
	..()
