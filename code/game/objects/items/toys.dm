...
/obj/item/toy/sword/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
	if (active)
...
/obj/item/toy/bosunwhistle/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
...
/obj/item/toy/prize/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
...
/obj/item/toy/figure/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
...
// Attack self
/obj/item/toy/plushie/carp/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
...
/obj/item/toy/plushie/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
...
/obj/item/toy/eight_ball/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
	if(!cooldown)
...
/obj/item/toy/AI
	...
	var/cooldown = 0
/*
/obj/item/toy/AI/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
...
/obj/item/toy/owl/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
	if(!cooldown) //for the sanity of everyone
...
/obj/item/toy/griffin/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
	if(!cooldown) //for the sanity of everyone
...
/obj/item/toy/cowgirlprize/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
	if(!cooldown) //for the sanity of everyone
...
/obj/item/toy/snakeoilprize/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
	if(!cooldown) //for the sanity of everyone
...
/obj/item/storage/daki/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
	var/body_choice
