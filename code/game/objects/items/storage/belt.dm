/obj/item/storage/belt
	...
	icon_state = "utility"
	storage_slots = 7
	max_storage_space = ITEM_SIZE_COST_NORMAL * 7 //This should ensure belts always have enough room to store whatever.
...
/obj/item/storage/belt/explorer
	...
	storage_slots = 7
	max_storage_space = ITEM_SIZE_COST_NORMAL * 7
	show_above_suit = 1
	can_hold = list(
		/obj/item/grenade,
		/obj/item/tool/crowbar,
...
/obj/item/storage/belt/spike_bandolier
	...
	max_storage_space = ITEM_SIZE_COST_SMALL * 14
...
/obj/item/storage/belt/fannypack
	...
	max_w_class = ITEM_SIZE_SMALL
	storage_slots = null
	max_storage_space = ITEM_SIZE_COST_NORMAL * 2
