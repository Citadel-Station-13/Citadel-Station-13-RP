...
/obj/item/storage/secure/briefcase/attack_hand(mob/user, datum/event_args/clickchain/e_args)
...
/obj/item/storage/secure/safe/attack_hand(mob/user, datum/event_args/clickchain/e_args)
