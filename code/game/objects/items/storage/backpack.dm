...
/obj/item/storage/backpack/saddlebag_common/can_equip(mob/M, slot, mob/user, flags)
	...
	var/datum/prototype/sprite_accessory/tail/legacy_taur/TT = H.tail_style
	if(istype(H) && istype(TT, /datum/prototype/sprite_accessory/tail/legacy_taur/horse))
		item_state = "[icon_base]_horse"
		return 1
	if(istype(H) && istype(TT, /datum/prototype/sprite_accessory/tail/legacy_taur/wolf))
		item_state = "[icon_base]_wolf"
		return 1
	if(istype(H) && istype(TT, /datum/prototype/sprite_accessory/tail/legacy_taur/cow))
		item_state = "[icon_base]_cow"
		return 1
	if(istype(H) && istype(TT, /datum/prototype/sprite_accessory/tail/legacy_taur/lizard))
		item_state = "[icon_base]_lizard"
		return 1
	if(istype(H) && istype(TT, /datum/prototype/sprite_accessory/tail/legacy_taur/feline))
		item_state = "[icon_base]_feline"
		return 1
	if(istype(H) && istype(TT, /datum/prototype/sprite_accessory/tail/legacy_taur/drake))
		item_state = "[icon_base]_drake"
		return 1
	if(istype(H) && istype(TT, /datum/prototype/sprite_accessory/tail/legacy_taur/otie))
		item_state = "[icon_base]_otie"
		return 1
	if(istype(H) && istype(TT, /datum/prototype/sprite_accessory/tail/legacy_taur/deer))
