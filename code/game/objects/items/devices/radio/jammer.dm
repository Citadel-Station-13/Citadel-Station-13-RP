...
/obj/item/radio_jammer/attack_hand(mob/user, datum/event_args/clickchain/e_args)
...
/obj/item/radio_jammer/attack_self(mob/user, datum/event_args/clickchain/e_args)
	. = ..()
	if(.)
		return
	if(on)
