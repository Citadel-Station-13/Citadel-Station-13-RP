...
/obj/item/holowarrant/proc/show_content(mob/user, forceshow)
	...
	if(active.fields["arrestsearch"] == "arrest")
		...
		[SSmapping.legacy_map_config.boss_name] in [SSmapping.legacy_map_config.station_name]</br>
		</br>
		...
		Vessel or habitat: _<u>[SSmapping.legacy_map_config.station_name]</u>____</br>
