/obj/item/airlock_painter
	...
	var/list/available_paint_jobs = list(
		...
		"Atmospherics" = /obj/machinery/door/airlock/engineeringatmos,
...
/obj/item/airlock_painter/proc/can_use(mob/user)
	if(!ink)
		...
		to_chat(user, SPAN_NOTICE("Out of ink!"))
...
*/
/obj/item/airlock_painter/decal/proc/paint_floor(turf/simulated/floor/target)
...
/obj/item/airlock_painter/decal/tile/paint_floor(turf/simulated/floor/target)
