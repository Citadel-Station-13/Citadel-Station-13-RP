...
/obj/item/flashlight/attack_self(datum/event_args/actor/actor, mob/user)
	if(power_use)
		if(!isturf(user.loc))
...
/obj/item/flashlight/flare/attack_self(datum/event_args/actor/actor, mob/user)
...
/obj/item/flashlight/glowstick/attack_self(datum/event_args/actor/actor, mob/user)
