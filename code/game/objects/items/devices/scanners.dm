...
/obj/item/healthanalyzer/attack_mob(mob/M, mob/user, clickchain_flags, list/params, mult, target_zone, intent)
	scan_mob(M, user)
...
/obj/item/slime_scanner/attack_mob(mob/M, mob/user, clickchain_flags, list/params, mult, target_zone, intent)
