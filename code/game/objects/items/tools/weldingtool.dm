...
/obj/item/weldingtool/attack_self(mob/user, datum/event_args/clickchain/e_args)
	. = ..()
	if(.)
		return
...
/obj/item/weldingtool/electric/attack_hand(mob/user, datum/event_args/clickchain/e_args)
