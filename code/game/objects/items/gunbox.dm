...
/obj/item/gunbox/attack_self(mob/user)
	...
	options["NT Mk58 (.45)"] = list(/obj/item/gun/projectile/ballistic/sec, /obj/item/ammo_magazine/m45/rubber, /obj/item/ammo_magazine/m45/flash)
	options["SW 625 Revolver (.45)"] = list(/obj/item/gun/projectile/ballistic/revolver/detective45, /obj/item/ammo_magazine/s45/rubber, /obj/item/ammo_magazine/s45/rubber)
	options["P92X (9mm)"] = list(/obj/item/gun/projectile/ballistic/p92x/sec, /obj/item/ammo_magazine/m9mm/rubber, /obj/item/ammo_magazine/m9mm/flash)
...
/obj/item/gunbox/lethal/attack_self(mob/user)
	var/list/options = list()
	options["M1911 Dynamic (.45)"] = list(/obj/item/gun/projectile/ballistic/colt, /obj/item/ammo_magazine/m45, /obj/item/ammo_magazine/m45)
	options["SW 625 Revolver (.45)"] = list(/obj/item/gun/projectile/ballistic/revolver/detective45, /obj/item/ammo_magazine/s45, /obj/item/ammo_magazine/s45)
	options["P92X (9mm)"] = list(/obj/item/gun/projectile/ballistic/p92x, /obj/item/ammo_magazine/m9mm, /obj/item/ammo_magazine/m9mm)
	var/choice = input(user,"Would you prefer a pistol or a revolver?") as null|anything in options
	if(src && choice)
		var/list/things_to_spawn = options[choice]
		for(var/new_type in things_to_spawn) // Spawn all the things, the gun and the ammo.
...
/obj/item/gunbox/attack_self(mob/user)
	var/list/options = list()
	options[".45 Pistol"] = list(/obj/item/gun/projectile/ballistic/colt/detective, /obj/item/ammo_magazine/m45/rubber, /obj/item/ammo_magazine/m45/rubber)
	options[".45 Revolver"] = list(/obj/item/gun/projectile/ballistic/revolver/detective45, /obj/item/ammo_magazine/s45/rubber, /obj/item/ammo_magazine/s45/rubber)
	var/choice = input(user,"Would you prefer a pistol or a revolver?") as null|anything in options
	if(src && choice)
		var/list/things_to_spawn = options[choice]
		for(var/new_type in things_to_spawn) // Spawn all the things, the gun and the ammo.
...
/obj/item/gunbox/donksoft/attack_self(mob/user)
	var/list/options = list()
	options["Classic DONKsoft Pistol"] = list(/obj/item/gun/projectile/ballistic/pistol/foam, /obj/item/ammo_magazine/mfoam/pistol, /obj/item/ammo_magazine/mfoam/pistol)
	options["Blue DONKsoft Pistol"] = list(/obj/item/gun/projectile/ballistic/pistol/foam/blue, /obj/item/ammo_magazine/mfoam/pistol, /obj/item/ammo_magazine/mfoam/pistol)
	options["DONKsoft Automag"] = list(/obj/item/gun/projectile/ballistic/pistol/foam/magnum, /obj/item/ammo_magazine/mfoam/pistol, /obj/item/ammo_magazine/mfoam/pistol)
...
/obj/item/gunbox/donksoft/shotgun/attack_self(mob/user)
	var/list/options = list()
	options["Classic DONKsoft Shotgun"] = list(/obj/item/gun/projectile/ballistic/shotgun/pump/foam, /obj/item/storage/box/foamdart, /obj/item/storage/box/foamdart)
	options["Blue DONKsoft Shotgun"] = list(/obj/item/gun/projectile/ballistic/shotgun/pump/foam/blue, /obj/item/storage/box/foamdart, /obj/item/storage/box/foamdart)
	var/choice = input(user,"What toy is in this box?") as null|anything in options
	if(src && choice)
		var/list/things_to_spawn = options[choice]
		for(var/new_type in things_to_spawn) // Spawn all the things, the gun and the ammo.
