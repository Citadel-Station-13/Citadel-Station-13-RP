...
/obj/item/gunbox/attack_self(mob/user, datum/event_args/clickchain/e_args)
...
/obj/item/gunbox/lethal/attack_self(mob/user, datum/event_args/clickchain/e_args)
	var/list/options = list()
...
/obj/item/gunbox/marksman/attack_self(mob/user, datum/event_args/clickchain/e_args)
	var/list/options = list()
...
/obj/item/gunbox/donksoft/attack_self(mob/user, datum/event_args/clickchain/e_args)
	var/list/options = list()
...
/obj/item/gunbox/donksoft/shotgun/attack_self(mob/user, datum/event_args/clickchain/e_args)
	var/list/options = list()
...
/obj/item/gunbox/donksoft/smg/attack_self(mob/user, datum/event_args/clickchain/e_args)
	var/list/options = list()
...
/obj/item/gunbox/carrier/blueshield/attack_self(mob/user, datum/event_args/clickchain/e_args)
	var/list/options = list()
...
/obj/item/gunbox/armor/security/attack_self(mob/user, datum/event_args/clickchain/e_args)
	var/list/options = list()
