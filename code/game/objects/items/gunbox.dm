...
/obj/item/gunbox/attack_self(datum/event_args/actor/actor, mob/user)
...
/obj/item/gunbox/lethal/attack_self(datum/event_args/actor/actor, mob/user)
	var/list/options = list()
...
/obj/item/gunbox/marksman/attack_self(datum/event_args/actor/actor, mob/user)
	var/list/options = list()
...
/obj/item/gunbox/donksoft/attack_self(datum/event_args/actor/actor, mob/user)
	var/list/options = list()
...
/obj/item/gunbox/donksoft/shotgun/attack_self(datum/event_args/actor/actor, mob/user)
	var/list/options = list()
...
/obj/item/gunbox/donksoft/smg/attack_self(datum/event_args/actor/actor, mob/user)
	var/list/options = list()
...
/obj/item/gunbox/carrier/blueshield/attack_self(datum/event_args/actor/actor, mob/user)
	var/list/options = list()
...
/obj/item/gunbox/armor/security/attack_self(datum/event_args/actor/actor, mob/user)
	var/list/options = list()
