...
/obj/item/antag_spawner/technomancer_apprentice/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
...
/obj/item/antag_spawner/syndicate_drone/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
