...
/obj/item/antag_spawner/technomancer_apprentice/attack_self(mob/user, datum/event_args/actor/e_args)
	. = ..()
	if(.)
		return
...
/obj/item/antag_spawner/syndicate_drone/attack_self(mob/user, datum/event_args/actor/e_args)
	. = ..()
	if(.)
		return
