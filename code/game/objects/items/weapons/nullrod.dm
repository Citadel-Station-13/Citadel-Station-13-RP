...
/obj/item/nullrod/claymore/multiverse/process_mob_melee(mob/M, mob/user, clickchain_flags, list/params, mult, target_zone, intent)
	force = rand(1, 30)
	return ..()
...
/obj/item/nullrod/claymore/bostaff/process_mob_melee(mob/M, mob/user, clickchain_flags, list/params, mult, target_zone, intent)
...
/obj/item/nullrod/rosary/process_mob_melee(mob/M, mob/user, clickchain_flags, list/params, mult, target_zone, intent)
