...
/obj/item/weapon/shield/fluff/wolfgirlshield
	...
	throw_speed = 2
	throw_range = 6
	item_icons = list(slot_l_hand_str = 'icons/mob/inhands/weapons/melee_lefthand.dmi', slot_r_hand_str = 'icons/mob/inhands/weapons/melee_righthand.dmi', slot_back_str = 'icons/vore/custom_items_vr.dmi', slot_wear_suit_str = 'icons/vore/custom_items_vr.dmi')
