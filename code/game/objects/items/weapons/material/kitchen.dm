...
/obj/item/material/kitchen/utensil/process_mob_melee(mob/M, mob/user, clickchain_flags, list/params, mult, target_zone, intent)
	if(!istype(M))
		return ..()
...
/obj/item/material/kitchen/rollingpin/process_mob_melee(mob/M, mob/user, clickchain_flags, list/params, mult, target_zone, intent)
