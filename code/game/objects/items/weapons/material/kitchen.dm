...
/obj/item/material/kitchen/utensil/attack_mob(mob/M, mob/user, clickchain_flags, list/params, mult, target_zone, intent)
	if(!istype(M))
		return ..()
...
/obj/item/material/kitchen/rollingpin/attack_mob(mob/M, mob/user, clickchain_flags, list/params, mult, target_zone, intent)
