...
/obj/item/rcd/attack_self(mob/user, datum/event_args/actor/clickchain/e_args)
	. = ..()
	if(.)
		return
	..()
...
/obj/item/rcd/electric/mounted/hardsuit/attack_self(mob/user, datum/event_args/actor/clickchain/e_args)
	. = ..()
	if(.)
		return
...
/obj/item/rcd_ammo/large
	...
	desc = "Do not ingest."
	materials_base = list(MAT_STEEL = 60000, MAT_GLASS = 12000)
