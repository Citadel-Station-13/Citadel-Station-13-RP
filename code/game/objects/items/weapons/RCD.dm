...
/obj/item/rcd/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
	..()
...
/obj/item/rcd/electric/mounted/hardsuit/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
