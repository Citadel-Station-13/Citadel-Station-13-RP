...
/obj/item/shield/energy/imperial
	...
	item_icons = list(SLOT_ID_LEFT_HAND = 'icons/mob/items/lefthand_melee_vr.dmi', SLOT_ID_RIGHT_HAND = 'icons/mob/items/righthand_melee_vr.dmi')
...
/obj/item/shield/fluff/wolfgirlshield
	...
	throw_speed = 2
	throw_range = 6
	item_icons = list(SLOT_ID_LEFT_HAND = 'icons/mob/items/lefthand_melee_vr.dmi', SLOT_ID_RIGHT_HAND = 'icons/mob/items/righthand_melee_vr.dmi', SLOT_ID_BACK = 'icons/vore/custom_items_vr.dmi', SLOT_ID_SUIT = 'icons/vore/custom_items_vr.dmi')
	attack_verb = list("shoved", "bashed")
	var/cooldown = 0 //shield bash cooldown. based on world.time
