...
/obj/item/shield/riot/flash/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
...
/obj/item/shield/energy/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
...
/obj/item/shield/energy/IsShield()
	if(active)
		...
		return 0
*/
/obj/item/shield/riot/tele/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
	active = !active
