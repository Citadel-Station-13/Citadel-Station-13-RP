...
/obj/item/grenade/explosive/ied/ashlander
...
/obj/item/grenade/explosive/ied/ashlander/on_explosion(var/turf/O)
	if(explosion_size)
		explosion(O, 1, 3, explosion_size, round(explosion_size/2), 0)

/obj/item/grenade/explosive/ied/ashlander/fragmentation
...
/obj/item/grenade/explosive/ied/ashlander/fragmentation/on_explosion(var/turf/O)
	if(explosion_size)
