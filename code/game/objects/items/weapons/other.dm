...
/obj/item/bikehorn/golden/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
	if(flip_cooldown < world.time)
...
/obj/item/cane/concealed/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
...
/obj/item/cane/whitecane/collapsible/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
	on = !on
