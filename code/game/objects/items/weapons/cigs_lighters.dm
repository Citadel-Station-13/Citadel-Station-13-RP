...
<<<<<<< HEAD
/obj/item/clothing/mask/smokable/cigarette/attack_self(mob/user, datum/event_args/actor/e_args)
=======
...
<<<<<<< HEAD
/obj/item/clothing/mask/smokable/pipe/attack_self(mob/user, datum/event_args/actor/e_args)
=======
...
<<<<<<< HEAD
/obj/item/flame/lighter/attack_self(mob/user, datum/event_args/actor/e_args)
=======
