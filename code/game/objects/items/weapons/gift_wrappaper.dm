...
/obj/item/gift/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
...
/obj/item/a_gift/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
	var/gift_type = pick(
...
/obj/item/b_gift/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
	var/gift_type = pick(
