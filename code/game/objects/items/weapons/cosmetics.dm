...
/obj/item/lipstick/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
...
/obj/item/haircomb/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
	var/text = "person"
...
/obj/item/makeover/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
	if(ishuman(user))
