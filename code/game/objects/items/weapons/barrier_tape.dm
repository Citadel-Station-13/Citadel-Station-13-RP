...
/obj/item/barrier_tape_roll/attack_hand(mob/user, datum/event_args/clickchain/e_args)
	update_icon()
	return ..()
...
/obj/item/barrier_tape_segment/attack_hand(mob/user, datum/event_args/clickchain/e_args)
