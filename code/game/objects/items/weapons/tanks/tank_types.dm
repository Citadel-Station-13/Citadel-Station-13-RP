...
/obj/item/weapon/tank/emergency/oxygen/Initialize()
	. = ..()
	air_contents.adjust_gas("oxygen", (10*ONE_ATMOSPHERE)*volume/(R_IDEAL_GAS_EQUATION*T20C))
...
/obj/item/weapon/tank/emergency/nitrogen/Initialize()
	. = ..()
	air_contents.adjust_gas("nitrogen", (10*ONE_ATMOSPHERE)*volume/(R_IDEAL_GAS_EQUATION*T20C))
