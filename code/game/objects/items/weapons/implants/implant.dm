...
/obj/item/implant/loyalty/get_data()
	var/dat = {"
<b>Implant Specifications:</b><BR>
<b>Name:</b> [SSmapping.legacy_map_config.company_name] Employee Management Implant<BR>
...
/obj/item/implant/loyalty/handle_implant(mob/M, target_zone = BP_TORSO)
	...
	if(antag_data && (antag_data.flags & ANTAG_IMPLANT_IMMUNE))
		H.visible_message("[H] seems to resist the implant!", "You feel the corporate tendrils of [SSmapping.legacy_map_config.company_name] try to invade your mind!")
		. = FALSE

/obj/item/implant/loyalty/post_implant(mob/M)
	var/mob/living/carbon/human/H = M
	clear_antag_roles(H.mind, 1)
	to_chat(H, "<span class='notice'>You feel a surge of loyalty towards [SSmapping.legacy_map_config.company_name].</span>")
...
/obj/item/implant/death_alarm/get_data()
	var/dat = {"
<b>Implant Specifications:</b><BR>
<b>Name:</b> [SSmapping.legacy_map_config.company_name] \"Profit Margin\" Class Employee Lifesign Sensor<BR>
<b>Life:</b> Activates upon death.<BR>
