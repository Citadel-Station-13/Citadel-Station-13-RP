...
/obj/item/weapon/storage/box/treats
	...
	starts_with = list(/obj/item/weapon/reagent_containers/food/snacks/dtreat = 7)
...
/obj/item/weapon/storage/box/wormcan
	...
	icon_state = "box"
	starts_with = list(/obj/item/weapon/reagent_containers/food/snacks/worm = 10)
