...
/obj/item/aiModule/safeguard/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
	..()
...
/obj/item/aiModule/oneHuman/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
	..()
...
/obj/item/aiModule/freeform/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
	..()
...
/obj/item/aiModule/freeformcore/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
	..()
...
/obj/item/aiModule/syndicate/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
	..()
