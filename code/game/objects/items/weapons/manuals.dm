...
/obj/item/book/manual/engineering_particle_accelerator/New()
	...
	dat = {"<html>
				...
				<ol>
					...
					<li><span class='danger'><b>When the singularity reaches a large enough size so it starts moving on it's own set the speed down to 0, but don't shut it off</b></span></li>
...
/obj/item/book/manual/engineering_singularity_safety
	...
	dat = {"<html>
				...
				<ol>
					<li><b><span class='danger'>PANIC!</span></b></li>
