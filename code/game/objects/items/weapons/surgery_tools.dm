...
/obj/item/surgical/retractor
	...
	matter = list(/datum/material/steel = 10000, "glass" = 5000)
...
/obj/item/surgical/hemostat
	...
	icon_state = "hemostat"
	matter = list(/datum/material/steel = 5000, "glass" = 2500)
	origin_tech = list(TECH_MATERIAL = 1, TECH_BIO = 1)
...
/obj/item/surgical/surgicaldrill
	...
	matter = list(/datum/material/steel = 15000, "glass" = 10000)
	force = 15.0
...
/obj/item/surgical/circular_saw
	...
	throw_range = 5
	origin_tech = list(TECH_MATERIAL = 1, TECH_BIO = 1)
	matter = list(/datum/material/steel = 20000,"glass" = 10000)
...
/obj/item/surgical/circular_saw/manager
	...
	matter = list(/datum/material/steel = 12500)
