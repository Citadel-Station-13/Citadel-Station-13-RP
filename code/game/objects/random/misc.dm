...
/obj/random/weapon/item_to_spawn()
	return pick(
		...
		prob(9);/obj/item/gun/projectile/ballistic/sol,
		...
		prob(6);/obj/item/gun/projectile/ballistic/z8,
		...
		prob(2);/obj/item/gun/projectile/ballistic/mini_uzi,
		prob(2);/obj/item/gun/projectile/ballistic/mini_uzi/taj,
		prob(4);/obj/item/gun/projectile/ballistic/wt274,
		...
		prob(3);/obj/item/gun/projectile/ballistic/bullpup,
		prob(2);/obj/item/gun/projectile/energy/pulse_rifle,
		prob(2);/obj/item/gun/projectile/energy/gun/nuclear,
		prob(2);/obj/item/gun/projectile/ballistic/lmg,
		...
		prob(1);/obj/item/gun/projectile/ballistic/as24,
