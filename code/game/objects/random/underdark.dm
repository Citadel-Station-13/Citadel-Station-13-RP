...
/obj/random/multiple/underdark/mechtool/item_to_spawn()
	return pick(
				...
				// prob(7);list(/obj/item/vehicle_component/module/ballistic/scattershot/rigged),
				prob(6);list(/obj/item/vehicle_component/module/repair_droid),
				prob(3);list(/obj/item/vehicle_component/module/gravcatapult),
				// prob(2);list(/obj/item/vehicle_component/module/energy/riggedlaser),
				// prob(2);list(/obj/item/vehicle_component/module/energy/flamer/rigged),
