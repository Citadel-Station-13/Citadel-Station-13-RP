...
/obj/random/maintenance/clean/item_to_spawn()
	return pick(prob(10);/obj/random/contraband,
				...
				prob(2);/obj/item/cell/basic/tier_1/large,
				prob(4);/obj/item/cell/basic/tier_2/weapon,
				prob(2);/obj/item/cell/basic/tier_2/small,
				prob(3);/obj/item/cell/basic/tier_2/medium,
				prob(2);/obj/item/cell/basic/tier_2/large,
				prob(4);/obj/item/cell/basic/tier_3/weapon,
				prob(2);/obj/item/cell/basic/tier_3/small,
				prob(3);/obj/item/cell/basic/tier_3/medium,
				prob(2);/obj/item/cell/basic/tier_3/large,
...
/obj/random/maintenance/security/item_to_spawn()
	return pick(prob(320);/obj/random/maintenance/clean,
				...
				prob(1);/obj/item/cell/basic/tier_1/weapon,
