...
/obj/random/maintenance/security/item_to_spawn()
	return pick(prob(320);/obj/random/maintenance/clean,
				...
				prob(2);/obj/item/storage/backpack/duffelbag/sec,
				prob(1);/obj/item/storage/backpack/duffelbag/syndie/ammo,
				prob(1);/obj/item/storage/backpack/duffelbag/syndie/med,
...
/obj/random/maintenance/medical/item_to_spawn()
	return pick(prob(320);/obj/random/maintenance/clean,
				...
				prob(3);/obj/item/storage/backpack/duffelbag/med,
				prob(1);/obj/item/storage/backpack/duffelbag/syndie/med,
...
/obj/random/maintenance/engineering/item_to_spawn()
	return pick(prob(320);/obj/random/maintenance/clean,
				...
				prob(3);/obj/item/storage/backpack/duffelbag/eng,
				prob(5);/obj/item/storage/box,
...
/obj/random/maintenance/research/item_to_spawn()
	return pick(prob(320);/obj/random/maintenance/clean,
				...
				prob(1);/obj/item/cell/device/weapon,
				prob(5);/obj/item/storage/backpack/sci,
				prob(5);/obj/item/storage/backpack/satchel/sci,
				prob(5);/obj/item/storage/backpack/messenger/sci,
