...
/obj/mecha/combat/fighter/touch_map_edge()
	...
	var/atom/movable/overmap/entity/visitable/our_ship = get_overmap_sector(z)
	...
	for(var/atom/movable/overmap/entity/visitable/V in range(1, our_ship))
		choices[V.name] = V
	...
	if(!choice)
		...
		var/atom/movable/overmap/entity/visitable/V = choices[choice]
