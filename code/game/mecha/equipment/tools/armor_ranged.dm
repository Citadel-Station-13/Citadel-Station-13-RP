...
/obj/item/mecha_parts/mecha_equipment/antiproj_armor_booster/handle_projectile_contact(obj/projectile/Proj, inc_damage)
...
/obj/item/mecha_parts/mecha_equipment/antiproj_armor_booster/proc/dynbulletdamage(obj/projectile/Proj)
	if(istype(Proj, /obj/projectile/test))
