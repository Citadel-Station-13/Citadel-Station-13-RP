/obj/machinery/mecha_part_fabricator
	...
	var/list/materials = list(MATERIAL_ID_STEEL = 0, MATERIAL_ID_GLASS = 0, MATERIAL_ID_PLASTIC = 0, MAT_PLASTEEL = 0, MATERIAL_ID_GOLD = 0,
		MATERIAL_ID_SILVER = 0, MATERIAL_ID_LEAD = 0, MATERIAL_ID_OSMIUM = 0, MATERIAL_ID_DIAMOND = 0, MATERIAL_ID_DURASTEEL = 0, MATERIAL_ID_PHORON = 0,
		MATERIAL_ID_URANIUM = 0, MATERIAL_ID_VERDANTIUM = 0, MATERIAL_ID_MORPHIUM= 0, MATERIAL_ID_METALLIC_HYDROGEN = 0, MATERIAL_ID_SUPERMATTER = 0)
	var/list/hidden_materials = list(MATERIAL_ID_PLASTEEL, MATERIAL_ID_DURASTEEL, MATERIAL_ID_VERDANTIUM, MATERIAL_ID_MORHPIUM, MATERIAL_ID_METALLIC_HYDROGEN, MATERIAL_ID_SUPERMATTER)
