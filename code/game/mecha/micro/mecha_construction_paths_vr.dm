...
/datum/construction/mecha/polecat_chassis/action(atom/used_atom, mob/user)
...
/datum/construction/mecha/weasel_chassis/action(atom/used_atom, mob/user)
	return check_all_steps(used_atom,user)
