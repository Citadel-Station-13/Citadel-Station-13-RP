...
/datum/design/item/mechfab/gopher/left_leg
	...
	materials = list(/datum/material/steel = 12500)
...
/datum/design/item/mechfab/polecat/armour
	...
	time = 25
	materials = list(/datum/material/steel = 12500, "plastic" = 7500)
...
/datum/design/item/mechfab/weasel/tri_leg
	...
	materials = list(/datum/material/steel = 27500)

/datum/design/item/mechfab/weasel/head
	name = "Weasel Head"
	id = "weasel_head"
	build_path = /obj/item/mecha_parts/micro/part/weasel_head
	materials = list(/datum/material/steel = 7000, "glass" = 2500)
...
/datum/design/item/mecha/medigun
	...
	materials = list(/datum/material/steel = 8000, "gold" = 2000, "silver" = 1750, "diamond" = 1500, "phoron" = 4000)
