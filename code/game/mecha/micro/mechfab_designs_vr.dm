...
/datum/design/item/mechfab/gopher/chassis
	...
	time = 3
	materials = list(MATERIAL_ID_STEEL = 7000)
...
/datum/design/item/mechfab/gopher/left_arm
	...
	materials = list(MATERIAL_ID_STEEL = 8750)
...
/datum/design/item/mechfab/gopher/left_leg
	...
	materials = list(MATERIAL_ID_STEEL = 12500)
...
/datum/design/item/mecha/drill/micro
	...
	time = 5
	materials = list(MATERIAL_ID_STEEL = 2500)
...
/datum/design/item/mechfab/polecat/armour
	...
	time = 25
	materials = list(MATERIAL_ID_STEEL = 12500, MATERIAL_ID_PLASTIC = 7500)
...
/datum/design/item/mechfab/weasel/tri_leg
	...
	materials = list(MATERIAL_ID_STEEL = 27500)
