...
/*
/mob/living/silicon/robot/instantiate_hud(datum/hud/HUD, ui_style, ui_color, ui_alpha)
	HUD.robot_hud(ui_style, ui_color, ui_alpha, src)*/

/datum/hud/proc/robot_hud(ui_style='icons/mob/screen1_robot.dmi', ui_color = "#ffffff", ui_alpha = 255, mob/living/silicon/robot/target)
