...
/obj/machinery/sleep_console/ui_interact(mob/user, datum/tgui/ui = null)
...
/obj/machinery/sleep_console/ui_data(mob/user)
	if(sleeper)
		return sleeper.ui_data(user)
	return null

/obj/machinery/sleep_console/ui_act(action, params, datum/tgui/ui, datum/ui_state/state)
	if(sleeper)
		return sleeper.ui_act(action, params, ui, state)
	return FALSE
