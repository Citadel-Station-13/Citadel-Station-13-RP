...
/datum/file/program/welcome/interact()
	...
	dat += "<center><span style='font-size:8pt'>Thank you for choosing NTOS, your gateway to the future of mobile computing technology, sponsored by [SSmapping.legacy_map_config.company_name] (R)</span></center><br>"
	...
	When you rented your laptop, you were supplied with programs that your [SSmapping.legacy_map_config.company_name] Issued ID has given you access to use. \
	In the event of a serious error, the right click menu will give you the ability to reset your computer. To open and close your laptop, alt-click your device.\
	 If you have any questions or technical issues, please contact your local computer technical experts at your local [SSmapping.legacy_map_config.boss_name]."
