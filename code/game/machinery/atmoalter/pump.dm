...
/obj/machinery/portable_atmospherics/powered/pump/attack_hand(mob/user, datum/event_args/clickchain/e_args)
	ui_interact(user)
...
/obj/machinery/portable_atmospherics/powered/pump/huge/attack_hand(mob/user, datum/event_args/clickchain/e_args)
