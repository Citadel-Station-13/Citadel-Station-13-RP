/obj/machinery/point_redemption_vendor/survey
	...
	//	new /datum/point_redemption_item("Clotting Kit",				/obj/item/storage/firstaid/clotting,						50),
		...
		new /datum/point_redemption_item("Rangefinder",					/obj/item/rangefinder,										100),
		new /datum/point_redemption_item("Laser Designator",					/obj/item/rangefinder/laser_designator,				250),
