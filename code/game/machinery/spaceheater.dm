...
/obj/machinery/space_heater/attack_hand(mob/user, datum/event_args/clickchain/e_args)
	interact(user)
...
/obj/machinery/power/thermoregulator/attack_hand(mob/user, datum/event_args/clickchain/e_args)
