...
/obj/machinery/floorlayer/examine(mob/user)
	. = ..()
	. += "<span class='notice'>\The [src] contains [T ? "[T.get_amount()] [T]":"no"] tile\s, dismantle is [mode["dismantle"] ? "on" : "off"], laying is [mode["laying"] ? "on" : "off"], collect is [mode["collect"] ? "on" : "off"].</span>"
