...
/obj/machinery/gear_painter/ui_data(mob/user, datum/tgui/ui, datum/tgui_embed_context/embed_context)
	. = list()
...
/obj/machinery/gear_painter/ui_act(action, list/params, datum/tgui/ui, datum/tgui_embed_context/embed_context)
	. = ..()
	if(.)
		return
	if(inserted)
