...
/obj/machinery/magma_pump/attack_hand(mob/user, datum/event_args/clickchain/e_args)
	interact(user)
...
/obj/machinery/magma_reservoir/attack_hand(mob/user, datum/event_args/clickchain/e_args)
	interact(user)
