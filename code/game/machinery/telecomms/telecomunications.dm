...
/obj/machinery/telecomms/receiver/proc/check_receive_level(datum/signal/signal)
	...
	//Where can we hear?
	var/list/listening_levels = SSmapping.legacy_map_config.get_map_levels(listening_level, TRUE, overmap_range)
...
/obj/machinery/telecomms/relay/receive_information(datum/signal/signal, obj/machinery/telecomms/machine_from)
	...
	if(can_send(signal))
		signal.data["level"] |= SSmapping.legacy_map_config.get_map_levels(listening_level)
...
/proc/can_telecomm(var/atom/A, var/atom/B, var/ad_hoc = FALSE)
	...
	return src_z in SSmapping.legacy_map_config.get_map_levels(dst_z, TRUE, om_range = DEFAULT_OVERMAP_RANGE)
