/obj/machinery/recharger
	...
	var/list/allowed_devices = list(/obj/item/gun/projectile/energy, /obj/item/melee/baton, /obj/item/modular_computer, /obj/item/computer_hardware/battery_module, /obj/item/cell, /obj/item/flashlight, /obj/item/electronic_assembly, /obj/item/weldingtool/electric, /obj/item/flash, /obj/item/ammo_casing/microbattery, /obj/item/shield_diffuser, /obj/item/ammo_magazine/cell_mag, /obj/item/gun/projectile/ballistic/cell_loaded)
	...
	if(allowed)
		...
		if(istype(G, /obj/item/gun/projectile/energy))
			...
			if(maggy.stored_ammo.len < 1)
				...
				return
		else if(istype(G, /obj/item/gun/projectile/ballistic/cell_loaded))
			var/obj/item/gun/projectile/ballistic/cell_loaded/gunny = G
...
/obj/machinery/recharger/process(delta_time)
	...
	if(!charging)
		...
		else if(istype(charging, /obj/item/gun/projectile/ballistic/cell_loaded))
			var/obj/item/gun/projectile/ballistic/cell_loaded/gunny = charging
