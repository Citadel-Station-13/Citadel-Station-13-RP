...
/obj/machinery/porta_turret/attack_hand(mob/user, list/params, datum/event_args/clickchain/e_args)
	if(isLocked(user))
		return
...
/obj/machinery/porta_turret_construct/attack_hand(mob/user, list/params, datum/event_args/clickchain/e_args)
	switch(build_step)
		if(4)
			if(!installation)
				return
