...
/obj/machinery/vending/voidsuit
	...
	desc = "A very motivated Teshari trying to sell his vast voidsuit collection. Himself, wearing a unique repainted voidsuit."
	icon = 'icons/obj/vending.dmi'
	icon_state = "void"
	icon_deny = "void-deny"
	icon_vend = "void-vend"
...
/obj/machinery/vending/winter
	...
	desc = "This poor man seems to be freezing, and his under layers of coats."
	icon = 'icons/obj/vending.dmi'
	icon_state = "winter"
	icon_deny = "winter-deny"
	icon_vend = "winter-vend"
...
/obj/machinery/vending/survivalist
	...
	desc = "Its no recruiter, but a Tajaran member of the SDF selling some gear."
	icon = 'icons/obj/vending.dmi'
	icon_state = "sdf"
	icon_deny = "sdf-deny"
	icon_vend = "sdf-vend"
