...
/obj/machinery/door_timer/ui_data(mob/user, datum/tgui/ui, datum/tgui_embed_context/embed_context)
	var/list/data = list()
	var/time_left = time_left(seconds = TRUE)
...
/obj/machinery/door_timer/ui_act(action, list/params, datum/tgui/ui, datum/tgui_embed_context/embed_context)
	if(..())
		return
