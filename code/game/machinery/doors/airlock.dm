...
/obj/machinery/door/airlock/get_material()
	if(mineral)
		return SSmaterials.material_by_id(mineral)
	return SSmaterials.material_by_id(/datum/material/steel)
...
/obj/machinery/door/airlock/CanAllowThrough(atom/movable/mover, turf/target)
	if (src.isElectrified())
		if (istype(mover, /obj/item))
			var/obj/item/i = mover
			if(world.time > last_spark + 2 SECONDS)
				if (i.matter && (/datum/material/steel in i.matter) && i.matter[/datum/material/steel] > 0)
