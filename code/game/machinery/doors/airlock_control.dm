...
/obj/machinery/airlock_sensor/attack_hand(mob/user, datum/event_args/clickchain/e_args)
	var/datum/signal/signal = new
	signal.transmission_method = TRANSMISSION_RADIO //radio signal
...
/obj/machinery/access_button/attack_hand(mob/user, datum/event_args/clickchain/e_args)
	..()
	if(!allowed(user))
