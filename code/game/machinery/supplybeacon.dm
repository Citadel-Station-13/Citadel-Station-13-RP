...
/obj/item/supply_beacon/attack_self(mob/user, datum/event_args/clickchain/e_args)
	. = ..()
	if(.)
		return
...
/obj/machinery/power/supply_beacon/attack_hand(mob/user, datum/event_args/clickchain/e_args)
