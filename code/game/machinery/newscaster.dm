...
/obj/machinery/newscaster/ui_status(mob/user)
	if(!ispowered || isbroken)
		return UI_CLOSE
	. = ..()
...
/obj/machinery/newscaster/ui_interact(mob/user, datum/tgui/ui, datum/tgui/parent_ui)
	ui = SStgui.try_update_ui(user, src, ui)
	if(!ui)
		ui = new(user, src, "Newscaster", "Newscaster Unit #[unit_no]")
		ui.open()

/obj/machinery/newscaster/ui_data(mob/user, datum/tgui/ui, datum/ui_state/state)
	var/list/data = ..()
