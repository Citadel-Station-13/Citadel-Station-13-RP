/obj/machinery/autolathe
	...
	var/list/stored_material =  list(/datum/material/steel = 0, "glass" = 0)
	var/list/storage_capacity = list(/datum/material/steel = 0, "glass" = 0)
...
/obj/machinery/autolathe/attackby(var/obj/item/O as obj, var/mob/user as mob)
	...
	if(istype(O,/obj/item/ammo_magazine/clip) || istype(O,/obj/item/ammo_magazine/s357) || istype(O,/obj/item/ammo_magazine/s38) || istype (O,/obj/item/ammo_magazine/s44)/* VOREstation Edit*/) // Prevents ammo recycling exploit with speedloaders.
		...
		if(speedloader.stored_ammo)
			...
			speedloader.matter = list(/datum/material/steel = 75) // It's just a hunk of scrap metal now.
...
/obj/machinery/autolathe/RefreshParts()
	...
	storage_capacity[/datum/material/steel] = mb_rating  * 25000
