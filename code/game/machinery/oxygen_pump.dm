...
/obj/machinery/oxygen_pump/ui_interact(mob/user, datum/tgui/ui, datum/tgui/parent_ui)
	if(!tank)
...
/obj/machinery/oxygen_pump/ui_data(mob/user, datum/tgui/ui, datum/ui_state/state)
	var/list/data = ..()
...
/obj/machinery/oxygen_pump/ui_act(action, list/params, datum/tgui/ui, datum/ui_state/state)
	if(..())
		return TRUE
