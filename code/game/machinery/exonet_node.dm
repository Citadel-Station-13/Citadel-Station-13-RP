...
/obj/machinery/exonet_node/map/Initialize(mapload, newdir)
	...
	desc = "This machine is one of many, many nodes inside [SSmapping.legacy_map_config.starsys_name]'s section of the Exonet, connecting the [SSmapping.legacy_map_config.station_short] to the rest of the system, at least \
	electronically."
