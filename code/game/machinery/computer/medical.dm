...
/obj/machinery/computer/med_data/ui_data(mob/user, datum/tgui/ui, datum/tgui_embed_context/embed_context)
	var/data[0]
	data["temp"] = temp
...
/obj/machinery/computer/med_data/ui_act(action, list/params, datum/tgui/ui, datum/tgui_embed_context/embed_context)
	if(..())
		return TRUE
