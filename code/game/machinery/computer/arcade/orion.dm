...
/obj/machinery/computer/arcade/orion_trail/ui_data(mob/user, datum/tgui/ui, datum/tgui_embed_context/embed_context)
	var/list/data = list()
...
/obj/machinery/computer/arcade/orion_trail/ui_static_data(mob/user, datum/tgui/ui, datum/tgui_embed_context/embed_context)
...
/obj/machinery/computer/arcade/orion_trail/ui_act(action, list/params, datum/tgui/ui, datum/tgui_embed_context/embed_context)
	. = ..()
	if(.)
		return
