...
/obj/machinery/computer/arcade/battle/Reset()
	...
	if(SSevents.holidays && SSevents.holidays[HOLIDAY_HALLOWEEN])
	...
	else if(SSevents.holidays && SSevents.holidays[HOLIDAY_CHRISTMAS])
	...
	else if(SSevents.holidays && SSevents.holidays[HOLIDAY_VALENTINES])
