...
/obj/machinery/computer/bioscan/preloading_instance(with_id)
	. = ..()
	if(network_key_obfuscated)
		network_key = SSmapping.obfuscated_persistent_id(network_key_obfuscated, "bioscan_network", with_id)
