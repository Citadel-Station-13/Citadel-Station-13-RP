...
/obj/machinery/computer/bioscan/ui_static_data(mob/user, datum/tgui/ui, datum/tgui_embed_context/embed_context)
	. = ..()
	.["scan"] = buffer
...
/obj/machinery/computer/bioscan/ui_data(mob/user, datum/tgui/ui, datum/tgui_embed_context/embed_context)
	. = ..()
	.["scan_ready"] = !on_cooldown()
	.["network"] = network_key || ""

/obj/machinery/computer/bioscan/ui_act(action, list/params, datum/tgui/ui, datum/tgui_embed_context/embed_context)
	. = ..()
	switch(action)
		if("scan")
			if(!network_key)
