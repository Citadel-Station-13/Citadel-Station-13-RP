...
/obj/machinery/embedded_controller/radio/airlock/advanced_airlock_controller/ui_data(mob/user, datum/tgui/ui, datum/tgui_embed_context/embed_context)
	. = list(
...
/obj/machinery/embedded_controller/radio/airlock/airlock_controller/ui_data(mob/user, datum/tgui/ui, datum/tgui_embed_context/embed_context)
	. = list(
		"chamber_pressure" = round(program.memory["chamber_sensor_pressure"]),
...
/obj/machinery/embedded_controller/radio/airlock/access_controller/ui_data(mob/user, datum/tgui/ui, datum/tgui_embed_context/embed_context)
	. = list(
		"exterior_status" = program.memory["exterior_status"],
		"interior_status" = program.memory["interior_status"],
		"processing" = program.memory["processing"],
