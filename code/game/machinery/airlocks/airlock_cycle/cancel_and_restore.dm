...
// TODO: assumed external pressure is dumb.
/datum/airlock_cycle/cancel_and_restore/create_cycling(was_on_side, assumed_external_pressure)
	var/datum/airlock_cycling/cycling = ..()
	cycling.blackboard[AIRLOCK_CYCLING_BLACKBOARD_IS_CANCEL_OP] = TRUE
	return cycling

/datum/airlock_cycle/cancel_and_restore/gather_phases(was_on_side, assumed_external_pressure)
	. = list()
