...
/obj/machinery/airlock_comopnent/vent
	name = "airlock vent"
...
/obj/machinery/airlock_comopnent/vent/ui_act(action, list/params, datum/tgui/ui)
	. = ..()
	if(.)
		return
...
/obj/machinery/airlock_comopnent/vent/ui_static_data(mob/user, datum/tgui/ui)
	. = ..()

/obj/machinery/airlock_comopnent/vent/ui_data(mob/user, datum/tgui/ui)
	. = ..()
...
/obj/machinery/airlock_comopnent/vent/ui_interact(mob/user, datum/tgui/ui, datum/tgui/parent_ui)
