...
/obj/machinery/pipedispenser/ui_data(mob/user, datum/tgui/ui, datum/tgui_embed_context/embed_context)
	var/list/data = list(
		"disposals" = disposals,
		"p_layer" = p_layer,
...
/obj/machinery/pipedispenser/ui_act(action, list/params, datum/tgui/ui, datum/tgui_embed_context/embed_context)
	if(..())
		return TRUE
