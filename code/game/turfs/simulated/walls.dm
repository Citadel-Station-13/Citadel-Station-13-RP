...
/turf/simulated/wall/fire_act(datum/gas_mixture_old/air, exposed_temperature, exposed_volume)//Doesn't fucking work because walls don't interact with air :(
	burn(exposed_temperature)

/turf/simulated/wall/adjacent_fire_act(turf/simulated/floor/adj_turf, datum/gas_mixture_old/adj_air, adj_temp, adj_volume)
	burn(adj_temp)
