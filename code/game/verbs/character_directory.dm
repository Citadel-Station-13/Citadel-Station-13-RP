...
/datum/character_directory/ui_static_data(mob/user, datum/tgui/ui, datum/tgui_state/state)
	var/list/data = ..()
...
/datum/character_directory/ui_act(action, list/params, datum/tgui/ui, datum/tgui_state/state)
	. = ..()
	if(.)
		return
