...
GENERATE_DESIGN_FOR_PROTOLATHE(/obj/item/gun/projectile/ballistic/nt_expedition/light_sidearm/smg/no_pin, /nt_expedition/light_smg, "nt-expeditionary-light_smg", /datum/prototype/techweb_node/faction_intrinsic/nanotrasen/ballistic_weapons)
