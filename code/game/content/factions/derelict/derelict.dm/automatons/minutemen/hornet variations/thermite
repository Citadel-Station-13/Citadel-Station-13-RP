...
/mob/living/simple_mob/mechanical/derelict/minuteman/hornet/thermite/apply_melee_effects(var/atom/A)
	if(isliving(A))
		var/mob/living/L = A
		if(L.reagents)
...
/mob/living/simple_mob/mechanical/derelict/minuteman/hornet/thermite/proc/inject_poison(mob/living/L, target_zone)
	if(prob(poison_chance))
		to_chat(L, "<span class='warning'>OH GOD YOUR VEINS ARE ON FIRE! AUUUUGH!!</span>")
