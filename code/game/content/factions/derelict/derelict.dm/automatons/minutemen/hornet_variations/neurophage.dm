...
/mob/living/simple_mob/mechanical/derelict/minuteman/hornet/neurophage/apply_melee_effects(var/atom/A)
	if(isliving(A))
		var/mob/living/L = A
		if(L.reagents)
...
/mob/living/simple_mob/mechanical/derelict/minuteman/hornet/neurophage/proc/inject_poison(mob/living/L, target_zone)
	if(prob(poison_chance))
		to_chat(L, "<span class='warning'>Your head begins to hurt..</span>")
