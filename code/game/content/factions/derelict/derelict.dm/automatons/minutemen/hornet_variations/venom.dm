/mob/living/simple_mob/mechanical/derelict/minuteman/hornet/venom
	...
	var/poison_type = "condensedcapsaicin_v"
	var/poison_chance = 100
	var/poison_per_bite = 10


/mob/living/simple_mob/mechanical/derelict/minuteman/hornet/venom/apply_melee_effects(var/atom/A)
	if(isliving(A))
		var/mob/living/L = A
		if(L.reagents)
...
/mob/living/simple_mob/mechanical/derelict/minuteman/hornet/venom/proc/inject_poison(mob/living/L, target_zone)
	if(prob(poison_chance))
		to_chat(L, "<span class='warning'>Your veins feel like they're on fire!</span>")
