...
/obj/structure/event/prop/cables
	icon_state = "cables"
	name = "cables"
	desc = "A series of cables that run along the ground. They seem heavy duty."
	color = "#808080"
	density = 0
...
/obj/structure/event/prop/terminal4
	icon_state = "terminal4"
	name = "abandoned console"
	desc = "A terminal, decorated in multiple odd sigils and runes of which you cannot hope to recognize."
	color = "#808080"

/obj/structure/event/prop/terminal5
	icon_state = "terminal5"
	name = "forlorn computer"
	desc = "This computer might have once served a purpose. Unfortunately, you can only make estimates of what that could have been."
	color = "#808080"

/obj/structure/event/prop/terminal6
	icon_state = "terminal6"
	name = "small ancient terminal"
	desc = "A terminal which appears smaller than any you might have seen before. What was this meant to do?"
	color = "#808080"

/obj/structure/event/prop/monitor1
	icon_state = "monitor1"
	name = "ancient monitor"
	desc = "An impossibly old monitor. If only the screen still worked..."
	color = "#808080"

/obj/structure/event/prop/monitor2
	icon_state = "monitor2"
	name = "derelict monitor"
	desc = "An impossibly old monitor adorned with four screens. If only it still worked..."
	color = "#808080"

/obj/structure/event/prop/monitor3
	icon_state = "monitor3"
	name = "large derelict monitor"
	desc = "A large monitor, fitted with eight screens. There's what looks like a control panel attached to its south side."
	color = "#808080"

/obj/structure/event/prop/monitor_broken
	icon_state = "monitor_broken"
	name = "shattered monitor"
	desc = "An ancient monitor. Its screen has been cracked open, revealing a interior filled with some sort of flesh..."
	color = "#808080"
...
/obj/structure/event/prop/machine1
	icon_state = "machine1"
...
/obj/structure/event/prop/cryofeed
	icon_state = "cryofeed"
	name = "large machine"
	desc = "A large machine, it appears to be built into the structure itself. Despite its age, you can still see some sort of substance running through its many tubes."
	color = "#808080"

/obj/structure/event/prop/button1
	icon_state = "button1"
	name = "keypad?"
...
/obj/structure/event/prop/primary_console
	icon = 'code/game/content/factions/derelict/derelict.dmi/32x32 props.dmi'
	icon_state = "primary_console"
	name = "gargantuan console"
	desc = "A massive console that somehow appears to be in better shape than the structure around you. Some foreign energy courses through it, causing the panel to glow eerily..."
	bounds = "64,64"
	bound_height = 64
	bound_width = 64
	color = "#808080"
...
/obj/structure/event/prop/pod
	...
	icon_state = "pod"
	name = "massive pod"
	desc = "A gargantuan pod that has been built into this places superstructure. A variety of clicks and beeps emit incessantly from it, however the glass is too tinted to see through..."
	bounds = "64,96"
	bound_height = 64
	bound_width = 96
	color = "#808080"

/obj/structure/event/prop/pod_broken
	icon = 'code/game/content/factions/derelict/derelict.dmi/64x96 props.dmi'
	icon_state = "pod_broken"
	name = "shattered pod"
	desc = "What appears to have once been some sort of pod, integrated into this places superstructure. Unfortunately, something appears to have shattered it. You can barely see what looks to be a massive, degraded corpse inside."
	bounds = "64,96"
	bound_height = 64
	bound_width = 96
	color = "#808080"

/obj/structure/event/prop/pillar_NW1
	icon = 'code/game/content/factions/derelict/derelict.dmi/64x128 props.dmi'
	icon_state = "pillar_NW1"
	name = "titanic pillar"
	desc = "A tianic pillar, running through the room as if a giant wandering amongst the lands. You can see an array of tubes and wires running alongside it."
	bounds = "64,128"
	bound_height = 64
	bound_width = 128
	density = 0
...
/obj/structure/event/prop/pillar_NW2
	icon = 'code/game/content/factions/derelict/derelict.dmi/64x128 props.dmi'
	icon_state = "pillar_NW2"
	name = "titanic pillar"
	desc = "A tianic pillar, running through the room as if a giant wandering amongst the lands. You can see an array of tubes and wires running alongside it."
	bounds = "64,128"
	bound_height = 64
...
/obj/structure/event/prop/pillar_SW1
	icon = 'code/game/content/factions/derelict/derelict.dmi/64x128 props.dmi'
	icon_state = "pillar_SW1"
	name = "titanic pillar"
	desc = "A tianic pillar, running through the room as if a giant wandering amongst the lands. You can see an array of tubes and wires running alongside it."
	bounds = "64,128"
	bound_height = 64
...
/obj/structure/event/prop/pillar_SW2
	icon = 'code/game/content/factions/derelict/derelict.dmi/64x128 props.dmi'
	icon_state = "pillar_SW1"
	name = "titanic pillar"
	desc = "A tianic pillar, running through the room as if a giant wandering amongst the lands. You can see an array of tubes and wires running alongside it."
...
/obj/structure/event/prop/pillar_SW1_fade
	icon = 'code/game/content/factions/derelict/derelict.dmi/64x128 props.dmi'
	icon_state = "pillar_SW1fade"
	name = "titanic pillar"
	desc = "A tianic pillar, running through the room as if a giant wandering amongst the lands. You can see an array of tubes and wires running alongside it."
	bounds = "64,128"
	bound_height = 64
...
/obj/structure/event/prop/pillar_SW2_fade
	icon = 'code/game/content/factions/derelict/derelict.dmi/64x128 props.dmi'
	icon_state = "pillar_SW2fade"
	name = "titanic pillar"
	desc = "A tianic pillar, running through the room as if a giant wandering amongst the lands. You can see an array of tubes and wires running alongside it."
	bounds = "64,128"
	bound_height = 64
