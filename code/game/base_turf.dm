...
proc/get_base_turf(var/z)
	if(!SSmapping.legacy_map_config.base_turf_by_z["[z]"])
		SSmapping.legacy_map_config.base_turf_by_z["[z]"] = /turf/space
	return SSmapping.legacy_map_config.base_turf_by_z["[z]"]
...
/client/proc/set_base_turf()
	...
	SSmapping.legacy_map_config.base_turf_by_z["[choice]"] = new_base_path
