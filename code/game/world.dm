...
//	s += "[game_version]"
	...
	s += "<br><small>Roleplay focused 18+ server featuring furries and more. Based on heavily modified VOREstation code. Apply in the Discord: https://discord.gg/citadelstation</small><br>" //CITADEL CHANGE - adds an educational fact to the hub entry!
