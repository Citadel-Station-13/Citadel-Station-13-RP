...
/datum/lore/codex/page/article14
	...
	<br><br>\
	Aetolus is the only garden world in the Almach Rim and among the most difficult to reach from the nearby system of Saint Columbia. Its seclusion and economic independence give it a great deal of weight in the Association, where Council representatives are among the most vehement in their opposition to OriCon- at odds with the Association's decision to reject Boiling Point's pan-Solar revolutionary praxis. It remains to be seen if Aetolus' hawkish ideals will fade over time, but because of the structure of the Association, there is no real chance of the junta being expelled from the government or removed from control of the Vounna system."
...
/datum/lore/codex/page/article21
	...
	data = "After five months of riots causing significant damage to industrial assets, life support, and government facilities, Saint Columbia seems poised to recover. A new constitution for the so-called \"Saint Columbia Democratic Union\" was posted online to significant acclaim. An influential militia group lead by Casini immigrant Luisa Tassis claimed responsibility for the constitution and will be hosting a referendum for all residents of the seven habitation domes of the nation. If adopted, Saint Columbia will remain a member state of OriCon, but Tassis' noted hostility towards the Solar Fleet makes it unlikely that continued presence of the Saint Columbia Fleet Base will be tolerated.\
	<br><br>\
...
/datum/lore/codex/page/valult
	...
	<br>\
	The Almach Association will be allowed to exist as a government entity independent of the Orion Confederation Government going forward on one condition - full, unilateral compliance with the Five Points of Human Sanctity.\
	<br><br>\
...
/datum/lore/codex/page/article29
	...
	data = "Pursuant to the continuing hostility from Secretary Tassis' Saint Columbia Democratic Union and the Almach Militia, the civilians of the Saint Columbia Fleet Base have been organized into an Iserlohn Republic. Named after the largest single module of the station, the Republic has applied to the Colonial Assembly as an independent protectorate, with provisional recognition already extended by Executive of Development Zehava Collins. In a move decried as nepotistic, Admiral McMullen declared independence and installed his daughter Anya as interim President pending ratification of a constitution. OriCon Fleet protocol forbids any member of the service from accepting any political appointment and is believed to be the main reason he did not take power himself. Anya McMullen is the administrative head of the base's hydroponics array and is considered a highly respected citizen of the colony, relationship to its military administrator notwithstanding."
...
/datum/lore/codex/page/article34
	...
	<br><br>\
	Purportedly, this address was met with a standing ovation from the population of Angessa's Pearl. In a separate dispatch, Martei stated her intention to tour OriCon as a foreign dignitary protected by the Respect for Diplomats Act."
...
/datum/lore/codex/page/article43
	...
	data = "As of 0352 this morning, New Reykjavik time, OriCon officials confirmed that all communications coming from the so-called 'Dark Triangle' had ceased. The Dark Triangle is a disputed region of space home to the independent world Natuna, which has maintained a more or less neutral relationship with OriCon for a little more than a decade.\
	<br><br>\
...
/datum/lore/codex/page/article44
	...
	<br><br>\
	Bluespace-lensed telescopes throughout OriCon, including the Vir-based Kara Interstellar Observatory, can once again pick up on tachyon signatures in the region. Traffic has been described as 'lower than usual' and no significant fleet assets are believed to be present in the region, though fixed-placement Hegemony installations now litter the Triangle's major star systems. Systems with significant Hegemony presence include Natuna and Ukupanipo, home to the primitive Uehshad species. Some have speculated that the presence of the Uehshad is the reason for the unexpected Hegemony takeover, though Icarus Front General Secretary Mackenzie West was quick to decry the move as 'an obvious imperial land-grab.'\
	<br><br>\
...
/datum/lore/codex/page/article45
	...
	<br><br>\
	This revelation has added more fuel to already heated Assembly arguments about OriCon response to the Unathi takeover. 'This is a prelude to invasion, nothing more and nothing less,' says New Seoul Representative Collin So-Yung, a noted Iconoclast. 'We must make it absolutely clear to the Hegemony that this is a threat we will not bow to, even in our present state of internal weakness. I suggest we pursue a fair peace with the Association, one where we can keep them as allies against this sort of encroachment instead of shattering our fleets during such a pivotal moment.'\
	<br><br>\
...
/datum/lore/codex/page/article46
	...
	<br><br>\
	This more aggressive approach to the Almach front comes on the tail of aggressive Hegemony deployments in the Dark Triangle, which OriCon has conceded was 'Immediately threatening, but after some deliberation, has brought some form of policing to a lawless region.'.\
	<br><br>\
...
/datum/lore/codex/page/article66
	...
	data = "The government of New Xanadu has surrendered to Association invaders following a disastrous relief effort by the Solar Fleet, whose interdiction vessels are believed to have been captured by the invading force. The manoeuvre leaves the bulk of the Sol fleet isolated in the Saint Columbia system - though a breakout is expected - and has led to widespread outrage in the Colonial Assembly. Critics of the war have damned the Fleet for their 'inability to fight a civilian rabble, gene-modded or otherwise' and renewed calls for a peaceful arrangement between the Orion Confederation Government and Association.\
	<br><br>\
