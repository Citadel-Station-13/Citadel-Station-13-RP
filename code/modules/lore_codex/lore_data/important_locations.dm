...
/datum/lore/codex/page/firnir/add_content()
	...
	kelvin (299Â°C) on the day side has caused this planet to go mostly ignored."
...
/datum/lore/codex/page/tyr/add_content()
	...
	The temperature on the surface can reach up to 405 degrees kelvin (132Â°C), which has deterred most people from the planet, except for two [quick_link("TSC", "TSCs")], \
...
/datum/lore/codex/page/magni/add_content()
	...
	keywords += list("Magni")
	data = "Outside of the habitable zone, the barren world Magni is generally at 202 kelvin (-71Â°C)."
...
/datum/lore/codex/page/kara/add_content()
	...
	[quick_link("NanoTrasen")]. The mid-atmospheric temperature of the gas giant averages to around 150 kelvin (-108Â°C)."
...
/datum/lore/codex/page/rota/add_content()
	name = "Rota (Gas Giant)"
	keywords += list("Rota")
	data = "An ice giant, with a beautiful ring system circling it. The average temperature for it is 165 kelvin (-157Â°C)."
