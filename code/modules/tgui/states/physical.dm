...
/datum/ui_state/physical/can_use_topic(datum/src_object, mob/user, datum/tgui/ui)
...
/datum/ui_state/physical_obscured_state/can_use_topic(datum/src_object, mob/user, datum/tgui/ui)
	. = user.shared_ui_interaction(src_object)
	if(. > UI_CLOSE)
