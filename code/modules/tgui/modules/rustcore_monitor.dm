...
/datum/tgui_module_old/rustcore_monitor/ui_act(action, list/params, datum/tgui/ui, datum/tgui_embed_context/embed_context)
	if(..())
		return TRUE
...
/datum/tgui_module_old/rustcore_monitor/ui_data(mob/user, datum/tgui/ui, datum/tgui_embed_context/embed_context)
	var/list/data = list()
	var/list/cores = list()
