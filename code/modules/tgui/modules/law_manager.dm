...
/datum/tgui_module_old/law_manager/proc/package_laws(list/data, field, list/datum/ai_law/laws)
...
/datum/tgui_module_old/law_manager/proc/package_multiple_laws(list/datum/ai_laws/laws)
...
/datum/tgui_module_old/law_manager/proc/is_malf(mob/user)
	return (is_admin(user) && !owner.is_slaved()) || is_special_role(user)

/datum/tgui_module_old/law_manager/proc/is_special_role(mob/user)
...
/datum/tgui_module_old/law_manager/proc/sync_laws(mob/living/silicon/ai/AI)
	if(!AI)
		return
	for(var/mob/living/silicon/robot/R in AI.connected_robots)
		R.sync()
