	...
	switch(action)
		...
		if("ear")
			if(can_change(APPEARANCE_ALL_HAIR))
				var/datum/sprite_accessory_meta/ears/instance = locate(params["ref"])
				if(params["clear"])
					instance = null
		...
		if("tail")
			if(can_change(APPEARANCE_ALL_HAIR))
				var/datum/sprite_accessory_meta/tail/instance = locate(params["ref"])
				if(params["clear"])
					instance = null
				if(!istype(instance) && !params["clear"])
					return FALSE
		...
		if("wing")
			if(can_change(APPEARANCE_ALL_HAIR))
				var/datum/sprite_accessory_meta/wing/instance = locate(params["ref"])
				if(params["clear"])
					instance = null
				if(!istype(instance) && !params["clear"])
					return FALSE
