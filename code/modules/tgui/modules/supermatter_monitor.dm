...
/datum/tgui_module/supermatter_monitor/ui_data(mob/user)
	...
	if(istype(active))
		...
		//data["SM_EPR"] = active.get_epr()
		if(air.total_moles)
			data["SM_gas_O2"] = round(100*air.gas[/datum/reagent/gas/oxygen]/air.total_moles,0.01)
			data["SM_gas_CO2"] = round(100*air.gas[/datum/reagent/gas/carbon_dioxide]/air.total_moles,0.01)
			data["SM_gas_N2"] = round(100*air.gas[/datum/reagent/gas/nitrogen]/air.total_moles,0.01)
			data["SM_gas_PH"] = round(100*air.gas[/datum/reagent/gas/phoron]/air.total_moles,0.01)
			data["SM_gas_N2O"] = round(100*air.gas["/datum/reagent/gas/nitrous_oxide"]/air.total_moles,0.01)
		else
			data["SM_gas_O2"] = 0
			data["SM_gas_CO2"] = 0
			data["SM_gas_N2"] = 0
