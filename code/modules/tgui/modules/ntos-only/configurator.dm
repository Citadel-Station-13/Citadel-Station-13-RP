...
/datum/tgui_module_old/computer_configurator/ui_data(mob/user, datum/tgui/ui, datum/tgui_embed_context/embed_context)
	movable = ui_host()
...
/datum/tgui_module_old/computer_configurator/ui_act(action, list/params, datum/tgui/ui, datum/tgui_embed_context/embed_context)
	if(..())
		return
	switch(action)
