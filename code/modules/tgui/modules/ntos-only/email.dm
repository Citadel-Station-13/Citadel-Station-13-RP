...
/datum/tgui_module_old/email_client/proc/check_for_new_messages(messages_read = FALSE)
	if(!current_account)
		return 0
...
/datum/tgui_module_old/email_client/proc/find_message_by_fuid(fuid)
...
/datum/tgui_module_old/email_client/proc/relayed_process(netspeed)
