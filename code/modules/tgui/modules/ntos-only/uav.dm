...
/datum/tgui_module/uav/proc/get_signal_to(atom/movable/AM)
	...
	var/list/zlevels_in_range = using_map_legacy.get_map_levels(their_z, FALSE)
	var/list/zlevels_in_long_range = using_map_legacy.get_map_levels(their_z, TRUE, om_range = DEFAULT_OVERMAP_RANGE) - zlevels_in_range
	var/their_signal = 0
