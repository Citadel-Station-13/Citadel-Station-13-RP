...
/obj/vehicle/legacy/train/rover/engine
	name = "NT Humvee"
...
/obj/vehicle/legacy/train/rover/trolley
	name = "Train trolley"
...
// Standard procs
//-------------------------------------------
/obj/vehicle/legacy/train/rover/engine/Initialize(mapload)
	. = ..()
	cell = new /obj/item/cell/high(src)
	key = new(src)
	turn_off()	//so engine verbs are correctly set

/obj/vehicle/legacy/train/rover/engine/Move(var/turf/destination)
...
/obj/vehicle/legacy/train/rover/trolley/attackby(obj/item/W as obj, mob/user as mob)
...
/obj/vehicle/legacy/train/rover/engine/attackby(obj/item/W as obj, mob/user as mob)
	if(istype(W, /obj/item/key/rover))
		if(!key)
			if(!user.attempt_insert_item_for_installation(W, src))
				return
			key = W
			verbs += /obj/vehicle/legacy/train/rover/engine/verb/remove_key
		return
	..()

//cargo trains are open topped, so there is a chance the projectile will hit the mob ridding the train instead
/obj/vehicle/legacy/train/rover/bullet_act(var/obj/item/projectile/Proj)
...
/obj/vehicle/legacy/train/rover/update_icon()
	if(open)
		icon_state = initial(icon_state) + "_open"
	else
		icon_state = initial(icon_state)

/obj/vehicle/legacy/train/rover/trolley/insert_cell(var/obj/item/cell/C, var/mob/living/carbon/human/H)
	return

/obj/vehicle/legacy/train/rover/engine/insert_cell(var/obj/item/cell/C, var/mob/living/carbon/human/H)
	..()
	update_stats()

/obj/vehicle/legacy/train/rover/engine/remove_cell(var/mob/living/carbon/human/H)
	..()
	update_stats()

/obj/vehicle/legacy/train/rover/engine/Bump(atom/Obstacle)
...
/obj/vehicle/legacy/train/rover/trolley/Bump(atom/Obstacle)
	if(!lead)
...
// Train procs
//-------------------------------------------
/obj/vehicle/legacy/train/rover/engine/turn_on()
	if(!key)
		return
	else
		..()
		...
		verbs -= /obj/vehicle/legacy/train/rover/engine/verb/stop_engine
		verbs -= /obj/vehicle/legacy/train/rover/engine/verb/start_engine
...
/obj/vehicle/legacy/train/rover/engine/turn_off()
	..()
...
/obj/vehicle/legacy/train/rover/RunOver(var/mob/living/M)
...
/obj/vehicle/legacy/train/rover/trolley/RunOver(var/mob/living/M)
	..()
	attack_log += text("\[[time_stamp()]\] <font color='red'>ran over [M.name] ([M.ckey])</font>")

/obj/vehicle/legacy/train/rover/engine/RunOver(var/mob/living/M)
	..()
...
// Interaction procs
//-------------------------------------------
/obj/vehicle/legacy/train/rover/engine/relaymove(mob/user, direction)
	if(user != load)
		return 0
...
/obj/vehicle/legacy/train/rover/engine/examine(mob/user)
	. = ..()
	. += "The power light is [on ? "on" : "off"].\nThere are[key ? "" : " no"] keys in the ignition."
	. += "The charge meter reads [cell? round(cell.percent(), 0.01) : 0]%"

/obj/vehicle/legacy/train/rover/engine/verb/start_engine()
...
/obj/vehicle/legacy/train/rover/engine/verb/stop_engine()
...
/obj/vehicle/legacy/train/rover/engine/verb/remove_key()
	set name = "Remove key"
	set category = "Vehicle"
	set src in view(0)
...
//-------------------------------------------
/obj/vehicle/legacy/train/rover/trolley/load(var/atom/movable/C)
...
/obj/vehicle/legacy/train/rover/engine/load(var/atom/movable/C)
...
/obj/vehicle/legacy/train/rover/engine/unload(var/mob/user, var/direction)
...
/obj/vehicle/legacy/train/rover/trolley/proc/load_object(var/atom/movable/C)
...
/obj/vehicle/legacy/train/rover/trolley/unload(var/mob/user, var/direction)
...
/obj/vehicle/legacy/train/rover/engine/latch(obj/vehicle/legacy/train/T, mob/user)
	...
	if(istype(T, /obj/vehicle/legacy/train/rover/trolley))
...
// engine.
//-------------------------------------------------------
/obj/vehicle/legacy/train/rover/engine/update_car(var/train_length, var/active_engines)
...
/obj/vehicle/legacy/train/rover/trolley/update_car(var/train_length, var/active_engines)
	src.train_length = train_length
	src.active_engines = active_engines
