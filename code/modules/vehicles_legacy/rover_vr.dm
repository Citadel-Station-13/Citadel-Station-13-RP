...
/obj/vehicle_old/train/rover/trolley/attackby_legacy(obj/item/W as obj, mob/user as mob)
...
/obj/vehicle_old/train/rover/engine/attackby_legacy(obj/item/W as obj, mob/user as mob)
	if(istype(W, /obj/item/key/rover))
		if(!key)
			if(!user.attempt_insert_item_for_installation(W, src))
				return
			key = W
			verbs += /obj/vehicle_old/train/rover/engine/verb/remove_key
		return
	..()
...
/obj/vehicle_old/train/rover/engine/turn_on()
	if(!key)
		...
		verbs -= /obj/vehicle_old/train/rover/engine/verb/stop_engine
		verbs -= /obj/vehicle_old/train/rover/engine/verb/start_engine
