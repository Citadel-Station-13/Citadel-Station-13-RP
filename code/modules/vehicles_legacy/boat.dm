...
/obj/vehicle_old/boat/sifwood/Initialize(mapload, material_name)
	return ..(mapload, MAT_SIFWOOD)

/obj/vehicle_old/boat/dragon
	name = "dragon boat"
...
/obj/vehicle_old/boat/dragon/sifwood/Initialize(mapload, material_name)
	return ..(mapload, MAT_SIFWOOD)
...
/obj/vehicle_old/boat/Initialize(mapload, material_name)
	. = ..()
	if(!material_name)
		material_name = "wood"
	material = get_material_by_name("[material_name]")
...
// Boarding.
/obj/vehicle_old/boat/MouseDroppedOnLegacy(var/atom/movable/C, mob/user)
	if(ismob(C))
		user_buckle_mob(C, user)
	else
		..(C, user)

/obj/vehicle_old/boat/load(mob/living/L, mob/living/user)
