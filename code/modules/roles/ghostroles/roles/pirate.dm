/datum/prototype/role/ghostrole/pirate
	name = "Pirate"
...
/datum/prototype/role/ghostrole/pirate/Instantiate(client/C, atom/loc, list/params)
	var/rp = rand(1, 3)
	switch(rp)
		if(1)
...
/obj/structure/ghost_role_spawner/pirate
	...
	anchored = TRUE
	density = TRUE
	role_type = /datum/prototype/role/ghostrole/pirate
	role_spawns = 1
