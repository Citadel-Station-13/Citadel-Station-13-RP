/datum/prototype/role/ghostrole/ashlander
	name = "Ashlander"
...
/datum/prototype/role/ghostrole/ashlander/Instantiate(client/C, atom/loc, list/params)
	var/rp = rand(1, 7)
	switch(rp)
		if(1)
			params["fluff"] = "nomad"
...
/obj/structure/ghost_role_spawner/ashlander
	...
	anchored = TRUE
	density = TRUE
	role_type = /datum/prototype/role/ghostrole/ashlander
	role_spawns = 1
