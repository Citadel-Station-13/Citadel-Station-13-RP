...
/datum/prototype/role/ghostrole/golem/free
	name = "Free Golem"
...
/datum/prototype/role/ghostrole/golem/servant
	name = "Servant Golem"
...
/obj/structure/ghost_role_spawner/golem/on_attack_hand(mob/user, act_intent = user.a_intent, unarmed_attack_flags)
	if(isgolem(user) && can_transfer)
		...
		var/datum/prototype/role/ghostrole/G = get_ghostrole_datum(/datum/prototype/role/ghostrole/golem/free)
		if(!G?.instantiator)
