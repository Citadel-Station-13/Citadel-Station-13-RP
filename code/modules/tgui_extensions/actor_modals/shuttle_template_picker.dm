 ...
 */
/datum/tgui_actor_modal/shuttle_template_picker
	tgui_interface = "actor_modal/ShuttleTemplatePicker"
	no_type_dupe = TRUE



/datum/tgui_actor_modal/shuttle_template_picker/New(datum/event_args/actor/actor, datum/callback/validity)
	. = ..()

#warn impl

/datum/tgui_actor_modal/shuttle_template_picker/ui_act(action, list/params, datum/tgui/ui, datum/ui_state/state, datum/event_args/actor/actor)
	. = ..()
	if(.)
		return
...
/datum/tgui_actor_modal/shuttle_template_picker/ui_static_data(mob/user, datum/tgui/ui)
	. = ..()
 ...
 * )
 */
/datum/tgui_actor_modal/shuttle_template_picker/proc/assemble_modules(mob/living/silicon/robot/for_robot) as /list
	. = list()
