...
/obj/structure/bookcase/attack_hand(mob/user, datum/event_args/clickchain/e_args)
	if(contents.len)
...
/obj/item/barcodescanner/attack_self(mob/user, datum/event_args/clickchain/e_args)
	. = ..()
	if(.)
		return
	mode += 1
