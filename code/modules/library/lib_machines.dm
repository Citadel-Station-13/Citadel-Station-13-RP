	...
	switch(screenstate)
		if(0)
			...
			if(src.arcanecheckout)
				...
				user.visible_message(SPAN_NOTICE("\The [user] stares at the blank screen for a few moments, [T.his] expression frozen in fear. When [T.he] finally awakens from it, [T.he] looks a lot older."), 2)
