...
/obj/item/integrated_circuit/manipulation/grabber/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
	drop_all()
...
/obj/item/integrated_circuit/manipulation/weapon_firing/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
	if(installed_gun)
...
/obj/item/integrated_circuit/manipulation/grenade/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
	if(attached_grenade)
