...
/obj/item/integrated_electronics/wirer/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
	switch(mode)
...
/obj/item/integrated_electronics/debugger/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
...
/obj/item/multitool/attack_self(datum/event_args/actor/actor, mob/user)
	if(selected_io)
		selected_io = null
