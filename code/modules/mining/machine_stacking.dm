...
/obj/machinery/mineral/stacking_unit_console/attack_hand(mob/user, datum/event_args/clickchain/e_args)
...
/obj/machinery/mineral/stacking_unit_console/interact(mob/user)
	...
	dat += "</table><hr>"
	dat += "<br>Stacking: [machine.stack_amt] <A href='?src=\ref[src];change_stack=1'>\[change\]</a><br><br>"
