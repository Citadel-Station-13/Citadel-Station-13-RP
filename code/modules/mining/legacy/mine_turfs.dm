#warn get rid of all of this literally all of it
...
/turf/simulated/mineral/bullet_act(var/obj/item/projectile/Proj) // only emitters for now
	...
	if(Proj.excavation_amount)
		...
		if(finds && finds.len)
			var/datum/find/legacy/F = finds[1]
...
/turf/simulated/mineral/proc/excavate_find(var/is_clean = 0, var/datum/find/legacy/F)
