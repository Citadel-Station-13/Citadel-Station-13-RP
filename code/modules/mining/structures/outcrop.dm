...
/obj/structure/outcrop
	...
	/// excavation level at full
	var/excavation_depth = EXCAVATION_LEVEL_OUTCROP
	/// excavation level current
	var/excavation_level = 0
	/// ore ids to drop
	var/list/ores

	#warn multi-ore-types

/obj/structure/outcrop/mine_functionality()
	return MINE_CAN_EXCAVATE | MINE_CAN_WEAKEN

/obj/structure/outcrop/proc/drop_ores()
