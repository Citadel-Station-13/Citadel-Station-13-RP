...
/obj/machinery/mineral/equipment_vendor
	...
	var/list/prize_list = list(
		...
		new /datum/data/mining_equipment("Ice Axe",				/obj/item/pickaxe/icepick,									300),
		new /datum/data/mining_equipment("Ice Pickaxe",				/obj/item/pickaxe/icepick/plasteel,									2200),
