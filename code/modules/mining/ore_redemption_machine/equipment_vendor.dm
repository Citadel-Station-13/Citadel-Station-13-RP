...
//		EQUIPMENT("Survival Equipment - Insulated Poncho",		/obj/random/thermalponcho,											750),
	...
	prize_list["Consumables"] = list(
		...
		EQUIPMENT("Burn Medipen",			/obj/item/reagent_containers/hypospray/autoinjector/biginjector/burn,				250),
		EQUIPMENT("Detox Medipen",			/obj/item/reagent_containers/hypospray/autoinjector/biginjector/toxin,				250),
		EQUIPMENT("Oxy Medipen",			/obj/item/reagent_containers/hypospray/autoinjector/biginjector/oxy,					250),
		//EQUIPMENT("Trauma Medipen",			/obj/item/reagent_containers/hypospray/autoinjector/biginjector/trauma,				250),
	)
	...
	prize_list["Hardsuit"] = list(
		EQUIPMENT("Hardsuit - Control Module",		/obj/item/rig/industrial,		2000),
