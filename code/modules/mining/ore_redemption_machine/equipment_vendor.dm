...
/obj/machinery/mineral/equipment_vendor
	...
	var/list/prize_list = list(
		...
		new /datum/data/mining_equipment("Climbing Pickaxe",				/obj/item/pickaxe/icepick,									300),
		new /datum/data/mining_equipment("Advanced Climbing Pickaxe",				/obj/item/pickaxe/icepick/plasteel,									2200),
