/obj/machinery/mineral/equipment_vendor/survey
	...
	prize_list = list(
		...
		new	/datum/data/mining_equipment("Gateway Guardian Pack",		/obj/item/storage/lockbox/gateway,						1000),
		new	/datum/data/mining_equipment("Cyan Posse Pack",		/obj/item/storage/lockbox/cowboy,						1000),
		new	/datum/data/mining_equipment("Conscript Pack",		/obj/item/storage/lockbox/russian,						500),
