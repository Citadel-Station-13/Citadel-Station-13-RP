/obj/machinery/mineral/equipment_vendor/survey
	...
	prize_list = list(
		...
		new	/datum/data/mining_equipment("Colonial Recce Pack",		/obj/item/storage/lockbox/colonial,						300),
		new	/datum/data/mining_equipment("Gateway Guardian Pack",		/obj/item/storage/lockbox/gateway,						300),
		new	/datum/data/mining_equipment("Cyan Posse Pack",		/obj/item/storage/lockbox/cowboy,						300),
		new	/datum/data/mining_equipment("Conscript Pack",		/obj/item/storage/lockbox/russian,						300),
		new	/datum/data/mining_equipment("Holy Crusade Pack",		/obj/item/storage/lockbox/crusade,						300),
		new	/datum/data/mining_equipment("Maniple Pack",		/obj/item/storage/lockbox/maniple,						300),
		...
		new /datum/data/mining_equipment("Defense Equipment - Marksman Box",	/obj/item/gunbox/marksman,					300),
