...
/obj/machinery/mineral/equipment_vendor/engineering
	...
	prize_list = list(
		...
		new /datum/data/mining_equipment("Power Tool - Holofan Projector", 				/obj/item/holosign_creator/combifan,				100),
		...
		new /datum/data/mining_equipment("Special Parts - Vimur Tank", 				/obj/item/tank/vimur, 50),
