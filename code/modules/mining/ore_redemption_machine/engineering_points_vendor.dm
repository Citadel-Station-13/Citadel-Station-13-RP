...
/obj/machinery/mineral/equipment_vendor/engineering
    ...
    prize_list = list(
        ...
        new /datum/data/mining_equipment("Power Tool - Hand Drill",                     /obj/item/tool/screwdriver/power,                   1000),
        new /datum/data/mining_equipment("Power Tool - Jaws of life",                   /obj/item/tool/crowbar/power,                       1000),
        new /datum/data/mining_equipment("Power Tool - Experimental Welder",            /obj/item/weldingtool/experimental,                 1000),
        new /datum/data/mining_equipment("Power Tool - Upgraded T-Ray Scanner",         /obj/item/t_scanner/upgraded,                       1000),
        new /datum/data/mining_equipment("Power Tool - Advanced T-Ray Scanner",         /obj/item/t_scanner/advanced,                       1000),
        new /datum/data/mining_equipment("Power Tool - Long Range Atmosphere scanner",  /obj/item/analyzer/longrange,                       1000),
        new /datum/data/mining_equipment("Superior Welding Goggles",                    /obj/item/clothing/glasses/welding/superior,        500),
        //Level 1 Stock parts, not really a good deal but doesnt need resources.
        new /datum/data/mining_equipment("Stock Parts - Capacitor",                 /obj/item/stock_parts/capacitor,        200),
        new /datum/data/mining_equipment("Stock Parts - Scanning Module",           /obj/item/stock_parts/scanning_module,  200),
        new /datum/data/mining_equipment("Stock Parts - Micro-Manipulator",         /obj/item/stock_parts/manipulator,      200),
        new /datum/data/mining_equipment("Stock Parts - Micro-Laser",               /obj/item/stock_parts/micro_laser,      200),
        new /datum/data/mining_equipment("Stock Parts - Matter Bin",                /obj/item/stock_parts/matter_bin,       200),
        
        //Level 2 stock parts, to make engineering kinda self sufficent for minor upgrades but the parts are also kinda expansive
        new /datum/data/mining_equipment("Stock Parts - Advanced Capacitor",        /obj/item/stock_parts/capacitor/adv,        2000),
        new /datum/data/mining_equipment("Stock Parts - Advanced Scanning Module",  /obj/item/stock_parts/scanning_module/adv,  2000),
        new /datum/data/mining_equipment("Stock Parts - Nano-Manipulator",          /obj/item/stock_parts/manipulator/nano,     2000),
        new /datum/data/mining_equipment("Stock Parts - High-Power Micro-Laser",    /obj/item/stock_parts/micro_laser/high,     2000),
        new /datum/data/mining_equipment("Stock Parts - Advanced Matter Bin",       /obj/item/stock_parts/matter_bin/adv,       2000)
    )
