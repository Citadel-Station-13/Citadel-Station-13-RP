 ...
 * /obj/item/rig_module/basic/vision/nvg
...
/obj/item/rig_module/basic/vision/mining
...
/obj/item/rig_module/basic/vision/installed()
	..()
	holder.visor = src

/obj/item/rig_module/basic/vision/engage()
...
/obj/item/rig_module/basic/vision/activate()
	if((. = ..()) && holder.wearer)
		holder.wearer.recalculate_vis()

/obj/item/rig_module/basic/vision/deactivate()
	if((. = ..()) && holder.wearer)
		holder.wearer.recalculate_vis()

/obj/item/rig_module/basic/vision/Initialize(mapload)
	. = ..()
