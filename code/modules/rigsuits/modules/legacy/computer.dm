...
/obj/item/ai_verbs/verb/hardsuit_interface()
	...
	if(!usr.loc || !usr.loc.loc || !istype(usr.loc.loc, /obj/item/rig_module/basic))
		to_chat(usr, "You are not loaded into a hardsuit.")
		return

	var/obj/item/rig_module/basic/module = usr.loc.loc
	if(!module.holder)
...
/obj/item/rig_module/basic/ai_container/process(delta_time)
	if(integrated_ai)
...
/obj/item/rig_module/basic/ai_container/proc/update_verb_holder()
	if(!verb_holder)
		verb_holder = new(src)
	if(integrated_ai)
...
/obj/item/rig_module/basic/ai_container/accepts_item(var/obj/item/input_device, var/mob/living/user)
...
/obj/item/rig_module/basic/ai_container/engage(atom/target)
...
/obj/item/rig_module/basic/ai_container/removed()
	eject_ai()
	..()

/obj/item/rig_module/basic/ai_container/proc/eject_ai(var/mob/user)
...
/obj/item/rig_module/basic/ai_container/proc/integrate_ai(var/obj/item/ai,var/mob/user)
	if(!ai) return
...
/obj/item/rig_module/basic/datajack/Initialize(mapload)
	. = ..()
	stored_research = list()

/obj/item/rig_module/basic/datajack/engage(atom/target)
...
/obj/item/rig_module/basic/datajack/accepts_item(var/obj/item/input_device, var/mob/living/user)
...
/obj/item/rig_module/basic/datajack/proc/load_data(var/incoming_data)
...
/obj/item/rig_module/basic/electrowarfare_suite/activate()
...
/obj/item/rig_module/basic/electrowarfare_suite/deactivate()
...
/obj/item/rig_module/basic/emp_shielding
...
/obj/item/rig_module/basic/emp_shielding/activate()
	if(!..())
		return

	holder.emp_protection += protection_amount

/obj/item/rig_module/basic/emp_shielding/deactivate()
	if(!..())
		return
