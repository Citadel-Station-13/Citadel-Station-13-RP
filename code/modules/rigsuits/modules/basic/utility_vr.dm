...
/obj/item/rig_module/basic/pat_module/deactivate()
	if(!..())
		return 0
...
/obj/item/rig_module/basic/rescue_pharm/process(delta_time)
	. = ..()
	if(active)
		var/did_work = 0
...
/obj/item/rig_module/basic/rescue_pharm/engage(atom/target)
	if(!target)
