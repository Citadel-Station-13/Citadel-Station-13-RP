...
/mob/living/simple_mob/xeno/hear_say(message, verb = "says", datum/language/language, alt_name = "",italics = 0, mob/speaker = null)
...
/mob/living/simple_mob/xeno/bullet_act(obj/projectile/P)
