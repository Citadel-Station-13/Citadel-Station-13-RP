/datum/sprite_accessory_meta/marking/synth
	icon = "icons/mob/sprite_accessories/markings/synth_stuff.dmi"

/datum/sprite_accessory_meta/marking/synth/spirit_lights
