...
/datum/sprite_accessory_meta/marking/vox
	icon = "icons/mob/sprite_accessories/markings/vox_stuff.dmi"

/datum/sprite_accessory_meta/marking/vox/vox_coloration
	name = "Vox Two Tone"
...
/datum/sprite_accessory_meta/marking/vox/vox_alt
	name = "Vox Alternate"
	icon_state = "bay_vox"
...
/datum/sprite_accessory_meta/marking/vox/vox_alt_eyes
...
/datum/sprite_accessory_meta/marking/vox/voxscales
	name = "Vox Scales"
...
/datum/sprite_accessory_meta/marking/vox/voxclaws
	name = "Vox Claws"
	icon_state = "Voxclaws"
	color_blend_mode = ICON_MULTIPLY
	body_parts = list(BP_L_FOOT,BP_R_FOOT,BP_L_HAND,BP_R_HAND)

/datum/sprite_accessory_meta/marking/vox/voxbeak
	name = "Vox Beak"
	icon_state = "Voxscales"
	color_blend_mode = ICON_MULTIPLY
	body_parts = list(BP_HEAD)
