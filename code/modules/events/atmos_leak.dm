...
/datum/event/atmos_leak/announce()
	command_announcement.Announce("Warning, hazardous [gas_data.names[gas_type]] gas leak detected in \the [target_area], evacuate the area and contain the damage!", "Hazard Alert")
