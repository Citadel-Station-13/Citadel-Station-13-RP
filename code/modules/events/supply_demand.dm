...
/datum/event/supply_demand/setup()
	my_department = "[using_map_legacy.company_name] Supply Division" // Can't have company name in initial value (not const)
...
/datum/event/supply_demand/announce()
	var/message = "[using_map_legacy.company_short] is comparing accounts and the bean counters found our division "
