...
/datum/event_container/proc/start_event()
	...
	if(next_event)
		...
		log_debug(span_debug_info("Starting event '[next_event.name]' of severity [severity_to_string[severity]]."))
...
/datum/event_container/proc/set_event_delay()
	...
	log_debug(span_debug_info("Next event of severity [severity_to_string[severity]] in [(next_event_time - world.time)/600] minutes."))
