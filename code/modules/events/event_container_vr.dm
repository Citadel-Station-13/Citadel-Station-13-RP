...
/datum/event_container/mundane/New()
	available_events = list(
		...
		new /datum/event_meta(EVENT_LEVEL_MUNDANE, "Electrical Storm",	/datum/event/electrical_storm, 	250,	list(ASSIGNMENT_ENGINEER = 20, ASSIGNMENT_JANITOR = 150), 1),
...
/datum/event_container/moderate/New()
	available_events = list(
		...
		new /datum/event_meta(EVENT_LEVEL_MODERATE, "Rat Migration",			/datum/event/hostile_migration,			65,		list(ASSIGNMENT_SECURITY = 25, ASSIGNMENT_ENGINEER = 10)),
	)
	add_disabled_events(list(
...
/datum/event_container/major/New()
	available_events = list(
		...
		new /datum/event_meta(EVENT_LEVEL_MAJOR, "Electrical Storm",	/datum/event/electrical_storm, 	25,	list(ASSIGNMENT_ENGINEER = 20, ASSIGNMENT_JANITOR = 150), 1),
