...
/datum/event/grub_infestation/end()
	...
	if(area_names.len)
		...
		GLOB.command_announcement.Announce("Sensors have narrowed down remaining active solargrubs to the followng areas: [english_list]", "Lifesign Alert", new_sound = 'sound/AI/aliens.ogg')
	grubs.Cut()