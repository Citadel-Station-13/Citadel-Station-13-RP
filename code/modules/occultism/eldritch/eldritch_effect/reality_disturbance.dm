...
/obj/effect/eldritch_effect/reality_disturbance/examine(mob/user, dist)
	. = ..()
...
/**
 * @return /obj/effect/eldritch_effect/reality_fracture
 */
/obj/effect/eldritch_effect/reality_disturbance/proc/create_fracture(datum/event_args/actor/by_actor, datum/eldritch_holder/by_holder)

	var/obj/effect/eldritch_effect/reality_fracture/created_fracture = new(loc, src)
