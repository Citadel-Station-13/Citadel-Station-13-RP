...
/datum/stargazer_mindnet_ability/commune
	...
	var/default_text_pattern = SPAN_ALIEN("You feel a distinctly alien voice permeate your mind: <b>%%INPUT%%</b>")

#warn log ocmmune

/datum/stargazer_mindnet_ability/commune/proc/format_user_input(datum/event_args/actor/actor, datum/stargazer_mindnet/mindnet, list/blackboard, datum/mind/target, dangerously_unsanitized_inputt)
...
/datum/stargazer_mindnet_ability/commune/xenochimera/format_user_input(datum/event_args/actor/actor, datum/stargazer_mindnet/mindnet, list/blackboard, datum/mind/target, dangerously_unsanitized_inputt)
