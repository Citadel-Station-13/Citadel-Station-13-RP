...
/datum/ability/mansus_ability/eldritch_blast/proc/fire_standard(atom/movable/anchor, datum/event_args/actor/clickchain/clickchain)
	return fire(anchor, clickchain, 25)

/datum/ability/mansus_ability/eldritch_blast/proc/fire_heavy(atom/movable/anchor, datum/event_args/actor/clickchain/clickchain)
	return fire(anchor, clickchain, 100)

/datum/ability/mansus_ability/eldritch_blast/proc/fire(atom/movable/anchor, datum/event_args/actor/clickchain/clickchain, intensity)
