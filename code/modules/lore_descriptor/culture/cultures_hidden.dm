...
/decl/lore_info/culture/hidden/monkey
	name = CULTURE_MONKEY
	language = "Chimpanzee"

/decl/lore_info/culture/hidden/monkey/get_random_name()
	return "[lowertext(name)] ([rand(100,999)])"

/decl/lore_info/culture/hidden/monkey/farwa
	name = CULTURE_FARWA

/decl/lore_info/culture/hidden/monkey/neara
	name = CULTURE_NEARA

/decl/lore_info/culture/hidden/monkey/stok
	name = CULTURE_STOK
