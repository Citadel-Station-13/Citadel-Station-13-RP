/datum/lore_info/culture/unathi
	name = CULTURE_UNATHI
	...
	society is a fractured mess divided by region, faith, and what clan a Unathi is in, leaving them unable to truly reach the height of \
