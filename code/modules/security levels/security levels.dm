...
/proc/set_station_security_level(var/level)
	switch(level)
		if("green")
	...
	if(level >= SEC_LEVEL_GREEN && level <= SEC_LEVEL_DELTA && level != GLOB.security_level)
		...
		for(var/obj/machinery/fire_alarm/FA in GLOB.machines)
			if(FA.z in (LEGACY_MAP_DATUM).contact_levels)
				FA.set_station_security_level(newlevel)
...
/*DEBUG
/mob/verb/set_thing0()
	set_station_security_level(0)
/mob/verb/set_thing1()
	set_station_security_level(1)
/mob/verb/set_thing2()
	set_station_security_level(2)
/mob/verb/set_thing3()
	set_station_security_level(3)
/mob/verb/set_thing4()
	set_station_security_level(4)
/mob/verb/set_thing5()
	set_station_security_level(5)
/mob/verb/set_thing6()
	set_station_security_level(6)
*/
