...
Changes from tg DAL:
  ...
  - Code:
	  - Instead of one flat luminosity var, light is represented by 3 atom vars:
		  ...
		  - light_color; hex string representing the RGB color of the light.
...
atom: (lighting_atom.dm)
  ...
  - var/light_color; hex string representing the RGB color of the light
