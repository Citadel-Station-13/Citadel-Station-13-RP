...
/datum/weather/cloudy/light
	...
	sky_cover = FALSE
	sky_cover_message = "You see a few clouds in the sky. It still looks pretty clear, though."
	light_cover = 0.05
...
/datum/weather/cloudy/moderate
	...
	sky_cover = FALSE
	sky_cover_message = "You see quite a few clouds in the sky. They roll across the landscape. The sky is mildly obstructed."
	light_cover = 0.15
...
/datum/weather/cloudy/severe
	...
	sky_cover = TRUE
	sky_cover_message = "There's many clouds in the sky. The sky is almost completely obtsructed."
	light_cover = 0.3
