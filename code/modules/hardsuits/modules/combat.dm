...
/obj/item/hardsuit_module/mounted/energy_blade/process(delta_time)
	...
	if(holder && holder.wearer)
		if(!(locate(/obj/item/melee/transforming/energy/blade) in holder.wearer))
			deactivate()
			return 0
...
/obj/item/hardsuit_module/mounted/energy_blade/activate()
	...
	var/obj/item/melee/transforming/energy/blade/blade = new(M)
	blade.creator = M
...
/obj/item/hardsuit_module/mounted/energy_blade/deactivate()
	...
	for(var/obj/item/melee/transforming/energy/blade/blade in M.contents)
		qdel(blade)
