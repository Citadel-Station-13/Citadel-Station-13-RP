...
//	playsound(src, 'sound/items/package_unwrap.ogg', 50, 1) we don't have this soundfile yet
...
//				playsound(src, pick('sound/bureaucracy/pen1.ogg','sound/bureaucracy/pen2.ogg'), 20)  dont have sound
				name = "[name] ([str])"
				if(!examtext && !nameset)
					nameset = 1
					update_icon()
