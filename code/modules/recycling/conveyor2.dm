...
/obj/machinery/conveyor/attack_hand(mob/user, datum/event_args/clickchain/e_args)
...
/obj/machinery/conveyor_switch/attack_hand(mob/user, datum/event_args/clickchain/e_args)
	if(!allowed(user))
...
// attack with hand, switch position
/obj/machinery/conveyor_switch/oneway/attack_hand(mob/user, datum/event_args/clickchain/e_args)
	if(position == 0)
		position = convdir
	else
		position = 0
