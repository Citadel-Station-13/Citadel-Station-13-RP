...
/obj/item/scrying/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
...
/obj/item/veilrender/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
	if(charges > 0)
...
/obj/item/voodoo/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
...
/obj/item/warpwhistle/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
