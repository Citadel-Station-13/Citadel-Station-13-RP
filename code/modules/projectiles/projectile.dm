...
//Must have source, and one of the following: target, params, or direct_angle_aim
/obj/item/projectile/proc/preparePixelProjectile(atom/target, atom/source, params, angle_offset = 0, direct_angle_aim)
	...
	else if(direct_angle_aim)
		setAngle(direct_angle_aim)
	else
