...
/obj/item/gun/ballistic/revolver/load_ammo(obj/item/A, mob/user)
	chamber_offset = 0
	return ..()
...
/obj/item/gun/ballistic/revolver/deckard/load_ammo(obj/item/A, mob/user)
...
/obj/item/gun/ballistic/revolver/lemat/examine(mob/user, dist)
	. = ..()
	if(secondary_loaded)
		var/to_print
