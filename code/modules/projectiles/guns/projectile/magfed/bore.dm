/obj/item/gun/projectile/magfed/matfed
...
/obj/item/gun/projectile/magfed/matfed/examine(mob/user, dist)
	. = ..()
	if(mat_storage)
		. += SPAN_NOTICE("It has [mat_storage] out of [max_mat_storage] units of [ammo_material] loaded.")

/obj/item/gun/projectile/magfed/matfed/update_overlays()
	. = ..()
...
/obj/item/gun/projectile/magfed/matfed/attack_hand(mob/user, list/params) // It doesn't keep a loaded item inside.
...
/obj/item/gun/projectile/magfed/matfed/check_ammo()
	if(mat_storage - mat_cost >= 0)
		return TRUE
	return FALSE

/obj/item/gun/projectile/magfed/matfed/use_ammo()
	mat_storage -= mat_cost

/obj/item/gun/projectile/magfed/matfed/attackby(var/obj/item/thing, var/mob/user)
	if(removable_components)
...
//phoron bore 2
/obj/item/gun/projectile/magfed/matfed/advanced
