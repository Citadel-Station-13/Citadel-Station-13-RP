/obj/item/gun/projectile/magfed/railgun
	name = "railgun"
...
/obj/item/gun/projectile/magfed/railgun/Initialize(mapload)
...
/obj/item/gun/projectile/magfed/railgun/show_ammo(var/mob/user)
...
/obj/item/gun/projectile/magfed/railgun/check_ammo()
	var/obj/item/rcd_ammo/ammo = loaded
	return ammo && ammo.remaining

/obj/item/gun/projectile/magfed/railgun/use_ammo()
	var/obj/item/rcd_ammo/ammo = loaded
	ammo.remaining--
	if(ammo.remaining <= 0)
		out_of_ammo()

/obj/item/gun/projectile/magfed/railgun/proc/out_of_ammo()
...
/obj/item/gun/projectile/magfed/railgun/automatic // Adminspawn only, this shit is absurd.
...
/obj/item/gun/projectile/magfed/railgun/automatic/examine(var/mob/user)
	. = ..()
	if(Adjacent(user))
		. += "<span class='notice'>Someone has scratched <i>Ultima Ratio Regum</i> onto the side of the barrel.</span>"

/obj/item/gun/projectile/magfed/railgun/flechette
	name = "flechette gun"
...
/obj/item/gun/projectile/magfed/railgun/heater
	name = "coil rifle"
...
/obj/item/gun/projectile/magfed/railgun/heater/pistol
	name = "coil pistol"
...
/obj/item/gun/projectile/magfed/railgun/flechette/sif
	name = "shredder rifle"
