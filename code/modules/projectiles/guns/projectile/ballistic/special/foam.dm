...
/obj/item/gun/projectile/ballistic/advanced_smg/foam/update_icon_state()
	. = ..()
	icon_state = (ammo_magazine)? "toy_smg" : "toy_smg-empty"

/obj/item/gun/projectile/ballistic/advanced_smg/foam/handle_suicide(mob/living/user)
	user.show_message("<span class = 'warning'>You feel rather silly, trying to commit suicide with a toy.</span>")
	mouthshoot = 0

/obj/item/gun/projectile/ballistic/advanced_smg/foam/blue
	icon_state = "toy_smg_blue"

/obj/item/gun/projectile/ballistic/advanced_smg/foam/blue/update_icon_state()
	. = ..()
	icon_state = (ammo_magazine)? "toy_smg_blue" : "toy_smg_blue-empty"

/obj/item/gun/projectile/ballistic/c20r/foam
	name = "toy submachine gun"
...
/obj/item/gun/projectile/ballistic/c20r/foam/update_icon_state()
	. = ..()
	if(ammo_magazine)
...
/obj/item/gun/projectile/ballistic/c20r/foam/handle_suicide(mob/living/user)
	user.show_message("<span class = 'warning'>You feel rather silly, trying to commit suicide with a toy.</span>")
	mouthshoot = 0

/obj/item/gun/projectile/ballistic/lmg/foam
...
/obj/item/gun/projectile/ballistic/lmg/foam/update_icon_state()
	. = ..()
...
/obj/item/gun/projectile/ballistic/lmg/foam/update_icon()
	. = ..()
	update_held_icon()

/obj/item/gun/projectile/ballistic/lmg/foam/handle_suicide(mob/living/user)
	user.show_message("<span class = 'warning'>You feel rather silly, trying to commit suicide with a toy.</span>")
	mouthshoot = 0
	return
