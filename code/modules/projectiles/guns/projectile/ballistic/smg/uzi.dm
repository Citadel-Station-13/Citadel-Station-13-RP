...
/obj/item/gun/projectile/ballistic/mini_uzi/update_icon_state()
	. = ..()
	if(ammo_magazine)
		icon_state = "mini-uzi"
	else
...
/obj/item/gun/projectile/ballistic/mini_uzi/custom
...
/obj/item/gun/projectile/ballistic/mini_uzi/custom/update_icon_state()
	. = ..()
	if(ammo_magazine)
		icon_state = "mini-uzi-custom"
	else
