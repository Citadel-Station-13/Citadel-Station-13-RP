/obj/item/gun/energy/kinetic_accelerator
	...
	item_icons = list(
		slot_l_hand_str = 'icons/item_onmob/lefthand/guns_vr.dmi',
		slot_r_hand_str = 'icons/item_onmob/righthand/guns_vr.dmi')
...
/obj/item/gun/energy/kinetic_accelerator/handle_post_fire(mob/user, atom/target, var/pointblank=0, var/reflex=0)
	. = ..()
	spawn(fire_delay)
...
/obj/item/borg/upgrade/modkit/efficiency/install(obj/item/gun/energy/kinetic_accelerator/KA, mob/user)
	. = ..()
	if(.)
		KA.charge_cost -= modifier

/obj/item/borg/upgrade/modkit/efficiency/uninstall(obj/item/gun/energy/kinetic_accelerator/KA)
	KA.charge_cost += modifier
	..()
