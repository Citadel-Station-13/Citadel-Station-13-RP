...
/obj/item/gun/projectile/ballistic/bow/attack_self(mob/user, datum/event_args/actor/actor)
	. = ..()
	if(.)
		return
	if(loaded.len)
...
/obj/item/gun/projectile/ballistic/bow/attack_hand(mob/user, datum/event_args/actor/clickchain/e_args)
