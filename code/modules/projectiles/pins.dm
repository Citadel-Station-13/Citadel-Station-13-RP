/obj/item/firing_pin
	...
	var/pin_removeable = TRUE		//Can be replaced by any pin.
	var/obj/item/gun/gun

/obj/item/firing_pin/Initialize(mapload, obj/item/gun/G)
	. = ..()
	if(istype(G))
		gun_insert(null, G)
...
/obj/item/firing_pin/proc/pin_auth(mob/living/user, atom/target, params)
	return TRUE
