...
/obj/projectile/bullet/srmrocket/on_impact_new(atom/target, impact_flags, def_zone, blocked)
...
/obj/projectile/bullet/srmrocket/weak/on_impact_new(atom/target, impact_flags, def_zone, blocked)
