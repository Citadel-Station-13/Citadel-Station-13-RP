...
/proc/infect_virus2(var/mob/living/carbon/M,var/datum/disease2/disease/disease,var/forced = 0)
	if(!istype(disease))
//		log_debug(span_debug_warning("Bad virus"))
		return
	if(!istype(M))
//		log_debug(span_debug_warning("Bad mob"))
		return
...
//			log_debug(span_debug_info("Adding virus"))
...
//	log_debug(span_debug_info("Infecting [M]"))
...
//	log_debug(span_debug_info("Spreading [vector] diseases from [src] to [victim]"))
	if (virus2.len > 0)
		for (var/ID in virus2)
//			log_debug(span_debug_info("Attempting virus [ID]"))
...
//					log_debug(span_debug_info("In range, infecting"))
					infect_virus2(victim,V)
//				else
//					log_debug(span_debug_warning("Could not reach target"))
...
//		log_debug(span_debug_info("Spreading [vector] diseases from [victim] to [src]"))
		var/nudity = 1
