...
/datum/topic_state/glasses_state/can_use_topic(src_object, mob/user)
	if(ishuman(user))
...
/datum/topic_state/nif_state/can_use_topic(src_object, mob/user)
	if(ishuman(user))
		var/mob/living/carbon/human/H = user
...
/datum/topic_state/commlink_state/can_use_topic(src_object, mob/user)
	if(ishuman(user))
		var/mob/living/carbon/human/H = user
