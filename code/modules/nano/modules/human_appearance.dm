...
/datum/nano_module/appearance_changer/Topic(ref, href_list, datum/topic_state/state = default_state)
	if(..())
		return 1
...
/datum/nano_module/appearance_changer/nano_ui_interact(mob/user, ui_key = "main", datum/nanoui/ui = null, force_open = 1, datum/topic_state/state = default_state)
