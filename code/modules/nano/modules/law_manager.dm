...
/datum/nano_module/law_manager/nano_ui_interact(mob/user, ui_key = "main", datum/nanoui/ui = null, force_open = 1, datum/topic_state/state = default_state)
	var/data[0]
	owner.lawsync()
...
/datum/nano_module/law_manager/proc/is_special_role(mob/user)
