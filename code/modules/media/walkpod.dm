//Direct port from Yawn wider addapted to citrp by Pixelkitty286
...
/obj/item/device/walkpod
	...
	var/datum/media_track/current_track		// Current track playing
...
/obj/item/device/walkpod/ui_interact(mob/user, datum/tgui/ui, datum/tgui/parent_ui)
	ui = SStgui.try_update_ui(user, src, ui)
	if(!ui)
		ui = new(user, src, "Jukebox", "PodZu Music Player")
		ui.open()

/obj/item/device/walkpod/ui_data(mob/user, datum/tgui/ui, datum/tgui_embed_context/embed_context)
	var/list/data = ..()
...
/obj/item/device/walkpod/ui_act(action, list/params, datum/tgui/ui, datum/tgui_embed_context/embed_context)
	if(..())
		return TRUE
