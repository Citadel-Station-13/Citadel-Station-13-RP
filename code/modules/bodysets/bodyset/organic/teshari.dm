...
/datum/prototype/bodyset/organic/teshari
	name = "Teshari"
	id = "teshari"
	group_id = "human"
...
/datum/prototype/sprite_accessory/tail/bodyset/teshari
	name = "teshari tail"
...
/datum/prototype/sprite_accessory/tail/bodyset/teshari/render(mob/for_whom, list/colors, layer_front, layer_behind, layer_side, with_base_state, with_variation, flattened)
