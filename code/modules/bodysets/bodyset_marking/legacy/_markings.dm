/datum/bodyset_marking/legacy
	abstract_type = /datum/bodyset_marking/legacy
	icon = "icons/mob/sprite_accessories/markings.dmi"
	color_uses_blend_add = TRUE

/datum/bodyset_marking/legacy/bands
	name = "Color Bands"
	id = "marking_bands"
	icon_state = "bands"
	body_parts = list(BP_L_FOOT,BP_R_FOOT,BP_L_LEG,BP_R_LEG,BP_L_ARM,BP_R_ARM,BP_L_HAND,BP_R_HAND,BP_TORSO,BP_GROIN)

/datum/bodyset_marking/legacy/bandsface
	name = "Color Bands (Face)"
	id = "marking_bands_face"
	icon_state = "bandsface"
	body_parts = list(BP_HEAD)

/datum/bodyset_marking/legacy/tigerhead
...
/datum/bodyset_marking/legacy/backstripe
	name = "Back Stripe"
	id = "marking_back"
...
/// Misc
/datum/bodyset_marking/legacy/abomination
	name = "Abomination"
...
/datum/bodyset_marking/legacy/abomination_alt
...
/datum/bodyset_marking/legacy/nevrean_female
...
/datum/bodyset_marking/legacy/shaggy_mane
...
/datum/bodyset_marking/legacy/jagged_teeth
	name = "Jagged teeth"
	id = "marking_teeth_jagged"
	icon_state = "jagged"
	body_parts = list(BP_HEAD)

/datum/bodyset_marking/legacy/blank_face
...
/datum/bodyset_marking/legacy/monster_mouth
	name = "Monster mouth"
	id = "marking_mouth_monster"
	icon_state = "monster"
	body_parts = list(BP_HEAD)

/datum/bodyset_marking/legacy/saber_teeth
	name = "Saber teeth"
	id = "marking_teeth_saber"
	icon_state = "saber"
	body_parts = list(BP_HEAD)

/datum/bodyset_marking/legacy/fangs
	name = "Fangs"
	id = "marking_teeth_fangs"
	icon_state = "fangs"
	body_parts = list(BP_HEAD)

/datum/bodyset_marking/legacy/tusks
	name = "Tusks"
	id = "marking_teeth_tusks"
	icon_state = "tusks"
	body_parts = list(BP_HEAD)

/datum/bodyset_marking/legacy/otie_face
	name = "Otie face"
...
/datum/bodyset_marking/legacy/otie_nose
	name = "Otie nose"
...
/datum/bodyset_marking/legacy/otienose_lite
...
/datum/bodyset_marking/legacy/backstripes
	name = "Back stripes"
...
/datum/bodyset_marking/legacy/belly_butt
	name = "Belly and butt"
...
/datum/bodyset_marking/legacy/fingers_toes
...
/datum/bodyset_marking/legacy/otie_socks
...
/datum/bodyset_marking/legacy/corvid_beak
	name = "Corvid beak"
...
/datum/bodyset_marking/legacy/corvid_belly
	name = "Corvid belly"
...
/datum/bodyset_marking/legacy/cow_body
	name = "Cow markings"
	id = "marking_body_cow"
	icon_state = "cowbody"
	color_uses_blend_add = FALSE
...
/datum/bodyset_marking/legacy/cow_nose
	name = "Cow nose"
	id = "marking_nose_cow"
	icon_state = "cownose"
	color_uses_blend_add = FALSE
...
/datum/bodyset_marking/legacy/zbody
...
/datum/bodyset_marking/legacy/znose
	name = "Jagged snout"
...
/datum/bodyset_marking/legacy/otter_nose
	name = "Otter nose"
...
/datum/bodyset_marking/legacy/otter_face
	name = "Otter face"
...
/datum/bodyset_marking/legacy/deer_face
	name = "Deer face"
...
/datum/bodyset_marking/legacy/sharkface
	name = "Akula snout"
...
/datum/bodyset_marking/legacy/sheppy_face
	name = "Shepherd snout"
...
/datum/bodyset_marking/legacy/sheppy_back
	name = "Shepherd back"
...
/datum/bodyset_marking/legacy/harpy_feathers
...
/datum/bodyset_marking/legacy/harpy_legs
...
/datum/bodyset_marking/legacy/chooves
	name = "Cloven hooves"
...
/datum/bodyset_marking/legacy/alurane
	name = "Alraune Body"
	id = "marking_body_alraune"
	icon_state = "alurane"
	body_parts = list(BP_L_FOOT,BP_R_FOOT,BP_L_LEG,BP_R_LEG,BP_L_ARM,BP_R_ARM,BP_L_HAND,BP_R_HAND,BP_GROIN,BP_TORSO,BP_HEAD)

/datum/bodyset_marking/legacy/body_tone
	name = "Body toning (for emergency contrast loss)"
	id = "marking_body_tone"
	icon_state = "btone"
	body_parts = list(BP_L_FOOT,BP_R_FOOT,BP_L_LEG,BP_R_LEG,BP_L_ARM,BP_R_ARM,BP_L_HAND,BP_R_HAND,BP_GROIN,BP_TORSO)

/datum/bodyset_marking/legacy/body_tone_alt
	name = "Body toning Alt"
	id = "marking_body_tone_alt"
	icon_state = "btonealt"
	body_parts = list(BP_L_FOOT,BP_R_FOOT,BP_L_LEG,BP_R_LEG,BP_L_ARM,BP_R_ARM,BP_L_HAND,BP_R_HAND,BP_GROIN,BP_TORSO,BP_HEAD)

/datum/bodyset_marking/legacy/skrell_highlight
...
/datum/bodyset_marking/legacy/skrell_chest
	name = "Skrell Chest"
...
/datum/bodyset_marking/legacy/skrell_leg
...
/datum/bodyset_marking/legacy/gloss
...
/datum/bodyset_marking/legacy/osocks_rarm
...
/datum/bodyset_marking/legacy/osocks_larm
...
/datum/bodyset_marking/legacy/osocks_rleg
...
/datum/bodyset_marking/legacy/osocks_lleg
...
/datum/bodyset_marking/legacy/catwomantorso
...
/datum/bodyset_marking/legacy/catwomangroin
...
/datum/bodyset_marking/legacy/catwoman_rleg
...
/datum/bodyset_marking/legacy/catwoman_lleg
...
/datum/bodyset_marking/legacy/tentacle_head
	name = "Squid Head"
...
/datum/bodyset_marking/legacy/tentacle_mouth
	name = "Tentacle Mouth"
...
/datum/bodyset_marking/legacy/rosette
	name = "Rosettes"
	id = "marking_rosettes"
	icon_state = "rosette"
	body_parts = list(BP_L_FOOT,BP_R_FOOT,BP_L_LEG,BP_R_LEG,BP_L_ARM,BP_R_ARM,BP_L_HAND,BP_R_HAND,BP_GROIN,BP_TORSO,BP_HEAD)

/datum/bodyset_marking/legacy/shadekin_snoot
	name = "Shadekin Snoot"
...
/datum/bodyset_marking/legacy/claws
	name = "Claws"
	id = "marking_claws"
	icon_state = "claws"
	color_uses_blend_add = FALSE
...
/datum/bodyset_marking/legacy/equine_snout //Why the long face? Works best with sergal bodytype.
	name = "Equine Snout"
...
/datum/bodyset_marking/legacy/equine_nose
	name = "Equine Nose"
...
/datum/bodyset_marking/legacy/short_snoot
	name = "Short Snout"
...
/datum/bodyset_marking/legacy/short_snoot_nose
...
/datum/bodyset_marking/legacy/fullhead
...
/datum/bodyset_marking/legacy/nosehuman
...
/datum/bodyset_marking/legacy/lipcolorhuman
	name = "Humanoid Lip Colour"
	id = "marking_lip"
	icon_state = "lipcolor"
	body_parts = list(BP_HEAD)

/datum/bodyset_marking/legacy/jackal_backpattern
...
/datum/bodyset_marking/legacy/jackal_bareback
