/datum/prototype/bodyset_marking/legacy/diona
	abstract_type = /datum/prototype/bodyset_marking/legacy/diona
	icon = "icons/mob/sprite_accessories/markings/diona.dmi"
	bodyset_group_restricted = list(
		"human",
	)

/datum/prototype/bodyset_marking/legacy/diona/diona_leaves
	name = "Diona Leaves"
...
/datum/prototype/bodyset_marking/legacy/diona/diona_thorns
	name = "Diona Thorns"
...
/datum/prototype/bodyset_marking/legacy/diona/diona_flowers
	name = "Diona Flowers"
...
/datum/prototype/bodyset_marking/legacy/diona/diona_moss
	name = "Diona moss"
