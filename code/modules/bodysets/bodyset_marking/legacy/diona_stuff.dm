/datum/bodyset_marking/diona
	abstract_type = /datum/bodyset_marking/diona
	icon = "icons/mob/sprite_accessories/markings/diona.dmi"
	species_allowed = list(SPECIES_DIONA, SPECIES_ALRAUNE)

/datum/bodyset_marking/diona/diona_leaves
	name = "Diona Leaves"
...
/datum/bodyset_marking/diona/diona_thorns
	name = "Diona Thorns"
...
/datum/bodyset_marking/diona/diona_flowers
	name = "Diona Flowers"
...
/datum/bodyset_marking/diona/diona_moss
	name = "Diona moss"
