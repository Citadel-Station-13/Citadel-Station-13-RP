...
/obj/item/deck/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
	shuffle()
...
/obj/item/pack/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
...
/obj/item/hand/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
	concealed = !concealed
