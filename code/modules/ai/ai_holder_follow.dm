...
/datum/ai_holder/fsm/proc/walk_to_leader()
...
/datum/ai_holder/fsm/proc/set_follow(mob/living/L, follow_for = 0)
...
/datum/ai_holder/fsm/proc/lose_follow()
...
/datum/ai_holder/fsm/proc/should_follow_leader()
	if(!leader)
		return FALSE
	if(follow_until_time && world.time > follow_until_time)
		lose_follow()
