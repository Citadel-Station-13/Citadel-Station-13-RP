...
/datum/ai_holder/fsm/proc/can_act()
	if(holder.key)
		return FALSE
...
/datum/ai_holder/fsm/proc/is_disabled()
	if(!can_act())
		return TRUE
	if(is_confused())
		return TRUE
...
/datum/ai_holder/fsm/proc/is_confused()
	return holder.confused > 0 && respect_confusion

// Called by the main loop.
/datum/ai_holder/fsm/proc/handle_disabled()
	if(!can_act())
...
/datum/ai_holder/fsm/proc/dangerous_wander()
