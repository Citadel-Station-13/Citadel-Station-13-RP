...
/datum/ai_holder/fsm/simple_mob
...
/datum/ai_holder/fsm/simple_mob/passive
	hostile = FALSE
	retaliate = FALSE
	can_flee = TRUE
...
/datum/ai_holder/fsm/simple_mob/inert/astar
	use_astar = TRUE

// Ranged mobs.

/datum/ai_holder/fsm/simple_mob/ranged
//	ranged = TRUE

// Tries to not waste ammo.
/datum/ai_holder/fsm/simple_mob/ranged/careful
	conserve_ammo = TRUE

/datum/ai_holder/fsm/simple_mob/ranged/pointblank
	pointblank = TRUE

// Runs away from its target if within a certain distance.
/datum/ai_holder/fsm/simple_mob/ranged/kiting
...
/datum/ai_holder/fsm/simple_mob/ranged/kiting/threatening
	threaten = TRUE
...
/datum/ai_holder/fsm/simple_mob/ranged/kiting/threatening/event
	base_wander_delay = 8

/datum/ai_holder/fsm/simple_mob/ranged/kiting/no_moonwalk
	moonwalk = FALSE

/datum/ai_holder/fsm/simple_mob/ranged/kiting/on_engagement(atom/A)
...
/datum/ai_holder/fsm/simple_mob/intentional


// These try to avoid collateral damage.
/datum/ai_holder/fsm/simple_mob/restrained
	violent_breakthrough = FALSE
	conserve_ammo = TRUE
	destructive = FALSE

// This does the opposite of the above subtype.
/datum/ai_holder/fsm/simple_mob/destructive
	destructive = TRUE

// Melee mobs.

/datum/ai_holder/fsm/simple_mob/melee

// Dances around the enemy its fighting, making it harder to fight back.
/datum/ai_holder/fsm/simple_mob/melee/evasive

/datum/ai_holder/fsm/simple_mob/melee/evasive/post_melee_attack(atom/A)
...
/datum/ai_holder/fsm/simple_mob/melee/hit_and_run
	can_flee = TRUE

// Used for the 'running' part of hit and run.
/datum/ai_holder/fsm/simple_mob/melee/hit_and_run/special_flee_check()
...
/datum/ai_holder/fsm/simple_mob/retaliate
	hostile = FALSE
	retaliate = TRUE

// Simple mobs that retaliate and support others in their faction who get attacked.
/datum/ai_holder/fsm/simple_mob/retaliate/cooperative
	cooperative = TRUE
