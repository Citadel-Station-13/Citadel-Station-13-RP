...
/datum/ai_holder/fsm/proc/engage_target()
...
/datum/ai_holder/fsm/proc/melee_attack(atom/A)
	pre_melee_attack(A)
	. = holder.IAttack(A)
	if(.)
		post_melee_attack(A)
...
// Ditto.
/datum/ai_holder/fsm/proc/ranged_attack(atom/A)
	pre_ranged_attack(A)
...
/datum/ai_holder/fsm/proc/special_attack(atom/movable/AM)
...
/datum/ai_holder/fsm/proc/on_engagement(atom/A)

// Called before a ranged attack is attempted.
/datum/ai_holder/fsm/proc/pre_ranged_attack(atom/A)

// Called before a melee attack is attempted.
/datum/ai_holder/fsm/proc/pre_melee_attack(atom/A)

// Called before a 'special' attack is attempted.
/datum/ai_holder/fsm/proc/pre_special_attack(atom/A)
...
/datum/ai_holder/fsm/proc/post_ranged_attack(atom/A)

// Ditto but for melee.
/datum/ai_holder/fsm/proc/post_melee_attack(atom/A)

// And one more for special snowflake attacks.
/datum/ai_holder/fsm/proc/post_special_attack(atom/A)

// Used to make sure projectiles will probably hit the target and not the wall or a friend.
/datum/ai_holder/fsm/proc/test_projectile_safety(atom/movable/AM)
...
/datum/ai_holder/fsm/proc/within_range(atom/movable/AM)
...
/datum/ai_holder/fsm/proc/closest_distance(atom/movable/AM)
...
/datum/ai_holder/fsm/proc/handle_resist()
	holder.resist()
...
/datum/ai_holder/fsm/proc/breakthrough(atom/target_atom)
...
/datum/ai_holder/fsm/proc/destroy_surroundings(direction, violent = TRUE)
...
/datum/ai_holder/fsm/proc/can_violently_breakthrough()
