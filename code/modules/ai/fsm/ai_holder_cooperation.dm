...
/datum/ai_holder/fsm/New(new_holder)
	..()
	if(cooperative)
...
/datum/ai_holder/fsm/proc/build_faction_friends()
...
/datum/ai_holder/fsm/proc/request_help()
...
/datum/ai_holder/fsm/proc/help_requested(mob/living/friend)
