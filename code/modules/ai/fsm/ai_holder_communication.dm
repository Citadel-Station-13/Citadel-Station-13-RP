...
/datum/ai_holder/fsm/proc/should_threaten()
	if(!threaten)
...
/datum/ai_holder/fsm/proc/threaten_target()
...
/datum/ai_holder/fsm/proc/will_threaten(mob/living/the_target)
...
/datum/ai_holder/fsm/proc/handle_idle_speaking()
...
/datum/ai_holder/fsm/proc/on_hear_say(mob/living/speaker, message)
	return

// This is to make responses feel a bit more natural and not instant.
/datum/ai_holder/fsm/proc/delayed_say(var/message, var/mob/speak_to)
