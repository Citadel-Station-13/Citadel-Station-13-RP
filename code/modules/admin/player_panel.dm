		...
		<head>
			<script type='text/javascript'>
				...
				function expand(data_id,target_id){
					...
					body += "<a href='?_src_=holder;[HrefToken()];notes=show;mob="+ref+"'>N</a> - "
					...
					body += "<a href='?_src_=holder;[HrefToken()];adminplayerobservefollow="+ref+"'>FLW</a><br>"
					if(antagonist > 0)
		...
		<table width='560' align='center' cellspacing='0' cellpadding='5' id='maintable'>
			<tr id='title_tr'>
				<td align='center'>
					...
					Hover over a line to see more information - <a href='?_src_=holder;[HrefToken()];check_antagonist=1'>Check antagonists</a>
					<p>
				</td>
			</tr>
			<tr id='search_tr'>
			...
			if(isliving(M))
				...
				if(iscarbon(M)) //Carbon stuff
					if(ishuman(M) && M.job)
						...
						M_job = "Monkey" // isSmall are monkeys (probably)
