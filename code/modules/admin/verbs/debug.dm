...
/client/proc/Cell()
	...
	t += "<span class='danger'>Temperature: [env.temperature]\n</span>"
	t += "<span class='danger'>Pressure: [env.return_pressure()]kPa\n</span>"
...
/client/proc/setup_supermatter_engine()
	...
	if(!found_the_pump && response == "Setup Completely")
		to_chat(src, "<span class='danger'>Unable to locate air supply to fill up with coolant, adding some coolant around the supermatter</span>")
