...
/client/proc/cmd_admin_create_centcom_report()
	...
	if(!input)
		return
	if(!customname)
		customname = "[SSmapping.legacy_map_config.company_name] Update"
	...
	switch(alert("Should this be announced to the general population?",,"Yes","No"))
		...
		if("No")
			to_chat(world, "<font color='red'>New [SSmapping.legacy_map_config.company_name] Update available at all communication consoles.</font>")
