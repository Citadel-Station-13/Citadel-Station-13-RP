...
/client/proc/cmd_admin_create_centcom_report()
	...
	if(!input)
		return
	if(!customname)
		customname = "[using_map_legacy().company_name] Update"
	...
	switch(alert("Should this be announced to the general population?",,"Yes","No"))
		...
		if("No")
			to_chat(world, "<font color='red'>New [using_map_legacy().company_name] Update available at all communication consoles.</font>")
