...
/client/proc/panicbunker()
	...
	if (config_legacy.panic_bunker && (!dbcon || !SSdbcore.Connect()))
...
/client/proc/paranoia_logging()
	...
	if (config_legacy.paranoia_logging && (!dbcon || !SSdbcore.Connect()))
...
/client/proc/ip_reputation()
	...
	if (config_legacy.ip_reputation && (!dbcon || !SSdbcore.Connect()))
