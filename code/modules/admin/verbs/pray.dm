...
/proc/message_centcom(text, mob/sender, iamessage)
	...
	msg = SPAN_ADMINNOTICE("<b><font color=orange>[uppertext(using_map_legacy.boss_short)]M[iamessage ? " IA" : ""]:</font>[ADMIN_FULLMONTY(sender)] [ADMIN_CENTCOM_REPLY(sender)]:</b> [msg]")
