...
/client/proc/cmd_admin_pm(whom, msg, datum/admin_help/AH)
	...
	if(irc)
		to_chat(src, "<span class='notice'>PM to-<b>Admins</b>: [rawmsg]</span>")
		admin_ticket_log(src, "<span class='danger'>Reply PM from-<b>[key_name(src, TRUE, TRUE)]</b> to <i>IRC</i>: [keywordparsedmsg]</span>")
		ircreplyamount--
		send2irc("Reply: [ckey]",rawmsg)
	else
		if(recipient.holder)
			if(holder)	//both are admins
				to_chat(recipient, "<span class='danger'>Admin PM from-<b>[key_name(src, recipient, 1)]</b>: [keywordparsedmsg]</span>")
				to_chat(src, "<span class='notice'>Admin PM to-<b>[key_name(recipient, src, 1)]</b>: [keywordparsedmsg]</span>")
				...
				var/replymsg = "<span class='danger'>Reply PM from-<b>[key_name(src, recipient, 1)]</b>: [keywordparsedmsg]</span>"
			...
			if(holder)	//sender is an admin but recipient is not. Do BIG RED TEXT
				...
				to_chat(recipient, "<span class='danger'>Admin PM from-<b>[key_name(src, recipient, 0)]</b>: [msg]</span>")
				to_chat(recipient, "<span class='danger'><i>Click on the administrator's name to reply.</i></span>")
				to_chat(src, "<span class='notice'>Admin PM to-<b>[key_name(recipient, src, 1)]</b>: [msg]</span>")
