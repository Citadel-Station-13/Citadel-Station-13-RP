...
/datum/proc/find_references(references_to_clear = INFINITY)
	if(usr?.client)
		if(alert(usr,"Running this will lock everything up for about 5 minutes.  Would you like to begin the search?", "Find References", list("Yes", "No")) != "Yes")
			return
