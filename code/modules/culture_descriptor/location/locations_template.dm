...
/decl/cultural_info/location/example
...
///OPTIONAL_LANGUAGES
	...
	// Unless of course you want said location to require it!
...
///DISTANCE
	...
	// This is distance from Sol in Light Years, but I plan to change this, you can set it if you really want to though just know that I'll change the coord system.
	distance = 0


///RULING_BODY

	// This is the faction or government that controls this location. Doesn't need to be set.
	// This one doesn't need to be defined. So you can use a string.
	ruling_body = "Who Fucking Knows Who"


///CAPITAL

	// The capital of this location. Generally the Capital City.
	capital = "Who Fucking Knows Where"
