...
/decl/cultural_info/culture/temp/auril
	name = TEMP_CULTURE_AURIL
	language = LANGUAGE_ENOCHIAN

/decl/cultural_info/culture/temp/dremachir
	name = TEMP_CULTURE_DREMACHIR
	language = LANGUAGE_DAEMON

/decl/cultural_info/culture/temp/replicant
...
/decl/cultural_info/culture/temp/phoronoid
	name = TEMP_CULTURE_PHORONOID
	language = LANGUAGE_BONES

/decl/cultural_info/culture/temp/promethean
	name = TEMP_CULTURE_PROMETHEAN
	language = LANGUAGE_SOL_COMMON

/decl/cultural_info/culture/temp/vasilissan
	name = TEMP_CULTURE_VASILISSAN
	language = LANGUAGE_VESPINAE

/decl/cultural_info/culture/temp/werebeast
