 ...
 */
/datum/supply_shipment/proc/auto_construct(list/atom/atoms, list/datum/export/exports)
 ...
 */
/datum/supply_shipment/proc/construct(list/atom/atoms, list/datum/export/exports)
