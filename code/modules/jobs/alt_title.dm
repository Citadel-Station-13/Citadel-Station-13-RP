...
/datum/prototype/simple/alt_title
	abstract_type = /datum/prototype/simple/alt_title
...
/datum/prototype/simple/alt_title/New()
 ...
 */
/datum/prototype/simple/alt_title/proc/check_background_ids(list/background_ids, strict)
	if(strict)
