...
/datum/job/station/xenobotanist
	...
	access = list(ACCESS_SCIENCE_ROBOTICS, ACCESS_SCIENCE_FABRICATION, ACCESS_SCIENCE_TOXINS, ACCESS_SCIENCE_MAIN, ACCESS_SCIENCE_XENOBOTANY, ACCESS_GENERAL_BOTANY)
