/datum/job/station/roboticist
	...
	access = list(ACCESS_SCIENCE_ROBOTICS, ACCESS_SCIENCE_FABRICATION, ACCESS_SCIENCE_TOXINS, ACCESS_ENGINEERING_TECHSTORAGE, ACCESS_MEDICAL_MORGUE, ACCESS_SCIENCE_MAIN, ACCESS_SCIENCE_FABRICATION) //As a job that handles so many corpses, it makes sense for them to have morgue access.
