...
/datum/job/station/xenobiologist
	...
	access = list(access_robotics, ACCESS_SCIENCE_FABRICATION, ACCESS_SCIENCE_TOXINS, ACCESS_SCIENCE_MAIN, ACCESS_SCIENCE_XENOBIO, access_hydroponics, ACCESS_SCIENCE_FABRICATION)
	minimal_access = list(ACCESS_SCIENCE_MAIN, ACCESS_SCIENCE_XENOBIO, access_hydroponics, ACCESS_SCIENCE_TOXINS,ACCESS_SCIENCE_FABRICATION)
