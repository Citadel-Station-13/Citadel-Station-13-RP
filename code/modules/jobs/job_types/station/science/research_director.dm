/datum/job/station/research_director
	...
	req_admin_notify = 1
	additional_access = list(ACCESS_SCIENCE_RD, ACCESS_COMMAND_BRIDGE, ACCESS_SCIENCE_FABRICATION, ACCESS_SCIENCE_GENETICS, ACCESS_MEDICAL_MORGUE,
						ACCESS_SCIENCE_TOXINS, ACCESS_COMMAND_TELEPORTER, ACCESS_SECURITY_MAIN,
						ACCESS_SCIENCE_MAIN, ACCESS_SCIENCE_ROBOTICS, ACCESS_SCIENCE_XENOBIO, ACCESS_COMMAND_UPLOAD, ACCESS_ENGINEERING_TECHSTORAGE,
	...
	minimal_access = list(ACCESS_SCIENCE_RD, ACCESS_COMMAND_BRIDGE, ACCESS_SCIENCE_FABRICATION, ACCESS_SCIENCE_GENETICS, ACCESS_MEDICAL_MORGUE,
						ACCESS_SCIENCE_TOXINS, ACCESS_COMMAND_TELEPORTER, ACCESS_SECURITY_MAIN,
						ACCESS_SCIENCE_MAIN, ACCESS_SCIENCE_ROBOTICS, ACCESS_SCIENCE_XENOBIO, ACCESS_COMMAND_UPLOAD, ACCESS_ENGINEERING_TECHSTORAGE,
						ACCESS_COMMAND_ANNOUNCE, ACCESS_COMMAND_KEYAUTH, ACCESS_ENGINEERING_TELECOMMS, ACCESS_GENERAL_GATEWAY, ACCESS_SCIENCE_XENOARCH, ACCESS_SCIENCE_EXONET)
