/datum/job/station/scientist
	...
	economic_modifier = 7
	access = list(access_robotics, access_research, access_tox_storage, access_science, access_xenobiology, access_xenoarch, access_xenobotany)
	minimal_access = list(access_research, access_tox_storage, access_science, access_xenoarch, access_xenobiology, access_xenobotany)
