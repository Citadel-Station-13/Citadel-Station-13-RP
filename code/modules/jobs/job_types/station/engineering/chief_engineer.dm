/datum/job/station/chief_engineer
	...
	additional_access = list(ACCESS_ENGINEERING_MAIN, ACCESS_ENGINEERING_ENGINE, ACCESS_ENGINEERING_TECHSTORAGE, ACCESS_ENGINEERING_MAINT,
						ACCESS_COMMAND_TELEPORTER, ACCESS_ENGINEERING_AIRLOCK, ACCESS_ENGINEERING_ATMOS, ACCESS_ENGINEERING_TRIAGE, ACCESS_COMMAND_EVA,
						ACCESS_COMMAND_BRIDGE, ACCESS_ENGINEERING_CONSTRUCTION, ACCESS_SECURITY_MAIN,
						ACCESS_ENGINEERING_CE, ACCESS_COMMAND_ANNOUNCE, ACCESS_COMMAND_KEYAUTH, ACCESS_ENGINEERING_TELECOMMS, ACCESS_COMMAND_UPLOAD)
	minimal_access = list(ACCESS_ENGINEERING_MAIN, ACCESS_ENGINEERING_ENGINE, ACCESS_ENGINEERING_TECHSTORAGE, ACCESS_ENGINEERING_MAINT,
						ACCESS_COMMAND_TELEPORTER, ACCESS_ENGINEERING_AIRLOCK, ACCESS_ENGINEERING_ATMOS, ACCESS_ENGINEERING_TRIAGE, ACCESS_COMMAND_EVA,
						ACCESS_COMMAND_BRIDGE, ACCESS_ENGINEERING_CONSTRUCTION, ACCESS_SECURITY_MAIN,
						ACCESS_ENGINEERING_CE, ACCESS_COMMAND_ANNOUNCE, ACCESS_COMMAND_KEYAUTH, ACCESS_ENGINEERING_TELECOMMS, ACCESS_COMMAND_UPLOAD)
