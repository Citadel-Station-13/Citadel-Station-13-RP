/datum/job/station/head_of_security
	...
	req_admin_notify = 1
	additional_access = list(ACCESS_SECURITY_EQUIPMENT, ACCESS_COMMAND_EVA, ACCESS_SECURITY_MAIN, ACCESS_SECURITY_BRIG, ACCESS_SECURITY_ARMORY,
						ACCESS_SECURITY_FORENSICS, ACCESS_MEDICAL_MORGUE, ACCESS_ENGINEERING_MAINT, ACCESS_COMMAND_LOCKERS,
						ACCESS_SCIENCE_MAIN, ACCESS_ENGINEERING_MAIN, ACCESS_SUPPLY_MINE, ACCESS_MEDICAL_MAIN, ACCESS_ENGINEERING_CONSTRUCTION, ACCESS_SUPPLY_MAIN,
						ACCESS_COMMAND_BRIDGE, ACCESS_SECURITY_HOS, ACCESS_COMMAND_ANNOUNCE, ACCESS_COMMAND_KEYAUTH, ACCESS_GENERAL_GATEWAY, ACCESS_ENGINEERING_AIRLOCK)
	minimal_access = list(ACCESS_SECURITY_EQUIPMENT, ACCESS_COMMAND_EVA, ACCESS_SECURITY_MAIN, ACCESS_SECURITY_BRIG, ACCESS_SECURITY_ARMORY,
						ACCESS_SECURITY_FORENSICS, ACCESS_MEDICAL_MORGUE, ACCESS_ENGINEERING_MAINT, ACCESS_COMMAND_LOCKERS,
						ACCESS_SCIENCE_MAIN, ACCESS_ENGINEERING_MAIN, ACCESS_SUPPLY_MINE, ACCESS_MEDICAL_MAIN, ACCESS_ENGINEERING_CONSTRUCTION, ACCESS_SUPPLY_MAIN,
						ACCESS_COMMAND_BRIDGE, ACCESS_SECURITY_HOS, ACCESS_COMMAND_ANNOUNCE, ACCESS_COMMAND_KEYAUTH, ACCESS_GENERAL_GATEWAY, ACCESS_ENGINEERING_AIRLOCK)
