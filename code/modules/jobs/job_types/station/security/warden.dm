/datum/job/station/warden
	...
	access = list(ACCESS_SECURITY_EQUIPMENT, access_eva, access_sec_doors, ACCESS_SECURITY_BRIG, ACCESS_SECURITY_ARMORY, access_maint_tunnels, access_morgue, access_external_airlocks)
