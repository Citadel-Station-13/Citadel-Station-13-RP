/datum/job/station/officer
	...
	access = list(ACCESS_SECURITY_EQUIPMENT, access_eva, access_sec_doors, access_brig, access_maint_tunnels, access_morgue, access_external_airlocks)
	minimal_access = list(ACCESS_SECURITY_EQUIPMENT, access_eva, access_sec_doors, access_brig, access_maint_tunnels, access_external_airlocks)
