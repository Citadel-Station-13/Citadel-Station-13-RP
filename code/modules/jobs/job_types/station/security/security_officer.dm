/datum/role/job/station/officer
	...
	minimal_access = list(ACCESS_SECURITY_EQUIPMENT, ACCESS_COMMAND_EVA, ACCESS_SECURITY_MAIN, ACCESS_SECURITY_BRIG, ACCESS_ENGINEERING_MAINT, ACCESS_ENGINEERING_AIRLOCK, ACCESS_SECURITY_GENPOP_ENTER, ACCESS_SECURITY_GENPOP_EXIT)
