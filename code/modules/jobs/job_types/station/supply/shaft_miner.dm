/datum/job/station/mining
	...
	access = list(ACCESS_ENGINEERING_MAINT, ACCESS_SUPPLY_MAIN, access_cargo, access_cargo_bot, ACCESS_SUPPLY_MINE, ACCESS_SUPPLY_MINE_OUTPOST)
	minimal_access = list(ACCESS_SUPPLY_MINE, ACCESS_SUPPLY_MINE_OUTPOST, ACCESS_SUPPLY_MAIN, access_cargo, access_cargo_bot)
