/datum/job/station/off_duty/engineering
	...
	access = list(ACCESS_ENGINEERING_MAINT, access_external_airlocks, access_construction)
	minimal_access = list(ACCESS_ENGINEERING_MAINT, access_external_airlocks)
