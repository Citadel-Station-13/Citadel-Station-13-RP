/datum/job/station/explorer
	...
	access = list(ACCESS_GENERAL_EXPLORER, access_external_airlocks, ACCESS_SCIENCE_MAIN, ACCESS_GENERAL_PILOT, ACCESS_GENERAL_GATEWAY)
	minimal_access = list(ACCESS_GENERAL_EXPLORER, access_external_airlocks, ACCESS_SCIENCE_MAIN, ACCESS_GENERAL_PILOT, ACCESS_GENERAL_GATEWAY)
