/datum/job/station/pathfinder
	...
	access = list(access_eva, ACCESS_ENGINEERING_MAINT, access_external_airlocks, ACCESS_GENERAL_PILOT, ACCESS_GENERAL_EXPLORER, ACCESS_SCIENCE_MAIN, ACCESS_GENERAL_GATEWAY, ACCESS_GENERAL_PATHFINDER)
	minimal_access = list(access_eva, ACCESS_ENGINEERING_MAINT, access_external_airlocks, ACCESS_GENERAL_PILOT, ACCESS_GENERAL_EXPLORER, ACCESS_SCIENCE_MAIN, ACCESS_GENERAL_GATEWAY, ACCESS_GENERAL_PATHFINDER)
