/datum/job/station/pathfinder
	...
	access = list(access_eva, ACCESS_ENGINEERING_MAINT, access_external_airlocks, access_pilot, access_explorer, access_research, access_gateway, access_pathfinder)
	minimal_access = list(access_eva, ACCESS_ENGINEERING_MAINT, access_external_airlocks, access_pilot, access_explorer, access_research, access_gateway, access_pathfinder)
