/datum/job/station/pathfinder
	...
	access = list(ACCESS_COMMAND_EVA, ACCESS_ENGINEERING_MAINT, ACCESS_ENGINEERING_AIRLOCK, ACCESS_GENERAL_PILOT, ACCESS_GENERAL_EXPLORER, ACCESS_SCIENCE_MAIN, ACCESS_GENERAL_GATEWAY, ACCESS_GENERAL_PATHFINDER)
