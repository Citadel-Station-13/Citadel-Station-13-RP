/datum/job/station/chief_medical_officer
	...
	req_admin_notify = 1
	additional_access = list(ACCESS_MEDICAL_MAIN, ACCESS_MEDICAL_EQUIPMENT, ACCESS_MEDICAL_MORGUE, ACCESS_SCIENCE_GENETICS, ACCESS_COMMAND_BRIDGE,
			ACCESS_MEDICAL_CHEMISTRY, ACCESS_MEDICAL_VIROLOGY, ACCESS_MEDICAL_CMO, ACCESS_MEDICAL_SURGERY, ACCESS_COMMAND_ANNOUNCE,
			ACCESS_COMMAND_KEYAUTH, ACCESS_SECURITY_MAIN, ACCESS_MEDICAL_PSYCH, ACCESS_COMMAND_EVA, ACCESS_ENGINEERING_AIRLOCK, ACCESS_ENGINEERING_MAINT)
	minimal_access = list(ACCESS_MEDICAL_MAIN, ACCESS_MEDICAL_EQUIPMENT, ACCESS_MEDICAL_MORGUE, ACCESS_SCIENCE_GENETICS, ACCESS_COMMAND_BRIDGE,
			ACCESS_MEDICAL_CHEMISTRY, ACCESS_MEDICAL_VIROLOGY, ACCESS_MEDICAL_CMO, ACCESS_MEDICAL_SURGERY, ACCESS_COMMAND_ANNOUNCE,
			ACCESS_COMMAND_KEYAUTH, ACCESS_SECURITY_MAIN, ACCESS_MEDICAL_PSYCH, ACCESS_COMMAND_EVA, ACCESS_ENGINEERING_AIRLOCK, ACCESS_ENGINEERING_MAINT)
