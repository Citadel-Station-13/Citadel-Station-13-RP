/datum/job/station/paramedic
	...
	access = list(ACCESS_MEDICAL_MAIN, access_medical_equip, ACCESS_MEDICAL_MORGUE, access_surgery, access_chemistry, access_virology, access_eva, ACCESS_ENGINEERING_MAINT, access_external_airlocks, access_psychiatrist)
	minimal_access = list(ACCESS_MEDICAL_MAIN, access_medical_equip, ACCESS_MEDICAL_MORGUE, access_eva, ACCESS_ENGINEERING_MAINT, access_external_airlocks)
