/datum/job/station/paramedic
	...
	access = list(ACCESS_MEDICAL_MAIN, ACCESS_MEDICAL_EQUIPMENT, ACCESS_MEDICAL_MORGUE, ACCESS_MEDICAL_SURGERY, access_chemistry, access_virology, access_eva, ACCESS_ENGINEERING_MAINT, access_external_airlocks, ACCESS_MEDICAL_PSYCH)
	minimal_access = list(ACCESS_MEDICAL_MAIN, ACCESS_MEDICAL_EQUIPMENT, ACCESS_MEDICAL_MORGUE, access_eva, ACCESS_ENGINEERING_MAINT, access_external_airlocks)
