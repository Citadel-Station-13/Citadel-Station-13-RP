/datum/job/station/head_of_personnel
	...
	additional_access = list(ACCESS_SECURITY_EQUIPMENT, ACCESS_SECURITY_MAIN, ACCESS_SECURITY_BRIG, ACCESS_SECURITY_FORENSICS,
						ACCESS_MEDICAL_MAIN, ACCESS_ENGINEERING_MAIN, ACCESS_COMMAND_CARDMOD, ACCESS_COMMAND_UPLOAD, ACCESS_COMMAND_EVA, ACCESS_COMMAND_BRIDGE,
						ACCESS_COMMAND_LOCKERS, ACCESS_ENGINEERING_MAINT, ACCESS_GENERAL_BAR, ACCESS_GENERAL_JANITOR, ACCESS_ENGINEERING_CONSTRUCTION, ACCESS_MEDICAL_MORGUE,
						ACCESS_GENERAL_CREMATOR, ACCESS_GENERAL_KITCHEN, ACCESS_SUPPLY_BAY, ACCESS_SUPPLY_MULEBOT, ACCESS_SUPPLY_MAIN, ACCESS_SUPPLY_QM, ACCESS_GENERAL_BOTANY, ACCESS_COMMAND_IAA,
						ACCESS_GENERAL_CHAPEL, ACCESS_GENERAL_LIBRARY, ACCESS_SCIENCE_MAIN, ACCESS_SUPPLY_MINE, ACCESS_COMMAND_VAULT, ACCESS_SUPPLY_MINE_OUTPOST,
