...
/datum/loadout_entry/uniform/cheongsam/New()
	...
	tweaks += new/datum/loadout_tweak/path(tim_sort(cheongsams, GLOBAL_PROC_REF(text_asc)))
...
/datum/loadout_entry/uniform/croptop/New()
	...
	tweaks += new/datum/loadout_tweak/path(tim_sort(croptops, GLOBAL_PROC_REF(text_asc)))
...
/datum/loadout_entry/uniform/jumpsuit/New()
	...
	tweaks += new/datum/loadout_tweak/path(tim_sort(jumpclothes, GLOBAL_PROC_REF(text_asc)))
...
/datum/loadout_entry/uniform/skirt/New()
	...
	tweaks += new/datum/loadout_tweak/path(tim_sort(skirts, GLOBAL_PROC_REF(text_asc)))
...
/datum/loadout_entry/uniform/pants/New()
	...
	tweaks += new/datum/loadout_tweak/path(tim_sort(pants, GLOBAL_PROC_REF(text_asc)))
...
/datum/loadout_entry/uniform/shorts/New()
	...
	tweaks += new/datum/loadout_tweak/path(tim_sort(shorts, GLOBAL_PROC_REF(text_asc)))
...
/datum/loadout_entry/uniform/suit/lawyer/New()
	...
	tweaks += new/datum/loadout_tweak/path(tim_sort(lsuits, GLOBAL_PROC_REF(text_asc)))
...
/datum/loadout_entry/uniform/suit/suit_jacket/New()
	...
	tweaks += new/datum/loadout_tweak/path(tim_sort(msuits, GLOBAL_PROC_REF(text_asc)))
...
/datum/loadout_entry/uniform/scrub/New()
	...
	tweaks += new/datum/loadout_tweak/path(tim_sort(scrubs, GLOBAL_PROC_REF(text_asc)))
...
/datum/loadout_entry/uniform/scrub_fem/New()
	...
	tweaks += new/datum/loadout_tweak/path(tim_sort(scrubs_fem, GLOBAL_PROC_REF(text_asc)))
...
/datum/loadout_entry/uniform/turtlebaggy_selection/New()
	...
	tweaks += new/datum/loadout_tweak/path(tim_sort(turtlebaggy_selection, GLOBAL_PROC_REF(text_asc)))
...
/datum/loadout_entry/uniform/wedding/New()
	...
	tweaks += new/datum/loadout_tweak/path(tim_sort(weddings, GLOBAL_PROC_REF(text_asc)))
...
/datum/loadout_entry/uniform/dresses/maid/New()
	...
	tweaks += new/datum/loadout_tweak/path(tim_sort(maids, GLOBAL_PROC_REF(text_asc)))
...
/datum/loadout_entry/uniform/brandjumpsuit_selection/New()
	...
	tweaks += new/datum/loadout_tweak/path(tim_sort(brandjumpsuit_selection, GLOBAL_PROC_REF(text_asc)))
...
/datum/loadout_entry/uniform/kimono_selection/New()
	...
	tweaks += new/datum/loadout_tweak/path(tim_sort(kimonos, GLOBAL_PROC_REF(text_asc)))
...
/datum/loadout_entry/uniform/future_fashion_selection/New()
	...
	tweaks += new/datum/loadout_tweak/path(tim_sort(future_fashion_selection, GLOBAL_PROC_REF(text_asc)))
...
/datum/loadout_entry/uniform/swimsuits/New()
	...
	tweaks += new/datum/loadout_tweak/path(tim_sort(swimsuits, GLOBAL_PROC_REF(text_asc)))
...
/datum/loadout_entry/uniform/summerdress_selection/New()
	...
	tweaks += new/datum/loadout_tweak/path(tim_sort(summerdress_selection, GLOBAL_PROC_REF(text_asc)))
...
/datum/loadout_entry/uniform/skinsuit_selection/New()
	...
	tweaks += new/datum/loadout_tweak/path(tim_sort(skinsuit_selection, GLOBAL_PROC_REF(text_asc)))
...
/datum/loadout_entry/uniform/skinsuitfem_selection/New()
	...
	tweaks += new/datum/loadout_tweak/path(tim_sort(skinsuitfem_selection, GLOBAL_PROC_REF(text_asc)))
...
/datum/loadout_entry/uniform/altbodysuit_selection/New()
	...
	tweaks += new/datum/loadout_tweak/path(tim_sort(altbodysuit_selection, GLOBAL_PROC_REF(text_asc)))
...
/datum/loadout_entry/uniform/altbodysuitfem_selection/New()
	...
	tweaks += new/datum/loadout_tweak/path(tim_sort(altbodysuitfem_selection, GLOBAL_PROC_REF(text_asc)))
...
/datum/loadout_entry/uniform/tajaran/summercloths_selection/New()
	...
	tweaks += new/datum/loadout_tweak/path(tim_sort(summercloths_selection, GLOBAL_PROC_REF(text_asc)))
...
/datum/loadout_entry/uniform/tajaran/tajara_dress_selection/New()
	...
	tweaks += new/datum/loadout_tweak/path(tim_sort(tajara_dress_selection, GLOBAL_PROC_REF(text_asc)))
