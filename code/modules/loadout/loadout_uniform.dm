...
/datum/loadout_entry/uniform/cheongsam/New()
	...
	gear_tweaks += new/datum/loadout_entry_tweak/path(tim_sort(cheongsams, /proc/cmp_text_asc))
...
/datum/loadout_entry/uniform/croptop/New()
	...
	gear_tweaks += new/datum/loadout_entry_tweak/path(tim_sort(croptops, /proc/cmp_text_asc))
...
/datum/loadout_entry/uniform/jumpsuit/New()
	...
	gear_tweaks += new/datum/loadout_entry_tweak/path(tim_sort(jumpclothes, /proc/cmp_text_asc))
...
/datum/loadout_entry/uniform/skirt/New()
	...
	gear_tweaks += new/datum/loadout_entry_tweak/path(tim_sort(skirts, /proc/cmp_text_asc))
...
/datum/loadout_entry/uniform/pants/New()
	...
	gear_tweaks += new/datum/loadout_entry_tweak/path(tim_sort(pants, /proc/cmp_text_asc))
...
/datum/loadout_entry/uniform/shorts/New()
	...
	gear_tweaks += new/datum/loadout_entry_tweak/path(tim_sort(shorts, /proc/cmp_text_asc))
...
/datum/loadout_entry/uniform/suit/lawyer/New()
	...
	gear_tweaks += new/datum/loadout_entry_tweak/path(tim_sort(lsuits, /proc/cmp_text_asc))
...
/datum/loadout_entry/uniform/suit/suit_jacket/New()
	...
	gear_tweaks += new/datum/loadout_entry_tweak/path(tim_sort(msuits, /proc/cmp_text_asc))
...
/datum/loadout_entry/uniform/scrub/New()
	...
	gear_tweaks += new/datum/loadout_entry_tweak/path(tim_sort(scrubs, /proc/cmp_text_asc))
...
/datum/loadout_entry/uniform/scrub_fem/New()
	...
	gear_tweaks += new/datum/loadout_entry_tweak/path(tim_sort(scrubs_fem, /proc/cmp_text_asc))
...
/datum/loadout_entry/uniform/turtlebaggy_selection/New()
	...
	gear_tweaks += new/datum/loadout_entry_tweak/path(tim_sort(turtlebaggy_selection, /proc/cmp_text_asc))
...
/datum/loadout_entry/uniform/wedding/New()
	...
	gear_tweaks += new/datum/loadout_entry_tweak/path(tim_sort(weddings, /proc/cmp_text_asc))
...
/datum/loadout_entry/uniform/dresses/maid/New()
	...
	gear_tweaks += new/datum/loadout_entry_tweak/path(tim_sort(maids, /proc/cmp_text_asc))
...
/datum/loadout_entry/uniform/brandjumpsuit_selection/New()
	...
	gear_tweaks += new/datum/loadout_entry_tweak/path(tim_sort(brandjumpsuit_selection, /proc/cmp_text_asc))
...
/datum/loadout_entry/uniform/kimono_selection/New()
	...
	gear_tweaks += new/datum/loadout_entry_tweak/path(tim_sort(kimonos, /proc/cmp_text_asc))
...
/datum/loadout_entry/uniform/future_fashion_selection/New()
	...
	gear_tweaks += new/datum/loadout_entry_tweak/path(tim_sort(future_fashion_selection, /proc/cmp_text_asc))
...
/datum/loadout_entry/uniform/swimsuits/New()
	...
	gear_tweaks += new/datum/loadout_entry_tweak/path(tim_sort(swimsuits, /proc/cmp_text_asc))
...
/datum/loadout_entry/uniform/summerdress_selection/New()
	...
	gear_tweaks += new/datum/loadout_entry_tweak/path(tim_sort(summerdress_selection, /proc/cmp_text_asc))
...
/datum/loadout_entry/uniform/skinsuit_selection/New()
	...
	gear_tweaks += new/datum/loadout_entry_tweak/path(tim_sort(skinsuit_selection, /proc/cmp_text_asc))
...
/datum/loadout_entry/uniform/skinsuitfem_selection/New()
	...
	gear_tweaks += new/datum/loadout_entry_tweak/path(tim_sort(skinsuitfem_selection, /proc/cmp_text_asc))
...
/datum/loadout_entry/uniform/altbodysuit_selection/New()
	...
	gear_tweaks += new/datum/loadout_entry_tweak/path(tim_sort(altbodysuit_selection, /proc/cmp_text_asc))
...
/datum/loadout_entry/uniform/altbodysuitfem_selection/New()
	...
	gear_tweaks += new/datum/loadout_entry_tweak/path(tim_sort(altbodysuitfem_selection, /proc/cmp_text_asc))
...
/datum/loadout_entry/uniform/tajaran/summercloths_selection/New()
	...
	gear_tweaks += new/datum/loadout_entry_tweak/path(tim_sort(summercloths_selection, /proc/cmp_text_asc))
...
/datum/loadout_entry/uniform/tajaran/tajara_dress_selection/New()
	...
	gear_tweaks += new/datum/loadout_entry_tweak/path(tim_sort(tajara_dress_selection, /proc/cmp_text_asc))
