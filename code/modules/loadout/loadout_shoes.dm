...
/datum/loadout_entry/shoes/lacey/New()
	...
	gear_tweaks += new/datum/loadout_entry_tweak/path(tim_sort(laces, /proc/cmp_text_asc))
...
/datum/loadout_entry/shoes/hitops/New()
	...
	gear_tweaks += new/datum/loadout_entry_tweak/path(tim_sort(hitops, /proc/cmp_text_asc))
