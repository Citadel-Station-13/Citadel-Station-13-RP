...
/datum/loadout_entry/xeno/tajaran/accessories/tajara_wrap/New()
	...
	gear_tweaks += new/datum/loadout_entry_tweak/path(tim_sort(tajara_wraps, /proc/cmp_text_asc))
...
/datum/loadout_entry/xeno/tajaran/shoes/workboots/New()
	...
	gear_tweaks += new/datum/loadout_entry_tweak/path(tim_sort(tworkboots, /proc/cmp_text_asc))
...
/datum/loadout_entry/xeno/tajaran/shoes/flats/New()
	...
	gear_tweaks += new/datum/loadout_entry_tweak/path(tim_sort(tflats, /proc/cmp_text_asc))
...
/datum/loadout_entry/xeno/promethean/uniform/cohesion_suit/New()
	...
	gear_tweaks += new/datum/loadout_entry_tweak/path(tim_sort(cohesionsuits, /proc/cmp_text_asc))
...
/datum/loadout_entry/xeno/phoronoid/accessories/suit_accessories/New()
	...
	gear_tweaks += new/datum/loadout_entry_tweak/path(tim_sort(plasaccessories, /proc/cmp_text_asc))
...
/datum/loadout_entry/xeno/skrell/chains/New()
	...
	gear_tweaks += new/datum/loadout_entry_tweak/path(tim_sort(chaintypes, /proc/cmp_text_asc))
...
/datum/loadout_entry/xeno/skrell/bands/New()
	...
	gear_tweaks += new/datum/loadout_entry_tweak/path(tim_sort(bandtypes, /proc/cmp_text_asc))
...
/datum/loadout_entry/xeno/skrell/cloth/short/New()
	...
	gear_tweaks += new/datum/loadout_entry_tweak/path(tim_sort(shorttypes, /proc/cmp_text_asc))
...
/datum/loadout_entry/xeno/skrell/cloth/long/New()
	...
	gear_tweaks += new/datum/loadout_entry_tweak/path(tim_sort(longtypes, /proc/cmp_text_asc))
...
/datum/loadout_entry/xeno/teshari/uniform/smock_selection/New()
	...
	gear_tweaks += new/datum/loadout_entry_tweak/path(tim_sort(smocks, /proc/cmp_text_asc))
...
/datum/loadout_entry/xeno/teshari/uniform/standard_undercoat_selection/New()
	...
	gear_tweaks += new/datum/loadout_entry_tweak/path(tim_sort(undercoats, /proc/cmp_text_asc))
...
/datum/loadout_entry/xeno/teshari/uniform/dress_smock_selection/New()
	...
	gear_tweaks += new/datum/loadout_entry_tweak/path(tim_sort(dresssmocks, /proc/cmp_text_asc))
...
/datum/loadout_entry/xeno/teshari/suit/standard_cloak_selection/New()
	...
	gear_tweaks += new/datum/loadout_entry_tweak/path(tim_sort(cloaks, /proc/cmp_text_asc))
...
/datum/loadout_entry/xeno/uniform/puffy_pants/New()
	...
	gear_tweaks += new/datum/loadout_entry_tweak/path(tim_sort(puffy_pants, /proc/cmp_text_asc))
...
/datum/loadout_entry/xeno/uniform/tight_pants/New()
	...
	gear_tweaks += new/datum/loadout_entry_tweak/path(tim_sort(tight_pants, /proc/cmp_text_asc))
...
/datum/loadout_entry/xeno/uniform/moth_skirt/New()
	...
	gear_tweaks += new/datum/loadout_entry_tweak/path(tim_sort(moth_skirt, /proc/cmp_text_asc))
...
/datum/loadout_entry/xeno/accessories/abdomen_guard/New()
	...
	gear_tweaks += new/datum/loadout_entry_tweak/path(tim_sort(abdomen_guard, /proc/cmp_text_asc))
...
/datum/loadout_entry/xeno/accessories/tunic_top/New()
	...
	gear_tweaks += new/datum/loadout_entry_tweak/path(tim_sort(tunic_top, /proc/cmp_text_asc))
...
/datum/loadout_entry/xeno/accessories/cloth_strap_top/New()
	...
	gear_tweaks += new/datum/loadout_entry_tweak/path(tim_sort(cloth_strap_top, /proc/cmp_text_asc))
...
/datum/loadout_entry/xeno/accessories/shoulder_pad_right/New()
	...
	gear_tweaks += new/datum/loadout_entry_tweak/path(tim_sort(shoulder_pad_right, /proc/cmp_text_asc))
...
/datum/loadout_entry/xeno/accessories/shoulder_pad_left/New()
	...
	gear_tweaks += new/datum/loadout_entry_tweak/path(tim_sort(shoulder_pad_left, /proc/cmp_text_asc))
...
/datum/loadout_entry/xeno/accessories/front_tunic/New()
	...
	gear_tweaks += new/datum/loadout_entry_tweak/path(tim_sort(front_tunic, /proc/cmp_text_asc))
...
/datum/loadout_entry/xeno/accessories/gaiter/New()
	...
	gear_tweaks += new/datum/loadout_entry_tweak/path(tim_sort(gaiter, /proc/cmp_text_asc))
...
/datum/loadout_entry/xeno/shoes/legwrap/New()
	...
	gear_tweaks += new/datum/loadout_entry_tweak/path(tim_sort(legwrap, /proc/cmp_text_asc))
