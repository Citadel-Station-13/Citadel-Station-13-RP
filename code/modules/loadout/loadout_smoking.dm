...
/datum/loadout_entry/pipe/New()
	...
	tweaks += new/datum/loadout_tweak/path(tim_sort(pipes, GLOBAL_PROC_REF(text_asc)))
...
/datum/loadout_entry/lighter/zippo/New()
	...
	tweaks += new/datum/loadout_tweak/path(tim_sort(zippos, GLOBAL_PROC_REF(text_asc)))
...
/datum/loadout_entry/cigarettes/New()
	...
	tweaks += new/datum/loadout_tweak/path(tim_sort(cigarettes, GLOBAL_PROC_REF(text_asc)))
