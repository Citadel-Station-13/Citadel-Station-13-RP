...
/datum/loadout_entry/accessory/wcoat/New()
	...
	tweaks += new/datum/loadout_tweak/path(tim_sort(wcoats, GLOBAL_PROC_REF(text_asc)))
...
/datum/loadout_entry/accessory/tie/New()
	...
	tweaks += new/datum/loadout_tweak/path(tim_sort(ties, GLOBAL_PROC_REF(text_asc)))
...
/datum/loadout_entry/accessory/scarf/New()
	...
	tweaks += new/datum/loadout_tweak/path(tim_sort(scarfs, GLOBAL_PROC_REF(text_asc)))
...
/datum/loadout_entry/accessory/jacket/New()
	...
	tweaks += new/datum/loadout_tweak/path(tim_sort(jackets, GLOBAL_PROC_REF(text_asc)))
...
/datum/loadout_entry/accessory/fannypack/New()
	...
	tweaks += new/datum/loadout_tweak/path(tim_sort(fannys, GLOBAL_PROC_REF(text_asc)))
...
/datum/loadout_entry/accessory/sweater/New()
	...
	tweaks += new/datum/loadout_tweak/path(tim_sort(sweaters, GLOBAL_PROC_REF(text_asc)))
...
/datum/loadout_entry/accessory/asym/New()
	...
	tweaks += new/datum/loadout_tweak/path(tim_sort(asyms, GLOBAL_PROC_REF(text_asc)))
...
/datum/loadout_entry/accessory/gaiter/New()
	...
	tweaks += new/datum/loadout_tweak/path(tim_sort(gaiters, GLOBAL_PROC_REF(text_asc)))
...
/datum/loadout_entry/accessory/halo_projector/New()
	...
	tweaks += new/datum/loadout_tweak/path(tim_sort(halos, GLOBAL_PROC_REF(text_asc)))
...
/datum/loadout_entry/accessory/tajaran/scarf/New()
	...
	tweaks += new/datum/loadout_tweak/path(tim_sort(tscarfs, GLOBAL_PROC_REF(text_asc)))
