...
// Legacy version. Need to investigate what the hell lootdrop in loot.dm does later.
...
/obj/effect/landmark/loot_spawn/New()
	...
	/*25;"alien", \ */ // TEMPORARY REMOVAL
	"lights", \
	25 - low_probability * 25;"engineering", \
	25 - low_probability * 25;"coffin", \
	/*25;"mimic", \ // TEMPORARY REMOVAL
	25;"viscerator", \ */ // TEMPORARY REMOVAL
	))
		if("treasure")
		...
		if("mimic")
			...
			var/obj/structure/closet/crate/secure/gear/C = new(src.loc) // TEMPORARY EDIT
			new /obj/item/storage/toolbox/electrical(C) //Placeholder to prevent errors. // TEMPORARY EDIT
		if("viscerator")
			//more tomb guardians!
			//var/num = rand(1,3) // TEMPORARY REMOVAL
			var/obj/structure/closet/crate/secure/gear/C = new(src.loc) // TEMPORARY EDIT
			new /obj/item/storage/toolbox/electrical(C) //Placeholder to prevent errors. // TEMPORARY EDIT
			//for(var/i=0,i<num,i++) // TEMPORARY REMOVAL
				//new /mob/living/simple_mob/hostile/viscerator(C)  // TEMPORARY REMOVAL
