...
/obj/machinery/account_database
	...
	density = TRUE
	anchored = TRUE
	req_one_access = list(ACCESS_COMMAND_HOP, access_captain, ACCESS_CENTCOM_ADMIRAL)
	var/receipt_num
	var/machine_id = ""
...
/obj/machinery/account_database/proc/get_access_level()
	...
	if (ACCESS_CENTCOM_ADMIRAL in held_card.access)
		return 2
	else if((ACCESS_COMMAND_HOP in held_card.access) || (access_captain in held_card.access))
		return 1
