...
/datum/design/item/weapon/mining/jackhammer
	...
	materials = list(MATERIAL_ID_STEEL = 2000, MATERIAL_ID_GLASS = 500, "silver" = 500)
...
/datum/design/item/weapon/mining/plasmacutter
	...
	materials = list(MATERIAL_ID_STEEL = 1500, MATERIAL_ID_GLASS = 500, "gold" = 500, "phoron" = 500)
...
/datum/design/item/weapon/mining/drill_diamond
	...
	materials = list(MATERIAL_ID_STEEL = 3000, MATERIAL_ID_GLASS = 1000, "diamond" = 2000)
...
/datum/design/item/device/mining_scanner_adv
	...
	materials = list(MATERIAL_ID_STEEL = 2000, MATERIAL_ID_GLASS = 1000)
