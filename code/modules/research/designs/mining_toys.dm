...
/datum/design/item/weapon/mining/drill
	...
	materials = list(/datum/material/steel = 6000, "glass" = 1000) //expensive, but no need for miners.
...
/datum/design/item/weapon/mining/jackhammer
	...
	materials = list(/datum/material/steel = 2000, "glass" = 500, "silver" = 500)
...
/datum/design/item/weapon/mining/plasmacutter
	...
	materials = list(/datum/material/steel = 1500, "glass" = 500, "gold" = 500, "phoron" = 500)
...
/datum/design/item/weapon/mining/drill_diamond
	...
	materials = list(/datum/material/steel = 3000, "glass" = 1000, "diamond" = 2000)
...
/datum/design/item/weapon/mining/advbore
	...
	materials = list(/datum/material/steel = 5000, "glass" = 2500, "gold" = 2500, "phoron" = 2500)
...
/datum/design/item/weapon/mining/vertibore
	...
	materials = list(/datum/material/steel = 10000, "glass" = 5000, "gold" = 5000, "phoron" = 5000, "diamond" = 100, "uranium" = 1000)
...
/datum/design/item/weapon/mining/mining_scanner_adv
	...
	materials = list(/datum/material/steel = 2000, "glass" = 1000)
