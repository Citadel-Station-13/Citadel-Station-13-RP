...
/datum/design/item/ai_holder/mmi
	...
	materials = list(/datum/material/steel = 1000, "glass" = 500)
...
/datum/design/item/ai_holder/posibrain
	...
	build_type = PROTOLATHE | PROSFAB
	materials = list(/datum/material/steel = 2000, "glass" = 1000, "silver" = 1000, "gold" = 500, "phoron" = 500, "diamond" = 100)
...
/datum/design/item/ai_holder/dronebrain
	...
	build_type = PROTOLATHE | PROSFAB
	materials = list(/datum/material/steel = 2000, "glass" = 1000, "silver" = 1000, "gold" = 500)
...
/datum/design/item/ai_holder/paicard
	...
	materials = list("glass" = 500, /datum/material/steel = 500)
