...
/datum/design/item/ai_holder/posibrain
	...
	build_type = PROTOLATHE | PROSFAB
	materials = list(MATERIAL_ID_STEEL = 2000, MATERIAL_ID_GLASS = 1000, "silver" = 1000, "gold" = 500, "phoron" = 500, "diamond" = 100)
...
/datum/design/item/ai_holder/dronebrain
	...
	build_type = PROTOLATHE | PROSFAB
	materials = list(MATERIAL_ID_STEEL = 2000, MATERIAL_ID_GLASS = 1000, "silver" = 1000, "gold" = 500)
