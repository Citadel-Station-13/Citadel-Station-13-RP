...
/datum/design/item/weapon/ballistic/advanced_smg
	...
	materials = list(MATERIAL_ID_STEEL = 8000, "silver" = 2000, "diamond" = 1000)
...
/datum/design/item/weapon/ballistic/ammo/ammo_9mmAdvanced
	...
	req_tech = list(TECH_COMBAT = 4, TECH_MATERIAL = 3)
	materials = list(MATERIAL_ID_STEEL = 3750, "silver" = 100) // Requires silver for proprietary magazines! Or something.
