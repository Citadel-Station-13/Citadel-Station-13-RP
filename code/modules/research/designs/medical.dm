/datum/design/item/medical
	materials = list(MATERIAL_ID_STEEL = 30, "glass" = 20)
...
/datum/design/item/medical/scalpel_laser1
	...
	materials = list(MATERIAL_ID_STEEL = 12500, "glass" = 7500)
...
/datum/design/item/medical/scalpel_laser2
	...
	materials = list(MATERIAL_ID_STEEL = 12500, "glass" = 7500, "silver" = 2500)
...
/datum/design/item/medical/scalpel_laser3
	...
	materials = list(MATERIAL_ID_STEEL = 12500, "glass" = 7500, "silver" = 2000, "gold" = 1500)
...
/datum/design/item/medical/scalpel_manager
	...
	materials = list (MATERIAL_ID_STEEL = 12500, "glass" = 7500, "silver" = 1500, "gold" = 1500, "diamond" = 750)
...
/datum/design/item/medical/saw_manager
	...
	materials = list (MATERIAL_ID_STEEL = 12500, MAT_PLASTIC = 800, "silver" = 1500, "gold" = 1500, MAT_OSMIUM = 1000)
...
/datum/design/item/medical/organ_ripper
	...
	materials = list (MATERIAL_ID_STEEL = 12500, MAT_PLASTIC = 8000, MAT_OSMIUM = 2500)
...
/datum/design/item/medical/improved_analyzer
	...
	materials = list(MATERIAL_ID_STEEL = 2000, "glass" = 1000, "silver" = 1000, "gold" = 1500)
...
/datum/design/item/medical/advanced_roller
	...
	materials = list(MATERIAL_ID_STEEL = 4000, "glass" = 2000, "phoron" = 2000)
