...
/datum/design/item/medical/scalpel_laser2
	...
	materials = list(MATERIAL_ID_STEEL = 12500, MATERIAL_ID_GLASS = 7500, "silver" = 2500)
...
/datum/design/item/medical/scalpel_laser3
	...
	materials = list(MATERIAL_ID_STEEL = 12500, MATERIAL_ID_GLASS = 7500, "silver" = 2000, "gold" = 1500)
...
/datum/design/item/medical/scalpel_manager
	...
	materials = list (MATERIAL_ID_STEEL = 12500, MATERIAL_ID_GLASS = 7500, "silver" = 1500, "gold" = 1500, "diamond" = 750)
...
/datum/design/item/medical/improved_analyzer
	...
	materials = list(MATERIAL_ID_STEEL = 2000, MATERIAL_ID_GLASS = 1000, "silver" = 1000, "gold" = 1500)
...
/datum/design/item/medical/advanced_roller
	...
	materials = list(MATERIAL_ID_STEEL = 4000, MATERIAL_ID_GLASS = 2000, "phoron" = 2000)
