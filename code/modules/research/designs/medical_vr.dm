...
/datum/design/item/medical/protohypospray
	...
	materials = list(MATERIAL_ID_STEEL = 500, MATERIAL_ID_GLASS = 1500, "silver" = 2000, "gold" = 1500, "uranium" = 1000)
...
/datum/design/item/medical/cell_based/cell_medigun
	...
	materials = list(MATERIAL_ID_STEEL = 8000, "plastic" = 8000, MATERIAL_ID_GLASS = 5000, "silver" = 1000, "gold" = 1000, "uranium" = 1000)
...
/datum/design/item/medical/cell_based/cell_medigun_mag
	...
	id = "cell_medigun_mag"
	req_tech = list(TECH_MATERIAL = 6, TECH_MAGNET = 4, TECH_POWER = 3, TECH_BIO = 5)
	materials = list(MATERIAL_ID_STEEL = 4000, "plastic" = 6000, MATERIAL_ID_GLASS = 3000, "silver" = 500, "gold" = 500)
...
/datum/design/item/medical/cell_based/cell_medigun_mag_advanced
	...
	materials = list(MATERIAL_ID_STEEL = 5000, "plastic" = 10000, MATERIAL_ID_GLASS = 5000, "silver" = 1500, "gold" = 1500, "diamond" = 5000)
...
/datum/design/item/ml3m_cell/brute
	...
	id = "ml3m_cell_brute"
	req_tech = list(TECH_MATERIAL = 3, TECH_MAGNET = 2, TECH_BIO = 2)
	materials = list(MATERIAL_ID_STEEL = 5000, MATERIAL_ID_GLASS = 5000)
...
/datum/design/item/ml3m_cell/toxin
	...
	materials = list(MATERIAL_ID_STEEL = 5000, MATERIAL_ID_GLASS = 5000, "plastic" = 2500)
...
/datum/design/item/ml3m_cell/brute2
	...
	materials = list(MATERIAL_ID_STEEL = 5000, MATERIAL_ID_GLASS = 5000, "plastic" = 2500, "gold" = 1000)
...
/datum/design/item/ml3m_cell/stabilize2
	...
	req_tech = list(TECH_MATERIAL = 5, TECH_MAGNET = 3, TECH_POWER = 2, TECH_BIO = 5)
	materials = list(MATERIAL_ID_STEEL = 5000, MATERIAL_ID_GLASS = 5000, "plastic" = 2500, "silver" = 1000)
...
/datum/design/item/ml3m_cell/omni2
	...
	id = "ml3m_cell_omni2"
	req_tech = list(TECH_MATERIAL = 5, TECH_MAGNET = 3, TECH_POWER = 2, TECH_BIO = 5)
	materials = list(MATERIAL_ID_STEEL = 5000, MATERIAL_ID_GLASS = 5000, "plastic" = 2500, "uranium" = 1000)
...
/datum/design/item/ml3m_cell/toxin2
	...
	materials = list(MATERIAL_ID_STEEL = 5000, MATERIAL_ID_GLASS = 5000, "plastic" = 2500, "uranium" = 1000, "silver" = 1000, "diamond" = 500)
...
/datum/design/item/ml3m_cell/haste
	...
	id = "ml3m_cell_haste"
	req_tech = list(TECH_MATERIAL = 6, TECH_MAGNET = 3, TECH_POWER = 3, TECH_BIO = 6)
	materials = list(MATERIAL_ID_STEEL = 5000, MATERIAL_ID_GLASS = 5000, "plastic" = 2500, "gold" = 1000, "silver" = 1000, "diamond" = 1000)
...
/datum/design/item/ml3m_cell/resist
	...
	id = "ml3m_cell_resist"
	req_tech = list(TECH_MATERIAL = 6, TECH_MAGNET = 3, TECH_POWER = 3, TECH_BIO = 6)
	materials = list(MATERIAL_ID_STEEL = 5000, MATERIAL_ID_GLASS = 5000, "plastic" = 2500, "gold" = 1000, "uranium" = 1000, "diamond" = 1000)
...
/datum/design/item/ml3m_cell/corpse_mend
	...
	req_tech = list(TECH_MATERIAL = 6, TECH_MAGNET = 3, TECH_POWER = 3, TECH_BIO = 6)
	materials = list(MATERIAL_ID_STEEL = 5000, MATERIAL_ID_GLASS = 5000, "plastic" = 2500, "phoron" = 3000, "diamond" = 3000)
...
/datum/design/item/ml3m_cell/brute3
	...
	materials = list(MATERIAL_ID_STEEL = 5000, MATERIAL_ID_GLASS = 5000, "plastic" = 2500, "diamond" = 500, "verdantium" = 1000)
...
/datum/design/item/ml3m_cell/shrink
	...
	materials = list(MATERIAL_ID_STEEL = 5000, MATERIAL_ID_GLASS = 5000, "plastic" = 2500, "uranium" = 2000)
