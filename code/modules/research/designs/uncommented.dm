...
datum/design/rust_fuel_port
	...
	build_type = IMPRINTER
	materials = list(MATERIAL_ID_GLASS = 2000, "sacid" = 20, MATERIAL_ID_URANIUM = 3000)
...
datum/design/rust_fuel_compressor
	...
	build_type = IMPRINTER
	materials = list(MATERIAL_ID_GLASS = 2000, "sacid" = 20, MATERIAL_ID_PHORON = 3000, MATERIAL_ID_DIAMOND = 1000)
...
datum/design/rust_core
	...
	build_type = IMPRINTER
	materials = list(MATERIAL_ID_GLASS = 2000, "sacid" = 20, MATERIAL_ID_PHORON = 3000, MATERIAL_ID_DIAMOND = 2000)
...
datum/design/rust_injector
	...
	build_type = IMPRINTER
	materials = list(MATERIAL_ID_GLASS = 2000, "sacid" = 20, MATERIAL_ID_PHORON = 3000, MATERIAL_ID_URANIUM = 2000)
	build_path = "/obj/item/weapon/circuitboard/rust_core"
*/
