...
/datum/design/item/stock_part/basic_matter_bin
	...
	materials = list(/datum/material/steel = 80)
...
/datum/design/item/stock_part/hyper_matter_bin
	...
	materials = list(/datum/material/steel = 200, MAT_VERDANTIUM = 60, MAT_DURASTEEL = 75)
...
/datum/design/item/stock_part/omni_matter_bin
	...
	materials = list(/datum/material/steel = 2000, MAT_PLASTEEL = 100, MAT_MORPHIUM = 100, MAT_DURASTEEL = 100)
...
/datum/design/item/stock_part/micro_mani
	...
	materials = list(/datum/material/steel = 30)
...
/datum/design/item/stock_part/hyper_mani
	...
	materials = list(/datum/material/steel = 200, MAT_VERDANTIUM = 50, MAT_DURASTEEL = 50)
...
/datum/design/item/stock_part/omni_mani
	...
	materials = list(/datum/material/steel = 2000, MAT_PLASTEEL = 500, MAT_MORPHIUM = 100, MAT_DURASTEEL = 100)
...
/datum/design/item/stock_part/super_capacitor
	...
	materials = list(/datum/material/steel = 50, "glass" = 50, "gold" = 20)
...
/datum/design/item/stock_part/hyper_capacitor
	...
	materials = list(/datum/material/steel = 200, MAT_GLASS = 100, MAT_VERDANTIUM = 30, MAT_DURASTEEL = 25)
...
/datum/design/item/stock_part/omni_capacitor
	...
	materials = list(/datum/material/steel = 2000, MAT_DIAMOND = 1000, MAT_GLASS = 1000, MAT_MORPHIUM = 100, MAT_DURASTEEL = 100)
...
/datum/design/item/stock_part/basic_sensor
	...
	materials = list(/datum/material/steel = 50, "glass" = 20)
...
/datum/design/item/stock_part/phasic_sensor
	...
	materials = list(/datum/material/steel = 50, "glass" = 20, "silver" = 10)
...
/datum/design/item/stock_part/hyper_sensor
	...
	materials = list(/datum/material/steel = 50, MAT_GLASS = 20, MAT_SILVER = 50, MAT_VERDANTIUM = 40, MAT_DURASTEEL = 50)
...
/datum/design/item/stock_part/omni_sensor
	...
	materials = list(/datum/material/steel = 1000, MAT_PLASTEEL = 500, MAT_GLASS = 750, MAT_SILVER = 500, MAT_MORPHIUM = 60, MAT_DURASTEEL = 100)
...
/datum/design/item/stock_part/basic_micro_laser
	...
	req_tech = list(TECH_MAGNET = 1)
	materials = list(/datum/material/steel = 10, "glass" = 20)
...
/datum/design/item/stock_part/ultra_micro_laser
	...
	materials = list(/datum/material/steel = 10, "glass" = 20, "uranium" = 10)
...
/datum/design/item/stock_part/hyper_micro_laser
	...
	materials = list(/datum/material/steel = 200, MAT_GLASS = 20, MAT_URANIUM = 30, MAT_VERDANTIUM = 50, MAT_DURASTEEL = 100)
...
/datum/design/item/stock_part/omni_micro_laser
	...
	materials = list(/datum/material/steel = 2000, MAT_GLASS = 500, MAT_URANIUM = 2000, MAT_MORPHIUM = 50, MAT_DURASTEEL = 100)
...
/datum/design/item/stock_part/RPED
	...
	materials = list(/datum/material/steel = 15000, "glass" = 5000)
...
/datum/design/item/stock_part/ARPED
	...
	materials = list(/datum/material/steel = 30000, "glass" = 10000)
