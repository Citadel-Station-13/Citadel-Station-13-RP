...
/datum/design/item/tool/experimental_welder
	...
	materials = list(/datum/material/steel = 70, "glass" = 120, "phoron" = 100)
...
/datum/design/item/tool/hand_drill
	...
	materials = list(/datum/material/steel = 300, "silver" = 100)
...
/datum/design/item/engineering/t_scanner_upg
	...
	materials = list(/datum/material/steel = 500, "phoron" = 150)
...
/datum/design/item/engineering/t_scanner_adv
	...
	materials = list(/datum/material/steel = 1250, "phoron" = 500, "silver" = 50)
...
/datum/design/item/engineering/atmosanalyzer
	...
	materials = list(/datum/material/steel = 200, "glass" = 100)
