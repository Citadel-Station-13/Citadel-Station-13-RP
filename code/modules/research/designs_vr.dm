...
/datum/design/item/implant/language
	...
	materials = list(MATERIAL_ID_STEEL = 7000, MATERIAL_ID_GLASS = 7000, MATERIAL_ID_GOLD = 2000, MATERIAL_ID_DIAMOND = 3000)
...
/datum/design/item/weapon/sizegun
	...
	materials = list(MATERIAL_ID_STEEL = 3000, MATERIAL_ID_GLASS = 2000, MATERIAL_ID_URANIUM = 2000)
...
/datum/design/item/weapon/advparticle
	...
	materials = list(MATERIAL_ID_STEEL = 5000, MATERIAL_ID_GLASS = 1000, MATERIAL_ID_GOLD = 1000, MATERIAL_ID_URANIUM = 750)
...
/datum/design/item/weapon/particlecannon
	...
	materials = list(MATERIAL_ID_STEEL = 10000, MATERIAL_ID_GLASS = 1500, MATERIAL_ID_GOLD = 2000, MATERIAL_ID_URANIUM = 1000, MATERIAL_ID_DIAMOND = 2000)
...
/datum/design/item/translocator
	...
	materials = list(MATERIAL_ID_STEEL = 4000, MATERIAL_ID_GLASS = 2000, MATERIAL_ID_URANIUM = 4000, MATERIAL_ID_DIAMOND = 2000)
...
/datum/design/item/nif
	...
	materials = list(MATERIAL_ID_STEEL = 5000, MATERIAL_ID_GLASS = 8000, MATERIAL_ID_URANIUM = 6000, MATERIAL_ID_DIAMOND = 6000)
...
/datum/design/item/nifbio
	...
	materials = list(MATERIAL_ID_STEEL = 10000, MATERIAL_ID_GLASS = 15000, MATERIAL_ID_URANIUM = 10000, MATERIAL_ID_DIAMOND = 10000)
...
/datum/design/item/nifrepairtool
	...
	id = "anrt"
	req_tech = list(TECH_MAGNET = 5, TECH_BLUESPACE = 5, TECH_MATERIAL = 5, TECH_ENGINEERING = 5, TECH_DATA = 5)
	materials = list(MATERIAL_ID_STEEL = 200, MATERIAL_ID_GLASS = 3000, MATERIAL_ID_URANIUM = 2000, MATERIAL_ID_DIAMOND = 2000)
...
/datum/design/item/rig
	...
	materials = list(MATERIAL_ID_STEEL = 6000, MATERIAL_ID_GLASS = 6000, MATERIAL_ID_SILVER = 6000, MATERIAL_ID_URANIUM = 4000)
...
/datum/design/item/rig_module
	req_tech = list(TECH_MATERIAL = 5, TECH_POWER = 5, TECH_MAGNET = 5)
	materials = list(MATERIAL_ID_STEEL = 6000, MATERIAL_ID_GLASS = 6000, MATERIAL_ID_SILVER = 4000, MATERIAL_ID_URANIUM = 2000)
