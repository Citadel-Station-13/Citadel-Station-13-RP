...
/datum/design/item/implant/language
	...
	materials = list(/datum/material/steel = 7000, "glass" = 7000, "gold" = 2000, "diamond" = 3000)
...
/datum/design/item/implant/backup
	...
	materials = list(/datum/material/steel = 2000, "glass" = 2000)
...
/datum/design/item/weapon/sizegun
	...
	materials = list(/datum/material/steel = 3000, "glass" = 2000, "uranium" = 2000)
...
/datum/design/item/translocator
	...
	materials = list(/datum/material/steel = 4000, "glass" = 2000, "uranium" = 4000, "diamond" = 2000)
