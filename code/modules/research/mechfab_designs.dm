...
/datum/design/item/mechfab/ripley/chassis
	...
	time = 10
	materials = list(MATERIAL_ID_STEEL = 15000)
...
/datum/design/item/mechfab/ripley/left_arm
	...
	time = 15
	materials = list(MATERIAL_ID_STEEL = 18750)
...
/datum/design/item/mechfab/ripley/left_leg
	...
	time = 15
	materials = list(MATERIAL_ID_STEEL = 22500)
...
/datum/design/item/mechfab/odysseus/left_arm
	...
	time = 12
	materials = list(MATERIAL_ID_STEEL = 7500)
...
/datum/design/item/mechfab/odysseus/left_leg
	...
	time = 13
	materials = list(MATERIAL_ID_STEEL = 11250)
...
/datum/design/item/mechfab/gygax/chassis/serenity
	...
	materials = list(MATERIAL_ID_STEEL = 18750, "phoron" = 4000)
...
/datum/design/item/mechfab/gygax/left_leg
	...
	time = 20
	materials = list(MATERIAL_ID_STEEL = 26250)
...
/datum/design/item/mechfab/gygax/armour
	...
	time = 60
	materials = list(MATERIAL_ID_STEEL = 37500, "diamond" = 7500)
...
/datum/design/item/mechfab/durand/left_arm
	...
	time = 20
	materials = list(MATERIAL_ID_STEEL = 26250, "silver" = 2250)
...
/datum/design/item/mechfab/durand/left_leg
	...
	time = 20
	materials = list(MATERIAL_ID_STEEL = 30000, "silver" = 2250)
...
/datum/design/item/mechfab/durand/armour
	...
	time = 60
	materials = list(MATERIAL_ID_STEEL = 37500, "uranium" = 7500)
...
/datum/design/item/mechfab/janus/torso
	...
	time = 300
	materials = list(MATERIAL_ID_STEEL = 30000, MAT_DURASTEEL = 8000, MAT_MORPHIUM = 10000, MAT_GOLD = 5000, MAT_VERDANTIUM = 5000)
...
/datum/design/item/mechfab/janus/head
	...
	time = 200
	materials = list(MATERIAL_ID_STEEL = 30000, MAT_DURASTEEL = 2000, MAT_MORPHIUM = 6000, MAT_GOLD = 5000)
...
/datum/design/item/mechfab/janus/left_arm
	...
	time = 200
	materials = list(MATERIAL_ID_STEEL = 30000, MAT_METALHYDROGEN = 3000, MAT_DURASTEEL = 2000, MAT_MORPHIUM = 3000, MAT_GOLD = 5000, MAT_DIAMOND = 7000)
...
/datum/design/item/mechfab/janus/left_leg
	...
	time = 200
	materials = list(MATERIAL_ID_STEEL = 30000, MAT_METALHYDROGEN = 3000, MAT_DURASTEEL = 2000, MAT_MORPHIUM = 3000, MAT_GOLD = 5000, MAT_URANIUM = 7000)
...
/datum/design/item/mecha/tracking
	...
	id = "mech_tracker"
	time = 5
	materials = list(MATERIAL_ID_STEEL = 375)
...
/datum/design/item/mecha/weapon/ion
	...
	materials = list(MATERIAL_ID_STEEL = 15000, "uranium" = 2000, "silver" = 2000, "osmium" = 4500, "plastic" = 2000)
...
/datum/design/item/mecha/weapon/rigged_ion
	...
	materials = list(MATERIAL_ID_STEEL = 13000, "uranium" = 1000, "silver" = 1000, "osmium" = 3000, "plastic" = 2000)
...
/datum/design/item/mecha/weapon/grenade_launcher
	...
	materials = list(MATERIAL_ID_STEEL = 7000, "gold" = 2000, "plastic" = 3000)
...
/datum/design/item/mecha/weapon/rigged_grenade_launcher
	...
	materials = list(MATERIAL_ID_STEEL = 5000, "gold" = 2000, "plastic" = 2000)
...
/datum/design/item/mecha/weapon/clusterbang_launcher
	...
	materials = list(MATERIAL_ID_STEEL = 15000, "gold" = 4500, "uranium" = 4500)
...
/datum/design/item/mecha/weapon/conc_grenade_launcher
	...
	materials = list(MATERIAL_ID_STEEL = 9000, "gold" = 1000, "osmium" = 1000, "plastic" = 3000)
...
/datum/design/item/mecha/weapon/frag_grenade_launcher
	...
	materials = list(MATERIAL_ID_STEEL = 10000, "gold" = 2500, "uranium" = 3000, "osmium" = 3000, "plastic" = 3000)
...
/datum/design/item/mecha/weapon/flamer
	...
	materials = list(MATERIAL_ID_STEEL = 10000, "gold" = 2000, "uranium" = 3000, "phoron" = 8000)
...
/datum/design/item/mecha/weapon/flamer_rigged
	...
	materials = list(MATERIAL_ID_STEEL = 8000, "gold" = 1500, "silver" = 1500, "uranium" = 2000, "phoron" = 6000)
...
/datum/design/item/mecha/weapon/flame_mg
	...
	materials = list(MATERIAL_ID_STEEL = 8000, "gold" = 2000, "silver" = 1750, "uranium" = 1500, "phoron" = 4000)
...
/datum/design/item/mecha/rcd
	...
	id = "mech_rcd"
	time = 120
	materials = list(MATERIAL_ID_STEEL = 20000, "plastic" = 10000, "phoron" = 18750, "silver" = 15000, "gold" = 15000)
...
/datum/design/item/mecha/crisis_drone
	...
	materials = list(MATERIAL_ID_STEEL = 8000, MAT_GOLD = 2000, MAT_SILVER = 3000, MAT_VERDANTIUM = 2500, MAT_GLASS = 3000)
...
/datum/design/item/mecha/rad_drone
	...
	materials = list(MATERIAL_ID_STEEL = 8000, MAT_GOLD = 2000, MAT_URANIUM = 3000, MAT_VERDANTIUM = 2500, MAT_GLASS = 3000)
...
/datum/design/item/mecha/ccw_armor
	...
	materials = list(MATERIAL_ID_STEEL = 11250, "silver" = 3750)
...
/datum/design/item/mecha/proj_armor
	...
	materials = list(MATERIAL_ID_STEEL = 15000, "gold" = 3750)
...
/datum/design/item/mecha/diamond_drill
	...
	materials = list(MATERIAL_ID_STEEL = 7500, "diamond" = 4875)
...
/datum/design/item/mecha/ground_drill
	...
	materials = list(MATERIAL_ID_STEEL = 7000, "silver" = 3000, "phoron" = 2000)
...
/datum/design/item/mecha/advorescanner
	...
	materials = list(MATERIAL_ID_STEEL = 5000, "osmium" = 3000, "silver" = 1000)
...
/datum/design/item/mecha/speedboost_ripley
	...
	materials = list(MATERIAL_ID_STEEL = 10000, "silver" = 1000, "gold" = 1000)
...
/datum/design/item/mechfab/vehicle/spacebike_chassis
	...
	materials = list(MATERIAL_ID_STEEL = 12000, "silver" = 3000, "phoron" = 3000, "osmium" = 1000)
...
/datum/design/item/mechfab/vehicle/quadbike_chassis
	...
	materials = list(MATERIAL_ID_STEEL = 15000, "silver" = 3000, "plastic" = 3000, "osmium" = 1000)
