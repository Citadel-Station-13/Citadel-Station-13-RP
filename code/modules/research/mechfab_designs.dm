...
/datum/design/item/mechfab/ripley/torso
	...
	time = 20
	materials = list(/datum/material/steel = 30000, "glass" = 11250)
...
/datum/design/item/mechfab/ripley/left_arm
	...
	time = 15
	materials = list(/datum/material/steel = 18750)
...
/datum/design/item/mechfab/ripley/left_leg
	...
	time = 15
	materials = list(/datum/material/steel = 22500)
...
/datum/design/item/mechfab/odysseus/head
	...
	time = 10
	materials = list(/datum/material/steel = 1500, "glass" = 7500)
...
/datum/design/item/mechfab/odysseus/left_arm
	...
	time = 12
	materials = list(/datum/material/steel = 7500)
...
/datum/design/item/mechfab/odysseus/left_leg
	...
	time = 13
	materials = list(/datum/material/steel = 11250)
...
/datum/design/item/mechfab/gygax/chassis/serenity
	...
	materials = list(/datum/material/steel = 18750, "phoron" = 4000)
...
/datum/design/item/mechfab/gygax/torso
	...
	time = 30
	materials = list(/datum/material/steel = 37500, "glass" = 15000)
...
/datum/design/item/mechfab/gygax/head
	...
	time = 20
	materials = list(/datum/material/steel = 15000, "glass" = 7500)
...
/datum/design/item/mechfab/gygax/left_leg
	...
	time = 20
	materials = list(/datum/material/steel = 26250)
...
/datum/design/item/mechfab/gygax/armour
	...
	time = 60
	materials = list(/datum/material/steel = 37500, "diamond" = 7500)
...
/datum/design/item/mechfab/durand/torso
	...
	time = 30
	materials = list(/datum/material/steel = 41250, "glass" = 15000, "silver" = 7500)
...
/datum/design/item/mechfab/durand/head
	...
	time = 20
	materials = list(/datum/material/steel = 18750, "glass" = 7500, "silver" = 2250)
...
/datum/design/item/mechfab/durand/left_arm
	...
	time = 20
	materials = list(/datum/material/steel = 26250, "silver" = 2250)
...
/datum/design/item/mechfab/durand/left_leg
	...
	time = 20
	materials = list(/datum/material/steel = 30000, "silver" = 2250)
...
/datum/design/item/mechfab/durand/armour
	...
	time = 60
	materials = list(/datum/material/steel = 37500, "uranium" = 7500)
...
/datum/design/item/mechfab/janus/torso
	...
	time = 300
	materials = list(/datum/material/steel = 30000, MAT_DURASTEEL = 8000, MAT_MORPHIUM = 10000, MAT_GOLD = 5000, MAT_VERDANTIUM = 5000)
...
/datum/design/item/mechfab/janus/head
	...
	time = 200
	materials = list(/datum/material/steel = 30000, MAT_DURASTEEL = 2000, MAT_MORPHIUM = 6000, MAT_GOLD = 5000)
...
/datum/design/item/mechfab/janus/left_arm
	...
	time = 200
	materials = list(/datum/material/steel = 30000, MAT_METALHYDROGEN = 3000, MAT_DURASTEEL = 2000, MAT_MORPHIUM = 3000, MAT_GOLD = 5000, MAT_DIAMOND = 7000)
...
/datum/design/item/mechfab/janus/left_leg
	...
	time = 200
	materials = list(/datum/material/steel = 30000, MAT_METALHYDROGEN = 3000, MAT_DURASTEEL = 2000, MAT_MORPHIUM = 3000, MAT_GOLD = 5000, MAT_URANIUM = 7000)
...
/datum/design/item/mecha/tracking
	...
	id = "mech_tracker"
	time = 5
	materials = list(/datum/material/steel = 375)
...
/datum/design/item/mecha/syringe_gun
	...
	time = 20
	materials = list(/datum/material/steel = 2250, "glass" = 1500)

/datum/design/item/mecha/passenger
	name = "Passenger Compartment"
	id = "mech_passenger"
	build_path = /obj/item/mecha_parts/mecha_equipment/tool/passenger
	materials = list(/datum/material/steel = 3750, "glass" = 3750)
...
/datum/design/item/mecha/shocker
	...
	materials = list(/datum/material/steel = 3500, "gold" = 750, "glass" = 1000)
...
/datum/design/item/mecha/weapon
	...
	materials = list(/datum/material/steel = 8000, "glass" = 2000)
...
/datum/design/item/mecha/weapon/scattershot
	...
	materials = list(/datum/material/steel = 8000, "glass" = 3000, "plastic" = 2000, "silver" = 2500)
...
/datum/design/item/mecha/weapon/rigged_scattershot
	...
	materials = list(/datum/material/steel = 7000, "glass" = 2000, "plastic" = 2000, "silver" = 2000)
...
/datum/design/item/mecha/weapon/laser
	...
	materials = list(/datum/material/steel = 8000, "glass" = 3000, "plastic" = 2000)
...
/datum/design/item/mecha/weapon/laser_heavy
	...
	materials = list(/datum/material/steel = 10000, "glass" = 3000, "diamond" = 2000, "osmium" = 5000, "plastic" = 2000)
...
/datum/design/item/mecha/weapon/rigged_laser_heavy
	...
	materials = list(/datum/material/steel = 8000, "glass" = 4000, "diamond" = 1500, "osmium" = 4000, "plastic" = 2000)
...
/datum/design/item/mecha/weapon/laser_xray
	...
	materials = list(/datum/material/steel = 9000, "glass" = 3000, "phoron" = 1000, "silver" = 1500, "gold" = 2500, "plastic" = 2000)
...
/datum/design/item/mecha/weapon/rigged_laser_xray
	...
	materials = list(/datum/material/steel = 8500, "glass" = 2500, "phoron" = 1000, "silver" = 1250, "gold" = 2000, "plastic" = 2000)
...
/datum/design/item/mecha/weapon/phase
	...
	materials = list(/datum/material/steel = 6000, "glass" = 3000, "plastic" = 3000)
...
/datum/design/item/mecha/weapon/ion
	...
	materials = list(/datum/material/steel = 15000, "uranium" = 2000, "silver" = 2000, "osmium" = 4500, "plastic" = 2000)
...
/datum/design/item/mecha/weapon/rigged_ion
	...
	materials = list(/datum/material/steel = 13000, "uranium" = 1000, "silver" = 1000, "osmium" = 3000, "plastic" = 2000)
...
/datum/design/item/mecha/weapon/grenade_launcher
	...
	materials = list(/datum/material/steel = 7000, "gold" = 2000, "plastic" = 3000)
...
/datum/design/item/mecha/weapon/rigged_grenade_launcher
	...
	materials = list(/datum/material/steel = 5000, "gold" = 2000, "plastic" = 2000)
...
/datum/design/item/mecha/weapon/clusterbang_launcher
	...
	materials = list(/datum/material/steel = 15000, "gold" = 4500, "uranium" = 4500)
...
/datum/design/item/mecha/weapon/conc_grenade_launcher
	...
	materials = list(/datum/material/steel = 9000, "gold" = 1000, "osmium" = 1000, "plastic" = 3000)
...
/datum/design/item/mecha/weapon/frag_grenade_launcher
	...
	materials = list(/datum/material/steel = 10000, "gold" = 2500, "uranium" = 3000, "osmium" = 3000, "plastic" = 3000)
...
/datum/design/item/mecha/weapon/flamer
	...
	materials = list(/datum/material/steel = 10000, "gold" = 2000, "uranium" = 3000, "phoron" = 8000)
...
/datum/design/item/mecha/weapon/flamer_rigged
	...
	materials = list(/datum/material/steel = 8000, "gold" = 1500, "silver" = 1500, "uranium" = 2000, "phoron" = 6000)
...
/datum/design/item/mecha/weapon/flame_mg
	...
	materials = list(/datum/material/steel = 8000, "gold" = 2000, "silver" = 1750, "uranium" = 1500, "phoron" = 4000)
...
/datum/design/item/mecha/rcd
	...
	id = "mech_rcd"
	time = 120
	materials = list(/datum/material/steel = 20000, "plastic" = 10000, "phoron" = 18750, "silver" = 15000, "gold" = 15000)
...
/datum/design/item/mecha/repair_droid
	...
	materials = list(/datum/material/steel = 7500, "gold" = 750, "silver" = 1500, "glass" = 3750)
...
/datum/design/item/mecha/shield_drone
	...
	materials = list(/datum/material/steel = 8000, "gold" = 2000, "silver" = 3000, "phoron" = 5000, "glass" = 3750)
...
/datum/design/item/mecha/crisis_drone
	...
	materials = list(/datum/material/steel = 8000, MAT_GOLD = 2000, MAT_SILVER = 3000, MAT_VERDANTIUM = 2500, MAT_GLASS = 3000)
...
/datum/design/item/mecha/rad_drone
	...
	materials = list(/datum/material/steel = 8000, MAT_GOLD = 2000, MAT_URANIUM = 3000, MAT_VERDANTIUM = 2500, MAT_GLASS = 3000)
...
/datum/design/item/mecha/jetpack
	...
	materials = list(/datum/material/steel = 7500, "silver" = 300, "glass" = 600)
...
/datum/design/item/mecha/phoron_generator
	...
	materials = list(/datum/material/steel = 7500, "silver" = 375, "glass" = 750)

/datum/design/item/mecha/energy_relay
	name = "Energy Relay"
	id = "mech_energy_relay"
	req_tech = list(TECH_MAGNET = 4, TECH_POWER = 3)
	materials = list(/datum/material/steel = 7500, "gold" = 1500, "silver" = 2250, "glass" = 1500)
...
/datum/design/item/mecha/ccw_armor
	...
	materials = list(/datum/material/steel = 11250, "silver" = 3750)
...
/datum/design/item/mecha/proj_armor
	...
	materials = list(/datum/material/steel = 15000, "gold" = 3750)
...
/datum/design/item/mecha/diamond_drill
	...
	materials = list(/datum/material/steel = 7500, "diamond" = 4875)
...
/datum/design/item/mecha/ground_drill
	...
	materials = list(/datum/material/steel = 7000, "silver" = 3000, "phoron" = 2000)
...
/datum/design/item/mecha/orescanner
	...
	materials = list(/datum/material/steel = 4000, "glass" = 1000)
...
/datum/design/item/mecha/advorescanner
	...
	materials = list(/datum/material/steel = 5000, "osmium" = 3000, "silver" = 1000)
...
/datum/design/item/mecha/powerwrench
	...
	materials = list(/datum/material/steel = 5000, "plastic" = 2000, "glass" = 1250)
...
/datum/design/item/mecha/powercrowbar
	...
	id = "mech_crowbar"
	req_tech = list(TECH_MATERIAL = 2, TECH_ENGINEERING = 2, TECH_POWER = 2)
	materials = list(/datum/material/steel = 4000, "osmium" = 3000, "glass" = 1000)
...
/datum/design/item/mecha/speedboost_ripley
	...
	materials = list(/datum/material/steel = 10000, "silver" = 1000, "gold" = 1000)
...
/datum/design/item/synthetic_flash
	...
	build_type = MECHFAB
	materials = list(/datum/material/steel = 562, "glass" = 562)
...
/datum/design/item/mechfab/vehicle/spacebike_chassis
	...
	materials = list(/datum/material/steel = 12000, "silver" = 3000, "phoron" = 3000, "osmium" = 1000)
...
/datum/design/item/mechfab/vehicle/quadbike_chassis
	...
	materials = list(/datum/material/steel = 15000, "silver" = 3000, "plastic" = 3000, "osmium" = 1000)
