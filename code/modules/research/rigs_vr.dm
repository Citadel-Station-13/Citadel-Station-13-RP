...
/datum/design/item/rig_module/lasercannon
	...
	materials = list(MATERIAL_ID_STEEL = 6000, MATERIAL_ID_GLASS = 6000, "silver" = 4000, "uranium" = 2000, "diamond" = 2000)
	sort_string = "OBADA"
...
/datum/design/item/rig_module/egun
	...
	materials = list(MATERIAL_ID_STEEL = 6000, MATERIAL_ID_GLASS = 6000, "silver" = 4000, "uranium" = 2000, "diamond" = 1000)
	sort_string = "OBADB"
