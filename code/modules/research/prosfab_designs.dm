...
/datum/design/item/prosfab/pros/torso
	time = 35
	materials = list(MATERIAL_ID_STEEL = 30000, MATERIAL_ID_GLASS = 7500)
...
/datum/design/item/prosfab/pros/head
	...
	time = 30
	materials = list(MATERIAL_ID_STEEL = 18750, MATERIAL_ID_GLASS = 3750)
//	req_tech = list(TECH_ENGINEERING = 2, TECH_MATERIAL = 3, TECH_DATA = 3)	//Saving the values just in case
...
/datum/design/item/prosfab/pros/l_arm
	...
	time = 20
	materials = list(MATERIAL_ID_STEEL = 10125)
...
/datum/design/item/prosfab/pros/l_hand
	...
	time = 15
	materials = list(MATERIAL_ID_STEEL = 3375)
...
/datum/design/item/prosfab/pros/l_leg
	...
	time = 20
	materials = list(MATERIAL_ID_STEEL = 8437)
...
/datum/design/item/prosfab/pros/l_foot
	...
	time = 15
	materials = list(MATERIAL_ID_STEEL = 2813)
...
/datum/design/item/prosfab/pros/internal/cell
	...
	time = 15
	materials = list(MATERIAL_ID_STEEL = 7500, MATERIAL_ID_GLASS = 3000)
...
/datum/design/item/prosfab/pros/internal/eyes
	...
	time = 15
	materials = list(MATERIAL_ID_STEEL = 5625, MATERIAL_ID_GLASS = 5625)
//	req_tech = list(TECH_ENGINEERING = 2, TECH_MATERIAL = 2)
...
/datum/design/item/prosfab/pros/internal/heart
	...
	time = 15
	materials = list(MATERIAL_ID_STEEL = 5625, MATERIAL_ID_GLASS = 1000)
//	req_tech = list(TECH_ENGINEERING = 2, TECH_MATERIAL = 2)
...
/datum/design/item/prosfab/pros/internal/spleen
	...
	time = 15
	materials = list(MATERIAL_ID_STEEL = 3000, MAT_GLASS = 750)
//	req_tech = list(TECH_ENGINEERING = 2, TECH_MATERIAL = 2)
...
/datum/design/item/prosfab/pros/internal/larynx
	...
	time = 15
	materials = list(MATERIAL_ID_STEEL = 2000, MAT_GLASS = 750, MAT_PLASTIC = 500)

//////////////////// Cyborg Parts ////////////////////
/datum/design/item/prosfab/cyborg
	category = "Cyborg Parts"
	time = 20
	materials = list(MATERIAL_ID_STEEL = 3750)
...
/datum/design/item/prosfab/cyborg/exoskeleton
	...
	time = 50
	materials = list(MATERIAL_ID_STEEL = 37500)
...
/datum/design/item/prosfab/cyborg/l_arm
	...
	time = 20
	materials = list(MATERIAL_ID_STEEL = 13500)
...
/datum/design/item/prosfab/robot_upgrade/restart
	...
	materials = list(MATERIAL_ID_STEEL = 45000, MATERIAL_ID_GLASS = 3750)
...
/datum/design/item/prosfab/robot_upgrade/vtec
	...
	id = "borg_vtec_module"
	materials = list(MATERIAL_ID_STEEL = 60000, MATERIAL_ID_GLASS = 4500, "gold" = 3750)
...
/datum/design/item/prosfab/robot_upgrade/tasercooler
	...
	materials = list(MATERIAL_ID_STEEL = 60000, MATERIAL_ID_GLASS = 4500, "gold" = 1500, "diamond" = 375)
...
/datum/design/item/prosfab/robot_upgrade/jetpack
	...
	materials = list(MATERIAL_ID_STEEL = 7500, "phoron" = 11250, "uranium" = 15000)
...
/datum/design/item/prosfab/robot_upgrade/advhealth
	...
	materials = list(MATERIAL_ID_STEEL = 10000, MATERIAL_ID_GLASS = 6500, "diamond" = 350)
...
/datum/design/item/prosfab/robot_upgrade/syndicate
	...
	materials = list(MATERIAL_ID_STEEL = 7500, MATERIAL_ID_GLASS = 11250, "diamond" = 7500)
...
/datum/design/item/prosfab/robot_upgrade/language
	...
	materials = list(MATERIAL_ID_STEEL = 25000, MATERIAL_ID_GLASS = 3000, "gold" = 350)
...
/datum/design/item/prosfab/synthmorphbag
	...
	id = "misc_synth_bag"
	materials = list(MATERIAL_ID_STEEL = 250, MATERIAL_ID_GLASS = 250, "plastic" = 2000)
...
/datum/design/item/prosfab/badge_nt
	...
	materials = list(MATERIAL_ID_STEEL = 1000, MATERIAL_ID_GLASS = 500, "plastic" = 1000)
...
/datum/design/item/prosfab/badge_gilthari
	...
	materials = list(MATERIAL_ID_STEEL = 1000, MATERIAL_ID_GLASS = 500, "gold" = 1000)
...
/datum/design/item/prosfab/badge_bishop
	...
	materials = list(MATERIAL_ID_STEEL = 500, MATERIAL_ID_GLASS = 2000, "plastic" = 500)
