...
/datum/design/item/prosfab/pros/torso
	time = 35
	materials = list(MATERIAL_ID_STEEL = 30000, "glass" = 7500)
...
/datum/design/item/prosfab/pros/head
	...
	time = 30
	materials = list(MATERIAL_ID_STEEL = 18750, "glass" = 3750)
//	req_tech = list(TECH_ENGINEERING = 2, TECH_MATERIAL = 3, TECH_DATA = 3)	//Saving the values just in case
...
/datum/design/item/prosfab/pros/internal/cell
	...
	time = 15
	materials = list(MATERIAL_ID_STEEL = 7500, "glass" = 3000)
...
/datum/design/item/prosfab/pros/internal/eyes
	...
	time = 15
	materials = list(MATERIAL_ID_STEEL = 5625, "glass" = 5625)
//	req_tech = list(TECH_ENGINEERING = 2, TECH_MATERIAL = 2)
...
/datum/design/item/prosfab/pros/internal/heart
	...
	time = 15
	materials = list(MATERIAL_ID_STEEL = 5625, "glass" = 1000)
//	req_tech = list(TECH_ENGINEERING = 2, TECH_MATERIAL = 2)
...
/datum/design/item/prosfab/robot_upgrade/restart
	...
	materials = list(MATERIAL_ID_STEEL = 45000, "glass" = 3750)
...
/datum/design/item/prosfab/robot_upgrade/vtec
	...
	id = "borg_vtec_module"
	materials = list(MATERIAL_ID_STEEL = 60000, "glass" = 4500, "gold" = 3750)
...
/datum/design/item/prosfab/robot_upgrade/tasercooler
	...
	materials = list(MATERIAL_ID_STEEL = 60000, "glass" = 4500, "gold" = 1500, "diamond" = 375)
...
/datum/design/item/prosfab/robot_upgrade/advhealth
	...
	materials = list(MATERIAL_ID_STEEL = 10000, "glass" = 6500, "diamond" = 350)
...
/datum/design/item/prosfab/robot_upgrade/syndicate
	...
	materials = list(MATERIAL_ID_STEEL = 7500, "glass" = 11250, "diamond" = 7500)
...
/datum/design/item/prosfab/robot_upgrade/language
	...
	materials = list(MATERIAL_ID_STEEL = 25000, "glass" = 3000, "gold" = 350)
...
/datum/design/item/prosfab/synthmorphbag
	...
	id = "misc_synth_bag"
	materials = list(MATERIAL_ID_STEEL = 250, "glass" = 250, "plastic" = 2000)
...
/datum/design/item/prosfab/badge_nt
	...
	materials = list(MATERIAL_ID_STEEL = 1000, "glass" = 500, "plastic" = 1000)
...
/datum/design/item/prosfab/badge_gilthari
	...
	materials = list(MATERIAL_ID_STEEL = 1000, "glass" = 500, "gold" = 1000)
...
/datum/design/item/prosfab/badge_bishop
	...
	materials = list(MATERIAL_ID_STEEL = 500, "glass" = 2000, "plastic" = 500)
