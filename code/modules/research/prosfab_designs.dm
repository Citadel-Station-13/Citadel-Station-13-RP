...
/datum/design/item/prosfab/pros/torso
	time = 35
	materials = list(/datum/material/steel = 30000, "glass" = 7500)
...
/datum/design/item/prosfab/pros/head
	...
	time = 30
	materials = list(/datum/material/steel = 18750, "glass" = 3750)
//	req_tech = list(TECH_ENGINEERING = 2, TECH_MATERIAL = 3, TECH_DATA = 3)	//Saving the values just in case
...
/datum/design/item/prosfab/pros/l_arm
	...
	time = 20
	materials = list(/datum/material/steel = 10125)
...
/datum/design/item/prosfab/pros/l_hand
	...
	time = 15
	materials = list(/datum/material/steel = 3375)
...
/datum/design/item/prosfab/pros/l_leg
	...
	time = 20
	materials = list(/datum/material/steel = 8437)
...
/datum/design/item/prosfab/pros/l_foot
	...
	time = 15
	materials = list(/datum/material/steel = 2813)
...
/datum/design/item/prosfab/pros/internal/cell
	...
	time = 15
	materials = list(/datum/material/steel = 7500, "glass" = 3000)
...
/datum/design/item/prosfab/pros/internal/eyes
	...
	time = 15
	materials = list(/datum/material/steel = 5625, "glass" = 5625)
//	req_tech = list(TECH_ENGINEERING = 2, TECH_MATERIAL = 2)
...
/datum/design/item/prosfab/pros/internal/heart
	...
	time = 15
	materials = list(/datum/material/steel = 5625, "glass" = 1000)
//	req_tech = list(TECH_ENGINEERING = 2, TECH_MATERIAL = 2)
...
/datum/design/item/prosfab/pros/internal/spleen
	...
	time = 15
	materials = list(/datum/material/steel = 3000, MAT_GLASS = 750)
//	req_tech = list(TECH_ENGINEERING = 2, TECH_MATERIAL = 2)
...
/datum/design/item/prosfab/pros/internal/larynx
	...
	time = 15
	materials = list(/datum/material/steel = 2000, MAT_GLASS = 750, MAT_PLASTIC = 500)

//////////////////// Cyborg Parts ////////////////////
/datum/design/item/prosfab/cyborg
	category = "Cyborg Parts"
	time = 20
	materials = list(/datum/material/steel = 3750)
...
/datum/design/item/prosfab/cyborg/exoskeleton
	...
	time = 50
	materials = list(/datum/material/steel = 37500)
...
/datum/design/item/prosfab/cyborg/torso
	...
	time = 35
	materials = list(/datum/material/steel = 30000)
...
/datum/design/item/prosfab/cyborg/l_arm
	...
	time = 20
	materials = list(/datum/material/steel = 13500)
...
/datum/design/item/prosfab/robot_upgrade/restart
	...
	materials = list(/datum/material/steel = 45000, "glass" = 3750)
...
/datum/design/item/prosfab/robot_upgrade/vtec
	...
	id = "borg_vtec_module"
	materials = list(/datum/material/steel = 60000, "glass" = 4500, "gold" = 3750)
...
/datum/design/item/prosfab/robot_upgrade/tasercooler
	...
	materials = list(/datum/material/steel = 60000, "glass" = 4500, "gold" = 1500, "diamond" = 375)
...
/datum/design/item/prosfab/robot_upgrade/jetpack
	...
	materials = list(/datum/material/steel = 7500, "phoron" = 11250, "uranium" = 15000)
...
/datum/design/item/prosfab/robot_upgrade/advhealth
	...
	materials = list(/datum/material/steel = 10000, "glass" = 6500, "diamond" = 350)
...
/datum/design/item/prosfab/robot_upgrade/syndicate
	...
	materials = list(/datum/material/steel = 7500, "glass" = 11250, "diamond" = 7500)
...
/datum/design/item/prosfab/robot_upgrade/language
	...
	materials = list(/datum/material/steel = 25000, "glass" = 3000, "gold" = 350)
...
/datum/design/item/prosfab/synthmorphbag
	...
	id = "misc_synth_bag"
	materials = list(/datum/material/steel = 250, "glass" = 250, "plastic" = 2000)
...
/datum/design/item/prosfab/badge_nt
	...
	materials = list(/datum/material/steel = 1000, "glass" = 500, "plastic" = 1000)
...
/datum/design/item/prosfab/badge_gilthari
	...
	materials = list(/datum/material/steel = 1000, "glass" = 500, "gold" = 1000)
...
/datum/design/item/prosfab/badge_bishop
	...
	materials = list(/datum/material/steel = 500, "glass" = 2000, "plastic" = 500)
