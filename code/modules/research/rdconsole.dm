		...
		if(3.1)
			...
			for(var/datum/design/D in files.known_designs)
				...
				for(var/M in D.materials)
					temp_dat += ", [D.materials[M]*linked_lathe.mat_efficiency] [CallMaterialName(M)]" //cit change - *incoherent screaming*
...
/obj/machinery/computer/rdconsole/core
	name = "Core R&D Console"
	id = 1
>>>>>>> 80220c1... Merge pull request #4878 from VOREStation/upstream-merge-6020
