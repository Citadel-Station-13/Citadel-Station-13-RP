...
/mob/living/silicon/infomorph/default_can_use_ui_topic(var/src_object)
	if(src_object in src)
		return shared_ui_interaction()
...
/mob/living/silicon/infomorph/ui_state(mob/user)
...
/mob/living/silicon/infomorph/ui_data(mob/user, datum/tgui/ui, datum/ui_state/state)
	var/list/data = ..()
...
/mob/living/silicon/infomorph/ui_act(action, list/params, datum/tgui/ui, datum/ui_state/state)
	if(..())
		return TRUE
