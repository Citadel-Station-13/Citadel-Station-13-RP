...
/obj/machinery/transhuman/synthprinter
	...
	var/list/stored_material =  list(MATERIAL_ID_STEEL = 30000, MATERIAL_ID_GLASS = 30000)
...
/obj/machinery/transhuman/synthprinter/proc/print(var/datum/transhuman/body_record/BR)
	...
	if(stored_material[MATERIAL_ID_STEEL] < body_cost || stored_material[MATERIAL_ID_GLASS] < body_cost)
		return 0
...
/obj/machinery/transhuman/synthprinter/proc/make_body()
	...
	//Machine specific stuff at the end
	stored_material[MATERIAL_ID_STEEL] -= body_cost
	stored_material[MATERIAL_ID_GLASS] -= body_cost
	busy = 0
	update_icon()
