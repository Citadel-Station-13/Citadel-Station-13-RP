...
/obj/machinery/transhuman/synthprinter/attack_hand(mob/user, datum/event_args/clickchain/e_args)
...
/obj/machinery/transhuman/resleever/attack_hand(mob/user, datum/event_args/clickchain/e_args)
