...
/obj/machinery/modular_computer/update_overlays()
	...
	if(cpu && cpu.integrity <= cpu.integrity_failure * cpu.integrity_max)
		. += "bsod"
		. += "broken"
...
/obj/machinery/modular_computer/proc/power_failure(malfunction = 0)
	...
	machine_stat = (machine_stat | NOPOWER)
	update_appearance()
...
/obj/machinery/modular_computer/attackby(obj/item/W as obj, mob/living/user)
	if (user.a_intent == INTENT_HELP && cpu && !(integrity_flags & INTEGRITY_NO_DECONSTRUCT))
