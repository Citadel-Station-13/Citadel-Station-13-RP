...
/obj/item/modular_computer/tablet/preset/cheap/Initialize(mapload)
	...
	install_component(new /obj/item/computer_hardware/battery(src, /obj/item/cell/computer/micro))
...
/obj/item/modular_computer/tablet/preset/security
	name = "\improper Security Officer's tablet"

/obj/item/modular_computer/tablet/preset/security/Initialize(mapload)
	. = ..()
	var/obj/item/computer_hardware/hard_drive/small/hard_drive = new
	install_component(new /obj/item/computer_hardware/processor_unit/small)
	install_component(new /obj/item/computer_hardware/battery(src, /obj/item/cell/computer))
