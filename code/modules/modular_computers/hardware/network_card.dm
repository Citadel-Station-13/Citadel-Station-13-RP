...
/obj/item/stock_parts/computer/network_card/diagnostics(var/mob/user)
	..()
...
/obj/item/stock_parts/computer/network_card/Initialize(mapload)
	. = ..()
...
/obj/item/stock_parts/computer/network_card/quantum
...
/obj/item/stock_parts/computer/network_card/quantum/get_signal(var/specific_action = 0)
	if(!holder2)
		return 0
	if(!enabled)
		return 0
