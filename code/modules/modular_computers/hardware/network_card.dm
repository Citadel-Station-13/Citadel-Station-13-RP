...
/obj/item/computer_hardware/network_card/proc/get_signal(var/specific_action = 0, list/routed_through)
	. = 0
	if(!enabled)
		return
...
/obj/item/computer_hardware/network_card/on_uninstall(var/obj/machinery/machine, var/temporary = FALSE)
	..()
	on_disable()
