...
/obj/item/computer_hardware/nano_printer/diagnostics()
	. = ..()
	. += "Paper buffer level: [stored_paper]/[max_paper]"
	. += "Printer language: [print_language]"

/obj/item/computer_hardware/nano_printer/proc/print_text(var/text_to_print, var/paper_title = null, var/paper_type = /obj/item/paper, var/list/md = null)
	if(printer_ready())
...
/obj/item/computer_hardware/nano_printer/proc/printer_ready()
	if(!stored_paper)
		return 0
	if(!enabled)
		return 0
