/datum/computer_file/program/alarm_monitor
	...
	extended_desc = "This program provides visual interface for a vessel's alarm system."
	requires_ntnet = 1
	size = 5
...
/datum/computer_file/program/alarm_monitor/proc/triggerAlarm(class, area/home, cameras, obj/source)
	if(isStationLevel(source.z))
		if(!(home.type in the_station_areas))
			return
	else if(!isNotStationLevel(source.z))
		return
