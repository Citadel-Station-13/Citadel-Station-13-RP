<<<<<<< HEAD:code/modules/nano/modules/crew_monitor.dm
	...
	for(var/mob/living/carbon/human/H in mob_list)
		if(istype(H.w_uniform, /obj/item/clothing/under))
			...
			if (C.has_sensor)
				tracked |= C
	return 1
>>>>>>> 30a6e8c... Merge pull request #5154 from VOREStation/upstream-merge-6031:code/modules/modular_computers/file_system/programs/medical/suit_sensors.dm
*/