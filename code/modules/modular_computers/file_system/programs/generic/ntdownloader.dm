...
/datum/computer_file/program/ntnetdownload/ui_act(action, list/params, datum/tgui/ui, datum/tgui_embed_context/embed_context)
	if(..())
		return TRUE
	switch(action)
		if("PRG_downloadfile")
...
/datum/computer_file/program/ntnetdownload/ui_data(mob/user, datum/tgui/ui, datum/tgui_embed_context/embed_context)
