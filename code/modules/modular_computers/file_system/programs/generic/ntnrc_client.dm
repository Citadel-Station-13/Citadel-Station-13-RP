...
/datum/computer_file/program/chatclient/ui_act(action, list/params, datum/tgui/ui, datum/tgui_embed_context/embed_context)
	if(..())
		return
...
/datum/computer_file/program/chatclient/ui_static_data(mob/user, datum/tgui/ui, datum/tgui_embed_context/embed_context)
	var/list/data = list()
	data["can_admin"] = can_run(user, FALSE, ACCESS_NETWORK)
	return data

/datum/computer_file/program/chatclient/ui_data(mob/user, datum/tgui/ui, datum/tgui_embed_context/embed_context)
