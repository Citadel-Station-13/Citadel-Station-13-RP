...
/datum/nano_module/uav/proc/get_signal_to(var/atom/movable/AM)
	...
	var/list/zlevels_in_range = SSmapping.get_connected_levels(their_z, long_range = FALSE)
	var/list/zlevels_in_long_range = SSmapping.get_connected_levels(their_z, long_range = TRUE) - zlevels_in_range
	var/their_signal = 0
