 ...
 */
/datum/computer_file/program/game/ui_data(mob/user, datum/tgui/ui, datum/tgui_embed_context/embed_context)
 ...
 */
/datum/computer_file/program/game/ui_act(action, list/params, datum/tgui/ui, datum/tgui_embed_context/embed_context)
