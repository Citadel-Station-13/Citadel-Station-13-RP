...
/datum/computer_file/program
	...
	var/datum/component/ntos/computer	// OS that runs this program.
...
/datum/computer_file/program/proc/on_startup(var/mob/living/user, var/datum/component/ntos/new_host)
