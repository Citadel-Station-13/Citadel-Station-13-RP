 ...
 *
 * The areas in this file aren't necessarily unique - they may be conflicting.
 * this is because tether, in its infinite wisdom, has no such thing as modularized areas
 * So, we all suffer the sins of the mappers before us.
 *
 * If an error occurs and you trace it to this file, your best bet is to make a generic area and replace both conflicting areas with that.
 */
