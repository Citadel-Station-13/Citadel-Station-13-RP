...
/datum/map_template/lateload/space/away_piratebase
	...
	associated_map_datum = /datum/map_level/space_lateload/away_piratebase
	ztraits = list(ZTRAIT_AWAY = TRUE, ZTRAIT_GRAVITY = FALSE)

/datum/map_level/space_lateload/away_piratebase
	name = "Away Mission - Pirate Base"
	base_turf = /turf/space
...
/datum/map_template/lateload/space/specialty
	...
	associated_map_datum = /datum/map_level/space_lateload/specialty
	ztraits = list(ZTRAIT_AWAY = TRUE, ZTRAIT_GRAVITY = FALSE)

/datum/map_level/space_lateload/specialty
	name = "Away Mission - Specialty"
	base_turf = /turf/space
*/
