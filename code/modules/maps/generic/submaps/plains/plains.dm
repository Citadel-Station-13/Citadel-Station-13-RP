...
/datum/map_template/submap/level_specific/plains/RationCache
	...
	suffix = "RationCache_vr.dmm"	cost = 5
...
/datum/map_template/submap/level_specific/plains/Oldhouse
	...
	suffix = "Oldhouse_vr.dmm"	cost = 15
