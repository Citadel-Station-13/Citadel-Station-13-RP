...
/obj/machinery/gravity_generator/main/ui_data(mob/user, datum/tgui/ui, datum/tgui_embed_context/embed_context)
	var/data[0]
...
/obj/machinery/gravity_generator/main/ui_act(action, list/params, datum/tgui/ui, datum/tgui_embed_context/embed_context)
	if((..()))
		return TRUE
