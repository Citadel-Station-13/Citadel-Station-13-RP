...
/obj/machinery/power/tesla_coil/attack_hand(mob/user, datum/event_args/clickchain/e_args)
...
/obj/machinery/power/grounding_rod/attack_hand(mob/user, datum/event_args/clickchain/e_args)
	if(user.a_intent == INTENT_GRAB && user_buckle_mob(user.pulling, user))
		return
	..()
