...
/obj/machinery/power/smes/ui_data(mob/user, datum/tgui/ui, datum/tgui_embed_context/embed_context)
	var/list/data = list(
		"capacity" = capacity,
...
/obj/machinery/power/smes/ui_act(action, list/params, datum/tgui/ui, datum/tgui_embed_context/embed_context)
	if(..())
		return TRUE
	switch(action)
		if("tryinput")
