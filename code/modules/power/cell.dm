...
/obj/item/weapon/cell/attackby(obj/item/W, mob/user)
	...
	if(istype(W, /obj/item/weapon/reagent_containers/syringe))
		...
		if(S.reagents.has_reagent("spicy purple", 5))
			...
			log_admin("LOG: [user.name] ([user.ckey]) injected a power cell with spicy purple, rigging it to explode.")
			message_admins("LOG: [user.name] ([user.ckey]) injected a power cell with spicy purple, rigging it to explode.")
