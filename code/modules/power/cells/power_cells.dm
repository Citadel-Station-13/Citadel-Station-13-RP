/obj/item/cell/crap
	...
	maxcharge = 500
	matter = list(MATERIAL_ID_STEEL = 700, MATERIAL_ID_GLASS = 40)
...
/obj/item/cell/high
	...
	icon_state = "hcell"
	maxcharge = 10000
	matter = list(MATERIAL_ID_STEEL = 700, MATERIAL_ID_GLASS = 60)
...
/obj/item/cell/super
	...
	icon_state = "scell"
	maxcharge = 20000
	matter = list(MATERIAL_ID_STEEL = 700, MATERIAL_ID_GLASS = 70)
...
/obj/item/cell/hyper
	...
	icon_state = "hpcell"
	maxcharge = 30000
	matter = list(MATERIAL_ID_STEEL = 700, MATERIAL_ID_GLASS = 80)
