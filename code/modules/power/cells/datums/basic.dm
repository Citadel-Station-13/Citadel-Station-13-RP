...
POWER_CELL_GENERATE_TYPES(/datum/power_cell/basic/tier_1)
...
POWER_CELL_GENERATE_TYPES(/datum/power_cell/basic/tier_2)
...
POWER_CELL_GENERATE_TYPES(/datum/power_cell/basic/tier_3)
