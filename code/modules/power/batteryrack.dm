...
/obj/machinery/power/smes/batteryrack/attackby_legacy(var/obj/item/W as obj, var/mob/user as mob) //these can only be moved by being reconstructed, solves having to remake the powernet.
