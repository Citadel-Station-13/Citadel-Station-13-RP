...
/atom/movable/overmap_object/entity/visitable/ship
	name = "spacecraft"
...
/atom/movable/overmap_object/entity/visitable/ship/Initialize(mapload)
	. = ..()
...
/atom/movable/overmap_object/entity/visitable/ship/Destroy()
	STOP_PROCESSING(SSprocessing, src)
	SSshuttle.ships -= src
	. = ..()

/atom/movable/overmap_object/entity/visitable/ship/relaymove(mob/user, direction, accel_limit)
	accelerate(direction, accel_limit)
	operator_skill = user.get_skill_value(/datum/skill/pilot)

/atom/movable/overmap_object/entity/visitable/ship/proc/is_still()
	return !MOVING(speed[1]) && !MOVING(speed[2])

/atom/movable/overmap_object/entity/visitable/ship/get_scan_data(mob/user)
	. = ..()
...
/atom/movable/overmap_object/entity/visitable/ship/proc/get_acceleration()
...
/atom/movable/overmap_object/entity/visitable/ship/proc/get_burn_acceleration()
	return round(burn() / get_vessel_mass(), SHIP_MOVE_RESOLUTION)

/atom/movable/overmap_object/entity/visitable/ship/proc/get_vessel_mass()
	. = vessel_mass
	for(var/atom/movable/overmap_object/entity/visitable/ship/ship in src)
		. += ship.get_vessel_mass()

/atom/movable/overmap_object/entity/visitable/ship/proc/get_speed()
	return round(sqrt(speed[1] ** 2 + speed[2] ** 2), SHIP_MOVE_RESOLUTION)

// Get heading in BYOND dir bits
/atom/movable/overmap_object/entity/visitable/ship/proc/get_heading()
	var/res = 0
	if(MOVING(speed[1]))
		if(speed[1] > 0)
			res |= EAST
...
/atom/movable/overmap_object/entity/visitable/ship/proc/get_heading_degrees()
	return (arctan(speed[2], speed[1]) + 360) % 360	// Yes ATAN2(y, x) is correct to get clockwise degrees

/atom/movable/overmap_object/entity/visitable/ship/proc/adjust_speed(n_x, n_y)
...
/atom/movable/overmap_object/entity/visitable/ship/proc/get_brake_path()
	if(!get_acceleration())
		return INFINITY
	if(is_still())
		return 0
...
/atom/movable/overmap_object/entity/visitable/ship/proc/decelerate()
...
/atom/movable/overmap_object/entity/visitable/ship/proc/accelerate(direction, accel_limit)
	if(can_burn())
		last_burn = world.time
...
/atom/movable/overmap_object/entity/visitable/ship/process(delta_time)
...
/atom/movable/overmap_object/entity/visitable/ship/Moved(atom/old_loc, direction, forced = FALSE)
	. = ..()
...
/atom/movable/overmap_object/entity/visitable/ship/update_icon()
	if(!is_still())
...
/atom/movable/overmap_object/entity/visitable/ship/setDir(new_dir)
	return ..(NORTH)	// NO! We always face north.

/atom/movable/overmap_object/entity/visitable/ship/proc/burn()
...
/atom/movable/overmap_object/entity/visitable/ship/proc/halt()
	adjust_speed(-speed[1], -speed[2])
	halted = 1

/atom/movable/overmap_object/entity/visitable/ship/proc/unhalt()
	if(!SSshuttle.overmap_halted)
		halted = 0

/atom/movable/overmap_object/entity/visitable/ship/proc/get_helm_skill()	// Delete this mover operator skill to overmap obj
	return operator_skill

/atom/movable/overmap_object/entity/visitable/ship/populate_sector_objects()
	..()
...
/atom/movable/overmap_object/entity/visitable/ship/proc/get_landed_info()
	return "This ship cannot land."

/atom/movable/overmap_object/entity/visitable/ship/get_distress_info()
