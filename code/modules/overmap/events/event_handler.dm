...
/singleton/overmap_event_handler/proc/start_hazard(obj/overmap/entity/visitable/ship/ship, obj/overmap/tiled/hazard/hazard)	// Make these accept both hazards or events
...
/singleton/overmap_event_handler/proc/stop_hazard(obj/overmap/entity/visitable/ship/ship, obj/overmap/tiled/hazard/hazard)
	for(var/event_type in hazard.events)
...
/singleton/overmap_event_handler/proc/on_turf_entered(turf/new_loc, obj/overmap/entity/visitable/ship/ship, old_loc)
	if(!istype(ship))
		return
	if(new_loc == old_loc)
		return
...
/singleton/overmap_event_handler/proc/on_turf_exited(turf/old_loc, obj/overmap/entity/visitable/ship/ship, new_loc)
	if(!istype(ship))
		return
	if(new_loc == old_loc)
		return
...
/singleton/overmap_event_handler/proc/is_event_included(list/hazards, obj/overmap/tiled/hazard/E, equal_or_better)	// This proc is only used so it can break out of 2 loops cleanly
