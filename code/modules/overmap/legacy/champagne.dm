...
/obj/item/champagne/proc/create_landable_shuttle(var/shuttle_name, var/turf/start_loc, var/area/shuttle_area)
	...
	var/base_turf = SSmapping.level_base_turf(get_z(start_loc)) || /turf/simulated/floor/plating
...
//
/obj/overmap/entity/visitable/ship/landable/champagne
	desc = "Newly minted space faring vessel."

/obj/overmap/entity/visitable/ship/landable/champagne/Initialize(mapload, _name, _shuttle)
	src.name = _name
