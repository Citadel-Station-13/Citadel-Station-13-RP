...
/obj/item/champagne/proc/create_landable_shuttle(var/shuttle_name, var/turf/start_loc, var/area/shuttle_area)
	...
	var/obj/overmap/visitable/ship/landable/champagne/newship = new(start_loc, shuttle_name, shuttle_name)
...
//
/obj/overmap/visitable/ship/landable/champagne
	desc = "Newly minted space faring vessel."

/obj/overmap/visitable/ship/landable/champagne/Initialize(mapload, _name, _shuttle)
	src.name = _name
