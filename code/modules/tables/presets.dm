...
/obj/structure/table/standard/Initialize(mapload)
	material = SSmaterials.get_material(/datum/material/solid/organic/plastic)
	return ..()
...
/obj/structure/table/steel/Initialize(mapload)
	material = SSmaterials.get_material(/datum/material/solid/metal/steel)
	return ..()
...
/obj/structure/table/marble/Initialize(mapload)
	material = SSmaterials.get_material(/datum/material/solid/stone/sandstone/marble)
	return ..()
...
/obj/structure/table/reinforced/Initialize(mapload)
	material   = SSmaterials.get_material(/datum/material/solid/organic/plastic)
	reinforced = SSmaterials.get_material(/datum/material/solid/metal/steel)
	return ..()
...
/obj/structure/table/wooden_reinforced/Initialize(mapload)
	material   = SSmaterials.get_material(/datum/material/organic/wood)
	reinforced = SSmaterials.get_material(/datum/material/solid/metal/steel)
	return ..()
...
/obj/structure/table/sifwoodentable/Initialize(mapload)
	material = SSmaterials.get_material(/datum/material/organic/wood/sif)
	return ..()
...
/obj/structure/table/hardwoodtable/Initialize(mapload)
	material = SSmaterials.get_material(/datum/material/organic/wood/hardwood)
	return ..()
...
/obj/structure/table/glass/Initialize(mapload)
	material = SSmaterials.get_material(/datum/material/solid/glass)
	return ..()
...
/obj/structure/table/borosilicate/Initialize(mapload)
	material = SSmaterials.get_material(/datum/material/solid/glass/phoron)
	return ..()
...
/obj/structure/table/holotable/Initialize(mapload)
	material = SSmaterials.get_material(/datum/material/solid/organic/plastic/holographic)
	return ..()
...
/obj/structure/table/woodentable/holotable/Initialize(mapload)
	material = SSmaterials.get_material(/datum/material/organic/wood/holographic)
	return ..()
...
/obj/structure/table/bananium/Initialize(mapload)
	material = SSmaterials.get_material(/datum/material/solid/metal/bananium)
	return ..()
...
/obj/structure/table/sandstone/Initialize(mapload)
	material = SSmaterials.get_material(/datum/material/solid/stone/sandstone)
	return ..()
...
/obj/structure/table/bone/Initialize(mapload)
	material = SSmaterials.get_material(/datum/material/solid/organic/bone)
	return ..()
