...
/obj/structure/table/proc/remove_reinforced(obj/item/S, mob/user)
	reinforced = common_material_remove(user, reinforced, 40 * S.tool_speed, "reinforcements", "screws", S.usesound)

/obj/structure/table/proc/remove_material(obj/item/W, mob/user)
	material = common_material_remove(user, material, 20 * W.tool_speed, "plating", "bolts", W.usesound)
