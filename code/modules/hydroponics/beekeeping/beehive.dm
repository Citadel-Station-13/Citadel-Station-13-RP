...
/obj/machinery/beehive/attack_hand(mob/user, list/params, datum/event_args/clickchain/e_args)
	if(!closed)
		if(honeycombs < 100)
...
/obj/item/beehive_assembly/attack_self(mob/user, datum/event_args/clickchain/e_args)
	. = ..()
	if(.)
		return
