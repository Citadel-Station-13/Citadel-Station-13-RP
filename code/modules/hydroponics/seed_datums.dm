...
/datum/seed/tomato/blood/New()
	..()
	set_trait(TRAIT_YIELD,3)
	set_trait(TRAIT_PRODUCT_COLOR,COLOR_RED)
...
/datum/seed/flower/lavender/New()
	...
	set_trait(TRAIT_PRODUCT_COLOR,"#B57EDC")
	set_trait(TRAIT_PLANT_COLOR,"#6B8C5E")
...
/datum/seed/flower/rose/New()
	...
	set_trait(TRAIT_PRODUCT_COLOR,"#ce0e0e")
	set_trait(TRAIT_PLANT_COLOR,"#6B8C5E")
	set_trait(TRAIT_PLANT_ICON,"bush5")
	set_trait(TRAIT_IDEAL_LIGHT, 7)
...
/datum/seed/flower/rose/blood/New()
	...
	set_trait(TRAIT_PLANT_COLOR,"#5e0303")
...
/datum/seed/lettuce/New()
	...
	set_trait(TRAIT_PRODUCT_COLOR,"#A8D0A7")
...
/datum/seed/lettuce/ice/New()
	...
	set_trait(TRAIT_PRODUCT_COLOR,"#9ABCC9")
...
/datum/seed/wabback/New()
	...
	set_trait(TRAIT_PRODUCT_COLOR,"#E6EDFA")
	set_trait(TRAIT_PLANT_ICON,"chute")
	set_trait(TRAIT_PLANT_COLOR, "#0650ce")
...
/datum/seed/wabback/vine/New()
	..()
	set_trait(TRAIT_PRODUCT_COLOR,"#2E2F32")
...
/datum/seed/onion/New()
	...
	set_trait(TRAIT_PRODUCT_COLOR,"#E0C367")
...
/datum/seed/rhubarb/New()
	...
	set_trait(TRAIT_PRODUCT_ICON,"stalk")
	set_trait(TRAIT_PRODUCT_COLOR,"#FD5656")
	set_trait(TRAIT_PLANT_ICON,"stalk3")
...
/datum/seed/celery/New()
	...
	set_trait(TRAIT_POTENCY,8)
	set_trait(TRAIT_PRODUCT_ICON,"stalk")
	set_trait(TRAIT_PRODUCT_COLOR,"#56FD56")
	set_trait(TRAIT_PLANT_ICON,"stalk3")
...
/datum/seed/durian/New()
	...
	set_trait(TRAIT_PRODUCT_COLOR,"#757631")
	set_trait(TRAIT_PLANT_COLOR,"#87C969")
...
/datum/seed/watermelon/New()
	...
	set_trait(TRAIT_PRODUCT_COLOR,"#3D8C3A")
...
/datum/seed/pumpkin/New()
	...
	set_trait(TRAIT_PRODUCT_COLOR,"#DBAC02")
	set_trait(TRAIT_PLANT_COLOR,"#21661E")
	set_trait(TRAIT_PLANT_ICON,"vine2")
	set_trait(TRAIT_WATER_CONSUMPTION, 6)
...
/datum/seed/diona/New()
	...
	set_trait(TRAIT_PRODUCT_COLOR,"#799957")
	set_trait(TRAIT_PLANT_COLOR,"#66804B")
...
/datum/seed/thaadra/New()
	..()
	set_trait(TRAIT_PLANT_ICON,"grass")
	set_trait(TRAIT_PLANT_COLOR,"#ABC7D2")
