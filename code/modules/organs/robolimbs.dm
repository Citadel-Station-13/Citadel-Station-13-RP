...
/datum/robolimb
	...
	var/modular_bodyparts = MODULAR_BODYPART_CYBERNETIC		// Whether or not this limb allows attaching/detaching, and whether or not it checks its parent as well.
	...
	var/list/species_alternates = list(SPECIES_TAJ = "Unbranded - Tajaran", SPECIES_UNATHI = "Unbranded - Unathi", SPECIES_TESHARI = "Unbranded - Teshari")
...
/datum/robolimb/veymed
	...
	robo_brute_mod = 1.1	// Not perfect, but *nearly*
	robo_burn_mod = 1.1
	modular_bodyparts = MODULAR_BODYPART_INVALID	// Lifelike Prosthetic.
...
/datum/robolimb/wooden
	...
	modular_bodyparts = MODULAR_BODYPART_PROSTHETIC	// Literal Solid Wood
...
/datum/robolimb/vulkanwrks	// Brass Variant of Eggnerd
	...
	blood_color = "#1F2631"
	unavailable_to_build = TRUE
	modular_bodyparts = MODULAR_BODYPART_INVALID	// Clockwork is complex and too fine tuned to just rip off
