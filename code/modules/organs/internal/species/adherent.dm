...
/obj/item/organ/internal/adherent/attack_self(mob/user)
	. = ..()
	if(.)
		return
	. = ..()
...
/obj/item/organ/internal/adherent/jets/ui_action_click()
	activatej()
...
/obj/item/organ/internal/adherent/float/ui_action_click()
	hover()
...
/obj/item/organ/internal/adherent/cooling_fins/ui_action_click()
	activatecf()
