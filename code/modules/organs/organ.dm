...
/obj/item/organ/proc/can_decay()
	return config_legacy.organs_decay && !HAS_TRAIT(src, TRAIT_ORGAN_PRESERVED) && !HAS_TRAIT(src, TRAIT_ORGAN_RECURSIVELY_PRESERVED) && (!owner || !HAS_TRAIT(owner, TRAIT_PRESERVE_ALL_ORGANS)) && decays
