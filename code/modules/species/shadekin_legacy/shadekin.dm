/datum/species/shadekin_legacy
	uid = SHADEKIN_ID_SHADEKIN_LEGACY
	name = SPECIES_SHADEKIN_LEGACY
	name_plural = SPECIES_SHADEKIN_LEGACY
...
/datum/species/shadekin_legacy/New()
	..()
...
/datum/species/shadekin_legacy/get_random_name()
	return "shadekin"

/datum/species/shadekin_legacy/handle_environment_special(mob/living/carbon/human/H, datum/gas_mixture/environment, dt)
	handle_shade(H)

/datum/species/shadekin_legacy/can_breathe_water()
	return TRUE	//they dont quite breathe

/datum/species/shadekin_legacy/add_inherent_verbs(mob/living/carbon/human/H)
	..()
	add_shadekin_abilities(H)

/datum/species/shadekin_legacy/proc/add_shadekin_abilities(mob/living/carbon/human/H)
...
/datum/species/shadekin_legacy/proc/handle_shade(mob/living/carbon/human/H)
...
/datum/species/shadekin_legacy/proc/get_energy(mob/living/carbon/human/H)
...
/datum/species/shadekin_legacy/proc/get_max_energy(mob/living/carbon/human/H)
	var/obj/item/organ/internal/brain/shadekin/shade_organ = H.internal_organs_by_name[O_BRAIN]
	if(!istype(shade_organ))
		return FALSE
...
/datum/species/shadekin_legacy/proc/set_energy(mob/living/carbon/human/H, new_energy)
	var/obj/item/organ/internal/brain/shadekin/shade_organ = H.internal_organs_by_name[O_BRAIN]
	if(!istype(shade_organ))
		return
...
/datum/species/shadekin_legacy/proc/set_max_energy(mob/living/carbon/human/H, new_max_energy)
	var/obj/item/organ/internal/brain/shadekin/shade_organ = H.internal_organs_by_name[O_BRAIN]
	if(!istype(shade_organ))
		return FALSE
...
/datum/species/shadekin_legacy/proc/check_infinite_energy(mob/living/carbon/human/H)
	var/obj/item/organ/internal/brain/shadekin/shade_organ = H.internal_organs_by_name[O_BRAIN]
	if(!istype(shade_organ))
		return FALSE
...
/datum/species/shadekin_legacy/proc/update_shadekin_hud(mob/living/carbon/human/H)
	var/turf/T = get_turf(H)
