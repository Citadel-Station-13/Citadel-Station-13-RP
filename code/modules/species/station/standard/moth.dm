...
/datum/species/moth
	...
	sprite_accessory_defaults = list(
		SPRITE_ACCESSORY_SLOT_EARS = /datum/prototype/sprite_accessory/ears/bodyset/moth,
		SPRITE_ACCESSORY_SLOT_WINGS = /datum/prototype/sprite_accessory/wing/bodyset/moth,
	)
