					...
					if(!halbody)
						...
						if(possible_points.len)
							...
							switch(rand(1,10))
								...
								if(3)
									halbody = image('icons/obj/food/food.dmi',target,"bigbiteburger",TURF_LAYER)
								if(4)
									halbody = image('icons/obj/food/food.dmi',target,"meatbreadslice",TURF_LAYER)
								if(5)
									halbody = image('icons/obj/food/food.dmi',target,"sausage",TURF_LAYER)
								if(6)
									halbody = image('icons/obj/food/food.dmi',target,"bearmeat",TURF_LAYER)
								if(7)
									halbody = image('icons/obj/food/food.dmi',target,"fishfillet",TURF_LAYER)
								if(8)
									halbody = image('icons/obj/food/food.dmi',target,"meat",TURF_LAYER)
								if(9)
									halbody = image('icons/obj/food/food.dmi',target,"meatstake",TURF_LAYER)
								if(10)
									halbody = image('icons/obj/food/food.dmi',target,"monkeysdelight",TURF_LAYER)
