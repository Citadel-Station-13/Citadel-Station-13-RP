...
/obj/machinery/computer/stockexchange/ui_act(action, list/params, datum/tgui/ui, datum/tgui_embed_context/embed_context)
	if(..())
		return TRUE
...
/obj/machinery/computer/stockexchange/ui_data(mob/user, datum/tgui/ui, datum/tgui_embed_context/embed_context)
	var/list/data = list()
...
/obj/machinery/computer/stockexchange/history/ui_data(mob/user, datum/tgui/ui, datum/tgui_embed_context/embed_context)
	var/list/data = list()
	//data["var"] = var
	return data

/obj/machinery/computer/stockexchange/history/ui_act(action, list/params, datum/tgui/ui, datum/tgui_embed_context/embed_context)
	if(..())
		return
	switch(action)
		if("copypasta")
...
/obj/machinery/computer/stockexchange/archive/ui_data(mob/user, datum/tgui/ui, datum/tgui_embed_context/embed_context)
	var/list/data = list()
	//data["var"] = var
	return data

/obj/machinery/computer/stockexchange/archive/ui_act(action, list/params, datum/tgui/ui, datum/tgui_embed_context/embed_context)
	if(..())
		return
