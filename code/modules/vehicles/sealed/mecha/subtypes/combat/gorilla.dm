...
/obj/vehicle/sealed/mecha/combat/gorilla/Initialize(mapload)
	. = ..()
	var/obj/item/vehicle_component/module/ME = new /obj/item/vehicle_component/module/tesla_energy_relay(src) // This thing basically cannot function without an external power supply.
	ME.attach(src)
	ME = new /obj/item/vehicle_component/module/weapon/ballistic/cannon(src)
	ME.attach(src)
	ME = new /obj/item/vehicle_component/module/weapon/ballistic/cannon/weak(src) //Saves energy, I suppose. Anti-infantry.
	ME.attach(src)
	ME = new /obj/item/vehicle_component/module/weapon/ballistic/missile_rack/explosive(src)
	ME.attach(src)
	ME = new /obj/item/vehicle_component/module/weapon/ballistic/lmg(src)
	ME.attach(src)
	return
...
/obj/item/vehicle_component/module/weapon/ballistic/cannon
	name = "8.8cm KwK 47"
...
/obj/item/vehicle_component/module/weapon/ballistic/cannon/weak
	name = "8.8 cm KwK 36"
...
/obj/item/vehicle_component/module/weapon/ballistic/mg42
