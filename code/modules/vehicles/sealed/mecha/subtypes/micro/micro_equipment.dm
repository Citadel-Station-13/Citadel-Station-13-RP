...
/obj/item/vehicle_component/module/weapon/energy/microlaser
...
/obj/item/vehicle_component/module/weapon/energy/laser/microheavy
	w_class = WEIGHT_CLASS_BULKY
...
/obj/item/vehicle_component/module/weapon/energy/microtaser
	w_class = WEIGHT_CLASS_BULKY
...
/obj/item/vehicle_component/module/weapon/ballistic/microshotgun
	w_class = WEIGHT_CLASS_BULKY
...
/obj/item/vehicle_component/module/weapon/ballistic/microshotgun/Topic(href,href_list)
	..()
	if(href_list["mode"])
...
/obj/item/vehicle_component/module/weapon/ballistic/microshotgun/get_equip_info()
	return "[..()] \[<a href='?src=\ref[src];mode=0'>BS</a>|<a href='?src=\ref[src];mode=1'>BB</a>|<a href='?src=\ref[src];mode=2'>S</a>\]"


/obj/item/vehicle_component/module/weapon/ballistic/missile_rack/grenade/microflashbang
	w_class = WEIGHT_CLASS_BULKY
...
/obj/item/vehicle_component/module/tool/drill/micro
	w_class = WEIGHT_CLASS_BULKY
	name = "drill"
...
/obj/item/vehicle_component/module/tool/drill/micro/action(atom/target)
			...
			if(istype(target, /turf/simulated/wall))
				...
				for(var/turf/simulated/mineral/M in range(chassis,1))
					if(get_dir(chassis,M)&chassis.dir)
						M.GetDrilled()
				log_message("Drilled through [target]")
				var/obj/item/vehicle_component/module/tool/micro/orescoop/ore_box = (locate(/obj/item/vehicle_component/module/tool/micro/orescoop) in chassis.equipment)
				if(ore_box)
...
/obj/item/vehicle_component/module/tool/micro/orescoop
	w_class = WEIGHT_CLASS_BULKY
...
/obj/item/vehicle_component/module/tool/micro/orescoop/action(atom/target)
	if(!action_checks(target))
		return
	set_ready_state(0)
	chassis.use_power(energy_drain)
...
/obj/item/vehicle_component/module/tool/micro/orescoop/Topic(href,href_list)
	..()
...
/obj/item/vehicle_component/module/tool/micro/orescoop/get_equip_info()
	return "[..()] <br /><a href='?src=\ref[src];empty_box=1'>Empty ore compartment</a>"

/obj/item/vehicle_component/module/tool/orescoop/verb/empty_box() //so you can still get the ore out if someone detaches it from the mech
