...
/obj/item/vehicle_component/integral
...
/obj/item/vehicle_component/integral/examine(mob/user, dist)
	. = ..()
...
/obj/item/vehicle_component/integral/Initialize(mapload)
	. = ..()
...
/obj/item/vehicle_component/integral/Destroy()
	detach()
	return ..()

// Damage code.

/obj/item/vehicle_component/integral/emp_act(var/severity = 4)
...
/obj/item/vehicle_component/integral/proc/adjust_integrity_mecha(var/amt = 0)
	integrity = clamp(integrity + amt, 0, integrity_max)
	return

/obj/item/vehicle_component/integral/proc/damage_part(var/dam_amt = 0, var/type = DAMAGE_TYPE_BRUTE)
	if(dam_amt <= 0)
		return FALSE
...
/obj/item/vehicle_component/integral/proc/get_efficiency()
...
/obj/item/vehicle_component/integral/proc/attach(var/obj/vehicle/sealed/mecha/target, var/mob/living/user)
	if(target)
...
/obj/item/vehicle_component/integral/proc/detach()
	if(chassis)
...
/obj/item/vehicle_component/integral/attackby(obj/item/W as obj, mob/user as mob)
...
/obj/item/vehicle_component/integral/proc/get_step_delay()
	return step_delay

/obj/item/vehicle_component/integral/proc/handle_move()
	return
