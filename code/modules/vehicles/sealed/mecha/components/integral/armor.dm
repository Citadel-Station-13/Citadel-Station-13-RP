...
/obj/item/vehicle_component/integral/armor/mining
...
/obj/item/vehicle_component/integral/armor/reinforced
...
/obj/item/vehicle_component/integral/armor/military/attach(var/obj/vehicle/sealed/mecha/target, var/mob/living/user)
	. = ..()
	if(.)
		var/typepass = FALSE
...
/obj/item/vehicle_component/integral/armor/marshal/attach(var/obj/vehicle/sealed/mecha/target, var/mob/living/user)
	. = ..()
	if(.)
		var/typepass = FALSE
		for(var/type in required_type)
...
/obj/item/vehicle_component/integral/armor/marshal/reinforced
...
/obj/item/vehicle_component/integral/armor/military/marauder
...
/obj/item/vehicle_component/integral/armor/military/marauder/attach(var/obj/vehicle/sealed/mecha/target, var/mob/living/user)
	. = ..()
	if(.)
		var/typepass = FALSE
		for(var/type in required_type)
...
/obj/item/vehicle_component/integral/armor/alien/attach(var/obj/vehicle/sealed/mecha/target, var/mob/living/user)
	. = ..()
	if(.)
