...
/obj/item/vehicle_component/module/hardpoint_actuator
...
/obj/item/vehicle_component/module/hardpoint_actuator/action(atom/target)
	if(!action_checks(target))
		return

	if(istype(target,/obj/item/vehicle_component/module))
		var/obj/item/vehicle_component/module/ME = target
