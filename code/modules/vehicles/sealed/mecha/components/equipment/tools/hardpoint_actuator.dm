...
/obj/item/vehicle_component/equipment/hardpoint_actuator
...
/obj/item/vehicle_component/equipment/hardpoint_actuator/action(atom/target)
	if(!action_checks(target))
		return

	if(istype(target,/obj/item/vehicle_component/equipment))
		var/obj/item/vehicle_component/equipment/ME = target
