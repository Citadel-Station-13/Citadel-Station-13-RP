...
/obj/item/vehicle_component/equipment/weapon/whisperblade/action(atom/target)
...
/*
/obj/item/vehicle_component/equipment/weapon/whisperblade/proc/slice_mob(mob/living/target, mob/user)
...
/obj/item/vehicle_component/equipment/weapon/infernoblade/action(atom/target)
	if(!action_checks(target)) return
...
/obj/item/vehicle_component/equipment/combat_shield/reticent/add_equip_overlay(obj/vehicle/sealed/mecha/M)
	if(!drone_overlay)
