/obj/item/vehicle_component/module/weapon
	name = "mecha weapon"
	range = RANGED
...
/obj/item/vehicle_component/module/weapon/action_checks(atom/target)
	if(projectiles <= 0)
		return 0
	return ..()

/obj/item/vehicle_component/module/weapon/action(atom/target, params)
...
/obj/item/vehicle_component/module/weapon/proc/Fire(atom/A, atom/target, params)
...
/obj/item/vehicle_component/module/weapon/proc/process_accuracy(obj/projectile, mob/living/user, atom/target)
