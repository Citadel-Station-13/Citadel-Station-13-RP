...
/obj/item/mecha_parts/component/armor/military/attach(var/obj/vehicle/sealed/mecha/target, var/mob/living/user)
	. = ..()
	if(.)
		var/typepass = FALSE
...
/obj/item/mecha_parts/component/armor/marshal/attach(var/obj/vehicle/sealed/mecha/target, var/mob/living/user)
	. = ..()
	if(.)
		var/typepass = FALSE
		for(var/type in required_type)
...
/obj/item/mecha_parts/component/armor/military/marauder/attach(var/obj/vehicle/sealed/mecha/target, var/mob/living/user)
	. = ..()
	if(.)
		var/typepass = FALSE
		for(var/type in required_type)
...
/obj/item/mecha_parts/component/armor/alien/attach(var/obj/vehicle/sealed/mecha/target, var/mob/living/user)
	. = ..()
	if(.)
