...
/obj/vehicle/sealed/mecha/Destroy()
	...
	if(wreckage)
		...
		for(var/slot in internal_components)
			var/obj/item/vehicle_component/integral/C = internal_components[slot]
			if(istype(C))
...
/obj/vehicle/sealed/mecha/proc/create_components()
	for(var/path in starting_components)
		var/obj/item/vehicle_component/integral/C = new path(src)
		C.attach(src)
...
/obj/vehicle/sealed/mecha/examine(mob/user, dist)
	...
	var/obj/item/vehicle_component/integral/armor/AC = internal_components[MECH_ARMOR]

	var/obj/item/vehicle_component/integral/hull/HC = internal_components[MECH_HULL]
...
/obj/vehicle/sealed/mecha/proc/get_step_delay()
	...
	var/obj/item/vehicle_component/integral/actuator/actuator = internal_components[MECH_ACTUATOR]
...
/obj/vehicle/sealed/mecha/proc/components_handle_damage(var/damage, var/type = DAMAGE_TYPE_BRUTE)
	...
	for(var/obj/item/vehicle_component/integral/C in (internal_components - list(MECH_HULL, MECH_ARMOR)))
...
/obj/vehicle/sealed/mecha/attack_hand(mob/user, datum/event_args/actor/clickchain/e_args)
	...
	var/obj/item/vehicle_component/integral/armor/ArmC = internal_components[MECH_ARMOR]
...
/obj/vehicle/sealed/mecha/attackby(obj/item/W as obj, mob/user as mob)
	...
	if(istype(W, /obj/item/vehicle_component/integral) && state == MECHA_CELL_OUT)
		var/obj/item/vehicle_component/integral/MC = W
		if(MC.attach(src))
	...
	if(istype(W, /obj/item/card/id)||istype(W, /obj/item/pda))
		...
		if(state==MECHA_PANEL_LOOSE)
			...
			for(var/slot in internal_components)
				var/obj/item/vehicle_component/integral/MC = internal_components[slot]
				if(istype(MC))
			...
			var/obj/item/vehicle_component/integral/RmC = removable_components[remove]
			RmC.detach()
...
/obj/vehicle/sealed/mecha/return_air()
	...
	var/obj/item/vehicle_component/integral/gas/GC = internal_components[MECH_GAS]
...
/obj/vehicle/sealed/mecha/proc/dynusepower(amount)
	update_cell_alerts()
	var/obj/item/vehicle_component/integral/electrical/EC = internal_components[MECH_ELECTRIC]
