/obj/item/vehicle_module/lazy/legacy/simple_generator
...
/obj/item/vehicle_module/lazy/legacy/simple_generator/Initialize(mapload)
	. = ..()
	init()

/obj/item/vehicle_module/lazy/legacy/simple_generator/Destroy()
	STOP_PROCESSING(SSobj, src)
	return ..()

/obj/item/vehicle_module/lazy/legacy/simple_generator/proc/init()
	fuel = new /obj/item/stack/material/phoron(src)
	fuel.amount = 0
	pr_mech_generator = new /datum/global_iterator/mecha_generator(list(src),0)
	pr_mech_generator.set_delay(equip_cooldown)

/obj/item/vehicle_module/lazy/legacy/simple_generator/on_uninstall(obj/vehicle/vehicle, datum/event_args/actor/actor, silent)
	..()
	deactivate()

/obj/item/vehicle_module/lazy/legacy/simple_generator/proc/activate()
	if(active)
		return
	active = TRUE
	START_PROCESSING(SSobj, src)

/obj/item/vehicle_module/lazy/legacy/simple_generator/proc/deactivate()
	if(!active)
		return
	active = FALSE
	STOP_PROCESSING(SSobj, src)

/obj/item/vehicle_module/lazy/legacy/simple_generator/Topic(href, href_list)
	..()
	if(href_list["toggle"])
...
/obj/item/vehicle_module/lazy/legacy/simple_generator/action(target)
	if(chassis)
...
/obj/item/vehicle_module/lazy/legacy/simple_generator/proc/load_fuel(var/obj/item/stack/material/P)
...
/obj/item/vehicle_module/lazy/legacy/simple_generator/attackby(weapon,mob/user)
...
/obj/item/vehicle_module/lazy/legacy/simple_generator/critfail()
	..()
...
/datum/global_iterator/mecha_generator/process(var/obj/item/vehicle_module/lazy/legacy/simple_generator/EG)
	if(!EG.chassis)
		stop()
...
/obj/item/vehicle_module/lazy/legacy/simple_generator/nuclear/init()
...
/obj/item/vehicle_module/lazy/legacy/simple_generator/nuclear/critfail()
	return

/datum/global_iterator/mecha_generator/nuclear

/datum/global_iterator/mecha_generator/nuclear/process(var/obj/item/vehicle_module/lazy/legacy/simple_generator/nuclear/EG)
	if(..())
