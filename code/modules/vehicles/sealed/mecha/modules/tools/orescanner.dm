...
/obj/item/vehicle_module/lazy/legacy/tool/orescanner/Initialize(mapload)
	my_scanner = new(src)
	return ..()

/obj/item/vehicle_module/lazy/legacy/tool/orescanner/Destroy()
	QDEL_NULL(my_scanner)
	return ..()

/obj/item/vehicle_module/lazy/legacy/tool/orescanner/action(var/atom/target)
...
/obj/item/vehicle_module/lazy/legacy/tool/orescanner/advanced
