...
/obj/item/vehicle_module/legacy/cloak/proc/start_cloak()
	if(chassis)
		chassis.cloak()
...
T
/obj/item/vehicle_module/legacy/cloak/proc/stop_cloak()
	if(chassis)
		chassis.uncloak()
...
/datum/global_iterator/mecha_cloak/process(var/obj/item/vehicle_module/legacy/cloak/cloak)
