...
/obj/item/vehicle_module/legacy/tesla_energy_relay/Initialize(mapload)
	. = ..()
	pr_energy_relay = new /datum/global_iterator/mecha_energy_relay(list(src),0)
	pr_energy_relay.set_delay(equip_cooldown)
	return

/obj/item/vehicle_module/legacy/tesla_energy_relay/Destroy()
	qdel(pr_energy_relay)
	pr_energy_relay = null
	return ..()

/obj/item/vehicle_module/legacy/tesla_energy_relay/detach()
...
/obj/item/vehicle_module/legacy/tesla_energy_relay/attach(obj/vehicle/sealed/mecha/M)
	..()
	chassis.proc_res["dyngetcharge"] = src
//	chassis.proc_res["dynusepower"] = src
	return

/obj/item/vehicle_module/legacy/tesla_energy_relay/can_attach(obj/vehicle/sealed/mecha/M)
	if(..())
		if(!M.proc_res["dyngetcharge"])// && !M.proc_res["dynusepower"])
			return 1
	return 0

/obj/item/vehicle_module/legacy/tesla_energy_relay/proc/dyngetcharge()
...
/obj/item/vehicle_module/legacy/tesla_energy_relay/proc/get_power_channel(var/area/A)
	var/pow_chan
	if(A)
...
/obj/item/vehicle_module/legacy/tesla_energy_relay/Topic(href, href_list)
	..()
...
/obj/item/vehicle_module/legacy/tesla_energy_relay/get_equip_info()
	if(!chassis) return
...
/datum/global_iterator/mecha_energy_relay/process(var/obj/item/vehicle_module/legacy/tesla_energy_relay/ER)
