...
/obj/item/vehicle_module/legacy/gravcatapult/action(atom/movable/target)
...
/obj/item/vehicle_module/legacy/gravcatapult/get_equip_info()
	return "[..()] [mode==1?"([locked||"Nothing"])":null] \[<a href='?src=\ref[src];mode=1'>S</a>|<a href='?src=\ref[src];mode=2'>P</a>\]"

/obj/item/vehicle_module/legacy/gravcatapult/Topic(href, href_list)
	..()
	if(href_list["mode"])
