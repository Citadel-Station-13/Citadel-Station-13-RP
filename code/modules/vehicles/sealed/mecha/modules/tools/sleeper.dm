...
/obj/item/vehicle_module/lazy/legacy/tool/sleeper/Initialize(mapload)
	. = ..()
...
/obj/item/vehicle_module/lazy/legacy/tool/sleeper/nano_ui_interact(var/mob/user, var/ui_key = "main", var/datum/nanoui/ui = null, var/force_open = 1, var/datum/topic_state/state = outside_state)
	...
	var/obj/item/vehicle_module/lazy/legacy/tool/syringe_gun/SG = locate(/obj/item/vehicle_module/lazy/legacy/tool/syringe_gun) in chassis
	if(SG)
...
/obj/item/vehicle_module/lazy/legacy/tool/sleeper/proc/inject_chemical(chemical, amount)
...
/obj/item/vehicle_module/lazy/legacy/tool/sleeper/proc/toggle_filter()
	if(!occupant_legacy)
		filtering = 0
		return
	filtering = !filtering

/obj/item/vehicle_module/lazy/legacy/tool/sleeper/proc/toggle_pump()
	if(!occupant_legacy)
		pumping = 0
		return
	pumping = !pumping
