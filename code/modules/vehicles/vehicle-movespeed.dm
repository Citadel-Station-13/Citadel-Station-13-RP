...
//* For now, vehicles use mob movespeed. This is because vehicles *//
//* will be converted into /mob vehicls sooner or later.          *//

/**
 * Updates our base move delay
 */
/obj/vehicle/proc/update_movespeed_base()
 ...
 */
/obj/vehicle/proc/add_movespeed_modifier(datum/movespeed_modifier/modifier, skip_update)
 ...
 * @return TRUE / FALSE on success / failure
 */
/obj/vehicle/proc/remove_movespeed_modifier(datum/movespeed_modifier/modifier, skip_update)
 ...
 * @return TRUE / FALSE on success / failure
 */
/obj/vehicle/proc/update_movespeed_modifier(datum/movespeed_modifier/modifier, list/params, skip_update)
 ...
 * @return TRUE / FALSE
 */
/obj/vehicle/proc/has_movespeed_modifier(datum/movespeed_modifier/modifier)
	var/key = istext(modifier) ? modifier : modifier.id
...
/obj/vehicle/proc/update_movespeed()
	. = 0
