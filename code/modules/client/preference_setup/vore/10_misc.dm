...
/datum/category_item/player_setup_item/vore/misc/load_character(var/savefile/S)
	from_file(S["show_in_directory"], pref.show_in_directory)
	from_file(S["directory_tag"],     pref.directory_tag)
	from_file(S["directory_erptag"],  pref.directory_erptag)
	from_file(S["directory_ad"],      pref.directory_ad)
	from_file(S["sensorpref"],        pref.sensorpref)

/datum/category_item/player_setup_item/vore/misc/save_character(var/savefile/S)
	to_file(S["show_in_directory"], pref.show_in_directory)
	to_file(S["directory_tag"],     pref.directory_tag)
	to_file(S["directory_erptag"],  pref.directory_erptag)
	to_file(S["directory_ad"],      pref.directory_ad)
	to_file(S["sensorpref"],        pref.sensorpref)
...
/datum/category_item/player_setup_item/vore/misc/OnTopic(var/href, var/list/href_list, var/mob/user)
	if(href_list["toggle_show_in_directory"])
		pref.show_in_directory = pref.show_in_directory ? FALSE : TRUE;
