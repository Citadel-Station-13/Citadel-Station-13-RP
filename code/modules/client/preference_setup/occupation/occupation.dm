...
/datum/category_item/player_setup_item/occupation/sanitize_character()
	...
	pref.job_civilian_high	= sanitize_integer(pref.job_civilian_high, 0, ALL, initial(pref.job_civilian_high)) //I'm not sorry, Kevin made me do this - Papalus
	pref.job_civilian_med	= sanitize_integer(pref.job_civilian_med, 0, ALL, initial(pref.job_civilian_med))
	pref.job_civilian_low	= sanitize_integer(pref.job_civilian_low, 0, ALL, initial(pref.job_civilian_low))
	pref.job_medsci_high	= sanitize_integer(pref.job_medsci_high, 0, ALL, initial(pref.job_medsci_high))
	pref.job_medsci_med		= sanitize_integer(pref.job_medsci_med, 0, ALL, initial(pref.job_medsci_med))
	pref.job_medsci_low		= sanitize_integer(pref.job_medsci_low, 0, ALL, initial(pref.job_medsci_low))
	pref.job_engsec_high	= sanitize_integer(pref.job_engsec_high, 0, ALL, initial(pref.job_engsec_high))
	pref.job_engsec_med 	= sanitize_integer(pref.job_engsec_med, 0, ALL, initial(pref.job_engsec_med))
	pref.job_engsec_low 	= sanitize_integer(pref.job_engsec_low, 0, ALL, initial(pref.job_engsec_low))
	pref.job_talon_high		= sanitize_integer(pref.job_talon_high, 0, ALL, initial(pref.job_talon_high))
	pref.job_talon_med 		= sanitize_integer(pref.job_talon_med, 0, ALL, initial(pref.job_talon_med))
	pref.job_talon_low 		= sanitize_integer(pref.job_talon_low, 0, ALL, initial(pref.job_talon_low))
