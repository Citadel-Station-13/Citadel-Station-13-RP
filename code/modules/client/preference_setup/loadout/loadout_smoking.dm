...
/datum/gear/pipe/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(tim_sort(pipes, GLOBAL_PROC_REF(cmp_text_asc)))
...
/datum/gear/lighter/zippo/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(tim_sort(zippos, GLOBAL_PROC_REF(cmp_text_asc)))
...
/datum/gear/cigarettes/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(tim_sort(cigarettes, GLOBAL_PROC_REF(cmp_text_asc)))
