...
/datum/gear/plushie/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(tim_sort(plushies, GLOBAL_PROC_REF(cmp_text_asc)))
...
/datum/gear/lunchbox/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(tim_sort(lunchboxes, GLOBAL_PROC_REF(cmp_text_asc)))
...
/datum/gear/tennis_ball/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(tim_sort(tennis_balls, GLOBAL_PROC_REF(cmp_text_asc)))
