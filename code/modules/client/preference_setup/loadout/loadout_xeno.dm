...
/datum/gear/xeno/promethean/uniform/cohesion_suit/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(tim_sort(cohesionsuits, GLOBAL_PROC_REF(cmp_text_asc)))
...
/datum/gear/xeno/phoronoid/accessories/suit_accessories/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(tim_sort(plasaccessories, GLOBAL_PROC_REF(cmp_text_asc)))
...
/datum/gear/xeno/skrell/chains/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(tim_sort(chaintypes, GLOBAL_PROC_REF(cmp_text_asc)))
...
/datum/gear/xeno/skrell/bands/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(tim_sort(bandtypes, GLOBAL_PROC_REF(cmp_text_asc)))
...
/datum/gear/xeno/skrell/cloth/short/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(tim_sort(shorttypes, GLOBAL_PROC_REF(cmp_text_asc)))
...
/datum/gear/xeno/skrell/cloth/long/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(tim_sort(longtypes, GLOBAL_PROC_REF(cmp_text_asc)))
...
/datum/gear/xeno/teshari/uniform/smock_selection/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(tim_sort(smocks, GLOBAL_PROC_REF(cmp_text_asc)))
...
/datum/gear/xeno/teshari/uniform/standard_undercoat_selection/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(tim_sort(undercoats, GLOBAL_PROC_REF(cmp_text_asc)))
...
/datum/gear/xeno/teshari/uniform/dress_smock_selection/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(tim_sort(dresssmocks, GLOBAL_PROC_REF(cmp_text_asc)))
...
/datum/gear/xeno/teshari/suit/standard_cloak_selection/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(tim_sort(cloaks, GLOBAL_PROC_REF(cmp_text_asc)))
...
/datum/gear/xeno/uniform/puffy_pants/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(tim_sort(puffy_pants, GLOBAL_PROC_REF(cmp_text_asc)))
...
/datum/gear/xeno/uniform/tight_pants/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(tim_sort(tight_pants, GLOBAL_PROC_REF(cmp_text_asc)))
...
/datum/gear/xeno/uniform/moth_skirt/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(tim_sort(moth_skirt, GLOBAL_PROC_REF(cmp_text_asc)))
...
/datum/gear/xeno/accessories/abdomen_guard/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(tim_sort(abdomen_guard, GLOBAL_PROC_REF(cmp_text_asc)))
...
/datum/gear/xeno/accessories/tunic_top/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(tim_sort(tunic_top, GLOBAL_PROC_REF(cmp_text_asc)))
...
/datum/gear/xeno/accessories/cloth_strap_top/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(tim_sort(cloth_strap_top, GLOBAL_PROC_REF(cmp_text_asc)))
...
/datum/gear/xeno/accessories/shoulder_pad_right/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(tim_sort(shoulder_pad_right, GLOBAL_PROC_REF(cmp_text_asc)))
...
/datum/gear/xeno/accessories/shoulder_pad_left/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(tim_sort(shoulder_pad_left, GLOBAL_PROC_REF(cmp_text_asc)))
...
/datum/gear/xeno/accessories/front_tunic/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(tim_sort(front_tunic, GLOBAL_PROC_REF(cmp_text_asc)))
...
/datum/gear/xeno/accessories/gaiter/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(tim_sort(gaiter, GLOBAL_PROC_REF(cmp_text_asc)))
...
/datum/gear/xeno/shoes/legwrap/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(tim_sort(legwrap, GLOBAL_PROC_REF(cmp_text_asc)))
