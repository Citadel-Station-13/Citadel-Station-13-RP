...
/obj/machinery/computer/telescience/examine(mob/user, dist)
	. = ..()
...
/obj/machinery/computer/telescience/attack_hand(mob/user, list/params, datum/event_args/clickchain/e_args)
	if(..())
		return
