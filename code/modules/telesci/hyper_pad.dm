...
/obj/machinery/hyperpad/centre/attack_hand(mob/user, list/params, datum/event_args/clickchain/e_args)
	. = ..()
	if(.)
		return
	detect(user)
...
/obj/machinery/hyperpad/attack_hand(mob/user, list/params, datum/event_args/clickchain/e_args)
	. = ..()
	if(primary)
