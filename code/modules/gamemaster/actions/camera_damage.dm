...
/datum/gm_action/camera_damage/proc/acquire_random_camera(remaining_attempts = 5)
...
/datum/gm_action/camera_damage/proc/is_valid_camera(obj/machinery/camera/C)
