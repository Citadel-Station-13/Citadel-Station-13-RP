...
/datum/chemical_reaction/slime/grey_new_slime/on_reaction(datum/reagents/holder)
...
/datum/chemical_reaction/slime/grey_monkey/on_reaction(datum/reagents/holder)
	for(var/i = 1 to 4)
...
/datum/chemical_reaction/slime/metal_materials_basic/on_reaction(datum/reagents/holder)
	for(var/i = 1 to 3)
...
/datum/chemical_reaction/slime/metal_materials_adv/on_reaction(datum/reagents/holder)
	for(var/i = 1 to 2)
...
/datum/chemical_reaction/slime/metal_materials_weird/on_reaction(datum/reagents/holder)
	for(var/i = 1 to 3)
...
/datum/chemical_reaction/slime/metal_materials_steel/on_reaction(datum/reagents/holder)
...
/datum/chemical_reaction/slime/blue_stability/on_reaction(datum/reagents/holder)
...
/datum/chemical_reaction/slime/blue_calm/on_reaction(datum/reagents/holder)
...
/datum/chemical_reaction/slime/purple_steroid/on_reaction(datum/reagents/holder)
...
/datum/chemical_reaction/slime/purple_infertility/on_reaction(datum/reagents/holder)
...
/datum/chemical_reaction/slime/purple_shrink/on_reaction(datum/reagents/holder)
...
/datum/chemical_reaction/slime/purple_fertility/on_reaction(datum/reagents/holder)
...
/datum/chemical_reaction/slime/orange_fire/on_reaction(datum/reagents/holder)
...
/datum/chemical_reaction/slime/orange_heatwave/on_reaction(datum/reagents/holder)
	var/turf/simulated/T = get_turf(holder.my_atom)
...
/datum/chemical_reaction/slime/orange_smoke/on_reaction(datum/reagents/holder)
...
/datum/chemical_reaction/slime/yellow_lightning/on_reaction(datum/reagents/holder)
...
/datum/chemical_reaction/slime/yellow_flashlight/on_reaction(datum/reagents/holder)
...
/datum/chemical_reaction/slime/yellow_emp/on_reaction(datum/reagents/holder)
...
/datum/chemical_reaction/slime/yellow_battery/on_reaction(datum/reagents/holder)
...
/datum/chemical_reaction/slime/gold_random_mobs/on_reaction(datum/reagents/holder)
...
/datum/chemical_reaction/slime/gold_hostile_mob/on_reaction(datum/reagents/holder)
...
/datum/chemical_reaction/slime/gold_safe_mob/on_reaction(datum/reagents/holder)
	var/type_to_spawn
...
/datum/chemical_reaction/slime/gold_materials_gold/on_reaction(datum/reagents/holder)
...
/datum/chemical_reaction/slime/silver_materials_basic/on_reaction(datum/reagents/holder)
	for(var/i = 1 to 2)
...
/datum/chemical_reaction/slime/silver_materials_adv/on_reaction(datum/reagents/holder)
...
/datum/chemical_reaction/slime/silver_materials_random/on_reaction(datum/reagents/holder)
	var/type_to_spawn
	var/amount = 5
...
/datum/chemical_reaction/slime/silver_materials_silver/on_reaction(datum/reagents/holder)
...
/datum/chemical_reaction/slime/dark_blue_cold_snap/on_reaction(datum/reagents/holder)
	var/turf/simulated/T = get_turf(holder.my_atom)
	if(!T) // Nullspace lacks zones.
		return
...
/datum/chemical_reaction/slime/dark_blue_temp_resist/on_reaction(datum/reagents/holder)
...
/datum/chemical_reaction/slime/dark_blue_death/on_reaction(datum/reagents/holder)
...
/datum/chemical_reaction/slime/red_mutation/on_reaction(datum/reagents/holder)
...
/datum/chemical_reaction/slime/red_enrage/on_reaction(datum/reagents/holder)
	for(var/mob/living/simple_mob/slime/S in view(get_turf(holder.my_atom)))
		if(S.stat)
			continue
...
/datum/chemical_reaction/slime/red_ferality/on_reaction(datum/reagents/holder)
...
/datum/chemical_reaction/slime/green_radpulse/on_reaction(datum/reagents/holder)
...
/datum/chemical_reaction/slime/green_emitter/on_reaction(datum/reagents/holder)
...
/datum/chemical_reaction/slime/green_uranium/on_reaction(datum/reagents/holder)
...
/datum/chemical_reaction/slime/pink_heal_pulse/on_reaction(datum/reagents/holder)
...
/datum/chemical_reaction/slime/oil_fakesplosion/on_reaction(datum/reagents/holder)
	playsound(get_turf(holder.my_atom), 'sound/effects/phasein.ogg', 75, 1)
...
/datum/chemical_reaction/slime/oil_explosion/on_reaction(datum/reagents/holder)
	..()
...
/datum/chemical_reaction/slime/bluespace_crystals/on_reaction(datum/reagents/holder)
	for(var/i = 1 to 5)
...
/datum/chemical_reaction/slime/bluespace_pouch/on_reaction(datum/reagents/holder)
...
/datum/chemical_reaction/slime/bluespace_chaotic_tele/on_reaction(datum/reagents/holder)
...
/datum/chemical_reaction/slime/bluespace_teleporter/on_reaction(datum/reagents/holder)
...
/datum/chemical_reaction/slime/cerulean_enhancer/on_reaction(datum/reagents/holder)
...
/datum/chemical_reaction/slime/cerulean_reinvigoration/on_reaction(datum/reagents/holder)
...
/datum/chemical_reaction/slime/cerulean_potion_mimic/on_reaction(datum/reagents/holder)
...
/datum/chemical_reaction/slime/cerulean_random_potion/on_reaction(datum/reagents/holder)
...
/datum/chemical_reaction/slime/amber_slimefood/on_reaction(datum/reagents/holder)
...
/datum/chemical_reaction/slime/amber_random_food/on_reaction(datum/reagents/holder)
...
/datum/chemical_reaction/slime/amber_snack/on_reaction(datum/reagents/holder)
...
/datum/chemical_reaction/slime/sapphire_promethean/on_reaction(datum/reagents/holder)
...
/datum/chemical_reaction/slime/sapphire_plushies/on_reaction(datum/reagents/holder)
	var/spawn_type
...
/datum/chemical_reaction/slime/sapphire_sapience/on_reaction(datum/reagents/holder)
...
/datum/chemical_reaction/slime/ruby_swole/on_reaction(datum/reagents/holder)
	for(var/mob/living/L in range(1, holder.my_atom))
...
/datum/chemical_reaction/slime/ruby_pull/on_reaction(datum/reagents/holder)
	var/location = get_turf(holder.my_atom)
...
/datum/chemical_reaction/slime/ruby_push/on_reaction(datum/reagents/holder)
	var/location = get_turf(holder.my_atom)
...
/datum/chemical_reaction/slime/emerald_agility/on_reaction(datum/reagents/holder)
	for(var/mob/living/L in range(1, holder.my_atom))
...
/datum/chemical_reaction/slime/emerald_speed/on_reaction(datum/reagents/holder)
	for(var/mob/living/L in range(1, holder.my_atom))
...
/datum/chemical_reaction/slime/emerald_hell/on_reaction(datum/reagents/holder)
...
/datum/chemical_reaction/slime/light_pink_friendship/on_reaction(datum/reagents/holder)
...
/datum/chemical_reaction/slime/light_pink_loyalty/on_reaction(datum/reagents/holder)
...
/datum/chemical_reaction/slime/light_pink_docility/on_reaction(datum/reagents/holder)
...
/datum/chemical_reaction/slime/light_pink_obedience/on_reaction(datum/reagents/holder)
...
/datum/chemical_reaction/slime/rainbow_random_slime/on_reaction(datum/reagents/holder)
...
/datum/chemical_reaction/slime/rainbow_random_extract/on_reaction(datum/reagents/holder)
...
/datum/chemical_reaction/slime/rainbow_colors/on_reaction(datum/reagents/holder)
...
/datum/chemical_reaction/slime/rainbow_unity/on_reaction(datum/reagents/holder)
