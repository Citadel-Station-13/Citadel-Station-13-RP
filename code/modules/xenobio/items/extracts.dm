...
/datum/chemical_reaction/instant/slime
	var/required = null

/datum/chemical_reaction/instant/slime/can_happen(var/datum/reagents/holder)
...
/datum/chemical_reaction/instant/slime/on_reaction(var/datum/reagents/holder)
	var/obj/item/slime_extract/T = holder.my_atom
	T.uses--
	if(T.uses <= 0)
...
/datum/chemical_reaction/instant/slime/grey_new_slime
	name = "Slime Spawn"
	id = "m_spawn"
	result = null
...
/datum/chemical_reaction/instant/slime/grey_new_slime/on_reaction(var/datum/reagents/holder)
...
/datum/chemical_reaction/instant/slime/grey_monkey
	name = "Slime Monkey"
	id = "m_monkey"
	result = null
...
/datum/chemical_reaction/instant/slime/grey_monkey/on_reaction(var/datum/reagents/holder)
	for(var/i = 1 to 4)
		new /obj/item/reagent_containers/food/snacks/monkeycube(get_turf(holder.my_atom))
	..()

/datum/chemical_reaction/instant/slime/grey_slimejelly
	name = "Slime Jelly"
	id = "m_jelly"
	result = "slimejelly"
...
/datum/chemical_reaction/instant/slime/metal_metamorphic
	name = "Slime Metal"
	id = "m_metal"
	required_reagents = list("phoron" = 5)
	result = "metamorphic"
...
/datum/chemical_reaction/instant/metamorphic
...
/datum/chemical_reaction/instant/metamorphic/iron
...
/datum/chemical_reaction/instant/metamorphic/silver
...
/datum/chemical_reaction/instant/metamorphic/gold
...
/datum/chemical_reaction/instant/metamorphic/platinum
...
/datum/chemical_reaction/instant/metamorphic/uranium
...
/datum/chemical_reaction/instant/metamorphic/phoron
...
/datum/chemical_reaction/instant/slime/metal_binding
	name = "Slime Binding"
	id = "m_binding"
...
/datum/chemical_reaction/instant/binding
...
/datum/chemical_reaction/instant/binding/plasteel // Two parts 'steel', one part platnium matches the smelter alloy recipe.
...
/datum/chemical_reaction/instant/slime/blue_frostoil
...
/datum/chemical_reaction/instant/slime/blue_stability
...
/datum/chemical_reaction/instant/slime/blue_stability/on_reaction(var/datum/reagents/holder)
...
/datum/chemical_reaction/instant/slime/purple_steroid
	name = "Slime Steroid"
	id = "m_steroid"
	required_reagents = list("phoron" = 5)
	result_amount = 1
...
/datum/chemical_reaction/instant/slime/purple_steroid/on_reaction(var/datum/reagents/holder)
...
/datum/chemical_reaction/instant/slime/orange_fire
	name = "Slime Fire"
	id = "m_fire"
	required_reagents = list("phoron" = 5)
	result_amount = 1
...
/datum/chemical_reaction/instant/slime/orange_fire/on_reaction(var/datum/reagents/holder)
...
/datum/chemical_reaction/instant/slime/yellow_emp
	name = "Slime EMP"
	id = "m_emp"
	required_reagents = list("water" = 5)
	result_amount = 1
...
/datum/chemical_reaction/instant/slime/yellow_emp/on_reaction(var/datum/reagents/holder)
...
/datum/chemical_reaction/instant/slime/yellow_battery
	name = "Slime Cell"
	id = "m_cell"
	required_reagents = list("phoron" = 5)
	result_amount = 1
...
/datum/chemical_reaction/instant/slime/yellow_battery/on_reaction(var/datum/reagents/holder)
	new /obj/item/cell/slime(get_turf(holder.my_atom))
	..()


/datum/chemical_reaction/instant/slime/yellow_flashlight
...
/datum/chemical_reaction/instant/slime/yellow_flashlight/on_reaction(var/datum/reagents/holder)
...
/datum/chemical_reaction/instant/slime/gold_gold
	name = "Slime Gold"
	id = "m_gold"
	result = "gold"
	required_reagents = list("phoron" = 5)
...
/datum/chemical_reaction/instant/slime/silver_silver
	name = "Slime Silver"
	id = "m_silver"
	result = "silver"
	required_reagents = list("phoron" = 5)
...
/datum/chemical_reaction/instant/slime/dark_purple_phoron
	name = "Slime Phoron"
	id = "m_phoron_harvest"
	result = "phoron"
	required_reagents = list("water" = 5)
...
/datum/chemical_reaction/instant/slime/dark_blue_cold_snap
...
/datum/chemical_reaction/instant/slime/dark_blue_cold_snap/on_reaction(var/datum/reagents/holder)
	var/turf/simulated/T = get_turf(holder.my_atom)
...
/datum/chemical_reaction/instant/slime/red_enrage
	name = "Slime Enrage"
	id = "m_enrage"
	required_reagents = list("blood" = 5)
	result_amount = 1
...
/datum/chemical_reaction/instant/slime/red_enrage/on_reaction(var/datum/reagents/holder)
...
/datum/chemical_reaction/instant/slime/red_mutation
	name = "Slime Mutation"
	id = "m_mutation"
	required_reagents = list("phoron" = 5)
	result_amount = 1
...
/datum/chemical_reaction/instant/slime/red_mutation/on_reaction(var/datum/reagents/holder)
...
/datum/chemical_reaction/instant/slime/green_uranium
	name = "Slime Uranium"
	id = "m_uranium"
	result = "uranium"
	required_reagents = list("phoron" = 5)
...
/datum/chemical_reaction/instant/slime/pink_clotting
...
/datum/chemical_reaction/instant/slime/pink_bone_fix
	name = "Slime Bone Med"
	id = "m_bone_fixer"
...
/datum/chemical_reaction/instant/slime/pink_organ_fix
...
/datum/chemical_reaction/instant/slime/oil_griff
...
/datum/chemical_reaction/instant/slime/oil_griff/on_reaction(var/datum/reagents/holder)
	..()
...
/datum/chemical_reaction/instant/slime/bluespace_lesser
...
/datum/chemical_reaction/instant/slime/bluespace_lesser/on_reaction(var/datum/reagents/holder)
	for(var/i = 1 to 5)
		new /obj/item/slime_crystal(get_turf(holder.my_atom))
	..()

/datum/chemical_reaction/instant/slime/bluespace_greater
...
/datum/chemical_reaction/instant/slime/bluespace_greater/on_reaction(var/datum/reagents/holder)
...
/datum/chemical_reaction/instant/slime/cerulean_enhancer
	name = "Slime Enhancer"
	id = "m_enhancer"
	required_reagents = list("phoron" = 5)
	result_amount = 1
...
/datum/chemical_reaction/instant/slime/cerulean_enhancer/on_reaction(var/datum/reagents/holder)
...
/datum/chemical_reaction/instant/slime/amber_slimefood
	name = "Slime Feeding"
	id = "m_slime_food"
	required_reagents = list("phoron" = 5)
	result_amount = 1
...
/datum/chemical_reaction/instant/slime/amber_slimefood/on_reaction(var/datum/reagents/holder)
	new /obj/item/slimepotion/feeding(get_turf(holder.my_atom))
	..()


/datum/chemical_reaction/instant/slime/amber_peoplefood
	name = "Slime Food"
	id = "m_people_food"
	required_reagents = list("water" = 5)
	result_amount = 1
...
/datum/chemical_reaction/instant/slime/amber_peoplefood/on_reaction(var/datum/reagents/holder)
...
/datum/chemical_reaction/instant/slime/sapphire_promethean
...
/datum/chemical_reaction/instant/slime/sapphire_promethean/on_reaction(var/datum/reagents/holder)
...
/datum/chemical_reaction/instant/slime/ruby_swole
	name = "Slime Strength"
	id = "m_strength"
	required_reagents = list("phoron" = 5)
	result_amount = 1
...
/datum/chemical_reaction/instant/slime/ruby_swole/on_reaction(var/datum/reagents/holder)
...
/datum/chemical_reaction/instant/slime/ruby_loyalty
	name = "Slime Loyalty"
	id = "m_strength"
	required_reagents = list("blood" = 5)
	result_amount = 1
...
/datum/chemical_reaction/instant/slime/ruby_loyalty/on_reaction(var/datum/reagents/holder)
...
/datum/chemical_reaction/instant/slime/emerald_fast
	name = "Slime Agility"
	id = "m_agility"
	required_reagents = list("phoron" = 5)
	result_amount = 1
...
/datum/chemical_reaction/instant/slime/emerald_fast/on_reaction(var/datum/reagents/holder)
	for(var/mob/living/L in range(1, holder.my_atom))
...
/datum/chemical_reaction/instant/slime/light_pink_docility
	name = "Slime Docility"
	id = "m_docile"
	required_reagents = list("water" = 5)
	result_amount = 1
...
/datum/chemical_reaction/instant/slime/light_pink_docility/on_reaction(var/datum/reagents/holder)
	new /obj/item/slimepotion/docility(get_turf(holder.my_atom))
	..()


/datum/chemical_reaction/instant/slime/light_pink_friendship
...
/datum/chemical_reaction/instant/slime/light_pink_friendship/on_reaction(var/datum/reagents/holder)
...
/datum/chemical_reaction/instant/slime/rainbow_random_slime
...
/datum/chemical_reaction/instant/slime/rainbow_random_slime/on_reaction(var/datum/reagents/holder)
...
/datum/chemical_reaction/instant/slime/rainbow_unity
	name = "Slime Unity"
	id = "m_unity"
	required_reagents = list("water" = 5)
	result_amount = 1
...
/datum/chemical_reaction/instant/slime/rainbow_unity/on_reaction(var/datum/reagents/holder)
