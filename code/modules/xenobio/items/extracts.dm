...
/datum/chemical_reaction/slime/can_happen(var/datum/reagent_holder/holder)
...
/datum/chemical_reaction/slime/on_reaction(datum/reagent_holder/holder, created_volume, instant)
	var/obj/item/slime_extract/T = holder.my_atom
	T.uses--
	if(T.uses <= 0)
...
/datum/chemical_reaction/slime/grey_new_slime/on_reaction(datum/reagent_holder/holder, created_volume, instant)
...
/datum/chemical_reaction/slime/grey_monkey/on_reaction(datum/reagent_holder/holder, created_volume, instant)
	for(var/i = 1 to 4)
...
/datum/chemical_reaction/slime/metal_materials_basic/on_reaction(datum/reagent_holder/holder, created_volume, instant)
	for(var/i = 1 to 3)
...
/datum/chemical_reaction/slime/metal_materials_adv
...
/datum/chemical_reaction/slime/metal_materials_adv/on_reaction(datum/reagent_holder/holder, created_volume, instant)
	for(var/i = 1 to 2)
...
/datum/chemical_reaction/slime/metal_materials_weird
...
/datum/chemical_reaction/slime/metal_materials_weird/on_reaction(datum/reagent_holder/holder, created_volume, instant)
	for(var/i = 1 to 3)
...
/datum/chemical_reaction/slime/metal_materials_steel
	name = "Slime Weird Construction Materials"
	id = "m_metal_steel"
...
/datum/chemical_reaction/slime/metal_materials_steel/on_reaction(datum/reagent_holder/holder, created_volume, instant)
...
/datum/chemical_reaction/slime/blue_stability/on_reaction(datum/reagent_holder/holder, created_volume, instant)
	new /obj/item/slimepotion/stabilizer(get_turf(holder.my_atom))
	..()


/datum/chemical_reaction/slime/blue_calm
	name = "Slime Calm"
	id = "m_blue_calm"
	required_reagents = list("water" = 5)
	result_amount = 1
...
/datum/chemical_reaction/slime/blue_calm/on_reaction(datum/reagent_holder/holder, created_volume, instant)
...
/datum/chemical_reaction/slime/blue_cryotoxin
...
/datum/chemical_reaction/slime/purple_steroid/on_reaction(datum/reagent_holder/holder, created_volume, instant)
	new /obj/item/slimepotion/steroid(get_turf(holder.my_atom))
	..()


/datum/chemical_reaction/slime/purple_infertility
...
/datum/chemical_reaction/slime/purple_infertility/on_reaction(datum/reagent_holder/holder, created_volume, instant)
	new /obj/item/slimepotion/infertility(get_turf(holder.my_atom))
	..()


/datum/chemical_reaction/slime/purple_shrink
	name = "Slime Shrink"
	id = "m_purple_shrink"
	required_reagents = list("water" = 5)
	result_amount = 1
...
/datum/chemical_reaction/slime/purple_shrink/on_reaction(datum/reagent_holder/holder, created_volume, instant)
	new /obj/item/slimepotion/shrink(get_turf(holder.my_atom))
	..()


/datum/chemical_reaction/slime/purple_fertility
	name = "Slime Fetility"
...
/datum/chemical_reaction/slime/purple_fertility/on_reaction(datum/reagent_holder/holder, created_volume, instant)
...
/datum/chemical_reaction/slime/orange_fire/on_reaction(datum/reagent_holder/holder, created_volume, instant)
	...
	spawn(5 SECONDS)
		if(holder && holder.my_atom)
			...
			for(var/turf/simulated/target_turf in view(2, T))
				target_turf.assume_gas(GAS_ID_VOLATILE_FUEL, 33, 1500+T0C)
				target_turf.assume_gas(GAS_ID_OXYGEN, 66, 1500+T0C)
				spawn(0)
...
/datum/chemical_reaction/slime/orange_heatwave
...
/datum/chemical_reaction/slime/orange_heatwave/on_reaction(datum/reagent_holder/holder, created_volume, instant)
	var/turf/simulated/T = get_turf(holder.my_atom)
	...
	if(env)
		...
		env.adjust_thermal_energy(15 * 1000 * 1000)

	playsound(T, 'sound/effects/phasein.ogg', 75, 1)
	..()


/datum/chemical_reaction/slime/orange_smoke
	name = "Slime Smoke"
	id = "m_orange_smoke"
	required_reagents = list("water" = 5)
	result_amount = 1
...
/datum/chemical_reaction/slime/orange_smoke/on_reaction(datum/reagent_holder/holder, created_volume, instant)
...
/datum/chemical_reaction/slime/orange_pyrotoxin
...
/datum/chemical_reaction/slime/yellow_lightning
...
/datum/chemical_reaction/slime/yellow_lightning/on_reaction(datum/reagent_holder/holder, created_volume, instant)
...
/datum/chemical_reaction/slime/yellow_flashlight/on_reaction(datum/reagent_holder/holder, created_volume, instant)
...
/datum/chemical_reaction/slime/yellow_emp/on_reaction(datum/reagent_holder/holder, created_volume, instant)
...
/datum/chemical_reaction/slime/yellow_battery/on_reaction(datum/reagent_holder/holder, created_volume, instant)
...
/datum/chemical_reaction/slime/gold_random_mobs
...
/datum/chemical_reaction/slime/gold_random_mobs/on_reaction(datum/reagent_holder/holder, created_volume, instant)
...
/datum/chemical_reaction/slime/gold_hostile_mob
...
/datum/chemical_reaction/slime/gold_hostile_mob/on_reaction(datum/reagent_holder/holder, created_volume, instant)
...
/datum/chemical_reaction/slime/gold_safe_mob
	name = "Slime Safe Mob"
	id = "m_gold_safe_mob"
	required_reagents = list("water" = 5)
	result_amount = 1
...
/datum/chemical_reaction/slime/gold_safe_mob/on_reaction(datum/reagent_holder/holder, created_volume, instant)
	var/type_to_spawn
...
/datum/chemical_reaction/slime/gold_materials_gold
	name = "Slime Gold"
	id = "m_gold_gold"
	required_reagents = list("slimejelly" = 5)
	result_amount = 1
...
/datum/chemical_reaction/slime/gold_materials_gold/on_reaction(datum/reagent_holder/holder, created_volume, instant)
...
/datum/chemical_reaction/slime/silver_materials_basic
...
/datum/chemical_reaction/slime/silver_materials_basic/on_reaction(datum/reagent_holder/holder, created_volume, instant)
	for(var/i = 1 to 2)
...
/datum/chemical_reaction/slime/silver_materials_adv
...
/datum/chemical_reaction/slime/silver_materials_adv/on_reaction(datum/reagent_holder/holder, created_volume, instant)
	var/type_to_spawn = pickweight(xenobio_silver_materials_adv)
	new type_to_spawn(get_turf(holder.my_atom), 3)
	..()


/datum/chemical_reaction/slime/silver_materials_random
...
/datum/chemical_reaction/slime/silver_materials_random/on_reaction(datum/reagent_holder/holder, created_volume, instant)
	var/type_to_spawn
	var/amount = 5
...
/datum/chemical_reaction/slime/silver_materials_silver
	name = "Slime Silver"
	id = "m_silver_silver"
	required_reagents = list("slimejelly" = 5)
	result_amount = 1
...
/datum/chemical_reaction/slime/silver_materials_silver/on_reaction(datum/reagent_holder/holder, created_volume, instant)
...
/datum/chemical_reaction/slime/dark_blue_cold_snap/on_reaction(datum/reagent_holder/holder, created_volume, instant)
	var/turf/simulated/T = get_turf(holder.my_atom)
	if(!T) // Nullspace lacks zones.
		return
...
/datum/chemical_reaction/slime/dark_blue_temp_resist
...
/datum/chemical_reaction/slime/dark_blue_temp_resist/on_reaction(datum/reagent_holder/holder, created_volume, instant)
...
/datum/chemical_reaction/slime/dark_blue_ice
	name = "Slime Ice"
	id = "m_darkblue_ice"
	result = "ice"
	required_reagents = list("water" = 5)
...
/datum/chemical_reaction/slime/dark_blue_death/on_reaction(datum/reagent_holder/holder, created_volume, instant)
...
/datum/chemical_reaction/slime/red_mutation/on_reaction(datum/reagent_holder/holder, created_volume, instant)
...
/datum/chemical_reaction/slime/red_enrage/on_reaction(datum/reagent_holder/holder, created_volume, instant)
	for(var/mob/living/simple_mob/slime/S in view(get_turf(holder.my_atom)))
		if(S.stat)
			continue
...
/datum/chemical_reaction/slime/red_hotsauce
...
/datum/chemical_reaction/slime/red_ferality/on_reaction(datum/reagent_holder/holder, created_volume, instant)
...
/datum/chemical_reaction/slime/green_radpulse
...
/datum/chemical_reaction/slime/green_radpulse/on_reaction(datum/reagent_holder/holder, created_volume, instant)
...
/datum/chemical_reaction/slime/green_emitter
...
/datum/chemical_reaction/slime/green_emitter/on_reaction(datum/reagent_holder/holder, created_volume, instant)
...
/datum/chemical_reaction/slime/green_uranium/on_reaction(datum/reagent_holder/holder, created_volume, instant)
...
/datum/chemical_reaction/slime/pink_heal_pulse/on_reaction(datum/reagent_holder/holder, created_volume, instant)
...
/datum/chemical_reaction/slime/oil_fuel
	name = "Slime Fuel"
	id = "m_oil_fuel"
	result = "fuel"
	required_reagents = list(MAT_PHORON = 5)
...
/datum/chemical_reaction/slime/oil_fakesplosion/on_reaction(datum/reagent_holder/holder, created_volume, instant)
	playsound(get_turf(holder.my_atom), 'sound/effects/phasein.ogg', 75, 1)
	explosion(get_turf(holder.my_atom), 0, 0, 0)
	..()


/datum/chemical_reaction/slime/oil_explosion
...
/datum/chemical_reaction/slime/oil_explosion/on_reaction(datum/reagent_holder/holder, created_volume, instant)
	..()
...
/datum/chemical_reaction/slime/bluespace_crystals
...
/datum/chemical_reaction/slime/bluespace_crystals/on_reaction(datum/reagent_holder/holder, created_volume, instant)
	for(var/i = 1 to 5)
		new /obj/item/slime_crystal(get_turf(holder.my_atom))
	..()


/datum/chemical_reaction/slime/bluespace_pouch
...
/datum/chemical_reaction/slime/bluespace_pouch/on_reaction(datum/reagent_holder/holder, created_volume, instant)
	new /obj/item/storage/backpack/holding/slime(get_turf(holder.my_atom))
	..()


/datum/chemical_reaction/slime/bluespace_chaotic_tele
...
/datum/chemical_reaction/slime/bluespace_chaotic_tele/on_reaction(datum/reagent_holder/holder, created_volume, instant)
...
/datum/chemical_reaction/slime/bluespace_teleporter
...
/datum/chemical_reaction/slime/bluespace_teleporter/on_reaction(datum/reagent_holder/holder, created_volume, instant)
...
/datum/chemical_reaction/slime/cerulean_enhancer/on_reaction(datum/reagent_holder/holder, created_volume, instant)
	new /obj/item/slimepotion/enhancer(get_turf(holder.my_atom))
	..()


/datum/chemical_reaction/slime/cerulean_reinvigoration
...
/datum/chemical_reaction/slime/cerulean_reinvigoration/on_reaction(datum/reagent_holder/holder, created_volume, instant)
	new /obj/item/slimepotion/reinvigoration(get_turf(holder.my_atom))
	..()


/datum/chemical_reaction/slime/cerulean_potion_mimic
...
/datum/chemical_reaction/slime/cerulean_potion_mimic/on_reaction(datum/reagent_holder/holder, created_volume, instant)
	new /obj/item/slimepotion/mimic(get_turf(holder.my_atom))
	..()


/datum/chemical_reaction/slime/cerulean_random_potion
...
/datum/chemical_reaction/slime/cerulean_random_potion/on_reaction(datum/reagent_holder/holder, created_volume, instant)
...
/datum/chemical_reaction/slime/amber_slimefood/on_reaction(datum/reagent_holder/holder, created_volume, instant)
	new /obj/item/slimepotion/feeding(get_turf(holder.my_atom))
	..()


/datum/chemical_reaction/slime/amber_random_food
...
/datum/chemical_reaction/slime/amber_random_food/on_reaction(datum/reagent_holder/holder, created_volume, instant)
...
/datum/chemical_reaction/slime/amber_snack
	name = "Slime Snack"
	id = "m_amber_snack"
	required_reagents = list("water" = 5)
	result_amount = 1
...
/datum/chemical_reaction/slime/amber_snack/on_reaction(datum/reagent_holder/holder, created_volume, instant)
	for(var/i = 1 to rand(3, 5))
		new /obj/item/reagent_containers/food/snacks/slime(get_turf(holder.my_atom))
	..()


/datum/chemical_reaction/slime/amber_goop
	name = "Slime Goop"
	id = "m_amber_goop"
	result = "slime_goop"
	required_reagents = list("slimejelly" = 5)
...
/datum/chemical_reaction/slime/sapphire_promethean/on_reaction(datum/reagent_holder/holder, created_volume, instant)
...
/datum/chemical_reaction/slime/sapphire_plushies/on_reaction(datum/reagent_holder/holder, created_volume, instant)
	var/spawn_type
...
/datum/chemical_reaction/slime/sapphire_sapience
	name = "Slime Sapience"
...
/datum/chemical_reaction/slime/sapphire_sapience/on_reaction(datum/reagent_holder/holder, created_volume, instant)
...
/datum/chemical_reaction/slime/ruby_swole/on_reaction(datum/reagent_holder/holder, created_volume, instant)
	for(var/mob/living/L in range(1, holder.my_atom))
...
/datum/chemical_reaction/slime/ruby_pull
	name = "Slime Pull"
	id = "m_ruby_pull"
	required_reagents = list("blood" = 5)
	result_amount = 1
...
/datum/chemical_reaction/slime/ruby_pull/on_reaction(datum/reagent_holder/holder, created_volume, instant)
	var/location = get_turf(holder.my_atom)
...
/datum/chemical_reaction/slime/ruby_brute_juice
...
/datum/chemical_reaction/slime/ruby_push/on_reaction(datum/reagent_holder/holder, created_volume, instant)
	var/location = get_turf(holder.my_atom)
...
/datum/chemical_reaction/slime/emerald_agility
	name = "Slime Agility"
...
/datum/chemical_reaction/slime/emerald_agility/on_reaction(datum/reagent_holder/holder, created_volume, instant)
	for(var/mob/living/L in range(1, holder.my_atom))
...
/datum/chemical_reaction/slime/emerald_speed
	name = "Slime Speed"
	id = "m_emerald_speed"
	required_reagents = list("blood" = 5)
	result_amount = 1
...
/datum/chemical_reaction/slime/emerald_speed/on_reaction(datum/reagent_holder/holder, created_volume, instant)
	for(var/mob/living/L in range(1, holder.my_atom))
...
/datum/chemical_reaction/slime/emerald_hyperzine
...
/datum/chemical_reaction/slime/emerald_hell/on_reaction(datum/reagent_holder/holder, created_volume, instant)
...
/datum/chemical_reaction/slime/light_pink_friendship/on_reaction(datum/reagent_holder/holder, created_volume, instant)
	new /obj/item/slimepotion/friendship(get_turf(holder.my_atom))
	..()


/datum/chemical_reaction/slime/light_pink_loyalty
	name = "Slime Loyalty"
...
/datum/chemical_reaction/slime/light_pink_loyalty/on_reaction(datum/reagent_holder/holder, created_volume, instant)
...
/datum/chemical_reaction/slime/light_pink_docility/on_reaction(datum/reagent_holder/holder, created_volume, instant)
	new /obj/item/slimepotion/docility(get_turf(holder.my_atom))
	..()


/datum/chemical_reaction/slime/light_pink_obedience
...
/datum/chemical_reaction/slime/light_pink_obedience/on_reaction(datum/reagent_holder/holder, created_volume, instant)
...
/datum/chemical_reaction/slime/rainbow_random_slime/on_reaction(datum/reagent_holder/holder, created_volume, instant)
...
/datum/chemical_reaction/slime/rainbow_random_extract
...
/datum/chemical_reaction/slime/rainbow_random_extract/on_reaction(datum/reagent_holder/holder, created_volume, instant)
	var/spawn_type = pickweight(xenobio_rainbow_extracts)
	new spawn_type(get_turf(holder.my_atom))
	..()


/datum/chemical_reaction/slime/rainbow_colors
	name = "Slime Colors"
	id = "m_rainbow_colors"
	required_reagents = list("water" = 5)
	result_amount = 1
...
/datum/chemical_reaction/slime/rainbow_colors/on_reaction(datum/reagent_holder/holder, created_volume, instant)
...
/datum/chemical_reaction/slime/rainbow_unity/on_reaction(datum/reagent_holder/holder, created_volume, instant)
