...
/obj/item/slime_cube/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
	if(!searching)
...
/obj/item/slime_crystal/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
...
/obj/item/flashlight/slime/attack_self(datum/event_args/actor/actor, mob/user)
