...
/obj/item/slime_cube/attack_self(mob/user, datum/event_args/actor/e_args)
	. = ..()
	if(.)
		return
	if(!searching)
...
/obj/item/slime_crystal/attack_self(mob/user, datum/event_args/actor/e_args)
	. = ..()
	if(.)
		return
...
/obj/item/flashlight/slime/attack_self(mob/user, datum/event_args/actor/e_args)
