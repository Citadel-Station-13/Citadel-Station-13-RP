...
/obj/item/slimepotion/stabilizer/attack_mob(mob/M, mob/user, clickchain_flags, list/params, mult, target_zone, intent)
...
/obj/item/slimepotion/mutator/attack_mob(mob/M, mob/user, clickchain_flags, list/params, mult, target_zone, intent)
	if(user.a_intent == INTENT_HARM)
		return ..()
	. = CLICKCHAIN_DO_NOT_PROPAGATE
	var/mob/living/simple_mob/slime/xenobio/S = M
...
/obj/item/slimepotion/docility/attack_mob(mob/M, mob/user, clickchain_flags, list/params, mult, target_zone, intent)
	if(user.a_intent == INTENT_HARM)
		return ..()
	. = CLICKCHAIN_DO_NOT_PROPAGATE
...
/obj/item/slimepotion/steroid/attack_mob(mob/M, mob/user, clickchain_flags, list/params, mult, target_zone, intent)
	if(user.a_intent == INTENT_HARM)
		return ..()
	. = CLICKCHAIN_DO_NOT_PROPAGATE
	var/mob/living/simple_mob/slime/xenobio/S = M
...
/obj/item/slimepotion/unity/attack_mob(mob/M, mob/user, clickchain_flags, list/params, mult, target_zone, intent)
	if(user.a_intent == INTENT_HARM)
		return ..()
	. = CLICKCHAIN_DO_NOT_PROPAGATE
	var/mob/living/simple_mob/slime/xenobio/S = M
...
/obj/item/slimepotion/loyalty/attack_mob(mob/M, mob/user, clickchain_flags, list/params, mult, target_zone, intent)
	if(user.a_intent == INTENT_HARM)
		return ..()
	. = CLICKCHAIN_DO_NOT_PROPAGATE
	var/mob/living/simple_mob/S = M
...
/obj/item/slimepotion/friendship/attack_mob(mob/M, mob/user, clickchain_flags, list/params, mult, target_zone, intent)
	if(user.a_intent == INTENT_HARM)
		return ..()
	. = CLICKCHAIN_DO_NOT_PROPAGATE
	var/mob/living/simple_mob/S = M
...
/obj/item/slimepotion/feeding/attack_mob(mob/M, mob/user, clickchain_flags, list/params, mult, target_zone, intent)
	if(user.a_intent == INTENT_HARM)
		return ..()
	. = CLICKCHAIN_DO_NOT_PROPAGATE
	var/mob/living/simple_mob/slime/xenobio/S = M
