...
/obj/item/slimepotion/stabilizer/process_mob_melee(mob/M, mob/user, clickchain_flags, list/params, mult, target_zone, intent)
...
/obj/item/slimepotion/mutator/process_mob_melee(mob/M, mob/user, clickchain_flags, list/params, mult, target_zone, intent)
	if(user.a_intent == INTENT_HARM)
		return ..()
	. = CLICKCHAIN_DO_NOT_PROPAGATE
	var/mob/living/simple_mob/slime/xenobio/S = M
...
/obj/item/slimepotion/docility/process_mob_melee(mob/M, mob/user, clickchain_flags, list/params, mult, target_zone, intent)
	if(user.a_intent == INTENT_HARM)
		return ..()
	. = CLICKCHAIN_DO_NOT_PROPAGATE
...
/obj/item/slimepotion/steroid/process_mob_melee(mob/M, mob/user, clickchain_flags, list/params, mult, target_zone, intent)
	if(user.a_intent == INTENT_HARM)
		return ..()
	. = CLICKCHAIN_DO_NOT_PROPAGATE
	var/mob/living/simple_mob/slime/xenobio/S = M
...
/obj/item/slimepotion/unity/process_mob_melee(mob/M, mob/user, clickchain_flags, list/params, mult, target_zone, intent)
	if(user.a_intent == INTENT_HARM)
		return ..()
	. = CLICKCHAIN_DO_NOT_PROPAGATE
	var/mob/living/simple_mob/slime/xenobio/S = M
...
/obj/item/slimepotion/loyalty/process_mob_melee(mob/M, mob/user, clickchain_flags, list/params, mult, target_zone, intent)
	if(user.a_intent == INTENT_HARM)
		return ..()
	. = CLICKCHAIN_DO_NOT_PROPAGATE
	var/mob/living/simple_mob/S = M
...
/obj/item/slimepotion/friendship/process_mob_melee(mob/M, mob/user, clickchain_flags, list/params, mult, target_zone, intent)
	if(user.a_intent == INTENT_HARM)
		return ..()
	. = CLICKCHAIN_DO_NOT_PROPAGATE
	var/mob/living/simple_mob/S = M
...
/obj/item/slimepotion/feeding/process_mob_melee(mob/M, mob/user, clickchain_flags, list/params, mult, target_zone, intent)
	if(user.a_intent == INTENT_HARM)
		return ..()
	. = CLICKCHAIN_DO_NOT_PROPAGATE
	var/mob/living/simple_mob/slime/xenobio/S = M
