...
/datum/gear/uniform/cheongsam/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(tim_sort(cheongsams, GLOBAL_PROC_REF(cmp_text_asc)))
...
/datum/gear/uniform/croptop/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(tim_sort(croptops, GLOBAL_PROC_REF(cmp_text_asc)))
...
/datum/gear/uniform/jumpsuit/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(tim_sort(jumpclothes, GLOBAL_PROC_REF(cmp_text_asc)))
...
/datum/gear/uniform/skirt/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(tim_sort(skirts, GLOBAL_PROC_REF(cmp_text_asc)))
...
/datum/gear/uniform/pants/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(tim_sort(pants, GLOBAL_PROC_REF(cmp_text_asc)))
...
/datum/gear/uniform/shorts/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(tim_sort(shorts, GLOBAL_PROC_REF(cmp_text_asc)))
...
/datum/gear/uniform/suit/lawyer/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(tim_sort(lsuits, GLOBAL_PROC_REF(cmp_text_asc)))
...
/datum/gear/uniform/suit/suit_jacket/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(tim_sort(msuits, GLOBAL_PROC_REF(cmp_text_asc)))
...
/datum/gear/uniform/scrub/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(tim_sort(scrubs, GLOBAL_PROC_REF(cmp_text_asc)))
...
/datum/gear/uniform/scrub_fem/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(tim_sort(scrubs_fem, GLOBAL_PROC_REF(cmp_text_asc)))
...
/datum/gear/uniform/turtlebaggy_selection/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(tim_sort(turtlebaggy_selection, GLOBAL_PROC_REF(cmp_text_asc)))
...
/datum/gear/uniform/wedding/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(tim_sort(weddings, GLOBAL_PROC_REF(cmp_text_asc)))
...
/datum/gear/uniform/dresses/maid/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(tim_sort(maids, GLOBAL_PROC_REF(cmp_text_asc)))
...
/datum/gear/uniform/brandjumpsuit_selection/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(tim_sort(brandjumpsuit_selection, GLOBAL_PROC_REF(cmp_text_asc)))
...
/datum/gear/uniform/kimono_selection/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(tim_sort(kimonos, GLOBAL_PROC_REF(cmp_text_asc)))
...
/datum/gear/uniform/future_fashion_selection/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(tim_sort(future_fashion_selection, GLOBAL_PROC_REF(cmp_text_asc)))
...
/datum/gear/uniform/swimsuits/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(tim_sort(swimsuits, GLOBAL_PROC_REF(cmp_text_asc)))
...
/datum/gear/uniform/summerdress_selection/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(tim_sort(summerdress_selection, GLOBAL_PROC_REF(cmp_text_asc)))
...
/datum/gear/uniform/skinsuit_selection/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(tim_sort(skinsuit_selection, GLOBAL_PROC_REF(cmp_text_asc)))
...
/datum/gear/uniform/skinsuitfem_selection/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(tim_sort(skinsuitfem_selection, GLOBAL_PROC_REF(cmp_text_asc)))
...
/datum/gear/uniform/altbodysuit_selection/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(tim_sort(altbodysuit_selection, GLOBAL_PROC_REF(cmp_text_asc)))
...
/datum/gear/uniform/altbodysuitfem_selection/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(tim_sort(altbodysuitfem_selection, GLOBAL_PROC_REF(cmp_text_asc)))
