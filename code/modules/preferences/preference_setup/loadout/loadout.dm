...
/hook/startup/proc/populate_gear_list()
	...
	loadout_categories = tim_sort(loadout_categories, GLOBAL_PROC_REF(cmp_text_asc))
	for(var/loadout_category in loadout_categories)
		var/datum/loadout_category/LC = loadout_categories[loadout_category]
		LC.gear = tim_sort(LC.gear, GLOBAL_PROC_REF(cmp_text_asc))	// DO NOT ADD A ", TRUE" TO THE END OF THIS FUCKING LINE IT'S WHAT WAS CAUSING ALPHABETIZATION TO BREAK
	return 1
