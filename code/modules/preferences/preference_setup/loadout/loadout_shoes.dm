...
/datum/gear/shoes/lacey/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(tim_sort(laces, GLOBAL_PROC_REF(cmp_text_asc)))
...
/datum/gear/shoes/hitops/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(tim_sort(hitops, GLOBAL_PROC_REF(cmp_text_asc)))
