...
/datum/gear_tweak/laptop
	var/list/ValidProcessors = list(/obj/item/stock_parts/computer/processor_unit/small, /obj/item/stock_parts/computer/processor_unit)
	var/list/ValidBatteries = list(/obj/item/stock_parts/computer/battery_module, /obj/item/stock_parts/computer/battery_module/advanced, /obj/item/stock_parts/computer/battery_module/super)
	var/list/ValidHardDrives = list(/obj/item/stock_parts/computer/hard_drive, /obj/item/stock_parts/computer/hard_drive/advanced, /obj/item/stock_parts/computer/hard_drive/super)
	var/list/ValidNetworkCards = list(/obj/item/stock_parts/computer/network_card, /obj/item/stock_parts/computer/network_card/advanced)
	var/list/ValidNanoPrinters = list(null, /obj/item/stock_parts/computer/nano_printer)
	var/list/ValidCardSlots = list(null, /obj/item/stock_parts/computer/card_slot)
	var/list/ValidTeslaLinks = list(null, /obj/item/stock_parts/computer/tesla_link)
