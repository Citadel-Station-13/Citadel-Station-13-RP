...
/datum/gear/accessory/armband/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(tim_sort(armbands, GLOBAL_PROC_REF(cmp_text_asc)))
...
/datum/gear/accessory/wcoat/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(tim_sort(wcoats, GLOBAL_PROC_REF(cmp_text_asc)))
...
/datum/gear/accessory/tie/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(tim_sort(ties, GLOBAL_PROC_REF(cmp_text_asc)))
...
/datum/gear/accessory/scarf/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(tim_sort(scarfs, GLOBAL_PROC_REF(cmp_text_asc)))
...
/datum/gear/accessory/jacket/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(tim_sort(jackets, GLOBAL_PROC_REF(cmp_text_asc)))
...
/datum/gear/accessory/fannypack/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(tim_sort(fannys, GLOBAL_PROC_REF(cmp_text_asc)))
...
/datum/gear/accessory/sweater/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(tim_sort(sweaters, GLOBAL_PROC_REF(cmp_text_asc)))
...
/datum/gear/accessory/asym/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(tim_sort(asyms, GLOBAL_PROC_REF(cmp_text_asc)))
...
/datum/gear/accessory/gaiter/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(tim_sort(gaiters, GLOBAL_PROC_REF(cmp_text_asc)))
