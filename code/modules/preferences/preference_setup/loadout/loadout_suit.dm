...
/datum/gear/suit/mil/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(tim_sort(mil_jackets, GLOBAL_PROC_REF(cmp_text_asc)))
...
/datum/gear/suit/hazard_vest/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(tim_sort(hazards, GLOBAL_PROC_REF(cmp_text_asc)))
...
/datum/gear/suit/hoodie/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(tim_sort(hoodies, GLOBAL_PROC_REF(cmp_text_asc)))
...
/datum/gear/suit/poncho/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(tim_sort(ponchos, GLOBAL_PROC_REF(cmp_text_asc)))
...
/datum/gear/suit/varsity/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(tim_sort(varsities, GLOBAL_PROC_REF(cmp_text_asc)))
...
/datum/gear/suit/track/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(tim_sort(tracks, GLOBAL_PROC_REF(cmp_text_asc)))
...
/datum/gear/suit/jacket_modular/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(tim_sort(the_jackets, GLOBAL_PROC_REF(cmp_text_asc)))
...
/datum/gear/suit/pullover/New()
	...
	gear_tweaks += new/datum/gear_tweak/path(tim_sort(pullovers, GLOBAL_PROC_REF(cmp_text_asc)))
