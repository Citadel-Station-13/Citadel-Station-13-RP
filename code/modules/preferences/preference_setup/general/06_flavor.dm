	...
	if(href_list["flavor_text"])
		switch(href_list["flavor_text"])
			...
			if("general")
				...
				if(CanUseTopic(user))
					log_game("[key_name(user)] set their general flavortext to [msg]")
				...
				if(CanUseTopic(user))
					log_game("[key_name(user)] set their flavortext for their [href_list["flavor_text"]] to [msg]")
					pref.flavor_texts[href_list["flavor_text"]] = msg
		SetFlavorText(user)
		...
		switch(href_list["flavour_text_robot"])
			...
			if("Default")
				...
				if(CanUseTopic(user))
					log_game("[key_name(user)] set their default robot flavortext to [msg]")
				...
				if(CanUseTopic(user))
					log_game("[key_name(user)] set their robot flavortext for the [href_list["flavour_text_robot"]] module to [msg]")
					pref.flavour_texts_robot[href_list["flavour_text_robot"]] = msg
