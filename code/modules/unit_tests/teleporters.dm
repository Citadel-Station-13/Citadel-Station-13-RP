/datum/unit_test/auto_teleporter_linking/Run()
	...
	var/obj/machinery/teleport/pad/hub = allocate(/obj/machinery/teleport/pad)
	var/obj/machinery/teleport/projector/station = allocate(/obj/machinery/teleport/projector, locate(run_loc_bottom_left.x + 1, run_loc_bottom_left.y, run_loc_bottom_left.z))
