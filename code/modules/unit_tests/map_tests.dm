...
/datum/unit_test/apc_area_test/Run()
	...
	exempt_areas += SSmapping.legacy_map_config.unit_test_exempt_areas.Copy()
	exempt_from_atmos += SSmapping.legacy_map_config.unit_test_exempt_from_atmos.Copy()
	exempt_from_apc += SSmapping.legacy_map_config.unit_test_exempt_from_apc.Copy()

	var/list/zs_to_test = SSmapping.legacy_map_config.unit_test_z_levels || list(1) //Either you set it, or you just get z1
