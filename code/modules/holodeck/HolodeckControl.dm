...
/obj/machinery/computer/HolodeckControl/emag_act(var/remaining_charges, var/mob/user as mob)
	...
	if (!emagged)
		...
		to_chat(user, "Warning.  Automatic shutoff and derezing protocols have been corrupted.  Please call [using_map_legacy.company_name] maintenance and do not use the simulator.")
