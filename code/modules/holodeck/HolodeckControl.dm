 ...
 */
/obj/machinery/computer/HolodeckControl/ui_data(mob/user, datum/tgui/ui, datum/ui_state/state)
	var/list/data = ..()
...
/obj/machinery/computer/HolodeckControl/ui_act(action, list/params, datum/tgui/ui, datum/ui_state/state)
	if(..())
		return TRUE
