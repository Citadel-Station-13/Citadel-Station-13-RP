...
/datum/lore/organization/tsc/nanotrasen/New()
	..()
	spawn(1) // BYOND shenanigans means SSmapping.legacy_map_config is not initialized yet.  Wait a tick.
		// Get rid of the current map from the list, so ships flying in don't say they're coming to the current map.
		var/string_to_test = "[SSmapping.legacy_map_config.station_name] in [SSmapping.legacy_map_config.starsys_name]"
