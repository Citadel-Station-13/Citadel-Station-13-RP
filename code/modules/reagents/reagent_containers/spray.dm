...
/obj/item/reagent_containers/spray/attack_self(datum/event_args/actor/actor, mob/user)
...
/obj/item/reagent_containers/spray/pepper/attack_self(datum/event_args/actor/actor, mob/user)
	safety = !safety
...
/obj/item/reagent_containers/spray/squirt/attack_self(datum/event_args/actor/actor, mob/user)
	pumped = !pumped
