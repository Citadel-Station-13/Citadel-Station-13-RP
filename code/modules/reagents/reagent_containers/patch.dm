...
>>>>>>> 68077313d... Fixes the inconsistencies in the applicability of chem patches on injured limbs.
=======
		if(affecting.robotic >= ORGAN_ROBOT)
>>>>>>> b17daa6de... Fixes the inconsistencies in the applicability of chem patches on injured limbs.
			to_chat(user, "<span class='notice'>\The [src] won't work on a robotic limb!</span>")
			return
