...
/obj/item/reagent_containers/hypospray/process_mob_melee(mob/M, mob/user, clickchain_flags, list/params, mult, target_zone, intent)
...
/obj/item/reagent_containers/hypospray/glukoz/process_mob_melee(mob/M, mob/user, clickchain_flags, list/params, mult, target_zone, intent)
	if(closed)
