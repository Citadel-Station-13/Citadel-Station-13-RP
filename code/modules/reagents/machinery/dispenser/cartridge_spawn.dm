/client/proc/spawn_chemdisp_cartridge(size in list("small", "medium", "large"), reagent in SSchemistry.reagent_lookup)
	...
	var/datum/reagent/R = SSchemistry.reagent_lookup[reagent]
	C.setLabel(R.name)
