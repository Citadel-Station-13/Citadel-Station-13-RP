...
/obj/machinery/chemical_dispenser/ui_static_data(mob/user, datum/tgui/ui, datum/tgui_embed_context/embed_context)
	. = ..()
...
/obj/machinery/chemical_dispenser/ui_data(mob/user, datum/tgui/ui, datum/tgui_embed_context/embed_context)
	. = ..()
...
/obj/machinery/chemical_dispenser/ui_act(action, list/params, datum/tgui/ui, datum/tgui_embed_context/embed_context)
	. = ..()
	if(.)
		return
	add_fingerprint(usr)
