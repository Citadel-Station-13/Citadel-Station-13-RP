...
/datum/reagent/modapplying/cryofluid/touch_expose_mob(mob/target, volume, temperature, list/data, organ_tag)
	. = ..()
...
/datum/reagent/modapplying/cryofluid/contact_expose_turf(turf/target, volume, temperature, list/data, vapor)
	. = ..()
