...
/datum/chemical_reaction/food/tofu/on_reaction(datum/reagent_holder/holder, created_volume)
...
/datum/chemical_reaction/food/chocolate_bar/on_reaction(datum/reagent_holder/holder, created_volume)
	var/location = get_turf(holder.my_atom)
	for(var/i = 1, i <= created_volume, i++)
...
/datum/chemical_reaction/food/chocolate_bar2/on_reaction(datum/reagent_holder/holder, created_volume)
	var/location = get_turf(holder.my_atom)
	for(var/i = 1, i <= created_volume, i++)
		new /obj/item/reagent_containers/food/snacks/chocolatebar(location)
	return
...
/datum/chemical_reaction/food/cheesewheel/on_reaction(datum/reagent_holder/holder, created_volume)
	var/location = get_turf(holder.my_atom)
	for(var/i = 1, i <= created_volume, i++)
...
/datum/chemical_reaction/food/bluecheesewheel/on_reaction(datum/reagent_holder/holder, created_volume)
	var/location = get_turf(holder.my_atom)
	for(var/i = 1, i <= created_volume, i++)
...
/datum/chemical_reaction/food/meatball/on_reaction(datum/reagent_holder/holder, created_volume)
	var/location = get_turf(holder.my_atom)
	for(var/i = 1, i <= created_volume, i++)
...
/datum/chemical_reaction/food/dough/on_reaction(datum/reagent_holder/holder, created_volume)
	var/location = get_turf(holder.my_atom)
	for(var/i = 1, i <= created_volume, i++)
...
/datum/chemical_reaction/food/syntiflesh/on_reaction(datum/reagent_holder/holder, created_volume)
	var/location = get_turf(holder.my_atom)
	for(var/i = 1, i <= created_volume, i++)
...
/datum/chemical_reaction/food/butter/on_reaction(datum/reagent_holder/holder, created_volume)
	var/location = get_turf(holder.my_atom)
	for(var/i = 1, i <= created_volume, i++)
...
/datum/chemical_reaction/food/meatsicle/on_reaction(datum/reagent_holder/holder, created_volume)
	var/location = get_turf(holder.my_atom)
	for(var/i = 1, i <= created_volume, i++)
