...
/obj/item/proc/spray_at_wide(atom/A as mob|obj, amount_per_transfer_from_this = 10, spray_size = null, delay = 2)
...
/obj/item/proc/extinguish_spray(atom/A as mob|obj|turf, mob/living/user, amount_per_transfer_from_this = 10, spray_size = 3, delay = 10, spray_particles = 3)
	var/direction = get_dir(src, A)
...
/obj/item/proc/ex_propel_object(obj/O, mob/user, movementdirection)
