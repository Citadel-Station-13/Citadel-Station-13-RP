/datum/lore/character_background/religion/krisitik_ruinist
	...
	category = "Krisitik"
	desc = "Ruinisms whose followers are called Ruinists worship the concept of enthrophy on cosmic level. Its sole god Ruin is a personification of enthrophy itself \
...
/datum/lore/character_background/religion/krisitik_precursor
	...
	they can gain special insight to the sacred mission of Ruinism. To this end Precursors Cultists found special preverance for the Vox a confirmed survivor precursor race \
	as well as Dionae. Precursor Cults often go out on expeditions to find precursor artifacts and knowledge, whether this means visiting Vox arkships, studying ruins on Dioscuri \
	...
	knowledge about precursor civilization that may protect the Krisitik race when faced with destruction."

/datum/lore/character_background/religion/krisitik_fission
	name = "Fission Cults"
	id = "religion_krisitik_fission"
	category = "Krisitik"
	desc = "Fission Cults are offshoot of Ruinism that is considered heretical and dangerous by their roots. The Fission cults do not Worship Fission rather they see Fission, the splitting \
	of atmos and the subsequent release of energy as a metaphor for how life should be lived. Radioactive particles may release a lot of energy over a long period of time as it \
	...
	to engage in criminal activity in order to live their extreme lives. This not only includes illegally trafficking of drugs but also murder, terrorism and piracy. It is not uncommon \
	for Fission Cultists with a terminal or authorities on their tail to launch kamikaze terror attacks in one final 'splitting of the atom'."
