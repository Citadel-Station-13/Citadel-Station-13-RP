...
/datum/lore/character_background/origin/oricon/sol/terran
	name = "Terra"
	id = "terra"
	desc = "You are from Humanity's storied homeworld of Terra. Whether you are from the sprawling cities spanning much of the planet's now verdant surface rebuilt after the calamitous Final War, or it's many orbital habitats, you are likely to have been taught much about humanity's long history upon Earth."
