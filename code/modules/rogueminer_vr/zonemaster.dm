...
/datum/rogue/zonemaster/proc/place_resources(var/turf/simulated/mineral/M)
	...
	if(!M.mineral && prob(rm_controller.diffstep_chances[rm_controller.diffstep])) //Difficulty translates directly into ore chance //Difficulty translates directly into ore chance
