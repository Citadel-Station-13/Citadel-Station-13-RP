...
/proc/log_orbital_deployment(datum/event_args/actor/actor, what, list/log_list)
	log_game("ORBITAL-DEPLOYMENT: [actor ? actor.actor_log_string() : "--userless--"] - [what][log_list ? "; data: [json_encode(log_list)]" : ""]")
