/obj/item/gun/projectile/ballistic/fluff/crestrose
	name = "Crescent Rose"
...
/obj/item/gun/projectile/ballistic/fluff/crestrose/switch_firemodes(mob/user)
	if(..())
		update_icon()
		update_held_icon()


/obj/item/gun/projectile/ballistic/fluff/crestrose/handle_shield(mob/user, var/damage, atom/damage_source = null, mob/attacker = null, var/def_zone = null, var/attack_text = "the attack")
