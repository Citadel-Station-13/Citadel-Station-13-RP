...
/obj/item/card/id/fluff/xennith
	...
	access = list(ACCESS_CENTCOM_GENERAL,ACCESS_CENTCOM_THUNDERDOME,ACCESS_CENTCOM_MEDICAL,ACCESS_CENTCOM_DORMS,ACCESS_CENTCOM_STORAGE,ACCESS_CENTCOM_TELEPORTER,access_research,access_xenobiology,ACCESS_ENGINEERING_MAINT,access_xenoarch,access_robotics,ACCESS_SCIENCE_TOXINS,ACCESS_SCIENCE_FABRICATION) //Yes, this looks awful. I tried calling both central and resarch access but it didn't work.
	age = 39
	blood_type = "O-"
	sex = "Female"
