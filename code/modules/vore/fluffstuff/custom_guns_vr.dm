...
/obj/item/gun/energy/frontier
	...
	icon_state = "phaser"
	item_state = "phaser"
	item_icons = list(slot_l_hand_str = 'icons/mob/inhands/guns_lefthand.dmi', slot_r_hand_str = 'icons/mob/inhands/guns_righthand.dmi', "slot_belt" = 'icons/mob/belt_vr.dmi')
...
/obj/item/gun/energy/frontier/locked/carbine
	...
	item_state = "retro"
	item_icons = list(slot_l_hand_str = 'icons/mob/inhands/guns_lefthand.dmi', slot_r_hand_str = 'icons/mob/inhands/guns_righthand.dmi')
