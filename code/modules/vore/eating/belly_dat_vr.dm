...
/datum/belly
	...
	var/list/slots = list(SLOT_ID_BACK,slot_handcuffed,SLOT_ID_LEFT_POCKET,SLOT_ID_RIGHT_POCKET,SLOT_ID_MASK,slot_l_hand,slot_r_hand,SLOT_ID_WORN_ID,SLOT_ID_GLASSES,SLOT_ID_GLOVES,SLOT_ID_HEAD,SLOT_ID_SHOES,SLOT_ID_BELT,SLOT_ID_SUIT,SLOT_ID_UNIFORM,SLOT_ID_SUIT_STORE,SLOT_ID_LEFT_EAR,SLOT_ID_RIGHT_EAR)
