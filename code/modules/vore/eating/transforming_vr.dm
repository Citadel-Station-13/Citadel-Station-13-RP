/obj/belly/proc/check_eyes(mob/living/carbon/human/M)
	var/mob/living/carbon/human/O = owner
	if(!istype(M) || !istype(O))
		return 0
	return (M.r_eyes != O.r_eyes || M.g_eyes != O.g_eyes || M.b_eyes != O.b_eyes)

/obj/belly/proc/change_eyes(mob/living/carbon/human/M, message=0)
	var/mob/living/carbon/human/O = owner
	if(!istype(M) || !istype(O))
		return
...
/obj/belly/proc/check_hair(mob/living/carbon/human/M)
	var/mob/living/carbon/human/O = owner
	if(!istype(M) || !istype(O))
		return 0
...
/obj/belly/proc/change_hair(mob/living/carbon/human/M, message=0)
	var/mob/living/carbon/human/O = owner
	if(!istype(M) || !istype(O))
		return
...
/obj/belly/proc/check_skin(mob/living/carbon/human/M)
	var/mob/living/carbon/human/O = owner
	if(!istype(M) || !istype(O))
		return 0
...
/obj/belly/proc/change_skin(mob/living/carbon/human/M, message=0)
	var/mob/living/carbon/human/O = owner
	if(!istype(M) || !istype(O))
		return
...
/obj/belly/proc/check_gender(mob/living/carbon/human/M, target_gender)
	var/mob/living/carbon/human/O = owner
	if(!istype(M) || !istype(O))
		return 0
...
/obj/belly/proc/change_gender(mob/living/carbon/human/M, target_gender, message=0)
	var/mob/living/carbon/human/O = owner
	if(!istype(M) || !istype(O))
		return
...
/obj/belly/proc/check_tail(mob/living/carbon/human/M)
	var/mob/living/carbon/human/O = owner
	if(!istype(M) || !istype(O))
		return 0
...
/obj/belly/proc/change_tail(mob/living/carbon/human/M, message=0)
	var/mob/living/carbon/human/O = owner
	if(!istype(M) || !istype(O))
		return
...
/obj/belly/proc/check_tail_nocolor(mob/living/carbon/human/M)
	var/mob/living/carbon/human/O = owner
	if(!istype(M) || !istype(O))
		return 0
...
/obj/belly/proc/change_tail_nocolor(mob/living/carbon/human/M, message=0)
	var/mob/living/carbon/human/O = owner
	if(!istype(M) || !istype(O))
		return
...
/obj/belly/proc/check_wing(mob/living/carbon/human/M)
	var/mob/living/carbon/human/O = owner
	if(!istype(M) || !istype(O))
		return 0
...
/obj/belly/proc/change_wing(mob/living/carbon/human/M, message=0)
	var/mob/living/carbon/human/O = owner
	if(!istype(M) || !istype(O))
		return
...
/obj/belly/proc/check_wing_nocolor(mob/living/carbon/human/M)
	var/mob/living/carbon/human/O = owner
	if(!istype(M) || !istype(O))
		return 0
...
/obj/belly/proc/change_wing_nocolor(mob/living/carbon/human/M, message=0)
	var/mob/living/carbon/human/O = owner
	if(!istype(M) || !istype(O))
		return
...
/obj/belly/proc/check_ears(mob/living/carbon/human/M)
	var/mob/living/carbon/human/O = owner
	if(!istype(M) || !istype(O))
		return 0
...
/obj/belly/proc/change_ears(mob/living/carbon/human/M, message=0)
	var/mob/living/carbon/human/O = owner
	if(!istype(M) || !istype(O))
		return
...
/obj/belly/proc/check_species(mob/living/carbon/human/M)
	var/mob/living/carbon/human/O = owner
	if(!istype(M) || !istype(O))
		return 0
...
/obj/belly/proc/change_species(mob/living/carbon/human/M, message=0, color_action = 0)	//color_action: 0 for default species, 1 to preserve, 2 to transfer from pred
	var/mob/living/carbon/human/O = owner
	if(!istype(M) || !istype(O))
		return
