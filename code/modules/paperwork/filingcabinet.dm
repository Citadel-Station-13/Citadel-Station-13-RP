...
/obj/structure/filingcabinet/attack_hand(mob/user, datum/event_args/clickchain/e_args)
	if(contents.len <= 0)
...
/obj/structure/filingcabinet/security/attack_hand(mob/user, datum/event_args/clickchain/e_args)
	populate()
	..()
...
/obj/structure/filingcabinet/medical/attack_hand(mob/user, datum/event_args/clickchain/e_args)
	populate()
	..()
