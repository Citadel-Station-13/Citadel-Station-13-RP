...
/obj/machinery/photocopier/faxmachine/proc/message_admins(var/mob/sender, var/faxname, var/obj/item/sent, var/reply_type, font_colour="#006100")
	var/msg = "<span class='notice fax'><b><font color='[font_colour]'>[faxname]: </font>[get_options_bar(sender, 2,1,1)]"
	...
	if (istype(sent, /obj/item/paper))
		var/obj/item/paper/sent_p = sent
		new /datum/admin_help(sent_p.info, sender.client, FALSE)
	//End of citadel edit
