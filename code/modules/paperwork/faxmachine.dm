...
var/list/admin_departments = list("[SSmapping.legacy_map_config.boss_name]", "Virgo-Prime Governmental Authority", "Supply") // Vorestation Edit
...
/obj/machinery/photocopier/faxmachine/Initialize(mapload)
	...
	allfaxes += src
	if(!destination)
		destination = "[SSmapping.legacy_map_config.boss_name]"
...
/obj/machinery/photocopier/faxmachine/nano_ui_interact(mob/user, ui_key = "main", var/datum/nanoui/ui = null, var/force_open = 1)
	...
	if(scan)
		...
		data["scanName"] = null
	data["bossName"] = SSmapping.legacy_map_config.boss_name
...
/obj/machinery/photocopier/faxmachine/proc/send_admin_fax(var/mob/sender, var/destination)
	...
	if (destination == SSmapping.legacy_map_config.boss_name)
		message_admins(sender, "[uppertext(SSmapping.legacy_map_config.boss_short)] FAX", rcvdcopy, "CentComFaxReply", "#006100")
		...
		message_admins(sender, "[uppertext(SSmapping.legacy_map_config.boss_short)] SUPPLY FAX", rcvdcopy, "CentComFaxReply", "#5F4519")
	else
