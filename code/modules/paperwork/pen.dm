...
/obj/item/pen/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
	if(!clickable)
...
/obj/item/pen/multi/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
	if(++selectedColor > 3)
...
/obj/item/pen/click/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
...
/obj/item/pen/chameleon/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
	/*
