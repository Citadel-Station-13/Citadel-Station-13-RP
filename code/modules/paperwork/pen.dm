...
/obj/item/pen/attack_self(mob/user, datum/event_args/actor/e_args)
	. = ..()
	if(.)
		return
	if(!clickable)
...
/obj/item/pen/multi/attack_self(mob/user, datum/event_args/actor/e_args)
	. = ..()
	if(.)
		return
	if(++selectedColor > 3)
...
/obj/item/pen/click/attack_self(mob/user, datum/event_args/actor/e_args)
	. = ..()
	if(.)
		return
...
/obj/item/pen/chameleon/attack_self(mob/user, datum/event_args/actor/e_args)
	. = ..()
	if(.)
		return
	/*
