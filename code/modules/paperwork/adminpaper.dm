...
/obj/item/paper/admin/proc/generateFooter()
	...
	text += "If this transmission is received in error, please notify both the sender and the office of [using_map_legacy().boss_name] Internal Affairs immediately so that corrective action may be taken."
