...
/turf/Entered(atom/movable/AM)
	. = ..()
	if(SSopenspace.subsystem_initialised && !AM.invisibility && isobj(AM))
...
/obj/update_icon()
	. = ..()
	if(SSopenspace.subsystem_initialised && !invisibility && isturf(loc))
		var/turf/T = GetAbove(src)
		if(isopenspace(T))
...
/obj/New()
	. = ..()
	if(SSopenspace.subsystem_initialised && !invisibility)
		var/turf/T = GetAbove(src)
		if(isopenspace(T))
