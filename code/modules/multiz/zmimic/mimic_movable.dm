...
/atom/movable/openspace/mimic/attack_hand(mob/user, datum/event_args/clickchain/e_args)
...
/atom/movable/openspace/turf_proxy/attack_hand(mob/user, datum/event_args/clickchain/e_args)
...
/atom/movable/openspace/turf_mimic/attack_hand(mob/user, datum/event_args/clickchain/e_args)
	to_chat(user, SPAN_NOTICE("You cannot reach \the [src] from here."))
