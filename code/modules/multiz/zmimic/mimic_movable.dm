...
/// The overlay that is directly mirroring us that we proxy movement to.
/atom/movable/var/tmp/atom/movable/openspace/overlay/bound_overlay
/// If TRUE, this atom will not be drawn on open turfs.
/atom/movable/var/no_z_overlay
...
/atom/movable/openspace/overlay/examine(...)
	return associated_atom.examine(arglist(args)) // Just pass all the args to the copied atom.
