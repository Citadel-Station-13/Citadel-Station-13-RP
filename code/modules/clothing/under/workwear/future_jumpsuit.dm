...
/obj/item/clothing/under/future_fashion
	...
	icon = 'icons/clothing/uniform/workwear/future/dark_blue.dmi'
...
/obj/item/clothing/under/future_fashion/green_striped
	...
	icon = 'icons/clothing/uniform/workwear/future/green.dmi'
	icon_state = "green"
	worn_bodytypes = BODYTYPES(BODYTYPE_DEFAULT)
	worn_rolldown_bodytypes = BODYTYPES(BODYTYPE_DEFAULT)
	worn_has_rollsleeve = UNIFORM_HAS_NO_ROLL
...
/obj/item/clothing/under/future_fashion/light_blue_striped
	...
	icon = 'icons/clothing/uniform/workwear/future/light_blue.dmi'
...
/obj/item/clothing/under/future_fashion/orange_striped
	...
	icon = 'icons/clothing/uniform/workwear/future/orange.dmi'
	icon_state = "orange"
	worn_bodytypes = BODYTYPES(BODYTYPE_DEFAULT)
	worn_rolldown_bodytypes = BODYTYPES(BODYTYPE_DEFAULT)
	worn_has_rollsleeve = UNIFORM_HAS_NO_ROLL
...
/obj/item/clothing/under/future_fashion/purple_striped
	...
	icon = 'icons/clothing/uniform/workwear/future/purple.dmi'
	icon_state = "purple"
	worn_bodytypes = BODYTYPES(BODYTYPE_DEFAULT)
	worn_rolldown_bodytypes = BODYTYPES(BODYTYPE_DEFAULT)
	worn_has_rollsleeve = UNIFORM_HAS_NO_ROLL
...
/obj/item/clothing/under/future_fashion/red_striped
	...
	icon = 'icons/clothing/uniform/workwear/future/red.dmi'
	icon_state = "red"
	worn_bodytypes = BODYTYPES(BODYTYPE_DEFAULT)
	worn_rolldown_bodytypes = BODYTYPES(BODYTYPE_DEFAULT)
	worn_has_rollsleeve = UNIFORM_HAS_NO_ROLL
