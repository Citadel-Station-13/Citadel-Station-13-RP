...
/obj/item/clothing/accessory/badge/attack_self(mob/user, datum/event_args/actor/clickchain/e_args)
	. = ..()
	if(.)
		return
...
/obj/item/clothing/accessory/badge/sheriff/attack_self(mob/user, datum/event_args/actor/clickchain/e_args)
	. = ..()
	if(.)
		return
...
/obj/item/clothing/accessory/badge/holo/attack_self(mob/user, datum/event_args/actor/clickchain/e_args)
	. = ..()
	if(.)
		return
	if(!stored_name)
