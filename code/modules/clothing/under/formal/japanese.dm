...
/obj/item/clothing/under/kimono_black
	...
	icon = 'icons/clothing/uniform/formal/dress/kimono_black.dmi'
...
/obj/item/clothing/under/kimono_sakura
	...
	icon = 'icons/clothing/uniform/formal/dress/kimono_sakura.dmi'
...
/obj/item/clothing/under/kimono_fancy
	...
	icon = 'icons/clothing/uniform/formal/dress/kimono_fancy.dmi'
...
/obj/item/clothing/under/kimono/red
	name = "red kimono"
	desc = "The traditional dress of old Earth Japan, the kimono remains ubiquitous across the galaxy due to its comfort, simplicity, and versatility."
	icon = 'icons/clothing/uniform/formal/dress/kimono_red.dmi'
...
/obj/item/clothing/under/kimono/orange
	name = "orange kimono"
	icon = 'icons/clothing/uniform/formal/dress/kimono_orange.dmi'
...
/obj/item/clothing/under/kimono/yellow
	name = "yellow kimono"
	icon = 'icons/clothing/uniform/formal/dress/kimono_yellow.dmi'
...
/obj/item/clothing/under/kimono/green
	name = "green kimono"
	icon = 'icons/clothing/uniform/formal/dress/kimono_green.dmi'
...
/obj/item/clothing/under/kimono/blue
	name = "blue kimono"
	icon = 'icons/clothing/uniform/formal/dress/kimono_blue.dmi'
...
/obj/item/clothing/under/kimono/purple
	name = "purple kimono"
	icon = 'icons/clothing/uniform/formal/dress/kimono_purple.dmi'
...
/obj/item/clothing/under/kimono/violet
	name = "violet kimono"
	icon = 'icons/clothing/uniform/formal/dress/kimono_violet.dmi'
...
/obj/item/clothing/under/kimono/pink
	name = "pink kimono"
	icon = 'icons/clothing/uniform/formal/dress/kimono_pink.dmi'
...
/obj/item/clothing/under/kimono/earth
	name = "earth kimono"
	icon = 'icons/clothing/uniform/formal/dress/kimono_earth.dmi'
