...
/obj/item/clothing/glasses/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
	if(toggleable)
...
/obj/item/clothing/glasses/welding/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
	toggle(user)
...
/obj/item/clothing/glasses/sunglasses/sechud/aviator/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
...
/obj/item/clothing/glasses/aerogelgoggles/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
	toggle()
