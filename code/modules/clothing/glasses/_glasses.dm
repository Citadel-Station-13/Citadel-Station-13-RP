...
/obj/item/clothing/glasses/attack_self(mob/user, datum/event_args/actor/e_args)
	. = ..()
	if(.)
		return
	if(toggleable)
...
/obj/item/clothing/glasses/welding/attack_self(mob/user, datum/event_args/actor/e_args)
	. = ..()
	if(.)
		return
	toggle(user)
...
/obj/item/clothing/glasses/sunglasses/sechud/aviator/attack_self(mob/user, datum/event_args/actor/e_args)
	. = ..()
	if(.)
		return
...
/obj/item/clothing/glasses/aerogelgoggles/attack_self(mob/user, datum/event_args/actor/e_args)
	. = ..()
	if(.)
		return
	toggle()
