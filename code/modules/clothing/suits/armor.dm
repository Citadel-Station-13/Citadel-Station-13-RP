...
/obj/item/clothing/suit/armor/reactive/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
	active = !( active )
...
/obj/item/clothing/suit/armor/vest/para/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
