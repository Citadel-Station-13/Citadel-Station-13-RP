...
/obj/item/clothing/suit/armor/reactive/attack_self(mob/user, datum/event_args/actor/clickchain/e_args)
	. = ..()
	if(.)
		return
	active = !( active )
...
/obj/item/clothing/suit/armor/vest/para/attack_self(mob/user, datum/event_args/actor/clickchain/e_args)
	. = ..()
	if(.)
		return
