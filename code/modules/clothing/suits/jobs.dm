...
/obj/item/clothing/suit/storage/toggle/necroagent //no armor on this one chief.
	name = "OSS&NECRO Field Jacket"
	desc = "A leather jacket branded with the OSS&NECRO logo on the back. Standard equipement for any OSS&NERCRO Field Operatives."
	icon_state = "agent_jacket"
	body_cover_flags = UPPER_TORSO|ARMS
	inv_hide_flags = HIDEHOLSTER
	allowed = list(/obj/item/gun/ballistic/sec/flash, /obj/item/tank/emergency/oxygen, /obj/item/flashlight, /obj/item/gun/energy, /obj/item/gun/ballistic, /obj/item/ammo_magazine,
	/obj/item/ammo_casing, /obj/item/melee/baton, /obj/item/handcuffs, /obj/item/storage/fancy/cigarettes, /obj/item/flame/lighter,
	/obj/item/tape_recorder, /obj/item/uv_light, /obj/item/stack/medical, /obj/item/reagent_containers/dropper, /obj/item/reagent_containers/hypospray, /obj/item/reagent_containers/syringe,
	/obj/item/healthanalyzer, /obj/item/flashlight, /obj/item/radio, /obj/item/tank/emergency/oxygen) //Given to both EMTs and Forensics, can carry equipement for both.
