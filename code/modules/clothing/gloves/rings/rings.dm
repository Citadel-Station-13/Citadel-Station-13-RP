...
/obj/item/clothing/gloves/ring/engagement/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
...
/obj/item/clothing/gloves/ring/seal/signet/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
	if(nameset)
...
/obj/item/clothing/gloves/ring/wedding/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
