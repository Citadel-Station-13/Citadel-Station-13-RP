...
/obj/item/clothing/gloves/ring/engagement/attack_self(mob/user, datum/event_args/actor/actor)
	. = ..()
	if(.)
		return
...
/obj/item/clothing/gloves/ring/seal/signet/attack_self(mob/user, datum/event_args/actor/actor)
	. = ..()
	if(.)
		return
	if(nameset)
...
/obj/item/clothing/gloves/ring/wedding/attack_self(mob/user, datum/event_args/actor/actor)
	. = ..()
	if(.)
		return
