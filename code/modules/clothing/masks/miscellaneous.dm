...
/obj/item/clothing/mask/muzzle/attack_hand(mob/user, list/params, datum/event_args/clickchain/e_args)
...
/obj/item/clothing/mask/bandana/attack_self(mob/user, datum/event_args/clickchain/e_args)
	. = ..()
...
/obj/item/clothing/mask/paper/attack_self(mob/user, datum/event_args/clickchain/e_args)
	. = ..()
	if(.)
		return
