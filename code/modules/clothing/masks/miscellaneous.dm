...
/obj/item/clothing/mask/bandana/attack_self(mob/user, datum/event_args/actor/clickchain/e_args)
	. = ..()
...
/obj/item/clothing/mask/paper/attack_self(mob/user, datum/event_args/actor/clickchain/e_args)
	. = ..()
	if(.)
		return
