...
/obj/item/rig_module/vision/engage()
	...
	if(starting_up)
		to_chat(holder.wearer, "<span class='notice'>You activate your visual sensors.</span>")
		return 1
	...
	if(vision_modes.len > 1)
		...
		to_chat(holder.wearer, "<span class='notice'>You cycle your sensors to <b>[vision.mode]</b> mode.</span>")
	else
		to_chat(holder.wearer, "<span class='notice'>Your sensors only have one mode.</span>")
	return 1
