...
/obj/item/clothing/head/welding/attack_self(mob/user, datum/event_args/actor/e_args)
	. = ..()
	if(.)
		return
	toggle(user)
...
/obj/item/clothing/head/cakehat/attack_self(mob/user, datum/event_args/actor/e_args)
	. = ..()
	if(.)
		return
	onfire = !(onfire)
...
/obj/item/clothing/head/ushanka/attack_self(mob/user, datum/event_args/actor/e_args)
	. = ..()
	if(.)
		return
