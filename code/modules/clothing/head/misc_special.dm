...
/obj/item/clothing/head/welding/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
	toggle(user)
...
/obj/item/clothing/head/cakehat/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
	onfire = !(onfire)
...
/obj/item/clothing/head/ushanka/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
