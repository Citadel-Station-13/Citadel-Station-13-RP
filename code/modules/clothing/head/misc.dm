...
/obj/item/clothing/head/reindeer/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
...
/obj/item/clothing/head/cowl/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
	if(src.icon_state == initial(icon_state))
