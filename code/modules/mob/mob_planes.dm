...
/datum/plane_holder/New(mob/this_guy)
	...
	plane_masters[VIS_FLOOR]      = new /atom/movable/screen/plane_master/main{plane = FLOOR_PLANE}
	plane_masters[VIS_GAME]       = new /atom/movable/screen/plane_master/main{plane = GAME_PLANE}
	plane_masters[VIS_SEETHROUGH] = new /atom/movable/screen/plane_master/main{plane = SEETHROUGH_PLANE}
