...
/mob/new_player/Topic(href, href_list[])
	...
	if(href_list["observe"])
		...
		if(alert(src,"Are you sure you wish to observe? You will have to wait two minutes before being able to respawn!","Player Setup","Yes","No") == "Yes") //Citadelstation edit
			if(!client)	return 1
