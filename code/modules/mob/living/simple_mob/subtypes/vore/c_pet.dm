...
/mob/living/simple_mob/animal/passive/honkpet/attack_hand(mob/user, datum/event_args/clickchain/e_args)
...
/mob/living/simple_mob/animal/passive/mimepet/attack_hand(mob/user, datum/event_args/clickchain/e_args)
	if(user.a_intent == INTENT_DISARM)
