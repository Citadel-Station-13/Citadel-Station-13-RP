...
/mob/living/simple_mob/animal/stormdrifter
	...
	ai_holder_type = /datum/ai_holder/fsm/simple_mob/stormdrifter
...
/datum/ai_holder/fsm/simple_mob/stormdrifter
	hostile = FALSE
	retaliate = TRUE
	can_flee = TRUE
...
/mob/living/simple_mob/animal/stormdrifter/bull
	...
	ai_holder_type = /datum/ai_holder/fsm/simple_mob/stormdrifter/bull
...
/datum/ai_holder/fsm/simple_mob/stormdrifter/bull
	hostile = TRUE
	cooperative = TRUE
	can_flee = FALSE

/datum/ai_holder/fsm/simple_mob/stormdrifter/bull_neutered
	hostile = FALSE
	cooperative = FALSE
	can_flee = FALSE
...
/mob/living/simple_mob/animal/stormdrifter/bull/attackby(var/obj/item/O as obj, var/mob/user as mob)
	if(istype(O, /obj/item/tool/wirecutters) || is_sharp(O))
		...
		ai_holder_type = /datum/ai_holder/fsm/simple_mob/stormdrifter/bull_neutered
