...
/mob/living/simple_mob/aquatic/Initialize(mapload)
	. = ..()
...
/mob/living/simple_mob/aquatic/Life()
...
/mob/living/simple_mob/aquatic/handle_atmos(atmos_suitable = TRUE)
