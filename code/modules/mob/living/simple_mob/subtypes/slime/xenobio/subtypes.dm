...
/mob/living/simple_mob/slime/xenobio/dark_purple/bullet_act(obj/projectile/proj, impact_flags, def_zone, efficiency)
	. = ..()
...
/mob/living/simple_mob/slime/xenobio/silver/bullet_act(obj/projectile/proj, impact_flags, def_zone, efficiency)
...
/mob/living/simple_mob/slime/xenobio/oil/bullet_act(obj/projectile/proj, impact_flags, def_zone, efficiency)
	. = ..()
	if(proj.damage_type && proj.damage_type == BURN && proj.damage) // Most bullets won't trigger the explosion, as a mercy towards Security.
