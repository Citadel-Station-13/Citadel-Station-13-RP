...
/mob/living/simple_mob/slime/xenobio/dark_purple/attackby_legacy(var/obj/item/W, var/mob/user)
...
/mob/living/simple_mob/slime/xenobio/oil/attackby_legacy(obj/item/W, mob/living/user)
	if(istype(W) && W.force && W.damtype == BURN)
