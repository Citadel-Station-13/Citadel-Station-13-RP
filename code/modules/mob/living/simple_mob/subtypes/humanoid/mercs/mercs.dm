...
/mob/living/simple_mob/humanoid/merc/melee/sword/bullet_act(obj/projectile/proj, impact_flags, def_zone, efficiency)
	if(prob(35))
...
/mob/living/simple_mob/humanoid/merc/ranged/space/suppressor/bullet_act(obj/projectile/proj, impact_flags, def_zone, efficiency)
	if(prob(50))
		visible_message("<span class='warning'>[src] blocks [proj] with its shield!</span>")
		if(proj.firer)
			ai_holder.react_to_attack_polaris(proj.firer)
...
/mob/living/simple_mob/humanoid/merc/voxpirate/boarder/bullet_act(obj/projectile/proj, impact_flags, def_zone, efficiency)
	if(prob(35))
