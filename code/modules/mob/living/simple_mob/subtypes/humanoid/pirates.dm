...
/mob/living/simple_mob/humanoid/pirate/las
	...
	loot_list = list(/obj/item/melee/transforming/energy/sword/pirate = 100)
...
/mob/living/simple_mob/humanoid/pirate/las/armored
	...
	movement_cooldown = 4
	armor_legacy_mob = list(melee = 30, bullet = 20, laser = 20, energy = 5, bomb = 5, bio = 100, rad = 100)
	loot_list = list(/obj/item/melee/transforming/energy/sword/pirate = 100, /obj/item/clothing/accessory/armor/armorplate/stab = 100)
...
/mob/living/simple_mob/humanoid/merc/melee/sword/bullet_act(obj/projectile/proj, impact_flags, def_zone, blocked)
	if(prob(25))
...
/mob/living/simple_mob/humanoid/pirate/mate
	...
	loot_list = list(/obj/item/melee/transforming/energy/sword/pirate = 100, /obj/item/clothing/suit/armor/riot/alt = 100)
...
/mob/living/simple_mob/humanoid/pirate/las/armored/old
	...
	loot_list = list(/obj/item/melee/transforming/energy/sword/pirate = 100, /obj/item/clothing/suit/armor/material/makeshift = 100)
...
/mob/living/simple_mob/humanoid/pirate/mate
	...
	loot_list = list(/obj/item/melee/transforming/energy/sword/pirate = 100, /obj/item/clothing/suit/pirate = 100)
