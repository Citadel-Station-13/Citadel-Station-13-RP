...
/obj/item/mmi/digital/posibrain/proc/transfer_personality(var/mob/candidate)
	...
	for (var/mob/M in viewers(T))
		M.show_message("<span class='notice'>The positronic brain beeps as it loads a personality.</span>")
...
/obj/item/mmi/digital/posibrain/proc/reset_search() //We give the players sixty seconds to decide, then reset the timer.
	...
	var/turf/T = get_turf_or_move(src.loc)
	for (var/mob/M in viewers(T))
		M.show_message("<span class='notice'>The positronic brain buzzes and beeps, and the golden lights fade away. Perhaps you could try again?</span>")
