...
/obj/item/mmi/attack_self(mob/user, datum/event_args/actor/clickchain/e_args)
	. = ..()
	if(.)
		return
	if(!brainmob)
...
/obj/item/mmi/digital/attack_self(mob/user, datum/event_args/actor/clickchain/e_args)
