...
/obj/effect/weaversilk/attack_hand(mob/user, list/params, datum/event_args/clickchain/e_args)
	..()
...
/obj/structure/bed/double/weaversilk_nest/attack_hand(mob/user, list/params, datum/event_args/clickchain/e_args)
	..()
