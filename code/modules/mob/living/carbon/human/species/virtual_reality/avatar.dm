...
/datum/species/shapeshifter/promethean/avatar
	...
	valid_transform_species = list(SPECIES_HUMAN, SPECIES_VATGROWN, SPECIES_UNATHI, SPECIES_TAJ, SPECIES_SKRELL, SPECIES_DIONA, SPECIES_TESHARI, SPECIES_VOX, SPECIES_MONKEY, SPECIES_SKELETON)
