			...
			switch(halpick)
				...
				if(36 to 55) //20% chance
					...
					switch(rand(1,12))
						...
						if(2)
							if(prob(50))SEND_SOUND(src, sound('sound/soundbytes/effects/explosion1.ogg'))
							else SEND_SOUND(src, sound('sound/soundbytes/effects/explosion2.ogg'))
						if(3) SEND_SOUND(src, sound('sound/soundbytes/effects/explosionfar.ogg'))
