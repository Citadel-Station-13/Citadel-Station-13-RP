...
/datum/species/shapeshifter/promethean
	...
	num_alternate_languages = 2 // Not stuck with one other lang
	...
	blood_volume = 560
	slowdown	 = -0.2
	brute_mod	 = 0.5	// Used to be 0.75
	burn_mod	 = 2
	oxy_mod		 = 0
	flash_mod	 = 0.5	// No centralized, lensed eyes.
	item_slowdown_mod = 0.66	// Used to be 1.33
...
/datum/species/shapeshifter/promethean/hug(var/mob/living/carbon/human/H, var/mob/living/target)
	...
	if(H.zone_sel.selecting == "head" || H.zone_sel.selecting == "r_hand" || H.zone_sel.selecting == "l_hand") return ..()
	var/t_him = "them"
	if(ishuman(target))
