/datum/species/shapeshifter/promethean
	...
	heal_rate = 0.35 //As of writing, original was 0.5 - Slows regen speed (bad)
	hunger_factor = 0.07 //As of writing, original was 0.2 - Slows hunger rate (good)
	...
	num_alternate_languages = 2 //Might be outdated: They currently have 3 in the other file
