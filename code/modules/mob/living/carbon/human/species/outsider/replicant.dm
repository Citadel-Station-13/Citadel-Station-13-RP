...
/datum/species/shapeshifter/replicant
	...
	valid_transform_species = list(SPECIES_HUMAN, SPECIES_VATGROWN, SPECIES_UNATHI, SPECIES_TAJ, SPECIES_SKRELL, SPECIES_DIONA, SPECIES_TESHARI, SPECIES_MONKEY, SPECIES_VOX)
