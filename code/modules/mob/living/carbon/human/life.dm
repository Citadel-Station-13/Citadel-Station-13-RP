	...
	if(reagents)
		...
		if(!isSynthetic())
			...
			for(var/obj/item/I in src)
				if(I.contaminated)
					if(check_belly(I)) continue					if(src.species && !(src.species.flags & CONTAMINATION_IMMUNE))	//VOREStation Edit: shadekin; CitadelRP: Black-Eyed Shadekin don't get afflicted from contaminated clothing
