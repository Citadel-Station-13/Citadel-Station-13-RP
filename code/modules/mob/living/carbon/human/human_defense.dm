...
/mob/living/carbon/human/legacy_mob_armor(def_zone, type)
	var/armorval = 0
	var/total = 0
...
/mob/living/carbon/human/legacy_mob_soak(def_zone, type)
	var/soakval = 0
	var/total = 0
...
/mob/living/carbon/human/proc/getsoak_organ(obj/item/organ/external/def_zone, type)
	if(!type || !def_zone)
		return 0
	var/soaked = 0
	var/list/protective_gear = def_zone.get_covering_clothing()
...
/mob/living/carbon/human/proc/attack_joint(obj/item/organ/external/organ, obj/item/W, effective_force, dislocate_mult, blocked, soaked)
...
/mob/living/carbon/human/proc/can_catch(obj/O)
