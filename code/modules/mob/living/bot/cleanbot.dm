...
/mob/living/bot/cleanbot/roomba/proc/annoy(var/mob/living/L)
	if(coolingdown == FALSE)
		switch(armed)
			if(1)
				L.visible_message(SPAN_WARNING("\The [src] [pick("prongs","pokes","pricks")] \the [L]"), SPAN_WARNING("The little shit, \the [src], stabs you with its attached fork!"))
				var/damage = rand(1,5)
				L.adjustBruteLoss(damage)
			if(2)
				L.visible_message(SPAN_WARNING("\The [src] prongs and singes \the [L]"), SPAN_WARNING("The little shit, \the [src], singes and stabs you with its attached fork and lighter!"))
...
/mob/living/bot/cleanbot/roomba/meido/annoy(var/mob/living/L)
	if(!coolingdown && armed)
		L.visible_message(SPAN_WARNING("\The [src] [pick("jabs","stabs","pokes")] \the [L]"), SPAN_WARNING("The little shit, \the [src], stabs you with its knife!"))
