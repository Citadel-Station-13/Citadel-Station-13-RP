...
/mob/living/bot/mulebot/ui_data(mob/user, datum/tgui/ui, datum/tgui_embed_context/embed_context)
	var/list/data = list(
		"suffix" = suffix,
		"power" = on,
...
/mob/living/bot/mulebot/ui_act(action, list/params, datum/tgui/ui, datum/tgui_embed_context/embed_context)
	if(..())
		return TRUE
