...
/mob/living/bot/mulebot
	...
	target_speed = 3
	max_frustration = 5
	botcard_access = list(ACCESS_ENGINEERING_MAINT, ACCESS_SUPPLY_MAIN, access_cargo, access_cargo_bot, ACCESS_SUPPLY_QM, ACCESS_SUPPLY_MINE, ACCESS_SUPPLY_MINE_OUTPOST)
