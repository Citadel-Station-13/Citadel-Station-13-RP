...
/mob/living/bot/secbot/ed209/slime
	...
	botcard_access = list(access_research, access_robotics, access_xenobiology, access_xenoarch, ACCESS_SCIENCE_FABRICATION, ACCESS_SCIENCE_TOXINS, access_maint_tunnels)
