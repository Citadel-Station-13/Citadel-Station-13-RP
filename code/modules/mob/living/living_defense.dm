...
/mob/living/proc/run_armor_check(var/def_zone = null, var/attack_flag = "melee", var/armour_pen = 0, var/absorb_text = null, var/soften_text = null)
	if(Debug2)
		to_chat(world.log, "## DEBUG: getarmor() was called.")
	...
	if(armor)
		...
		if(Debug2)
			to_chat(world.log, "## DEBUG: The range of armor variance is [armor_variance_range].  The variance picked by RNG is [armor_variance].")
		...
		if(Debug2)
			to_chat(world.log, "## DEBUG: Armor when [src] was attacked was [armor].")
	return armor
