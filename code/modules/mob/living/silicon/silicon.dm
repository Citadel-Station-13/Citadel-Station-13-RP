...
/mob/living/silicon/emp_act(severity)
	switch(severity)
		if(1)
			src.take_random_targeted_damage(brute = 0, brute = 20, damage_mode = DAMAGE_MODE_INTERNAL, weapon_descriptor = "electromagnetic surge")
			Confuse(5)
		if(2)
			src.take_random_targeted_damage(brute = 0, brute = 15, damage_mode = DAMAGE_MODE_INTERNAL, weapon_descriptor = "electromagnetic surge")
			Confuse(4)
		if(3)
			src.take_random_targeted_damage(brute = 0, brute = 10, damage_mode = DAMAGE_MODE_INTERNAL, weapon_descriptor = "electromagnetic surge")
			Confuse(3)
		if(4)
			src.take_random_targeted_damage(brute = 0, brute = 5, damage_mode = DAMAGE_MODE_INTERNAL, weapon_descriptor = "electromagnetic surge")
			Confuse(2)
