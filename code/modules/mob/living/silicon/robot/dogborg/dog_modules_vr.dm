...
/obj/item/dogborg/jaws/small/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
...
/obj/item/dogborg/boop_module/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
...
/obj/item/dogborg/tongue/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
	var/mob/living/silicon/robot/R = user
...
/obj/item/pupscrubber/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
	var/mob/living/silicon/robot/R = user
...
/obj/item/lightreplacer/dogborg/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
...
/obj/item/dogborg/pounce/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
	var/mob/living/silicon/robot/R = user
