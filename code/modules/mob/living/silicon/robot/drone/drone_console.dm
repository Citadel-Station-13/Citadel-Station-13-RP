...
/obj/machinery/computer/drone_control/attack_hand(var/mob/user as mob)
	...
	for(var/mob/living/silicon/robot/drone/D in mob_list)
		...
		dat += "<BR>[D.real_name] ([D.stat == 2 ? "<span class='danger'>INACTIVE</span>" : "<font color='green'>ACTIVE</FONT>"])"
	...
	dat += "[dronefab ? "<A href='?src=\ref[src];toggle_fab=1'>[(dronefab.produce_drones && !(dronefab.stat & NOPOWER)) ? "ACTIVE" : "INACTIVE"]</A>" : "<span class='danger'><b>FABRICATOR NOT DETECTED.</b></span> (<A href='?src=\ref[src];search_fab=1'>search</a>)"]"
