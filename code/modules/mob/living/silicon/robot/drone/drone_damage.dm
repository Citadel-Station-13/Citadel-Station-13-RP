...
/mob/living/silicon/robot/drone/take_overall_damage(brute, burn, damage_mode, weapon_descriptor, defer_updates)(var/brute = 0, var/burn = 0, var/sharp = 0, var/used_weapon = null)
	bruteloss += brute
	fireloss += burn
