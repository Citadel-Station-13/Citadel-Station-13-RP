...
/mob/living/silicon/robot/drone/init()
	...
	flavor_text = "It's a tiny little repair drone. The casing is stamped with an corporate logo and the subscript: '[SSmapping.legacy_map_config.company_name] Recursive Repair Systems: Fixing Tomorrow's Problem, Today!'"
