...
/mob/living/silicon/robot/drone/init()
	...
	flavor_text = "It's a tiny little repair drone. The casing is stamped with an corporate logo and the subscript: '[using_map_legacy().company_name] Recursive Repair Systems: Fixing Tomorrow's Problem, Today!'"
...
/mob/living/silicon/robot/drone/construction/matriarch/Initialize()
	. = ..()
	matrix_tag = "[using_map_legacy().company_name]"
