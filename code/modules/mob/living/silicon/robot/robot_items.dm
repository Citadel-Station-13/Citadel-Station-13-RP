...
/obj/item/portable_destructive_analyzer/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
...
/obj/item/pen/robopen/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
...
/obj/item/form_printer/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
...
/obj/item/borg/combat/shield/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
	set_shield_level()
...
/obj/item/inflatable_dispenser/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
	mode = !mode
