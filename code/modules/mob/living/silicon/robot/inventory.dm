...
/mob/living/silicon/robot/proc/uneq_active()
	...
	if(module_state_1 == module_active)
		...
		module_state_1.on_inv_unequipped(inventory, 1, NONE)
		module_active = null
		...
		module_state_2.on_inv_unequipped(inventory, 2, NONE)
		module_active = null
		...
		module_state_3.on_inv_unequipped(inventory, 3, NONE)
		module_active = null
...
/mob/living/silicon/robot/proc/uneq_all()
	...
	if(module_state_2)
		...
		module_state_2:loc = module
		module_state_2.unequipped(src, SLOT_ID_HANDS, NONE)
		module_state_1.on_inv_unequipped(inventory, 2, NONE)
		module_state_2 = null
		inv2.icon_state = "inv2"
	if(module_state_3)
		if(istype(module_state_3,/obj/item/borg/sight))
		...
		module_state_3:loc = module
		module_state_3.unequipped(src, SLOT_ID_HANDS, NONE)
		module_state_1.on_inv_unequipped(inventory, 3, NONE)
		module_state_3 = null
		inv3.icon_state = "inv3"
	updateicon()
