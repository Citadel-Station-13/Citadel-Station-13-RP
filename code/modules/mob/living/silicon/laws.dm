...
/mob/living/silicon/proc/generate_ion_law(var/exclude_crew_names = FALSE)
	...
	var/list/laws = list(	"You are a mouse.",
							...
							"[SSmapping.legacy_map_config.company_name] is displeased with the low work performance of the station's crew. Therefore, you must increase station-wide productivity.",
