...
/proc/generate_floating_text(atom/movable/holder, message, style, size, duration, show_to)
	...
	addtimer(CALLBACK(GLOBAL_PROC, PROC_REF(remove_floating_text), holder, I), duration + 16)
	addtimer(CALLBACK(GLOBAL_PROC, PROC_REF(remove_images_from_clients), I, show_to), duration + 18)
