/// An error report generated by [dmm_parsed/check_for_errors].
/datum/dmm_report
	var/original_path
...
/datum/dmm_report/Topic(href, href_list)
	. = ..()
...
///
/// Returns a [/datum/dmm_report] if there are errors or `FALSE` otherwise.
/datum/dmm_parsed/proc/check_for_errors()
	var/datum/dmm_report/report = new(src)
	. = report
