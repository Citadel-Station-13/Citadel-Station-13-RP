...
/obj/effect/mapping_helpers/airlock/Initialize()
	..()
...
/obj/effect/mapping_helpers/airlock/Destroy()
	my_controller = null
	my_area = null
	my_device = null
	return ..()

/obj/effect/mapping_helpers/airlock/proc/setup()
...
/*
	Doors
*/
/obj/effect/mapping_helpers/airlock/door
	name = "use a subtype! - airlock door"
	my_device_type = /obj/machinery/door/airlock

/obj/effect/mapping_helpers/airlock/door/setup()
...
/obj/effect/mapping_helpers/airlock/door/ext_door
	name = "exterior airlock door"
	icon_state = "doorout"
	tag_addon = "_outer"

/obj/effect/mapping_helpers/airlock/door/int_door
	name = "interior airlock door"
	icon_state = "doorin"
	tag_addon = "_inner"

/obj/effect/mapping_helpers/airlock/door/simple
...
/obj/effect/mapping_helpers/airlock/atmos/chamber_pump
	name = "chamber pump"
	icon_state = "pump"
	tag_addon = "_pump"
...
*/
/obj/effect/mapping_helpers/airlock/sensor
	name = "use a subtype! - airlock sensor"
	my_device_type = /obj/machinery/airlock_sensor
	var/command

/obj/effect/mapping_helpers/airlock/sensor/setup()
...
/obj/effect/mapping_helpers/airlock/sensor/ext_sensor
	name = "exterior sensor"
	icon_state = "sensout"
	tag_addon = "_exterior_sensor"
	command = "cycle_exterior"

/obj/effect/mapping_helpers/airlock/sensor/chamber_sensor
	name = "chamber sensor"
	icon_state = "sens"
	tag_addon = "_sensor"
	command = "cycle"

/obj/effect/mapping_helpers/airlock/sensor/int_sensor
...
/obj/effect/mapping_helpers/airlock/buttons
