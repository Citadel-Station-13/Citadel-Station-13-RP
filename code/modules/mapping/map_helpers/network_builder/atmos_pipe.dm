...
/atom/movable/map_helper/network_builder/atmos_pipe/scan_directions()
	var/turf/T
	for(var/i in GLOB.cardinals)
		...
		if(!T)
			continue
		var/found = FALSE
		for(var/atom/movable/map_helper/network_builder/atmos_pipe/other in T)
			if(other.pipe_layer == pipe_layer)
...
/atom/movable/map_helper/network_builder/atmos_pipe/build_network()
