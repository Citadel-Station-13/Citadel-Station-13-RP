...
*/
/obj/effect/map_helper/network_builder/atmos_pipe
...
/obj/effect/map_helper/network_builder/atmos_pipe/check_duplicates()
	for(var/obj/effect/map_helper/network_builder/atmos_pipe/other in loc)
		if(other == src)
			continue
...
/obj/effect/map_helper/network_builder/atmos_pipe/scan_directions()
	var/turf/T
	for(var/i in GLOB.cardinals)
		...
		if(!T)
			continue
		var/found = FALSE
		for(var/obj/effect/map_helper/network_builder/atmos_pipe/other in T)
			if(other.pipe_layer == pipe_layer)
...
/obj/effect/map_helper/network_builder/atmos_pipe/build_network()
...
/obj/effect/map_helper/network_builder/atmos_pipe/distro
...
/obj/effect/map_helper/network_builder/atmos_pipe/scrubbers
