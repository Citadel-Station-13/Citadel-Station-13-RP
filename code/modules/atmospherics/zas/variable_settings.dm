...
/datum/variable_settings_controller/atmospherics
	...
	initial_entries = list(
		...
		/datum/variable_setting_entry/atmos/hepipes/thickness = 0.01
	)
	presets = list(
	"ZAS - Standard" = list(
		/datum/variable_setting_entry/atmos/fire/consumption_rate = 0.25,
...
/datum/variable_setting_entry/atmos/hepipes/thickness
	name = "Thickness of pipe walls"
	desc = "How thick are the pipe walls?"
