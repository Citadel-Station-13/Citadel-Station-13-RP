/atom
	...
	var/CanZonePass = ZONE_PASS_YES
	var/CanZonePassVertical = ZONE_PASS_YES

//These procs are called on the atom with the point of reference that turf 1 is the turf the atom is on, and turf 2 is the is T!
...
/atom/proc/CanZonePass(turf/T, vertical = FALSE)
	switch(CanZonePass)
		if(ZONE_PASS_PROC)
