...
/datum/gas_mixture_old/proc/zburn(zone/zone, force_burn, no_check = 0)
...
datum/gas_mixture_old/proc/check_recombustability(list/fuel_objs)
	. = 0
	for(var/g in gas)
...
/datum/gas_mixture_old/proc/check_combustability(obj/effect/decal/cleanable/liquid_fuel/liquid=null)
	. = 0
...
/datum/gas_mixture_old/proc/calculate_firelevel(total_fuel, total_oxidizers, reaction_limit, gas_volume)
	CACHE_VSC_PROP(atmos_vsc, /atmos/fire/firelevel_multiplier, firelevel_multiplier)
