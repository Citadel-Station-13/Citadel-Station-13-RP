...
/obj/machinery/atmospherics/component/unary/heat_exchanger/process(delta_time)
	..()
	if(!partner)
		return FALSE
...
/obj/machinery/atmospherics/component/unary/heat_exchanger/attackby(obj/item/W, mob/user)
	if (!W.is_wrench())
		return ..()
	var/turf/T = src.loc
