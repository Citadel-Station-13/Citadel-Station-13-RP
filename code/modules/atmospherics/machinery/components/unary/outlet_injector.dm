...
/obj/machinery/atmospherics/component/unary/outlet_injector/hide(i)
	update_underlays()
...
/obj/machinery/atmospherics/component/unary/outlet_injector/attackby(obj/item/W as obj, mob/user as mob)
