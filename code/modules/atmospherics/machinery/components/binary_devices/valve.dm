...
/obj/machinery/atmospherics/valve/attack_hand(mob/user, datum/event_args/clickchain/e_args)
...
/obj/machinery/atmospherics/valve/digital/attack_hand(mob/user, datum/event_args/clickchain/e_args)
	if(!powered())
		return
	if(!src.allowed(user))
