...
/obj/machinery/atmospherics/component/trinary/molar_filter/ui_data(mob/user, datum/tgui/ui, datum/tgui_embed_context/embed_context)
	. = ..()
	.["lower"] = mass_lower
	.["upper"] = mass_upper
	.["invert"] = invert
...
/obj/machinery/atmospherics/component/trinary/molar_filter/ui_act(action, list/params, datum/tgui/ui, datum/tgui_embed_context/embed_context)
	. = ..()
	if(.)
		return
	switch(action)
