...
/obj/machinery/atmospherics/tvalve/attack_hand(mob/user, list/params, datum/event_args/clickchain/e_args)
...
/obj/machinery/atmospherics/tvalve/digital/attack_hand(mob/user, list/params, datum/event_args/clickchain/e_args)
	if(!powered())
		return
	if(!src.allowed(user))
