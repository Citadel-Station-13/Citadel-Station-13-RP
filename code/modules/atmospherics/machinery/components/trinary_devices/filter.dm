...
/obj/machinery/atmospherics/component/trinary/filter/ui_data(mob/user, datum/tgui/ui, datum/tgui_embed_context/embed_context)
	. = ..()
	.["filtering"] = filtering
	.["maxRate"] = air1.volume
	.["rate"] = flow_setting

/obj/machinery/atmospherics/component/trinary/filter/ui_static_data(mob/user, datum/tgui/ui, datum/tgui_embed_context/embed_context)
	. = ..()
	.["atmosContext"] = global.gas_data.tgui_gas_context()

/obj/machinery/atmospherics/component/trinary/filter/ui_act(action, list/params, datum/tgui/ui, datum/tgui_embed_context/embed_context)
	. = ..()
	if(.)
		return
	switch(action)
