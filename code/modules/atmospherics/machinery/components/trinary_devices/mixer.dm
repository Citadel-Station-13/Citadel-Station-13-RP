...
/obj/machinery/atmospherics/component/trinary/mixer/ui_data(mob/user, datum/tgui/ui, datum/tgui_embed_context/embed_context)
	var/list/data = list()
	data["on"] = use_power
...
/obj/machinery/atmospherics/component/trinary/mixer/ui_act(action, list/params, datum/tgui/ui, datum/tgui_embed_context/embed_context)
	if(..())
		return TRUE
