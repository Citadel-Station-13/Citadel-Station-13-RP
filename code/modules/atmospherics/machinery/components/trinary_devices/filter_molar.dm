/obj/machinery/atmospherics/component/trinary/filter_molar
	name = "molar filter"
	desc = "A prototype filter that filters gases based on their molar mass."
	#warn sprites
	icon = 'icons/atmos/filter_molar.dmi'
	icon_state = "map"
	density = FALSE
...
/obj/machinery/atmospherics/component/trinary/filter_molar/Initialize(mapload)
	. = ..()
	air1.volume = ATMOS_DEFAULT_VOLUME_FILTER
	air2.volume = ATMOS_DEFAULT_VOLUME_FILTER
	air3.volume = ATMOS_DEFAULT_VOLUME_FILTER

/obj/machinery/atmospherics/component/trinary/filter_molar/update_icon_state()
	if(mirrored)
		icon_state = "m"
	else
		icon_state = ""
...
/obj/machinery/atmospherics/component/trinary/filter_molar/process(delta_time)
	..()
...
/obj/machinery/atmospherics/component/trinary/filter_molar/proc/set_rate(liters)
	flow_setting = clamp(liters, 0, air1.volume)

/obj/machinery/atmospherics/component/trinary/filter_molar/ui_interact(mob/user, datum/tgui/ui, datum/tgui/parent_ui)
	ui = SStgui.try_update_ui(user, src, ui)
	if(!ui)
		ui = new(user, src, "AtmosFilter", name)
		ui.open()

/obj/machinery/atmospherics/component/trinary/filter_molar/ui_data(mob/user)
	. = ..()
	.["filtering"] = filtering
	.["maxRate"] = air1.volume
	.["rate"] = flow_setting

/obj/machinery/atmospherics/component/trinary/filter_molar/ui_static_data(mob/user, datum/tgui/ui, datum/ui_state/state)
	. = ..()
	.["atmosContext"] = global.gas_data.tgui_gas_context()

/obj/machinery/atmospherics/component/trinary/filter_molar/ui_act(action, params)
	. = ..()
	if(.)
		return
	switch(action)
...
/obj/machinery/atmospherics/component/trinary/filter_molar/mirrored
	icon_state = "mmap"
	dir = SOUTH
