...
/obj/machinery/computer/area_atmos/ui_data(mob/user, datum/tgui/ui, datum/tgui_embed_context/embed_context)
...
/obj/machinery/computer/area_atmos/ui_act(action, list/params, datum/tgui/ui, datum/tgui_embed_context/embed_context)
	if(..())
		return TRUE
