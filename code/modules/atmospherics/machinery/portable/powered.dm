...
/obj/machinery/portable_atmospherics/powered/ui_static_data(mob/user, datum/tgui/ui, datum/tgui_embed_context/embed_context)
	. = ..()
	.["useCharge"] = TRUE
...
/obj/machinery/portable_atmospherics/powered/ui_data(mob/user, datum/tgui/ui, datum/tgui_embed_context/embed_context)
	. = ..()
