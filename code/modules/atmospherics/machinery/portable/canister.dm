...
/obj/machinery/portable_atmospherics/canister/ui_static_data(mob/user, datum/tgui/ui, datum/tgui_embed_context/embed_context)
	return list(
...
/obj/machinery/portable_atmospherics/canister/ui_data(mob/user, datum/tgui/ui, datum/tgui_embed_context/embed_context)
	. = list(
...
/obj/machinery/portable_atmospherics/canister/ui_act(action, list/params, datum/tgui/ui, datum/tgui_embed_context/embed_context)
	. = ..()
	if(.)
		return
