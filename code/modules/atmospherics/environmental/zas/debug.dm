...
/client/proc/Test_ZAS_Connection(var/turf/simulated/T as turf)
	...
	var/turf/other_turf = T.get_vertical_step(direction_list[direction])
	...
	var/t_block = T.CanAtmosPass(other_turf, T.get_vertical_dir(other_turf))
	var/o_block = other_turf.CanAtmosPass(T, other_turf.get_vertical_dir(T))
