/datum/atmosphere
	...
	var/gas_string
	/// gas temperature - just caching. Generated by [generate_gas_string()]
...
/datum/atmosphere/proc/generate_gas_string()
	...
	gasmix.temperature = (!isnull(minimum_temp) && !isnumm(maximum_temp))? rand(minimum_temp, maximum_temp) : temp
	...
	temperature_cached = gasmix.temperature
