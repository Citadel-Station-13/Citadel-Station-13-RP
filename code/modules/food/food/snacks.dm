...
/obj/item/reagent_containers/food/snacks/attack_self(mob/user, datum/event_args/actor/e_args)
	. = ..()
	if(.)
		return
	if(sealed)
...
/obj/item/reagent_containers/food/snacks/donkpocket/sinpocket/attack_self(mob/user, datum/event_args/actor/e_args)
	. = ..()
	if(.)
		return
	if(has_been_heated)
...
/obj/item/reagent_containers/food/snacks/monkeycube/attack_self(mob/user, datum/event_args/actor/e_args)
	. = ..()
	if(.)
		return
	if(wrapped)
...
/obj/item/pizzabox/attack_self(mob/user, datum/event_args/actor/e_args)
	. = ..()
	if(.)
		return
