...
/obj/item/reagent_containers/food/snacks/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
	if(sealed)
...
/obj/item/reagent_containers/food/snacks/donkpocket/sinpocket/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
	if(has_been_heated)
...
/obj/item/reagent_containers/food/snacks/monkeycube/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
	if(wrapped)
...
/obj/item/pizzabox/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
