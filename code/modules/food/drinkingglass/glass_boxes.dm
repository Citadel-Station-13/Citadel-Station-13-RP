...
/obj/item/weapon/storage/box/mixedglasses/PopulateContents()
	. = ..()
...
/obj/item/weapon/storage/box/glasses/PopulateContents()
	. = ..()
	for(var/i in 1 to 7)
		new glass_type(src)
...
/obj/item/weapon/storage/box/glass_extras/PopulateContents()
	. = ..()
