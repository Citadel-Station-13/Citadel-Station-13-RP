...
/obj/item/storage/box/mixedglasses/Initialize(mapload)
	. = ..()
...
/obj/item/storage/box/glasses/Initialize(mapload)
	. = ..()
	for(var/i = 1 to 7)
		new glass_type(src)
...
/obj/item/storage/box/glass_extras/Initialize(mapload)
	. = ..()
	for(var/i = 1 to 14)
		new extra_type(src)
