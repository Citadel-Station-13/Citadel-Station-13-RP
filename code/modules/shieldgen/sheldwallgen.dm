...
/obj/machinery/shieldwallgen/new_bullet_act(obj/projectile/proj, impact_flags, def_zone)
	. = ..()
...
/obj/machinery/shieldwall/new_bullet_act(obj/projectile/proj, impact_flags, def_zone)
	. = ..()
	if(needs_power)
		var/obj/machinery/shieldwallgen/G
		if(prob(50))
