...
/obj/effect/shield/proc/take_damage_legacy(damage, damtype, hitby)
	if(!gen)
		qdel(src)
		return
...
/obj/effect/shield/CanAllowThrough(atom/movable/mover, turf/target)
	. = ..()
...
// Explosions
/obj/effect/shield/legacy_ex_act(severity)
	if(!disabled_for)
...
// Beams
/obj/projectile/beam/can_pass_shield(obj/machinery/power/shield_generator/gen)
