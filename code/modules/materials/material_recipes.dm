...
/datum/material/wood/generate_recipes()
	...
	recipes += new/datum/stack_recipe("boat", /obj/vehicle_old/boat, 20, time = 10 SECONDS, supplied_material = "[name]", pass_stack_color = TRUE)
	recipes += new/datum/stack_recipe("dragon boat", /obj/vehicle_old/boat/dragon, 50, time = 30 SECONDS, supplied_material = "[name]", pass_stack_color = TRUE)
