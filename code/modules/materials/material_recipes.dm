...
/datum/material/resin/generate_recipes()
	...
	recipes += new/datum/stack_recipe("[display_name] barricade", /obj/structure/alien/resin/wall, 5, time = 5 SECONDS, one_per_turf = 1, on_floor = 1, pass_stack_color = TRUE)
	...
	recipes += new/datum/stack_recipe("[display_name] membrane", /obj/structure/alien/resin/membrane, 1, time = 2 SECONDS, pass_stack_color = TRUE)
	recipes += new/datum/stack_recipe("[display_name] node", /obj/structure/alien/weeds/node, 1, time = 4 SECONDS)
