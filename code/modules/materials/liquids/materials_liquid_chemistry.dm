/datum/material/liquid/surfactant // Foam precursor
	name = "surfacant"
...
/datum/material/liquid/foaming_agent // Metal foaming agent. This is lithium hydride. Add other recipes (e.g. LiH + H2O -> LiOH + H2) eventually.
	name = "foaming agent"
