/datum/material/liquid/water
	...
	chilling_products = list(
		/datum/material/solid/ice = 1
	)

/*
/datum/material/liquid/water/affect_blood(var/mob/living/M, var/removed, var/datum/reagents/holder)
	..()
	if(ishuman(M))
		...
		if(data && data["holy"])
			if(iscultist(M))
				if(prob(10))
					var/datum/special_role/cultist/cult = GET_datum(/datum/special_role/cultist)
					cult.offer_uncult(M)
				if(prob(2))
				...
				var/datum/special_role/godcult = GET_datum(/datum/special_role/godcultist)
...
/datum/material/liquid/water/affect_ingest(var/mob/living/M, var/removed, var/datum/reagents/holder)
	..()
...
/datum/material/liquid/water/touch_turf(var/turf/T, var/amount, var/datum/reagents/holder)
...
/datum/material/liquid/water/touch_obj(var/obj/O, var/amount, var/datum/reagents/holder)
	..()
...
/datum/material/liquid/water/touch_mob(var/mob/living/M, var/amount, var/datum/reagents/holder)
	..()
	if(istype(M))
