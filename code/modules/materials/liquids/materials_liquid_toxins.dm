/datum/material/liquid/denatured_toxin
...
/datum/material/liquid/plasticide
	name = "plasticide"
...
/datum/material/liquid/amatoxin
	name = "amatoxin"
	uid = "liquid_amatoxin"
	...
	heating_products = list(
		/datum/material/liquid/denatured_toxin = 1
	)
...
/datum/material/liquid/carpotoxin
	name = "carpotoxin"
...
/*
/datum/material/liquid/venom/affect_blood(var/mob/living/M, var/removed, var/datum/reagents/holder)
	if(prob(REAGENT_VOLUME(holder, type)*2))
		SET_STATUS_MAX(M, STAT_CONFUSE, 3)
	..()
*/

/datum/material/liquid/cyanide //Fast and Lethal
	name = "cyanide"
	uid = "liquid_cyanide"
...
// /datum/material/liquid/cyanide/affect_blood(var/mob/living/M, var/removed, var/datum/reagents/holder)
// 	..()
// 	ADJ_STATUS(M, STAT_ASLEEP, 1)

/datum/material/liquid/heartstopper
	name = "heartstopper"
...
/*
/datum/material/liquid/heartstopper/affect_blood(var/mob/living/M, var/removed, var/datum/reagents/holder)
	..()
	ADJ_STATUS(M, STAT_CONFUSE, 1.5)

/datum/material/liquid/heartstopper/affect_overdose(var/mob/living/M)
	..()
	if(ishuman(M))
...
/datum/material/liquid/zombiepowder
	name = "zombie powder"
	...
	heating_products = list(
		/datum/material/liquid/carpotoxin = 0.2,
		// /datum/material/liquid/sedatives = 0.4,
		/datum/material/solid/metal/copper = 0.4
	)
	// taste_mult = 1.2
	// exoplanet_rarity = MAT_RARITY_EXOTIC

/*
/datum/material/liquid/zombiepowder/affect_blood(var/mob/living/M, var/removed, var/datum/reagents/holder)
	..()
...
/datum/material/liquid/zombiepowder/on_leaving_metabolism(atom/parent, metabolism_class)
	var/mob/M = parent
	if(istype(M))
		M.status_flags &= ~FAKEDEATH
	. = ..()
...
/datum/material/liquid/fertilizer //Reagents used for plant fertilizers.
	name = "fertilizer"
...
/datum/material/liquid/weedkiller
	name = "weedkiller"
	...
	// toxicity = 4
	heating_products = list(
		/datum/material/liquid/bromide = 0.4,
		/datum/material/liquid/water = 0.6
	)
	heating_point = 100 CELSIUS
	// metabolism = REM * 0.25
	// defoliant = TRUE
...
/datum/material/liquid/tar
	...
	// toxicity = 4
	heating_products = list(
		/datum/material/liquid/acetone = 0.4,
		/datum/material/solid/carbon = 0.4,
		// /datum/material/liquid/ethanol = 0.2
	)
...
/datum/material/liquid/hair_remover
	name = "hair remover"
...
// /datum/material/liquid/hair_remover/affect_touch(var/mob/M, var/removed, var/datum/reagents/holder)
// 	M.lose_hair()
// 	holder.remove_reagent(type, REAGENT_VOLUME(holder, type))

/datum/material/liquid/zombie
...
/*
/datum/material/liquid/zombie/affect_touch(var/mob/living/M, var/removed, var/datum/reagents/holder)
	affect_blood(M, removed * 0.5, holder)

/datum/material/liquid/zombie/affect_blood(var/mob/living/M, var/removed, var/datum/reagents/holder)
	..()
