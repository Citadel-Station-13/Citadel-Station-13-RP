...
/datum/material/glass/reinforced
	id = MATERIAL_ID_GLASS_REINFORCED
	...
	composite_material = list(MATERIAL_ID_STEEL = SHEET_MATERIAL_AMOUNT / 2, "glass" = SHEET_MATERIAL_AMOUNT)
	window_options = list("One Direction" = 1, "Full Window" = 4, "Windoor" = 2)
...
/datum/material/glass/phoron/reinforced
	id = MATERIAL_ID_GLASS_PHORON_REINFORCED
