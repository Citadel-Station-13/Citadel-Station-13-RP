...
/*
/datum/material/gas/helium/affect_blood(var/mob/living/M, var/removed, var/datum/reagents/holder)
	..()
	M.add_chemical_effect(CE_SQUEAKY, 1)
*/

/datum/material/gas/carbon_dioxide
	name = "carbon dioxide"
...
/datum/material/gas/carbon_monoxide
...
/*
/datum/material/gas/carbon_monoxide/affect_blood(mob/living/M, removed, datum/reagents/holder)
	if(!istype(M))
		return
	var/warning_message
	var/warning_prob = 10
...
/datum/material/gas/methyl_bromide
	name = "methyl bromide"
	...
	vapor_products = list(
		/datum/material/gas/methyl_bromide = 1
	)
	// value = 0.25

/*
/datum/material/gas/methyl_bromide/affect_blood(mob/living/M, removed, datum/reagents/holder)
	. = ..()
	if(!ishuman(M))
		return
	var/mob/living/carbon/human/H = M
...
/datum/material/gas/nitrous_oxide
	name = "sleeping agent"
	...
	gas_overlay_limit = 1
	gas_flags = GAS_FLAG_OXIDIZER //N2O is a powerful oxidizer
...
/*
/datum/material/gas/nitrous_oxide/affect_blood(mob/living/M, removed, datum/reagents/holder)
	var/dosage = LAZYACCESS(M.chem_doses, type)
	if(dosage >= 1)
...
/datum/material/gas/nitrodioxide
...
/datum/material/gas/nitricoxide
	name = "nitric oxide"
...
/*
/datum/material/gas/xenon/affect_blood(mob/living/M, removed, datum/reagents/holder)
	var/dosage = LAZYACCESS(M.chem_doses, type)
	if(dosage >= 1)
		if(prob(5)) SET_STATUS_MAX(M, STAT_ASLEEP, 3)
		SET_STATUS_MAX(M, STAT_DIZZY, 3)
...
/datum/material/gas/sulfur_dioxide
	name = "sulfur dioxide"
	...
	gas_symbol = "SO2"
	dissolves_into = list(
		/datum/material/solid/sulfur = 0.5,
		/datum/material/gas/oxygen = 0.5
	)

/datum/material/gas/hydrogen
	name = "hydrogen"
	...
	gas_flags = GAS_FLAG_FUEL
	burn_product = /datum/material/liquid/water
	gas_symbol_html = "H<sub>2</sub>"
	gas_symbol = "H2"
	dissolves_into = list(
		// /datum/material/liquid/fuel/hydrazine = 1
	)
	// value = 0.4

/datum/material/gas/hydrogen/tritium
	name = "tritium"
	codex_name = null
	uid = "gas_tritium"
...
/datum/material/gas/hydrogen/deuterium
	name = "deuterium"
	codex_name = null
	uid = "gas_deuterium"
	...
	// 	/datum/material/gas/hydrogen/tritium = 1
	// )
