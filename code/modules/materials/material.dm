...
/datum/material
	...
	var/icon_base = 'icons/turf/walls/solid/wall.dmi'
	/// Overlay used.
	var/icon_reinf = 'icons/turf/walls/solid/reinforced.dmi'
	var/wall_stripe_icon = 'icons/turf/walls/solid/stripe.dmi'
	/// Door base icon tag.
