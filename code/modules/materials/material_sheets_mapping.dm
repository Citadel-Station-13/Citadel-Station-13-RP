...
STACK_SUBTYPES(rglass,         "reinforced glass",              solid/glass,                pane,       /datum/material/solid/metal/steel)
STACK_SUBTYPES(rborosilicate,  "reinforced borosilicate glass", solid/glass/borosilicate,   pane,       /datum/material/solid/metal/steel)
