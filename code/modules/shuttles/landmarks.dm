...
/obj/effect/shuttle_landmark/LateInitialize()
	...
	if(GLOB.using_map.use_overmap)
		var/atom/movable/overmap/entity/visitable/location = get_overmap_sector(z)
		if(location && location.docking_codes)
			docking_controller.docking_codes = location.docking_codes

/obj/effect/shuttle_landmark/forceMove()
	var/atom/movable/overmap/entity/visitable/map_origin = get_overmap_sector(z)
	. = ..()
	var/atom/movable/overmap/entity/visitable/map_destination = get_overmap_sector(z)
...
/obj/effect/shuttle_landmark/proc/sector_set(var/atom/movable/overmap/entity/visitable/O, shuttle_name)
...
/obj/effect/shuttle_landmark/automatic/sector_set(var/atom/movable/overmap/entity/visitable/O)
	..()
