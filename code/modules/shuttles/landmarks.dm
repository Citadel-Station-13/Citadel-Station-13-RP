...
/obj/effect/shuttle_landmark/LateInitialize()
	...
	if((LEGACY_MAP_DATUM).use_overmap)
		var/obj/overmap/visitable/location = get_overmap_sector(z)
		if(location && location.docking_codes)

			docking_controller.docking_codes = location.docking_codes

/obj/effect/shuttle_landmark/forceMove()
	var/obj/overmap/visitable/map_origin = get_overmap_sector(z)
	. = ..()
	var/obj/overmap/visitable/map_destination = get_overmap_sector(z)
...
/obj/effect/shuttle_landmark/proc/sector_set(var/obj/overmap/visitable/O, shuttle_name)
...
/obj/effect/shuttle_landmark/automatic/sector_set(var/obj/overmap/visitable/O)
	..()
