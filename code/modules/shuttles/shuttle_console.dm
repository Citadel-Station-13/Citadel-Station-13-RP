...
/obj/machinery/computer/shuttle_control/ui_act(action, list/params, datum/tgui/ui, datum/tgui_embed_context/embed_context)
	if(..())
		return TRUE
	if(skip_act)
		return
...
/obj/machinery/computer/shuttle_control/ui_data(mob/user, datum/tgui/ui, datum/tgui_embed_context/embed_context)
	var/datum/shuttle/autodock/shuttle = SSshuttle.shuttles[shuttle_tag]
	if(!istype(shuttle))
