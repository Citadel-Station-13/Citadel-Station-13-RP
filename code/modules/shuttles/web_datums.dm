...
/datum/shuttle_destination/proc/announce_departure()
	...
	if(!radio_announce)
		command_announcement.Announce(get_departure_message(),(announcer ? announcer : "[using_map_legacy().boss_name]"))
	else
		GLOB.global_announcer.autosay(get_departure_message(),(announcer ? announcer : "[using_map_legacy().boss_name]"))
...
/datum/shuttle_destination/proc/announce_arrival()
	...
	if(!radio_announce)
		command_announcement.Announce(get_arrival_message(),(announcer ? announcer : "[using_map_legacy().boss_name]"))
	else
		GLOB.global_announcer.autosay(get_arrival_message(),(announcer ? announcer : "[using_map_legacy().boss_name]"))
