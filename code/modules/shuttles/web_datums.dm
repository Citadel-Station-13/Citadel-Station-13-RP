...
/datum/shuttle_destination/proc/announce_departure()
	...
	if(!radio_announce)
		command_announcement.Announce(get_departure_message(),(announcer ? announcer : "[SSmapping.legacy_map_config.boss_name]"))
	else
		GLOB.global_announcer.autosay(get_departure_message(),(announcer ? announcer : "[SSmapping.legacy_map_config.boss_name]"))
...
/datum/shuttle_destination/proc/announce_arrival()
	...
	if(!radio_announce)
		command_announcement.Announce(get_arrival_message(),(announcer ? announcer : "[SSmapping.legacy_map_config.boss_name]"))
	else
		GLOB.global_announcer.autosay(get_arrival_message(),(announcer ? announcer : "[SSmapping.legacy_map_config.boss_name]"))
