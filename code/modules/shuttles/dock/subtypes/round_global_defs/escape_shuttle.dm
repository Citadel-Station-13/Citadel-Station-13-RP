...
// Formerly /datum/shuttle/autodock/ferry/round_global/escape_shuttle
// /datum/shuttle/autodock/ferry/round_global/escape_shuttle

// /datum/shuttle/autodock/ferry/round_global/escape_shuttle/can_launch(var/user)
...
// /datum/shuttle/autodock/ferry/round_global/escape_shuttle/can_force(var/user)
// 	if (istype(user, /obj/machinery/computer/shuttle_control))
// 		var/obj/machinery/computer/shuttle_control/C = user
...
// /datum/shuttle/autodock/ferry/round_global/escape_shuttle/can_cancel(var/user)
// 	if (istype(user, /obj/machinery/computer/shuttle_control))
// 		var/obj/machinery/computer/shuttle_control/C = user
// 		if (!C.has_authorization())
// 			return 0
...
// /datum/shuttle/autodock/ferry/round_global/escape_shuttle/launch(var/user)
...
// /datum/shuttle/autodock/ferry/round_global/escape_shuttle/force_launch(var/user)
...
// /datum/shuttle/autodock/ferry/round_global/escape_shuttle/cancel_launch(var/user)
