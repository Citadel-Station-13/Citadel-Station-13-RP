...
/datum/keybinding/human/quick_equipbelt/down(client/user)
	var/mob/living/carbon/human/H = user.mob
	H.auto_held_insert_or_draw_for_storage_in_slot(/datum/inventory_slot_meta/inventory/belt)
	return TRUE
...
/datum/keybinding/human/bag_equip/down(client/user)
	var/mob/living/carbon/human/H = user.mob
	H.auto_held_insert_or_draw_for_storage_in_slot(/datum/inventory_slot_meta/inventory/back)
	return TRUE
