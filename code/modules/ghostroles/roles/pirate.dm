/datum/ghostrole/pirate
	...
	important_info = "You are a member of a pirate crew. You pillage, kidnap, and steal for profit and pleasure. NanoTrasen has recently moved into this system, providing plenty of opportunities for plunder, but beware! Certain areas are considered off limits, even to pirates. Only a fool would anger Nebula Gas by raiding their station, although vessels in transit are fair game. Attempting to visit NanoTrasen's primary facility is equally dangerous and ill-advised. Focusing on isolated bands in transit or on uninhabited planets may be the most reliable way to score precious booty."
