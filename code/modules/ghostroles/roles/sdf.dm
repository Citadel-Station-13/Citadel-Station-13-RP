/datum/role/ghostrole/sdf
	...
	spawntext = "You are a soldier tasked to protect haddi's folley sector, posted on the Outpost 12, with the SDF corvette 'shining singing knight'. Hunt Pirates, kill xenos, protect the sector. Make sure to read your SOP !"
...
/datum/role/ghostrole/sdf/Greet(mob/created, datum/component/ghostrole_spawnpoint/spawnpoint, list/params)
	. = ..()
	to_chat(created, "<i> ATTENTION : STANDING ORDERS SOLDIER ! MAKE SURE THE SECTOR IS SAFE ! YOU MAY USE THE SHINING SINGING KNIGHT TO PATROL THE SECTOR ! MAKE SURE YOU RESPECT THE SOP ! AND FOR GOD SAKE, DONT MESS WITH CORPORATIONS AFFAIRS !</i>")
