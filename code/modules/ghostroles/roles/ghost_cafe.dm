...
/datum/action/disguise
	...
	var/static/list/mob_blacklist = typecacheof(list(
		/mob/living/simple_mob/pet,
		/mob/living/simple_mob/hostile/retaliate/goose,
		/mob/living/simple_mob/hostile/poison,
		...
		/mob/living/simple_mob/kiwi,
		/mob/living/simple_mob/babyKiwi,
		/mob/living/simple_mob/deer,
		/mob/living/simple_mob/parrot,
		/mob/living/simple_mob/hostile/lizard,
		/mob/living/simple_mob/crab,
		/mob/living/simple_mob/cockroach,
		/mob/living/simple_mob/butterfly,
		/mob/living/simple_mob/mouse,
		/mob/living/simple_mob/sloth,
		/mob/living/simple_mob/opossum,
		/mob/living/simple_mob/hostile/bear,
		/mob/living/simple_mob/hostile/asteroid/polarbear,
		/mob/living/simple_mob/hostile/asteroid/wolf,
		/mob/living/carbon/monkey,
		/mob/living/simple_mob/hostile/gorilla,
		/mob/living/carbon/alien/larva,
		/mob/living/simple_mob/hostile/retaliate/frog
	))
