/datum/ghostrole/ashlander
	...
	important_info = "Your tribe still worships the Buried Ones. The wastes are sacred ground, its monsters a blessed bounty. You would never willingly leave your homeland behind. You have seen lights in the distance - falling from the heavens, and returning. They foreshadow the arrival of outsiders to your domain. Ensure your tribe remains protected at all costs."
