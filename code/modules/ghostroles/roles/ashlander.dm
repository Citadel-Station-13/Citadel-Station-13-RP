/datum/ghostrole/ashlander
	...
	important_info = "Your tribe still worships the Buried Ones. The wastes are sacred ground, its creatures a blessed bounty - your people have long farmed these creatures. From Goliaths you can harvest fresh meat and hardy leather, and you may breed  them using Bentar seeds. Gutshank glands may be milked for water. You would never willingly leave your homeland behind. You have seen lights in the distance - falling from the heavens, and returning. They foreshadow the arrival of outsiders to your domain. Ensure your tribe remains protected at all costs."
