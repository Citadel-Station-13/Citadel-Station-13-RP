...
/obj/item/fishing_rod/proc/create_fishing_line(atom/movable/target, target_py = null)
	...
	var/datum/beam/fishing_line/fishing_line_beam = new(user, target, icon_state = "gray_pixel_line_scaling", beam_color = beam_color, override_target_pixel_y = target_py)
