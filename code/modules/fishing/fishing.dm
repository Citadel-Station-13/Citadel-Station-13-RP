...
/turf/simulated/water/proc/handle_fish()	// Subtypes should over-ride this, and supply their own GLOB lists for maximum Mix and Match power.
	if(has_fish)
...
/turf/simulated/water/deep/pool/handle_fish()
	if(has_fish)
...
/turf/simulated/water/ex_act(severity)	// Explosive fishing.
	if(prob(5 * severity))
		pick_fish()
		if(fish_type)
...
/turf/simulated/water/proc/pick_fish()
	if(has_fish)
...
/turf/simulated/water/attackby(obj/item/P as obj, mob/user as mob)
...
/turf/simulated/water/indoors
	outdoors = FALSE
	min_fishing_time = 33
	max_fishing_time = 99

/turf/simulated/water/indoors/handle_fish()
	if(has_fish)
		rare_fish_list = GLOB.generic_fishing_rare_list
		uncommon_fish_list = GLOB.generic_fishing_uncommon_list
		common_fish_list = GLOB.generic_fishing_common_list
...
/turf/simulated/water/deep/indoors
	outdoors = FALSE
	min_fishing_time = 33
	max_fishing_time = 70

/turf/simulated/water/deep/indoors/handle_fish()
	if(has_fish)
		rare_fish_list = GLOB.generic_fishing_rare_list
		uncommon_fish_list = GLOB.generic_fishing_uncommon_list
		common_fish_list = GLOB.generic_fishing_common_list
