...
/obj/item/ano_scanner/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
	interact(user)
...
/obj/item/depth_scanner/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
	ui_interact(user)
...
/obj/item/beacon_locator/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
...
/obj/item/xenoarch_multi_tool/attack_self(datum/event_args/actor/actor, mob/user)
	. = ..()
	if(.)
		return
