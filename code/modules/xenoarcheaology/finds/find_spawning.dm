...
/obj/item/archaeological_find/New(loc, var/new_item_type)
	...
	source_material = pick("cordite","quadrinium",/datum/material/steel,"titanium","aluminium","ferritic-alloy","plasteel","duranium")
