...
/datum/talking_atom/proc/catchMessage(var/msg, var/mob/source)
	...
	if(prob(30))
		...
		holder_atom.loc.visible_message("<font color='blue'>[icon2html(thing = holder_atom, target = world)]] [pick(options)]</font>")
...
/datum/talking_atom/proc/SaySomething(var/word = null)
	...
	for(var/mob/M in listening)
		to_chat(M, "[icon2html(thing = holder_atom, target = M)] <b>[holder_atom]</b> reverberates, \"<font color='blue'>[msg]</font>\"")
