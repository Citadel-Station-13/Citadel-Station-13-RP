...
/datum/unit_test/maptest_get_turf_pixel/Run()
	...
	// we dont have colossus simplemob for some reason
	var/mob/living/simple_mob/vore/aggressive/deathclaw/long_larry = allocate(/mob/living/simple_mob/vore/aggressive/deathclaw, north)
