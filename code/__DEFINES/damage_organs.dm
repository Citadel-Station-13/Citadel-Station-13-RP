...
//#define PSIONIC		"psi"//add for the case we want psionics
/*old cit
...
#define ORGAN_LIFELIKE		(1<<14) // Robotic, made to appear organic
#define ORGAN_NANOFORM		(1<<15) // VOREStation Add - Fully nanoswarm organ
