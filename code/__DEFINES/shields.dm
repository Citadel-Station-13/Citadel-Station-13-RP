...
#define ENERGY_UPKEEP_PER_TILE 40	// Base upkeep per tile protected. Multiplied by various enabled shield modes. Without them the field does literally nothing. 40W
