...
#define OBJ_PERSIST_DEFAULT_TUNING_DEBRIS_DROP_N_LARGEST 0
...
#define OBJ_PERSIST_DEFAULT_TUNING_DEBRIS_IMPORTANT_DEMOTION_ZONE_THRESHOLD 0
#define OBJ_PERSIST_DEFAULT_TUNING_DEBRIS_IMPORTANT_DEMOTION_LEVEL_THRESHOLD 0

#define OBJ_PERSIST_DEFAULT_TUNING_TRASH_DROP_N_LARGEST 0
#define OBJ_PERSIST_DEFAULT_TUNING_TRASH_DROP_N_SMALLEST 0
#define OBJ_PERSIST_DEFAULT_TUNING_TRASH_DROP_N_MOST_ISOLATED 0
#define OBJ_PERSIST_DEFAULT_TUNING_TRASH_DROP_N_LEAST_ISOLATED 0
