...
#define RUNLEVEL_SETUP 2		// While the gamemode setup is running.  I.E gameSSticker.setup()
#define RUNLEVEL_GAME 4			// After successful game SSticker setup, while the round is running.
