...
/// This sepcies doesn't have hair.
#define HAS_NO_HAIR (1<<5)
/// Hair colour selectable in chargen. (RGB)
#define HAS_HAIR_COLOR (1<<6)
/// Radiation causes this character to glow.
#define RADIATION_GLOWS (1<<7)
/// Sets default skin colors based on icons.
#define HAS_BASE_SKIN_COLOURS (1<<8)
...
DEFINE_BITFIELD(species_appearance_flags, list(
	...
	"HAS_BASE_SKIN_COLOURS" = HAS_BASE_SKIN_COLOURS
))
