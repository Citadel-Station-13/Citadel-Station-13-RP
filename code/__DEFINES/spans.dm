...
#define span_alloyheavy(str) ("<span class = 'heavy_alloy'>[str]</span>")
...
#define span_cult_bold(str) ("<span class='cultbold'>[str]</span>")
#define span_cult_bold_italic(str) ("<span class='cultboldtalic'>[str]</span>")
#define span_cult_italic(str) ("<span class='cultitalic'>[str]</span>")
#define span_cult_large(str) ("<span class='cultlarge'>[str]</span>")
...
#define span_enteradio(str) ("<span class='entradio'>[str]</span>")
