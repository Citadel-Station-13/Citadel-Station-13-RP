...
#define LOG_ADMIN (1<<0)
#define LOG_ADMIN_PRIVATE (1<<1)
#define LOG_ASAY (1<<2)
#define LOG_ATTACK (1<<3)
#define LOG_CHAT (1<<4)
#define LOG_CLONING (1<<5)
#define LOG_COMMENT (1<<6)
#define LOG_DSAY (1<<7)
#define LOG_ECON (1<<8)
#define LOG_EMOTE (1<<9)
#define LOG_GAME (1<<10)
#define LOG_MECHA (1<<11)
#define LOG_OOC (1<<12)
#define LOG_OWNERSHIP (1<<13)
#define LOG_PDA (1<<14)
#define LOG_RADIO_EMOTE (1<<15)
#define LOG_SAY (1<<16)
#define LOG_SHUTTLE (1<<17)
#define LOG_TELECOMMS (1<<18)
#define LOG_VICTIM (1<<19)
#define LOG_VIRUS (1<<20)
#define LOG_WHISPER (1<<21)
