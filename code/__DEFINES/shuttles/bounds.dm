...
/// * this is set if a dock is protecting its bounding box, or similar.
#define SHUTTLE_BOUNDING_SOFT_FAULT 2
...
#define SHUTTLE_BOUNDING_HARD_FAULT 3
...
#define SHUTTLE_BOUNDS_CHECKING_FOR_PRIVILEGED_DOCKING (1<<2)
