...
#define DECLARE_SHUTTLE_DOCK_PRESET_ALIGNED(TYPEPATH, NAME)
#define DECLARE_SHUTTLE_DOCK_PRESET_CENTERED(TYPEPATH, NAME)

#warn impl aligned/center
#define DECLARE_SHUTTLE_DOCK_MAP_PRESET_ALIGNED(MAP_FRAGMENT, TYPEPATH, NAME) DECLARE_SHUTTLE_DOCK_PRESET(/map_specific/##MAP_FRAGMENT##TYPEPATH, NAME)
#define DECLARE_SHUTTLE_DOCK_MAP_PRESET_CENTERED(MAP_FRAGMENT, TYPEPATH, NAME) DECLARE_SHUTTLE_DOCK_PRESET(/map_specific/##MAP_FRAGMENT##TYPEPATH, NAME)
