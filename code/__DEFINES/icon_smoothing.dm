...
#define DEFAULT_UNDERLAY_ICON 'icons/turf/floors_old.dmi'
...
#define SMOOTH_GROUP_TURF_OPEN S_TURF(0) ///turf/simulated
#define SMOOTH_GROUP_TURF_OPENSPACE S_TURF(1) ///turf/simulated/open

#define SMOOTH_GROUP_TURF_CHASM S_TURF(2) ///turf/simulated/chasm, /turf/simulated/floor/fakepit
#define SMOOTH_GROUP_FLOOR_LAVA S_TURF(3) ///turf/simulated/lava/smooth
#define SMOOTH_GROUP_FLOOR_TRANSPARENT_GLASS S_TURF(4) ///turf/simulated/floor/glass

#define SMOOTH_GROUP_OPEN_FLOOR S_TURF(5) ///turf/simulated/floor

#define SMOOTH_GROUP_FLOOR_GRASS S_TURF(6) ///turf/simulated/misc/grass
#define SMOOTH_GROUP_FLOOR_ASH S_TURF(7) ///turf/simulated/misc/ashplanet/ash
#define SMOOTH_GROUP_FLOOR_ASH_ROCKY S_TURF(8) ///turf/simulated/misc/ashplanet/rocky
#define SMOOTH_GROUP_FLOOR_ICE S_TURF(9) ///turf/simulated/misc/ice
#define SMOOTH_GROUP_FLOOR_SNOWED S_TURF(10) ///turf/simulated/floor/plating/snowed

#define SMOOTH_GROUP_UNSIMULATED_TURFS S_TURF(11) ///turf/unsimulated
#define SMOOTH_GROUP_CLOSED_TURFS S_TURF(12) ///!THIS IS TEMPORARY

#define MAX_S_TURF SMOOTH_GROUP_CLOSED_TURFS //Always match this value with the one above it.
...
#define SMOOTH_GROUP_SURVIVAL_TIANIUM_POD S_OBJ(14) ///turf/simulated/wall/mineral/titanium/survival/pod, /obj/machinery/door/airlock/survival_pod, /obj/structure/window/reinforced/shuttle/survival_pod
#define SMOOTH_GROUP_HIERO_WALL S_OBJ(15) ///obj/effect/temp_visual/elite_tumor_wall, /obj/effect/temp_visual/hierophant/wall
#define SMOOTH_GROUP_BAMBOO_WALLS S_TURF(16) //![/turf/simulated/wall/mineral/bamboo, /obj/structure/falsewall/bamboo]
#define SMOOTH_GROUP_PLASTINUM_WALLS S_TURF(17) //![turf/simulated/indestructible/riveted/plastinum]

#define SMOOTH_GROUP_PAPERFRAME S_OBJ(20) ///obj/structure/window/paperframe, /obj/structure/mineral_door/paperframe

#define SMOOTH_GROUP_WINDOW_FULLTILE S_OBJ(21) ///turf/simulated/indestructible/fakeglass, /obj/structure/window/fulltile, /obj/structure/window/reinforced/fulltile, /obj/structure/window/reinforced/tinted/fulltile, /obj/structure/window/plasma/fulltile, /obj/structure/window/reinforced/plasma/fulltile
#define SMOOTH_GROUP_WINDOW_FULLTILE_BRONZE S_OBJ(22) ///obj/structure/window/bronze/fulltile
#define SMOOTH_GROUP_WINDOW_FULLTILE_PLASTITANIUM S_OBJ(23) ///turf/simulated/indestructible/opsglass, /obj/structure/window/reinforced/plasma/plastitanium
...
#define SMOOTH_GROUP_SHUTTLE_PARTS S_OBJ(66) ///obj/structure/window/reinforced/shuttle, /obj/structure/window/reinforced/plasma/plastitanium, /turf/simulated/indestructible/opsglass, /obj/structure/shuttle
