...
/**
 * fuck you, we're not doing icongen scripts today
 */

// TODO: ICONGEN SO WE CAN NOT DO THIS AND MAKE IT PRETTY
#define ATMOS_MAPPING_FULL_IX(path, iconbase)			ATMOS_MAPPING_FULL_PX_DOUBLE(path)
#define ATMOS_MAPPING_LAYERS_IX(path, iconbase)			ATMOS_MAPPING_LAYERS_PX_DOUBLE(path)
