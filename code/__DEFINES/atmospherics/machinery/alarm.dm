//* air alarm mode
/// Everything off
#define AIR_ALARM_MODE_OFF 0
/// vents on, scrubbers scrub
#define AIR_ALARM_MODE_SCRUB 1
/// vents on, scrubbers siphon
#define AIR_ALARM_MODE_REPLACE 2
/// vents off, scrubbers siphon
#define AIR_ALARM_MODE_SIPHON 3
/// siphon and then switch to scrub
#define AIR_ALARM_MODE_CYCLE 4
/// panic siphon - rapidly siphon all air out of room
#define AIR_ALARM_MODE_PANIC 5
/// contaminated - high power scrub
#define AIR_ALARM_MODE_CONTAMINATED 6
/// vents on, scrubbers off
#define AIR_ALARM_MODE_FILL 7
