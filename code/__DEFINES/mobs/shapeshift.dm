...
/// size - standard 50% to 150%.
#define SHAPESHIFT_CAPABILITY_SIZE (1<<12)
...
#define SHAPESHIFT_CAPABILITIES_PROTEAN (SHAPESHIFT_CAPABILITIES_CHANGELING & ~(SHAPESHIFT_CAPABILITY_FACE_NAME))
...
DEFINE_BITFIELD(shapeshift_capability, list(
	...
	BITFIELD(SHAPESHIFT_CAPABILITY_BODY_COLOR),
