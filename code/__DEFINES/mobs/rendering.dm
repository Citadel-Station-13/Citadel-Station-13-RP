...
#define HUMAN_LAYER_SPRITEACC_HORNS_FRONT (FLOAT_LAYER - 350)
#define HUMAN_LAYER_SPRITEACC_EARS_FRONT (FLOAT_LAYER - 351)
#define HUMAN_LAYER_SPRITEACC_HAIR_FRONT (FLOAT_LAYER - 352)
#define HUMAN_LAYER_SPRITEACC_FACEHAIR_FRONT (FLOAT_LAYER - 353)
#define HUMAN_LAYER_SPRITEACC_WINGS_FRONT (FLOAT_LAYER - 354)
#define HUMAN_LAYER_SPRITEACC_TAIL_FRONT (FLOAT_LAYER - 355)
...
#define HUMAN_LAYER_SPRITEACC_HORNS_BEHIND (FLOAT_LAYER - 780)
#define HUMAN_LAYER_SPRITEACC_EARS_BEHIND (FLOAT_LAYER - 781)
#define HUMAN_LAYER_SPRITEACC_HAIR_BEHIND (FLOAT_LAYER - 782)
#define HUMAN_LAYER_SPRITEACC_FACEHAIR_BEHIND (FLOAT_LAYER - 783)
#define HUMAN_LAYER_SPRITEACC_WINGS_BEHIND (FLOAT_LAYER - 784)
#define HUMAN_LAYER_SPRITEACC_TAIL_BEHIND (FLOAT_LAYER - 785)
