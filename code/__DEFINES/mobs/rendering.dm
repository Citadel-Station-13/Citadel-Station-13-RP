...
#define HUMAN_LAYER_SPRITEACC_TAIL_ALT (FLOAT_LAYER - 349)
#define HUMAN_LAYER_SPRITEACC_WINGS (FLOAT_LAYER - 300)
...
#define HUMAN_LAYER_SPRITEACC_HORNS (FLOAT_LAYER - 473)
#define HUMAN_LAYER_SPRITEACC_EARS (FLOAT_LAYER - 474)
#define HUMAN_LAYER_SPRITEACC_HAIR (FLOAT_LAYER - 475)
#define HUMAN_LAYER_SPRITEACC_FACEHAIR (FLOAT_LAYER - 476)
...
#define HUMAN_LAYER_SPRITEACC_TAIL (FLOAT_LAYER - 600)
