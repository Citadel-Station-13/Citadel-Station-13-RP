...
#define HUMAN_LAYER_SPRITEACC_HORNS_FRONT (FLOAT_LAYER - 473)
#define HUMAN_LAYER_SPRITEACC_EARS_FRONT (FLOAT_LAYER - 474)
#define HUMAN_LAYER_SPRITEACC_HAIR_FRONT (FLOAT_LAYER - 475)
#define HUMAN_LAYER_SPRITEACC_FACEHAIR_FRONT (FLOAT_LAYER - 476)
#define HUMAN_LAYER_SPRITEACC_WINGS_FRONT (FLOAT_LAYER - 300)
#define HUMAN_LAYER_SPRITEACC_TAIL_FRONT (FLOAT_LAYER - 600)


#define HUMAN_LAYER_SLOT_LEGCUFFED (FLOAT_LAYER - 349)
#define HUMAN_LAYER_SLOT_HANDCUFFED (FLOAT_LAYER - 350)
...
#define HUMAN_LAYER_SPRITEACC_HORNS_BEHIND (FLOAT_LAYER - 473)
#define HUMAN_LAYER_SPRITEACC_EARS_BEHIND (FLOAT_LAYER - 474)
#define HUMAN_LAYER_SPRITEACC_HAIR_BEHIND (FLOAT_LAYER - 475)
#define HUMAN_LAYER_SPRITEACC_FACEHAIR_BEHIND (FLOAT_LAYER - 476)
#define HUMAN_LAYER_SPRITEACC_WINGS_BEHIND (FLOAT_LAYER - 300)
#define HUMAN_LAYER_SPRITEACC_TAIL_BEHIND (FLOAT_LAYER - 600)
