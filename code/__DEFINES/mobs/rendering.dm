...
#define HUMAN_LAYER_SPRITEACC_HORNS_FRONT (FLOAT_LAYER - 476)
#define HUMAN_LAYER_SPRITEACC_EARS_FRONT (FLOAT_LAYER - 477)
...
#define HUMAN_LAYER_SPRITEACC_HAIR_BEHIND (FLOAT_LAYER - 950)
#define HUMAN_LAYER_SPRITEACC_HORNS_BEHIND (FLOAT_LAYER - 951)
#define HUMAN_LAYER_SPRITEACC_EARS_BEHIND (FLOAT_LAYER - 952)
