...
#define SPECIES_ZORREN_FLAT	 "Zorren Flatland"
#define SPECIES_ZORREN_HIGH	 "Zorren Highlander"
...
#define VIS_CH_HEALTH_VR	23	// Zandario TODO - Finally clean up terrible HUD code.
