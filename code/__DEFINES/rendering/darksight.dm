...
#define SOFT_DARKSIGHT_FOV_TIER_2 SOFT_DARKSIGHT_FOV_180 // Linear progression. What is balance?
#define SOFT_DARKSIGHT_FOV_TIER_3 SOFT_DARKSIGHT_FOV_270 // I was thinking of making the overall default 180, but the balance people would strangle me
#define SOFT_DARKSIGHT_FOV_NVGS SOFT_DARKSIGHT_FOV_90 // As if they won't do it now
