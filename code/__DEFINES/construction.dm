...
#define PIPES_FUEL_LAYER		(EXPOSED_PIPE_LAYER - 0.04)
#define PIPES_SUPPLY_LAYER		(EXPOSED_PIPE_LAYER - 0.03)
#define PIPES_SCRUBBER_LAYER	(EXPOSED_PIPE_LAYER - 0.02)
#define PIPES_AUX_LAYER			(EXPOSED_PIPE_LAYER - 0.01)
#define PIPES_HE_LAYER			(EXPOSED_PIPE_LAYER + 0.01)
