...
#define PIPES_FUEL_LAYER		(GAS_PIPE_HIDDEN_LAYER - 0.04)
#define PIPES_SUPPLY_LAYER		(GAS_PIPE_HIDDEN_LAYER - 0.03)
#define PIPES_SCRUBBER_LAYER	(GAS_PIPE_HIDDEN_LAYER - 0.02)
#define PIPES_AUX_LAYER			(GAS_PIPE_HIDDEN_LAYER - 0.01)
#define PIPES_HE_LAYER			(GAS_PIPE_HIDDEN_LAYER + 0.01)
