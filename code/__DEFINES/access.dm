...
#define ACCESS_FACTION_TRADERROOM1 1611//Motel-Inn-Room1
STANDARD_ACCESS_DATUM(ACCESS_FACTION_TRADERROOM1, faction/trader/room1, "Nebula-Room-1")

#define ACCESS_FACTION_TRADERROOM2 1612//Motel-Inn-Room2
STANDARD_ACCESS_DATUM(ACCESS_FACTION_TRADERROOM2, faction/trader/room2, "Nebula-Room-2")

#define ACCESS_FACTION_TRADERROOM3 1613//Motel-Inn-Room3
STANDARD_ACCESS_DATUM(ACCESS_FACTION_TRADERROOM3, faction/trader/room3, "Nebula-Room-3")

#define ACCESS_FACTION_TRADERROOM4 1614//Motel-Inn-Room4
STANDARD_ACCESS_DATUM(ACCESS_FACTION_TRADERROOM4, faction/trader/room4, "Nebula-Room-4")

#define ACCESS_FACTION_TRADERROOM5 1615//Motel-Inn-Room5
STANDARD_ACCESS_DATUM(ACCESS_FACTION_TRADERROOM5, faction/trader/room5, "Nebula-Room-5")

#define ACCESS_FACTION_TRADERROOM6 1616//Motel-Inn-Room6
STANDARD_ACCESS_DATUM(ACCESS_FACTION_TRADERROOM6, faction/trader/room6, "Nebula-Room-6")

#define ACCESS_FACTION_TRADERROOM7 1617//Motel-Inn-Room7
STANDARD_ACCESS_DATUM(ACCESS_FACTION_TRADERROOM7, faction/trader/room7, "Nebula-Room-7")

#define ACCESS_FACTION_TRADERROOM8 1618//Motel-Inn-Room8
STANDARD_ACCESS_DATUM(ACCESS_FACTION_TRADERROOM8, faction/trader/room8, "Nebula-Room-8")

#define ACCESS_FACTION_TRADERROOM_VIP 1619//Motel-Inn-VIP
STANDARD_ACCESS_DATUM(ACCESS_FACTION_TRADERROOM_VIP, faction/trader/room/vip, "Nebula-Room-VIP")

#define ACCESS_FACTION_TRADERROOM_SHUTTLE1 1620 //Caravan
STANDARD_ACCESS_DATUM(ACCESS_FACTION_TRADERROOM_SHUTTLE1, faction/trader/shuttle1, "Nebula-Shuttle-Carvan")

#define ACCESS_FACTION_TRADERROOM_SHUTTLE2 1621//Adventurer
STANDARD_ACCESS_DATUM(ACCESS_FACTION_TRADERROOM_SHUTTLE2, faction/trader/shuttle2, "Nebula-Shuttle-Adventurer")

#define ACCESS_FACTION_TRADERROOM_SHUTTLE3 1622//TUG
STANDARD_ACCESS_DATUM(ACCESS_FACTION_TRADERROOM_SHUTTLE3, faction/trader/shuttle3, "Nebula-Shuttle-Tug")

#define ACCESS_FACTION_TRADERROOM_SHUTTLE4 1623//Runabout
STANDARD_ACCESS_DATUM(ACCESS_FACTION_TRADERROOM_SHUTTLE4, faction/trader/shuttle4, "Nebula-Shuttle-Runabout")

#define ACCESS_FACTION_TRADERROOM_FUEL 1624//FUEL
STANDARD_ACCESS_DATUM(ACCESS_FACTION_TRADERROOM_FUEL, faction/trader/fuel, "Nebula-Fuel")
