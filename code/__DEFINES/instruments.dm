...
///100/(1.025^50) calculated for [INSTRUMENT_MIN_SUSTAIN_DROPOFF] to be 30.
#define INSTRUMENT_EXP_FALLOFF_MIN			1.025
...
///Legacy instrument. Implies INSTRUMENT_DO_NOT_AUTOSAMPLE
#define INSTRUMENT_LEGACY (1<<0)
///Do not automatically sample
#define INSTRUMENT_DO_NOT_AUTOSAMPLE (1<<1)
