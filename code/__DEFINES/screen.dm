...
#define SCREEN_LOC_MOB_HUD_INVENTORY_SLOT_DRAWER_ALIGNED(MAIN_AXIS, CROSS_AXIS) "LEFT+[MAIN_AXIS]:[6 + (MAIN_AXIS * 2)],BOTTOM+[CROSS_AXIS]:[5 + (CROSS_AXIS * 2)]"
/// slot alignment for hand-anchor
#define SCREEN_LOC_MOB_HUD_INVENTORY_SLOT_HANDS_ALIGNED(MAIN_AXIS, CROSS_AXIS) "CENTER-1:[16 + (MAIN_AXIS > 0 ? (34 * (MAIN_AXIS + 1)) : (-34 * MAIN_AXIS))],BOTTOM+[CROSS_AXIS]:[5 + (CROSS_AXIS * 2)]"
