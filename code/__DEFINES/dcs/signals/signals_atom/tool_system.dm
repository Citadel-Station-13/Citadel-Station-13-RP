...
/// from base of dynamic_tool_functions: (I, datum/event_args/actor/clickchain/e_args, functions, hint_images) where I = item, e_args = clickchain data.
/// inject by merging into functions, and associating hints to images in hint_images
/// remember to use merge_double_lazy_assoc_list() to merge function lists!
#define COMSIG_ATOM_TOOL_FUNCTIONS "tool_functions"
