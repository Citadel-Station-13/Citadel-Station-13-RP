...
#define HOLOMAP_PIXEL_OFFSET_X(zLevel) ((SSmapping.legacy_map_config.holomap_offset_x.len >= zLevel) ? SSmapping.legacy_map_config.holomap_offset_x[zLevel] : 0)
#define HOLOMAP_PIXEL_OFFSET_Y(zLevel) ((SSmapping.legacy_map_config.holomap_offset_y.len >= zLevel) ? SSmapping.legacy_map_config.holomap_offset_y[zLevel] : 0)
#define HOLOMAP_LEGEND_X(zLevel) ((SSmapping.legacy_map_config.holomap_legend_x.len >= zLevel) ? SSmapping.legacy_map_config.holomap_legend_x[zLevel] : 96)
#define HOLOMAP_LEGEND_Y(zLevel) ((SSmapping.legacy_map_config.holomap_legend_y.len >= zLevel) ? SSmapping.legacy_map_config.holomap_legend_y[zLevel] : 96)
