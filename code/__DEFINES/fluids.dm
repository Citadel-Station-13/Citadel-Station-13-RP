/// Depth a fluid begins self-deleting
#define FLUID_EVAPORATION_POINT 3
/// Depth a fluid counts as qdel'd
#define FLUID_DELETING -1
/// Depth shallow icon is used
#define FLUID_SHALLOW 200
#define FLUID_OVER_MOB_HEAD 300
/// Depth deep icon is used
#define FLUID_DEEP 800
/// Arbitrary max value for flooding.
#define FLUID_MAX_DEPTH FLUID_DEEP*4
/// Amount of water flow needed to push items.
