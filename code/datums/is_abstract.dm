...
/**
 *! TL;DR
 * Basically this is useful for atoms "basetypes"
 * So like '/obj/item/clothing' should never exist so on the item we write:
 *
 *? /obj/item/clothing
 *? 	abstract_type = /obj/item/clothing
 *
 * And this will prevent the item from being spawned in the world!
 * Subtypes will work of course.
 *
 *! @Zandario
 */
...
/**
 * Passed a path or instance, returns whether it is abstract.
 * Otherwise null.
 */
