...
/datum/event_args/shuttle/traversal/web
	/// old node; should not, but might be be null
	var/datum/shuttle_web_node/from_node
	/// new node; should not, but might be null
...
/datum/event_args/shuttle/traversal/overmap
	/// old location; if null, we are coming from freeflight
	/// new location; if null, we are going to freeflight
