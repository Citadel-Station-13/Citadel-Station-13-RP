...
/**
 * TODO  Consider if we want to keep this, and if we do, consider if we want to consider if we should we make this a controller like prototypes? @Zandario
 */
/repository/singletons
	...
	/**
	 * A map of (/singleton/path = TRUE, ...).
	 * Indicates whether a path has been tried for instances.
	 */
	...
	/**
	 * A map of (/singleton/path = TRUE, ...).
	 * Indicates whether a path has been tried for type_maps.
	 */
	...
	/**
	 * A map of (/singleton/path = TRUE, ...).
	 * Indicates whether a path has been tried for subtype_maps.
	 */
	...
	/**
	 * A map of (/singleton/path = TRUE, ...).
	 * Indicates whether a path has been tried for type_lists.
	 */
	...
	/**
	 * A map of (/singleton/path = TRUE, ...).
	 * Indicates whether a path has been tried for subtype_lists.
	 */
...
/singleton/Destroy()
	...
	return QDEL_HINT_LETMELIVE // Prevents singleton destruction
