...
/datum/uplink_item/item/hardsuit_modules/thermal
	...
	item_cost = 15
	path = /obj/item/rig_module/basic/vision/thermal

/datum/uplink_item/item/hardsuit_modules/energy_net
	name = "Net Projector"
	item_cost = 20
	path = /obj/item/rig_module/basic/fabricator/energy_net

/datum/uplink_item/item/hardsuit_modules/plasma_cutter
	name = "Plasma Cutter"
	item_cost = 20
	path = /obj/item/rig_module/basic/device/plasmacutter
