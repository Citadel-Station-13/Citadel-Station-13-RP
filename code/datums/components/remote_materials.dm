...
/datum/component/remote_materials/proc/_MakeLocal()
	...
	mat_container = parent.AddComponent(/datum/component/material_container,
		list(/datum/material/solid/metal/iron, /datum/material/glass, /datum/material/silver, /datum/material/solid/metal/gold, /datum/material/diamond, /datum/material/plasma, /datum/material/uranium, /datum/material/bananium, /datum/material/titanium, /datum/material/bluespace, /datum/material/plastic),
		local_size,
		FALSE,
		/obj/item/stack)
