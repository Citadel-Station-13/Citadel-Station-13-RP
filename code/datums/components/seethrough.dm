...
/**
 * see_through_map is a define pointing to a specific map.
 * It's basically defining the area which is considered behind. See see_through_maps.dm for a list of maps.
 */
