...
/datum/component/gps/proc/display_list()
	...
	dat["curr_y"] = curr.y
	dat["curr_z"] = curr.z
	dat["curr_z_name"] = SSmapping.fluff_level_id(curr.z)
	var/list/gps_list = list()
	dat["gps_list"] = gps_list
	dat["z_level_detection"] = SSmapping.get_connected_levels(curr.z, NO_OVERMAP_RANGE, long_range)
	...
	for(var/gps in GLOB.GPS_list - src)
		...
		gps_data["z_name"] = SSmapping.fluff_level_id(T.z)
