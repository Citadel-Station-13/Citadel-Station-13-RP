...
/datum/component/slippery
	...
	var/list/slot_whitelist = list(SLOT_OCLOTHING, SLOT_ICLOTHING, SLOT_GLOVES, SLOT_FEET, SLOT_HEAD, SLOT_MASK, SLOT_BELT/*, SLOT_NECK*/)
...
/datum/component/slippery/clowning/Slip_on_wearer(datum/source, atom/movable/AM)
	. = ..()
	var/obj/item/I = holder.get_equipped_item(SLOT_FEET)
	// if(holder.body_position == LYING_DOWN && !holder.buckled)
	if(holder.lying && !holder.buckled)
