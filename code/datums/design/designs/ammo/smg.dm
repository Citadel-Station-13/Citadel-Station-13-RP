...
/datum/design/ammo/smg/a9mm_t
	...
	build_path = /obj/item/ammo_magazine/a9mmt

/datum/design/ammo/smg/a9mm_hunter_t
	id = "AmmoSMG9mmHunterT"
	lathe_type = LATHE_TYPE_AUTOLATHE
	design_unlock = DESIGN_UNLOCK_INTRINSIC
	build_path = /obj/item/ammo_magazine/a9mmt/hunter

/datum/design/ammo/smg/a9mm_rubber_t
	id = "AmmoSMG9mmRubberT"
	lathe_type = LATHE_TYPE_AUTOLATHE
	design_unlock = DESIGN_UNLOCK_INTRINSIC
	build_path = /obj/item/ammo_magazine/a9mmt/rubber

/datum/design/ammo/smg/a9mm_practice_t
	id = "AmmoSMG9mmPracticeT"
	lathe_type = LATHE_TYPE_AUTOLATHE
	design_unlock = DESIGN_UNLOCK_INTRINSIC
	build_path = /obj/item/ammo_magazine/a9mmt/practice

/datum/design/ammo/smg/a9mm_flash_t
	id = "AmmoSMG9mmFlashT"
	lathe_type = LATHE_TYPE_AUTOLATHE
	design_unlock = DESIGN_UNLOCK_INTRINSIC
	build_path = /obj/item/ammo_magazine/a9mmt/flash
