...
//attack modifier needs to fucking go - kevinz000
...
// No comment
/atom/proc/attackby(obj/item/W, mob/user, params, attack_modifier = 1)
	return
...
/mob/living/attackby(obj/item/I, mob/user, params, attack_modifier)
	...
	return I.attack(src, user, user.zone_selected, attack_modifier)
