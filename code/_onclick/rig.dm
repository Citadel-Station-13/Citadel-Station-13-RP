...
#define CLICK_MODE_MIDDLE_CLICK 0
#define CLICK_MODE_ALT 1
#define CLICK_MODE_CTRL 2
#define MAX_HARDSUIT_CLICK_MODE 2

/client
	var/hardsuit_click_mode = CLICK_MODE_MIDDLE_CLICK
...
/client/verb/toggle_hardsuit_mode()
	...
	switch(hardsuit_click_mode)
		...
		if(CLICK_MODE_CTRL)
			...
			hardsuit_click_mode = CLICK_MODE_MIDDLE_CLICK

/mob/living/MiddleClickOn(atom/A)
	if(client && client.hardsuit_click_mode == CLICK_MODE_MIDDLE_CLICK)
		if(HardsuitClickOn(A))
			return
	..()

/mob/living/AltClickOn(atom/A)
	if(client && client.hardsuit_click_mode == CLICK_MODE_ALT)
		if(HardsuitClickOn(A))
			return
	..()

/mob/living/CtrlClickOn(atom/A)
	if(client && client.hardsuit_click_mode == CLICK_MODE_CTRL)
		if(HardsuitClickOn(A))
			return
	..()
...
#undef CLICK_MODE_MIDDLE_CLICK
#undef CLICK_MODE_ALT
#undef CLICK_MODE_CTRL
