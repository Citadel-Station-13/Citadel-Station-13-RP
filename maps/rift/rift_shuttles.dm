...
/datum/shuttle/web_shuttle/excursion
	...
	warmup_time = 0
	current_area = /area/shuttle/excursion/rift
...
/datum/shuttle_destination/excursion/rift
	name = "NSB Atlas Excursion Hangar"
	my_area = /area/shuttle/excursion/rift
	...
	routes_to_make = list(
		/datum/shuttle_destination/excursion/outside_rift = 0,
	)
...
/datum/shuttle_destination/excursion/outside_rift
	name = "Nearby NSB Atlas"
	my_area = /area/shuttle/excursion/rift_nearby
	preferred_interim_area = /area/shuttle/excursion/space_moving

	routes_to_make = list(
		/datum/shuttle_destination/excursion/docked_rift = 0,
		/datum/shuttle_destination/excursion/lythios43c_orbit = 30 SECONDS
	)


/datum/shuttle_destination/excursion/docked_rift
	name = "NSB Adephagia Docking Arm"
	my_area = /area/shuttle/excursion/rift_dockarm
...
/datum/shuttle_destination/excursion/lythios43c_orbit
	name = "Lythios-43c Orbit"
	my_area = /area/shuttle/excursion/space
	preferred_interim_area = /area/shuttle/excursion/space_moving

	routes_to_make = list(
		/datum/shuttle_destination/excursion/lythios43c_sky = 30 SECONDS,
		/datum/shuttle_destination/excursion/bluespace = 30 SECONDS
	)


/datum/shuttle_destination/excursion/lythios43c_sky
	name = "Skies of Lythios-43c"
