...
/obj/item/weapon/book/manual/rust_engine/New()
	...
	dat = {"<html>
				...
				<br><br>
				<ol>
				<li>If the engine's SMES (The one closer to the engine room itself) is low on power: Put spicy purple in pacman generator, wrench it onto the blue wire knot beneath it, and turn it on at power 2. Running it too hot can cause an explosion, be wary.</li>
