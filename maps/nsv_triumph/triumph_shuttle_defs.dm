...
/*
// Triumph Shuttle
/datum/shuttle/ferry/triumph_backup
	name = "Triumph Backup"
	location = 1 // At offsite
	warmup_time = 5
	move_time = 45
	area_offsite = /area/shuttle/triumph/surface
	area_station = /area/shuttle/triumph/station
	area_transition = /area/shuttle/triumph/transit
