...
DECLARE_SHUTTLE_DOCK_MAP_PRESET_CENTERED(/tether, /backup_ferry, "Backup Ferry Hanger")
	docking_restrict_to_starting = TRUE
DECLARE_SHUTTLE_DOCK_MAP_PRESET_CENTERED(/tether, /tour_bus, "Tour Bus Hanger")
	docking_restrict_to_starting = TRUE
DECLARE_SHUTTLE_DOCK_MAP_PRESET_CENTERED(/tether, /expedition_shuttle, "Expedition Shuttle Hanger")
	docking_restrict_to_starting = TRUE
