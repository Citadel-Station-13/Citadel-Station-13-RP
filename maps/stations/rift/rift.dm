...
/datum/map_level/rift/station/underground_deep
	...
	path = "maps/stations/rift/map_files/rift-02-underground2.dmm"
	traits = list(
		ZTRAIT_STATION,
		ZTRAIT_FACILITY_SAFETY,
		ZTRAIT_GRAVITY,
...
/datum/map_level/rift/station/underground_shallow
	...
	path = "maps/stations/rift/map_files/rift-03-underground1.dmm"
	traits = list(
		ZTRAIT_STATION,
		ZTRAIT_FACILITY_SAFETY,
		ZTRAIT_GRAVITY,
...
/datum/map_level/rift/station/surface_low
	...
	path = "maps/stations/rift/map_files/rift-04-surface1.dmm"
	traits = list(
		ZTRAIT_STATION,
		ZTRAIT_FACILITY_SAFETY,
		ZTRAIT_GRAVITY,
...
/datum/map_level/rift/station/surface_mid
	...
	path = "maps/stations/rift/map_files/rift-05-surface2.dmm"
	traits = list(
		ZTRAIT_STATION,
		ZTRAIT_FACILITY_SAFETY,
		ZTRAIT_GRAVITY,
...
/datum/map_level/rift/station/surface_high
	...
	path = "maps/stations/rift/map_files/rift-06-surface3.dmm"
	traits = list(
		ZTRAIT_STATION,
		ZTRAIT_FACILITY_SAFETY,
		ZTRAIT_GRAVITY,
...
/datum/map_level/rift/base
	...
	path = "maps/stations/rift/map_files/rift-07-west_base.dmm"
	traits = list(
		ZTRAIT_STATION,
		ZTRAIT_GRAVITY,
	)
...
/datum/map_level/rift/deep
	...
	path = "maps/stations/rift/map_files/rift-08-west_deep.dmm"
	traits = list(
		ZTRAIT_STATION,
		ZTRAIT_GRAVITY,
...
/datum/map_level/rift/caves
	...
	path = "maps/stations/rift/map_files/rift-09-west_caves.dmm"
	traits = list(
		ZTRAIT_STATION,
		ZTRAIT_GRAVITY,
	)
