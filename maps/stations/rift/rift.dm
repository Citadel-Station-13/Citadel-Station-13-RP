...
/datum/map_level/rift/station/underground_floor
	...
	relative_path = "map_files/rift-01-underground3.dmm"
	traits = list(
		ZTRAIT_STATION,
...
/datum/map_level/rift/station/underground_deep
	...
	relative_path = "map_files/rift-02-underground2.dmm"
	traits = list(
		ZTRAIT_STATION,
		ZTRAIT_FACILITY_SAFETY,
		ZTRAIT_GRAVITY,
...
/datum/map_level/rift/station/underground_shallow
	...
	relative_path = "map_files/rift-03-underground1.dmm"
	traits = list(
		ZTRAIT_STATION,
		ZTRAIT_FACILITY_SAFETY,
		ZTRAIT_GRAVITY,
...
/datum/map_level/rift/station/surface_low
	...
	relative_path = "map_files/rift-04-surface1.dmm"
	traits = list(
		ZTRAIT_STATION,
		ZTRAIT_FACILITY_SAFETY,
		ZTRAIT_GRAVITY,
...
/datum/map_level/rift/station/surface_mid
	...
	relative_path = "map_files/rift-05-surface2.dmm"
	traits = list(
		ZTRAIT_STATION,
		ZTRAIT_FACILITY_SAFETY,
		ZTRAIT_GRAVITY,
...
/datum/map_level/rift/station/surface_high
	...
	relative_path = "map_files/rift-06-surface3.dmm"
	traits = list(
		ZTRAIT_STATION,
		ZTRAIT_FACILITY_SAFETY,
		ZTRAIT_GRAVITY,
...
/datum/map_level/rift/base
	...
	relative_path = "map_files/rift-07-west_base.dmm"
	traits = list(
		ZTRAIT_STATION,
		ZTRAIT_GRAVITY,
	)
...
/datum/map_level/rift/deep
	...
	relative_path = "map_files/rift-08-west_deep.dmm"
	traits = list(
		ZTRAIT_STATION,
		ZTRAIT_GRAVITY,
...
/datum/map_level/rift/caves
	...
	relative_path = "map_files/rift-09-west_caves.dmm"
	traits = list(
		ZTRAIT_STATION,
		ZTRAIT_GRAVITY,
	)
...
/datum/map_level/rift/plains
	...
	relative_path = "map_files/rift-10-west_plains.dmm"
	base_turf = /turf/simulated/floor/outdoors/safeice/lythios43c
	flags = LEGACY_LEVEL_STATION|LEGACY_LEVEL_CONTACT|LEGACY_LEVEL_PLAYER
	planet_path = /datum/planet/lythios43c
...
/datum/map_level/rift/colony
	...
	relative_path = "map_files/rift-11-orbital.dmm"
