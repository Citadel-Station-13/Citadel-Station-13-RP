// Used to be tether_jobs.dm ... Why I do not know - Bloop
// I think these are the Talon Z levels. Make sure to have these z levels defined in whatever map defines you are creating. Tempted to just define them here but thats something to test later
/*
