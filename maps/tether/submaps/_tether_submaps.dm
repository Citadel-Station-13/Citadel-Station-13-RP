...
/datum/map_z_level/tether_lateload/underdark
	...
	z = Z_LEVEL_UNDERDARK //cit change

/datum/map_template/tether_lateload/tether_underdark/on_map_loaded(z)
	. = ..()
	seed_submaps(list(Z_LEVEL_UNDERDARK), 100, /area/mine/unexplored/underdark, /datum/map_template/underdark) // cit change - hoo boy, ports virgo 4586
	...
	new /datum/random_map/noise/ore(null, 1, 1, Z_LEVEL_UNDERDARK, 64, 64)         // Create the mining ore distribution map. cit change end
...
/datum/map_template/tether_lateload/away_beach_cave/on_map_loaded(z) // cit change
	. = ..()
...
/datum/map_z_level/tether_lateload/away_beach_cave
	...
	z = Z_LEVEL_BEACH_CAVE //cit change
...
/datum/map_z_level/tether_lateload/away_alienship
	...
	z = Z_LEVEL_ALIENSHIP // cit change
...
/datum/map_template/tether_lateload/away_aerostat_surface/on_map_loaded(z) //cit change
	. = ..()
...
/datum/map_z_level/tether_lateload/away_aerostat_surface
	...
	z = Z_LEVEL_AEROSTAT_SURFACE //cit change
