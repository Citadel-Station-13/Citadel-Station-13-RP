...
/obj/away_mission_init/beachcave/initialize()
	...
	/*seed_submaps(list(z), 50, /area/tether_away/cave/unexplored/normal, /datum/map_template/surface/mountains/normal) cit change - virgo #4586 port
	...
	new /datum/random_map/noise/ore/beachmine(null, 1, 1, Z_LEVEL_BEACH_CAVE, 64, 64)*/ // cit change end
