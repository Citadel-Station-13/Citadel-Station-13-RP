...
/obj/machinery/button/remote/blast_door/strelka/blockade/trigger()
	...
	sealed = !sealed
	if(sealed)
		command_announcement.Announce("Vessel is now entering Blockade Runner Mode. Closing ship shutters.", "Blockade Runner mode", new_sound = sound('sound/effects/blockade_runner_riff.ogg', volume=25))
	else
