...
/obj/item/paper/strelkashuttles
	...
	info = "Our vessel is one of the smallest of the fleet. So, we have also less shuttles. The Decades Old shuttle is civilian, The Javelot is a excursion shuttle, and the Hammerdart is made for security and medical. The Hammerdart authority falls under both the CMO and HOS."
...
/obj/item/paper/strelkacommand/pathfinder
	...
	info = "Since this vessel is a Nanotrasen Exploration Vessel, the Pathfinder get acces to the bridge. On it, they can use the ballista, charter movement of the vessel, and helm it if they have the right accreditation. The chain of command doesn't change."
