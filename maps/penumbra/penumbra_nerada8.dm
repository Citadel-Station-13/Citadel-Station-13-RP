var/datum/planet/nerada8/planet_nerada8 = null

/datum/time/nerada8
	seconds_in_day = 3 HOURS

/datum/planet/nerada8
	name = "Virgo-3B"
	...
	current_time = new /datum/time/nerada8()
	expected_z_levels = list(
						Z_LEVEL_SURFACE_MAIN
						)
	planetary_wall_type = /turf/unsimulated/wall/planetary/penumbra

/datum/planet/nerada8/New()
	..()
	planet_nerada8 = src
	weather_holder = new /datum/weather_holder/nerada8(src)

/datum/planet/nerada8/update_sun()
	..()
...
/datum/weather_holder/nerada8
	temperature = T0C
	allowed_weather_types = list(
		WEATHER_CLEAR		= new /datum/weather/nerada8/clear(),
		WEATHER_OVERCAST	= new /datum/weather/nerada8/overcast(),
		WEATHER_LIGHT_SNOW	= new /datum/weather/nerada8/light_snow(),
		WEATHER_SNOW		= new /datum/weather/nerada8/snow(),
		WEATHER_BLIZZARD	= new /datum/weather/nerada8/blizzard(),
		WEATHER_RAIN		= new /datum/weather/nerada8/rain(),
		WEATHER_STORM		= new /datum/weather/nerada8/storm(),
		WEATHER_HAIL		= new /datum/weather/nerada8/hail(),
		WEATHER_BLOOD_MOON	= new /datum/weather/nerada8/blood_moon()
		)
...
/datum/weather/nerada8
	name = "nerada8 base"
	temp_high = 243.15 // -20c
	temp_low = 233.15  // -30c

/datum/weather/nerada8/clear
	name = "clear"
...
/datum/weather/nerada8/overcast
	name = "overcast"
	light_modifier = 0.8
	transition_chances = list(
		WEATHER_CLEAR = 25,
...
/datum/weather/nerada8/light_snow
	name = "light snow"
...
/datum/weather/nerada8/light_snow/process_effects()
	..()
...
/datum/weather/nerada8/snow/process_effects()
	..()
	for(var/mob/living/L in living_mob_list)
		if(L.z in holder.our_planet.expected_z_levels)
			var/turf/T = get_turf(L)
...
/datum/weather/nerada8/blizzard
	name = "blizzard"
...
/datum/weather/nerada8/blizzard/process_effects()
	..()
	for(var/mob/living/L in living_mob_list)
		if(L.z in holder.our_planet.expected_z_levels)
			var/turf/T = get_turf(L)
...
/datum/weather/nerada8/rain/process_effects()
	..()
	for(var/mob/living/L in living_mob_list)
		if(L.z in holder.our_planet.expected_z_levels)
			var/turf/T = get_turf(L)
...
/datum/weather/nerada8/storm/process_effects()
	..()
	for(var/mob/living/L in living_mob_list)
		if(L.z in holder.our_planet.expected_z_levels)
			var/turf/T = get_turf(L)
...
/datum/weather/nerada8/storm/proc/handle_lightning()
...
/datum/weather/nerada8/hail/process_effects()
	..()
...
/datum/weather/nerada8/blood_moon
	name = "blood moon"
	light_modifier = 0.5
	light_color = "#FF0000"
