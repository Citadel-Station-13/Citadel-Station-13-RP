...
import { Component, createRef, FocusEventHandler, KeyboardEventHandler, MouseEventHandler, RefObject } from 'inferno';
...
export class NumberInput extends Component<Props, State> {
  ...
  handleBlur: FocusEventHandler<HTMLInputElement> = (event) => {
    ...
    const targetValue = clamp(
      // i fukign love inferno types!!!! (have to explicitly set target type)
      // even though its set in FocusEventHandler
