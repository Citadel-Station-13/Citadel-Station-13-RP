...
LayoutContent.defaultHooks = {
  // bug: no way to test if `scrollable` is false or not (should not hook if not!)
  onComponentDidMount: (node: HTMLDivElement) => addScrollableNode(node),
  onComponentWillUnmount: (node: HTMLDivElement) => removeScrollableNode(node),
};
