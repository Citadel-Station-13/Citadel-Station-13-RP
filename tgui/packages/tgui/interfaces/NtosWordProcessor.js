    ...
    <NtosWindow resizable theme={PC_device_theme}>
      <NtosWindow.Content scrollable>
        {error && (
          ...
          <Section title="File Browser" buttons={
            <Button
              icon="arrow-left"
          ...
          <Section title={"Document: " + filename}>
            <Box>
              <Button
                onClick={() => act("PRG_newfile")}>
                New
              </Button>
              <Button
                onClick={() => act("PRG_loadmenu")}>
                Load
              </Button>
              <Button
                onClick={() => act("PRG_savefile")}>
                Save
              </Button>
              <Button
                onClick={() => act("PRG_saveasfile")}>
                Save As
              </Button>
            </Box>
            <Box>
              <Button
                onClick={() => act("PRG_editfile")}>
                Edit
              </Button>
              <Button
                onClick={() => act("PRG_txtrpeview")}>
                Preview
              </Button>
              <Button
                onClick={() => act("PRG_taghelp")}>
                Formatting Help
              </Button>
              <Button
                disabled={!filedata}
            ...
            {/* This dangerouslySetInnerHTML is only ever passed data that has
              * passed through pencode2html.
