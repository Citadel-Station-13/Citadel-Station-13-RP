...
export const MaterialProcessor = (props, context) => {
  ...
  const { on, fast, ores, unclaimedPoints, idName, idPoints } = data;
                  ...
                  <Fragment>
                    <Button
                      ...
                      onClick={() =>
                        act('change_mode', {
                          ore: ore.name,
                          mode: MaterialProcessorMode.Alloy,
                        })
                      }
                    />
                    <Button
                      ...
                      onClick={() =>
                        act('change_mode', {
                          ore: ore.name,
                          mode: MaterialProcessorMode.Smelt,
                        })
                      }
                    />
                    <Button
                      ...
                      tooltipPosition="top"
                      selected={
                        ore.processing === MaterialProcessorMode.Compress
                      }
                      onClick={() =>
                        act('change_mode', {
                          ore: ore.name,
                          mode: MaterialProcessorMode.Compress,
                        })
                      }
                    />
                    <Button
                      ...
                      onClick={() =>
                        act('change_mode', {
                          ore: ore.name,
                          mode: MaterialProcessorMode.None,
                        })
                      }
                    />
                  </Fragment>
