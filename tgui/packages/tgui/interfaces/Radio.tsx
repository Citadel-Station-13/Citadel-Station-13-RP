...
export const Radio = (props) => {
  ...
  const tunedChannel = RADIO_CHANNELS
    .find(channel => channel.freq === Number(rawfreq));
    ...
    <Window
      ...
      <Window.Content>
          ...
          <LabeledList>
            <LabeledList.Item label="Frequency">
              <NumberInput
                ...
                onChange={(value) => act('setFrequency', {
        ...
        <Section title="Channels">
          ...
          <LabeledList>
            {!chan_list ? null : chan_list.map(channel => {
              const channeldata = RADIO_CHANNELS
                .find(c => c.freq === Number(channel.freq));
              let color = "default";
              if (channeldata) {
