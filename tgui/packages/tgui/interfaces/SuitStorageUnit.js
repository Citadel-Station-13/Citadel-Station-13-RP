...
const SuitStorageUnitPanel = (props, context) => {
  ...
  return (
    <Section title="Maintenance Panel">
      ...
      <br />
      <Box>
        A small dial with a biohazard symbol next to it.
        It&apos;s pointing towards a gauge that
        reads {uv_super ? "15nm" : "185nm"}.
        <Flex
          mt={1}
          align="center"
          textAlign="center">
...
const SuitStorageUnitBroken = (props, context) => {
  return (
    <NoticeBox danger>
      ...
      Please call for a qualified individual to perform maintenance.
    </NoticeBox>
  );
};
