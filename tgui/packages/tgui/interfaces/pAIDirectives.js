      ...
      <Window.Content scrollable>
        ...
        <Section title="Directives">
          ...
          <Box mt={1} italic>
            ...
            tripping over pedantics and getting snared by technicalities.
            Above all, you should strive to be seen as the ideal, unwavering
            digital companion that you are.
          </Box>
          <Box mt={1} bold>
