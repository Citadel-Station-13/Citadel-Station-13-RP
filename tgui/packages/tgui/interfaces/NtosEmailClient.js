...
export const NtosEmailClientViewMessage = (props, context) => {
  ...
  return (
    <Section title={cur_title} buttons={administrator ? (
      <Button
        icon="times"
        onClick={() => act("back")} />
    ) : (
  ...
  return (
    <Section title="New Message" level={2} buttons={
      ...
      <LabeledList>
        ...
        <LabeledList.Item label="Attachments" buttons={msg_hasattachment && (
          <Button
            color="bad"
            icon="times"
...
const NtosEmailClientError = (props, context) => {
  ...
  return (
    <Section title="Notification" buttons={
      <Button
        icon="arrow-left"
        content="Return"
        onClick={() => act("reset")} />
