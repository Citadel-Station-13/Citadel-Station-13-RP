  ...
  return (
    <Window
      ...
      <Window.Content>
        ...
        {primary && secondary ? (
          <Flex spacing={1}>
            <Flex.Item shrink={1} grow={1}><TEGCirculator name="Primary Circulator" values={primary} /></Flex.Item>
            <Flex.Item shrink={1} grow={1}><TEGCirculator name="Secondary Circulator" values={secondary} /></Flex.Item>
          </Flex>
        ) : (
          <Box color="bad">
            Warning! Both circulators must be connected in order
