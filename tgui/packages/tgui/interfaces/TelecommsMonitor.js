...
export const TelecommsMonitor = (props, context) => {
  ...
  const [tab, setTab] = useSharedState(context, 'tab', 'network-entity');
  const operational = selected && selected.status;

  return (
    <Window theme="ntos" resizable width={575} height={400}>
            ...
            <Section title="Network Entity Status">
              <LabeledList>
                  ...
                  <ProgressBar
                    ...
                    ranges={{
                      good: [
                        // 0-30%
                        -Infinity,
                        selected.netspeed * 0.3,
                      ],
                      average: [
                        // 30-70%
                        selected.netspeed * 0.31,
                        selected.traffic * 0.7,
                      ],
                      bad: [
                        // 70-100%
                ...
                <LabeledList.Item label="Frequency Listening">
                  <Box>
                    {operational &&
                      selected.freq_listening.map((thing) => {
              ...
              <Section title="Servers Linked" level={3}>
