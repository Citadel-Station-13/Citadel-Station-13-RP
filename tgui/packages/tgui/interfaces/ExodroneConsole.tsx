...
const TravelTargetSelectionScreen = (
  ...
  const { can_travel, travel_error, drone_travel_coefficient } = drone;
        ...
        {site && (
          <Section
            ...
            buttons={
              <Box>
                ETA:{' '}
                {formatTime(site.distance * drone_travel_coefficient, 'short')}
                <Button
                  ml={1}
...
const TimeoutScreen = (props: { readonly drone: DroneBusy }) => {
...
const DroneScreen = (props: { readonly drone: ActiveDrone & DroneData }) => {
  const { drone } = props;
