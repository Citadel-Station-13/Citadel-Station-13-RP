  ...
  assembleState = (): ColorPickerState => {
    if (typeof this.props.currentColor !== 'string') {
      ...
      return {
        ...
        cBlue: 255,
        cAlpha: 255,
        cMatrix: ConvertByondColorMatrixtoRGBAC(
          this.props.currentColor as ByondColorMatrix,
        ),
      };
    } else {
      // string
                    ...
                    <Stack vertical>
                      <Stack.Item textAlign="center">
                        ...
                        <Slider
                          ...
                          value={cHue}
                          onDrag={(e, val) => {
                            let [r, g, b] = HSVtoRGB(val, cSat, cVal).map((n) =>
                              round(n, 2),
                            );
                            this.setState((prev) => ({
                              ...prev,
                      ...
                      <Stack.Item textAlign="center">
                        ...
                        <Slider
                          ...
                          value={cSat}
                          onDrag={(e, val) => {
                            let [r, g, b] = HSVtoRGB(cHue, val, cVal).map((n) =>
                              round(n, 2),
                            );
                            this.setState((prev) => ({
                              ...prev,
                      ...
                      <Stack.Item textAlign="center">
                        ...
                        <Slider
                          ...
                          value={cVal}
                          onDrag={(e, val) => {
                            let [r, g, b] = HSVtoRGB(cHue, cSat, val).map((n) =>
                              round(n, 2),
                            );
                            this.setState((prev) => ({
                              ...prev,
                          ...
                          return (
                            <Table.Cell key={i2}>
                              ...
                              <NumberInput
                                ...
                                maxValue={10}
                                step={0.01}
                                value={this.state.cMatrix[ifull]}
                                onChange={(e, val) => {
                                  this.setState((prev) => {
                                    ...
                                    return {
                                      ...prev,
                                      cMatrix:
                                        modified as ByondColorMatrixRGBAC,
                                    };
                                  });
                                  this.props.setColor(this.state.cMatrix);
                                }}
                          ...
                          return (
                            <Table.Cell key={i2}>
                              ...
                              <NumberInput
                                ...
                                maxValue={10}
                                step={0.01}
                                value={round(this.state.cMatrix[ifull], 4)}
                                onChange={(e, val) => {
                                  this.setState((prev) => {
                                    let modified = prev.cMatrix.slice();
                                    modified[ifull] = val;
                                  ...
                                  this.props.setColor(
                                    ConvertByondColorMatrixRGBACToRGBC(
                                      this.state.cMatrix,
                                    ),
                                  );
                                }}
