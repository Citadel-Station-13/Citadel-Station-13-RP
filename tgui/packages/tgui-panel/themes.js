...
export const setClientTheme = name => {
  ...
  if (name === 'light') {
    return Byond.winset({
      ...
      'stat_tab.tab-background-color': COLOR_WHITE_DARKBG,
      'stat_tab.tab-text-color': COLOR_WHITE_TEXT,
  ...
  if (name === 'dark') {
    Byond.winset({
      ...
      'stat_tab.tab-background-color': COLOR_DARK_BG,
      'stat_tab.tab-text-color': COLOR_DARK_TEXT,
