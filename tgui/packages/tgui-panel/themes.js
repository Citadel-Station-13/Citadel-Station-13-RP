...
export const setClientTheme = name => {
  ...
  if (name === 'light') {
    return Byond.winset({
      ...
      'statbrowserbackground-color': COLOR_WHITE_BG,
      'statbrowsertab-background-color': COLOR_WHITE_DARKBG,
      'statbrowsertext-color': COLOR_WHITE_TEXT,
      'statbrowsertab-text-color': COLOR_WHITE_TEXT,
      'statbrowserprefix-color': COLOR_WHITE_TEXT,
      'statbrowsersuffix-color': COLOR_WHITE_TEXT,
  ...
  if (name === 'dark') {
    Byond.winset({
      ...
      'statbrowserbackground-color': COLOR_DARK_DARKBG,
      'statbrowsertab-background-color': COLOR_DARK_BG,
      'statbrowsertext-color': COLOR_DARK_TEXT,
      'statbrowsertab-text-color': COLOR_DARK_TEXT,
      'statbrowserprefix-color': COLOR_DARK_TEXT,
      'statbrowsersuffix-color': COLOR_DARK_TEXT,
      // Say, OOC, me Buttons etc.
